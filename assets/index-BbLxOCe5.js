 ...
 */const Es=function(i){const e=[];let n=0;for(let r=0;r<i.length;r++){let o=i.charCodeAt(r);o<128?e[n++]=o:o<2048?(e[n++]=o>>6|192,e[n++]=o&63|128):(o&64512)===55296&&r+1<i.length&&(i.charCodeAt(r+1)&64512)===56320?(o=65536+((o&1023)<<10)+(i.charCodeAt(++r)&1023),e[n++]=o>>18|240,e[n++]=o>>12&63|128,e[n++]=o>>6&63|128,e[n++]=o&63|128):(e[n++]=o>>12|224,e[n++]=o>>6&63|128,e[n++]=o&63|128)}return e},Xo=function(i){const e=[];let n=0,r=0;for(;n<i.length;){const o=i[n++];if(o<128)e[r++]=String.fromCharCode(o);else if(o>191&&o<224){const c=i[n++];e[r++]=String.fromCharCode((o&31)<<6|c&63)}else if(o>239&&o<365){const c=i[n++],l=i[n++],u=i[n++],p=((o&7)<<18|(c&63)<<12|(l&63)<<6|u&63)-65536;e[r++]=String.fromCharCode(55296+(p>>10)),e[r++]=String.fromCharCode(56320+(p&1023))}else{const c=i[n++],l=i[n++];e[r++]=String.fromCharCode((o&15)<<12|(c&63)<<6|l&63)}}return e.join("")},ks={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(i,e){if(!Array.isArray(i))throw Error("encodeByteArray takes an array as a parameter");this.init_();const n=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,r=[];for(let o=0;o<i.length;o+=3){const c=i[o],l=o+1<i.length,u=l?i[o+1]:0,p=o+2<i.length,_=p?i[o+2]:0,E=c>>2,S=(c&3)<<4|u>>4;let w=(u&15)<<2|_>>6,k=_&63;p||(k=64,l||(w=64)),r.push(n[E],n[S],n[w],n[k])}return r.join("")},encodeString(i,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(i):this.encodeByteArray(Es(i),e)},decodeString(i,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(i):Xo(this.decodeStringToByteArray(i,e))},decodeStringToByteArray(i,e){this.init_();const n=e?this.charToByteMapWebSafe_:this.charToByteMap_,r=[];for(let o=0;o<i.length;){const c=n[i.charAt(o++)],u=o<i.length?n[i.charAt(o)]:0;++o;const _=o<i.length?n[i.charAt(o)]:64;++o;const S=o<i.length?n[i.charAt(o)]:64;if(++o,c==null||u==null||_==null||S==null)throw new Yo;const w=c<<2|u>>4;if(r.push(w),_!==64){const k=u<<4&240|_>>2;if(r.push(k),S!==64){const P=_<<6&192|S;r.push(P)}}}return r},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let i=0;i<this.ENCODED_VALS.length;i++)this.byteToCharMap_[i]=this.ENCODED_VALS.charAt(i),this.charToByteMap_[this.byteToCharMap_[i]]=i,this.byteToCharMapWebSafe_[i]=this.ENCODED_VALS_WEBSAFE.charAt(i),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[i]]=i,i>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(i)]=i,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(i)]=i)}}};class Yo extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const Qo=function(i){const e=Es(i);return ks.encodeByteArray(e,!0)},As=function(i){return Qo(i).replace(/\./g,"")},Os=function(i){try{return ks.decodeString(i,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ea=()=>Zo().__FIREBASE_DEFAULTS__,ta=()=>{if(typeof process>"u"||typeof xr>"u")return;const i=xr.__FIREBASE_DEFAULTS__;if(i)return JSON.parse(i)},ia=()=>{if(typeof document>"u")return;let i;try{i=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=i&&Os(i[1]);return e&&JSON.parse(e)},na=()=>{try{return Jo()||ea()||ta()||ia()}catch(i){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${i}`);return}},ra=i=>{var e;return(e=na())==null?void 0:e[`_${i}`]};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pe(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function sa(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(pe())}function oa(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function aa(){const i=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof i=="object"&&i.id!==void 0}function ca(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function la(){try{return typeof indexedDB=="object"}catch{return!1}}function da(){return new Promise((i,e)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",o=self.indexedDB.open(r);o.onsuccess=()=>{o.result.close(),n||self.indexedDB.deleteDatabase(r),i(!0)},o.onupgradeneeded=()=>{n=!1},o.onerror=()=>{var c;e(((c=o.error)==null?void 0:c.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ua="FirebaseError";class Le extends Error{constructor(e,n,r){super(n),this.code=e,this.customData=r,this.name=ua,Object.setPrototypeOf(this,Le.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Nt.prototype.create)}}class Nt{constructor(e,n,r){this.service=e,this.serviceName=n,this.errors=r}create(e,...n){const r=n[0]||{},o=`${this.service}/${e}`,c=this.errors[e],l=c?ha(c,r):"Error",u=`${this.serviceName}: ${l} (${o}).`;return new Le(o,u,r)}}function ha(i,e){return i.replace(fa,(n,r)=>{const o=e[r];return o!=null?String(o):`<${r}?>`})}const fa=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var j;(function(i){i[i.DEBUG=0]="DEBUG",i[i.VERBOSE=1]="VERBOSE",i[i.INFO=2]="INFO",i[i.WARN=3]="WARN",i[i.ERROR=4]="ERROR",i[i.SILENT=5]="SILENT"})(j||(j={}));const va={debug:j.DEBUG,verbose:j.VERBOSE,info:j.INFO,warn:j.WARN,error:j.ERROR,silent:j.SILENT},ya=j.INFO,_a={[j.DEBUG]:"log",[j.VERBOSE]:"log",[j.INFO]:"info",[j.WARN]:"warn",[j.ERROR]:"error"},Ia=(i,e,...n)=>{if(e<i.logLevel)return;const r=new Date().toISOString(),o=_a[e];if(o)console[o](`[${r}]  ${i.name}:`,...n);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class yn{constructor(e){this.name=e,this._logLevel=ya,this._logHandler=Ia,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in j))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?va[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,j.DEBUG,...e),this._logHandler(this,j.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,j.VERBOSE,...e),this._logHandler(this,j.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,j.INFO,...e),this._logHandler(this,j.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,j.WARN,...e),this._logHandler(this,j.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,j.ERROR,...e),this._logHandler(this,j.ERROR,...e)}}const Ta=(i,e)=>e.some(n=>i instanceof n);let Nr,Rr;function wa(){return Nr||(Nr=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function ba(){return Rr||(Rr=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Cs=new WeakMap,an=new WeakMap,Ls=new WeakMap,Xi=new WeakMap,_n=new WeakMap;function Sa(i){const e=new Promise((n,r)=>{const o=()=>{i.removeEventListener("success",c),i.removeEventListener("error",l)},c=()=>{n(Oe(i.result)),o()},l=()=>{r(i.error),o()};i.addEventListener("success",c),i.addEventListener("error",l)});return e.then(n=>{n instanceof IDBCursor&&Cs.set(n,i)}).catch(()=>{}),_n.set(e,i),e}function Ea(i){if(an.has(i))return;const e=new Promise((n,r)=>{const o=()=>{i.removeEventListener("complete",c),i.removeEventListener("error",l),i.removeEventListener("abort",l)},c=()=>{n(),o()},l=()=>{r(i.error||new DOMException("AbortError","AbortError")),o()};i.addEventListener("complete",c),i.addEventListener("error",l),i.addEventListener("abort",l)});an.set(i,e)}let cn={get(i,e,n){if(i instanceof IDBTransaction){if(e==="done")return an.get(i);if(e==="objectStoreNames")return i.objectStoreNames||Ls.get(i);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return Oe(i[e])},set(i,e,n){return i[e]=n,!0},has(i,e){return i instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in i}};function ka(i){cn=i(cn)}function Aa(i){return i===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...n){const r=i.call(Yi(this),e,...n);return Ls.set(r,e.sort?e.sort():[e]),Oe(r)}:ba().includes(i)?function(...e){return i.apply(Yi(this),e),Oe(Cs.get(this))}:function(...e){return Oe(i.apply(Yi(this),e))}}function Oa(i){return typeof i=="function"?Aa(i):(i instanceof IDBTransaction&&Ea(i),Ta(i,wa())?new Proxy(i,cn):i)}function Oe(i){if(i instanceof IDBRequest)return Sa(i);if(Xi.has(i))return Xi.get(i);const e=Oa(i);return e!==i&&(Xi.set(i,e),_n.set(e,i)),e}const Yi=i=>_n.get(i);function Da(i,e,{blocked:n,upgrade:r,blocking:o,terminated:c}={}){const l=indexedDB.open(i,e),u=Oe(l);return r&&l.addEventListener("upgradeneeded",p=>{r(Oe(l.result),p.oldVersion,p.newVersion,Oe(l.transaction),p)}),n&&l.addEventListener("blocked",p=>n(p.oldVersion,p.newVersion,p)),u.then(p=>{c&&p.addEventListener("close",()=>c()),o&&p.addEventListener("versionchange",_=>o(_.oldVersion,_.newVersion,_))}).catch(()=>{}),u}const Pa=["get","getKey","getAll","getAllKeys","count"],Ca=["put","add","delete","clear"],Qi=new Map;function Mr(i,e){if(!(i instanceof IDBDatabase&&!(e in i)&&typeof e=="string"))return;if(Qi.get(e))return Qi.get(e);const n=e.replace(/FromIndex$/,""),r=e!==n,o=Ca.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(o||Pa.includes(n)))return;const c=async function(l,...u){const p=this.transaction(l,o?"readwrite":"readonly");let _=p.store;return r&&(_=_.index(u.shift())),(await Promise.all([_[n](...u),o&&p.done]))[0]};return Qi.set(e,c),c}ka(i=>({...i,get:(e,n,r)=>Mr(e,n)||i.get(e,n,r),has:(e,n)=>!!Mr(e,n)||i.has(e,n)}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class La{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(xa(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function xa(i){const e=i.getComponent();return(e==null?void 0:e.type)==="VERSION"}const ln="@firebase/app",$r="0.14.11";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ye=new yn("@firebase/app"),Na="@firebase/app-compat",Ra="@firebase/analytics-compat",Ma="@firebase/analytics",$a="@firebase/app-check-compat",Ba="@firebase/app-check",Wa="@firebase/auth",Ua="@firebase/auth-compat",Fa="@firebase/database",Va="@firebase/data-connect",ja="@firebase/database-compat",qa="@firebase/functions",Ha="@firebase/functions-compat",za="@firebase/installations",Ga="@firebase/installations-compat",Ka="@firebase/messaging",Ja="@firebase/messaging-compat",Xa="@firebase/performance",Ya="@firebase/performance-compat",Qa="@firebase/remote-config",Za="@firebase/remote-config-compat",ec="@firebase/storage",tc="@firebase/storage-compat",ic="@firebase/firestore",nc="@firebase/ai",rc="@firebase/firestore-compat",sc="firebase",oc="12.12.0",ac={[ln]:"fire-core",[Na]:"fire-core-compat",[Ma]:"fire-analytics",[Ra]:"fire-analytics-compat",[Ba]:"fire-app-check",[$a]:"fire-app-check-compat",[Wa]:"fire-auth",[Ua]:"fire-auth-compat",[Fa]:"fire-rtdb",[Va]:"fire-data-connect",[ja]:"fire-rtdb-compat",[qa]:"fire-fn",[Ha]:"fire-fn-compat",[za]:"fire-iid",[Ga]:"fire-iid-compat",[Ka]:"fire-fcm",[Ja]:"fire-fcm-compat",[Xa]:"fire-perf",[Ya]:"fire-perf-compat",[Qa]:"fire-rc",[Za]:"fire-rc-compat",[ec]:"fire-gcs",[tc]:"fire-gcs-compat",[ic]:"fire-fst",[rc]:"fire-fst-compat",[nc]:"fire-vertex","fire-js":"fire-js",[sc]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cc=new Map,lc=new Map,Br=new Map;function Wr(i,e){try{i.container.addComponent(e)}catch(n){ye.debug(`Component ${e.name} failed to register with FirebaseApp ${i.name}`,n)}}function tt(i){const e=i.name;if(Br.has(e))return ye.debug(`There were multiple attempts to register component ${e}.`),!1;Br.set(e,i);for(const n of cc.values())Wr(n,i);for(const n of lc.values())Wr(n,i);return!0}function $e(i){return i==null?!1:i.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uc="firebase-heartbeat-database",hc=1,kt="firebase-heartbeat-store";let Zi=null;function xs(){return Zi||(Zi=Da(uc,hc,{upgrade:(i,e)=>{switch(e){case 0:try{i.createObjectStore(kt)}catch(n){console.warn(n)}}}}).catch(i=>{throw In.create("idb-open",{originalErrorMessage:i.message})})),Zi}async function fc(i){try{const n=(await xs()).transaction(kt),r=await n.objectStore(kt).get(Ns(i));return await n.done,r}catch(e){if(e instanceof Le)ye.warn(e.message);else{const n=In.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});ye.warn(n.message)}}}async function Ur(i,e){try{const r=(await xs()).transaction(kt,"readwrite");await r.objectStore(kt).put(e,Ns(i)),await r.done}catch(n){if(n instanceof Le)ye.warn(n.message);else{const r=In.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});ye.warn(r.message)}}}function Ns(i){return`${i.name}!${i.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mc=1024,pc=30;class gc{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new yc(n),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){var e,n;try{const o=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),c=Fr();if(((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((n=this._heartbeatsCache)==null?void 0:n.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===c||this._heartbeatsCache.heartbeats.some(l=>l.date===c))return;if(this._heartbeatsCache.heartbeats.push({date:c,agent:o}),this._heartbeatsCache.heartbeats.length>pc){const l=_c(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(l,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(r){ye.warn(r)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const n=Fr(),{heartbeatsToSend:r,unsentEntries:o}=vc(this._heartbeatsCache.heartbeats),c=As(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=n,o.length>0?(this._heartbeatsCache.heartbeats=o,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),c}catch(n){return ye.warn(n),""}}}function Fr(){return new Date().toISOString().substring(0,10)}function vc(i,e=mc){const n=[];let r=i.slice();for(const o of i){const c=n.find(l=>l.agent===o.agent);if(c){if(c.dates.push(o.date),Vr(n)>e){c.dates.pop();break}}else if(n.push({agent:o.agent,dates:[o.date]}),Vr(n)>e){n.pop();break}r=r.slice(1)}return{heartbeatsToSend:n,unsentEntries:r}}class yc{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return la()?da().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const n=await fc(this.app);return n!=null&&n.heartbeats?n:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const r=await this.read();return Ur(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const r=await this.read();return Ur(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:[...r.heartbeats,...e.heartbeats]})}else return}}function Vr(i){return As(JSON.stringify({version:2,heartbeats:i})).length}function _c(i){if(i.length===0)return-1;let e=0,n=i[0].date;for(let r=1;r<i.length;r++)i[r].date<n&&(n=i[r].date,e=r);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ic(i){tt(new et("platform-logger",e=>new La(e),"PRIVATE")),tt(new et("heartbeat",e=>new gc(e),"PRIVATE")),De(ln,$r,i),De(ln,$r,"esm2020"),De("fire-js","")}Ic("");var Tc="firebase",wc="12.12.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */De(Tc,wc,"app");var jr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let yi="12.12.0";function bc(i){yi=i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class He{constructor(e){this.binaryString=e}static fromBase64String(e){const n=function(o){try{return atob(o)}catch(c){throw typeof DOMException<"u"&&c instanceof DOMException?new Wc("Invalid base64 string: "+c):c}}(e);return new He(n)}static fromUint8Array(e){const n=function(o){let c="";for(let l=0;l<o.length;++l)c+=String.fromCharCode(o[l]);return c}(e);return new He(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(n){return btoa(n)}(this.binaryString)}toUint8Array(){return function(n){const r=new Uint8Array(n.length);for(let o=0;o<n.length;o++)r[o]=n.charCodeAt(o);return r}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return Pe(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}He.EMPTY_BYTE_STRING=new He("");const Kr="(default)";class ci{constructor(e,n){this.projectId=e,this.database=n||Kr}static empty(){return new ci("","")}get isDefaultDatabase(){return this.database===Kr}isEqual(e){return e instanceof ci&&e.projectId===this.projectId&&e.database===this.database}}function Uc(i,e){if(!Object.prototype.hasOwnProperty.apply(i.options,["projectId"]))throw new F(U.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ci(i.options.projectId,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fc{constructor(e,n=null,r=[],o=[],c=null,l="F",u=null,p=null){this.path=e,this.collectionGroup=n,this.explicitOrderBy=r,this.filters=o,this.limit=c,this.limitType=l,this.startAt=u,this.endAt=p,this.Ee=null,this.Ie=null,this.Re=null,this.startAt,this.endAt}}function Vc(i){return new Fc(i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zc(i){const e={};return i.timeoutSeconds!==void 0&&(e.timeoutSeconds=i.timeoutSeconds),e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gc="ComponentProvider",Qr=new Map;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */wt._jsonSchemaVersion="firestore/querySnapshot/1.0",wt._jsonSchema={type:K("string",wt._jsonSchemaVersion),bundleSource:K("string","QuerySnapshot"),bundleName:K("string"),bundle:K("string")};(function(e,n=!0){bc(vi),tt(new et("firestore",(r,{instanceIdentifier:o,options:c})=>{const l=r.getProvider("app").getImmediate(),u=new Xc(new kc(r.getProvider("auth-internal")),new Dc(l,r.getProvider("app-check-internal")),Uc(l,o),l);return c={useFetchStreams:n,...c},u._setSettings(c),u},"PUBLIC").setMultipleInstances(!0)),De(rs,ss,e),De(rs,ss,"esm2020")})();function Fs(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const tl=Fs,Vs=new Nt("auth","Firebase",Fs());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const li=new yn("@firebase/auth");function il(i,...e){li.logLevel<=j.WARN&&li.warn(`Auth (${vi}): ${i}`,...e)}function ni(i,...e){li.logLevel<=j.ERROR&&li.error(`Auth (${vi}): ${i}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function os(i,...e){throw En(i,...e)}function js(i,...e){return En(i,...e)}function qs(i,e,n){const r={...tl(),[e]:n};return new Nt("auth","Firebase",r).create(e,{appName:i.name})}function ri(i){return qs(i,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function En(i,...e){if(typeof i!="string"){const n=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=i.name),i._errorFactory.create(n,...r)}return Vs.create(i,...e)}function W(i,e,...n){if(!i)throw En(e,...n)}function bt(i){const e="INTERNAL ASSERTION FAILED: "+i;throw ni(e),new Error(e)}function di(i,e){i||bt(e)}function nl(){return as()==="http:"||as()==="https:"}function as(){var i;return typeof self<"u"&&((i=self.location)==null?void 0:i.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rl(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(nl()||aa()||"connection"in navigator)?navigator.onLine:!0}function sl(){if(typeof navigator>"u")return null;const i=navigator;return i.languages&&i.languages[0]||i.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $t{constructor(e,n){this.shortDelay=e,this.longDelay=n,di(n>e,"Short delay should be less than long delay!"),this.isMobile=sa()||ca()}get(){return rl()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ol(i,e){di(i.emulator,"Emulator should always be set here");const{url:n}=i.emulator;return e?`${n}${e.startsWith("/")?e.slice(1):e}`:n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cl=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],ll=new $t(3e4,6e4);function zs(i,e){return i.tenantId&&!e.tenantId?{...e,tenantId:i.tenantId}:e}async function _i(i,e,n,r,o={}){return Gs(i,o,async()=>{let c={},l={};r&&(e==="GET"?l=r:c={body:JSON.stringify(r)});const u=Ds({key:i.config.apiKey,...l}).slice(1),p=await i._getAdditionalHeaders();p["Content-Type"]="application/json",i.languageCode&&(p["X-Firebase-Locale"]=i.languageCode);const _={method:e,headers:p,...c};return oa()||(_.referrerPolicy="no-referrer"),i.emulatorConfig&&Ps(i.emulatorConfig.host)&&(_.credentials="include"),Hs.fetch()(await Ks(i,i.config.apiHost,n,u),_)})}async function Gs(i,e,n){i._canInitEmulator=!1;const r={...al,...e};try{const o=new dl(i),c=await Promise.race([n(),o.promise]);o.clearNetworkTimeout();const l=await c.json();if("needConfirmation"in l)throw Zt(i,"account-exists-with-different-credential",l);if(c.ok&&!("errorMessage"in l))return l;{const u=c.ok?l.errorMessage:l.error.message,[p,_]=u.split(" : ");if(p==="FEDERATED_USER_ID_ALREADY_LINKED")throw Zt(i,"credential-already-in-use",l);if(p==="EMAIL_EXISTS")throw Zt(i,"email-already-in-use",l);if(p==="USER_DISABLED")throw Zt(i,"user-disabled",l);const E=r[p]||p.toLowerCase().replace(/[_\s]+/g,"-");if(_)throw qs(i,E,_);os(i,E)}}catch(o){if(o instanceof Le)throw o;os(i,"network-request-failed",{message:String(o)})}}async function Ks(i,e,n,r){const o=`${e}${n}?${r}`,c=i,l=c.config.emulator?ol(i.config,o):`${i.config.apiScheme}://${o}`;return cl.includes(n)&&(await c._persistenceManagerAvailable,c._getPersistenceType()==="COOKIE")?c._getPersistence()._getFinalTarget(l).toString():l}class dl{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,r)=>{this.timer=setTimeout(()=>r(js(this.auth,"network-request-failed")),ll.get())})}}function Zt(i,e,n){const r={appName:i.name};n.email&&(r.email=n.email),n.phoneNumber&&(r.phoneNumber=n.phoneNumber);const o=js(i,e,r);return o.customData._tokenResponse=n,o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ul(i,e){return _i(i,"POST","/v1/accounts:delete",e)}async function ui(i,e){return _i(i,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function un(i,e,n=!1){if(n)return e;try{return await e}catch(r){throw r instanceof Le&&fl(r)&&i.auth.currentUser===i&&await i.auth.signOut(),r}}function fl({code:i}){return i==="auth/user-disabled"||i==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function us(i){const e=i.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(wl(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(_l(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Sl(e))return"Blackberry";if(El(e))return"Webos";if(Il(e))return"Safari";if((e.includes("chrome/")||Tl(e))&&!e.includes("edge/"))return"Chrome";if(bl(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=i.match(n);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function _l(i=pe()){return/firefox\//i.test(i)}function Il(i=pe()){const e=i.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Tl(i=pe()){return/crios\//i.test(i)}function wl(i=pe()){return/iemobile/i.test(i)}function bl(i=pe()){return/android/i.test(i)}function Sl(i=pe()){return/blackberry/i.test(i)}function El(i=pe()){return/webos/i.test(i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kl{constructor(e){this.auth=e,this.queue=[]}pushCallback(e,n){const r=c=>new Promise((l,u)=>{try{const p=e(c);l(p)}catch(p){u(p)}});r.onAbort=n,this.queue.push(r);const o=this.queue.length-1;return()=>{this.queue[o]=()=>Promise.resolve()}}async runMiddleware(e){if(this.auth.currentUser===e)return;const n=[];try{for(const r of this.queue)await r(e),r.onAbort&&n.push(r.onAbort)}catch(r){n.reverse();for(const o of n)try{o()}catch{}throw this.auth._errorFactory.create("login-blocked",{originalMessage:r==null?void 0:r.message})}}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Al(i,e={}){return _i(i,"GET","/v2/passwordPolicy",zs(i,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nl(i){switch(i){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Rl(i){tt(new et("auth",(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),o=e.getProvider("heartbeat"),c=e.getProvider("app-check-internal"),{apiKey:l,authDomain:u}=r.options;W(l&&!l.includes(":"),"invalid-api-key",{appName:r.name});const p={apiKey:l,authDomain:u,clientPlatform:i,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Qs(i)},_=new Pl(r,o,c,p);return Ll(_,n),_},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,r)=>{e.getProvider("auth-internal").initialize()})),tt(new et("auth-internal",e=>{const n=Cl(e.getProvider("auth").getImmediate());return(r=>new xl(r))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),De(fs,ms,Nl(i)),De(fs,ms,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ml=5*60;ra("authIdTokenMaxAge");Rl("Browser");console.warn("⚠️ Firebase未設定。.envファイルにAPIキーを設定してください。");function Zs(i){const e=new Date(i),n=e.getFullYear(),r=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${n}-${r}-${o}`}function At(i){const e=new Date(i),n=["日","月","火","水","木","金","土"];return`${e.getMonth()+1}月${e.getDate()}日（${n[e.getDay()]}）`}function Bt(){return Zs(new Date)}function eo(i){const e=Math.floor(i/60),n=i%60;return`${String(e).padStart(2,"0")}:${String(n).padStart(2,"0")}`}function te(i){if(!i)return 0;const[e,n]=i.split(":").map(Number);return e*60+n}function to(){return Date.now().toString(36)+Math.random().toString(36).slice(2,9)}function io(i,e,n,r){const c=ei(n-i),l=ei(r-e),u=Math.sin(c/2)**2+Math.cos(ei(i))*Math.cos(ei(n))*Math.sin(l/2)**2;return 6371*2*Math.atan2(Math.sqrt(u),Math.sqrt(1-u))}function ei(i){return i*(Math.PI/180)}function se(i){const e=document.createElement("div");return e.textContent=i,e.innerHTML}function R(i,e="info",n=3e3){const r=document.getElementById("toast-container"),o={success:"check_circle",error:"error",warning:"warning",info:"info"},c=document.createElement("div");c.className=`toast ${e}`,c.innerHTML=`
  ...
  `,r.appendChild(c),setTimeout(()=>{c.style.opacity="0",c.style.transform="translateX(40px)",c.style.transition="all .3s ease",setTimeout(()=>c.remove(),300)},n)}function Ii(i,e,n=""){const r=document.getElementById("modal-overlay");document.getElementById("modal-title").textContent=i,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=n,r.style.display="flex"}function Ce(){document.getElementById("modal-overlay").style.display="none"}function Ti(i,e){return new Promise(n=>{const r=`<p>${se(e)}</p>`;Ii(i,r,`
    ...
    `),document.getElementById("confirm-ok").onclick=()=>{Ce(),n(!0)},document.getElementById("confirm-cancel").onclick=()=>{Ce(),n(!1)}})}function Ot(i,e){const r={身体介護:{20:1670,30:2500,60:3960,90:5790,120:7630},生活援助:{20:1830,45:2250,60:2870},通院等乗降介助:{per_trip:990},医療的ケア:{30:3e3,60:5e3}}[i];if(!r)return 3e3;if(r.per_trip)return r.per_trip;const o=Object.keys(r).map(Number).sort((l,u)=>l-u);let c=o[0];for(const l of o)e>=l&&(c=l);return r[c]||3e3}function $l(i){{console.warn("Firebase未設定のためログイン画面を表示します"),setTimeout(()=>i(null,null),100);return}}async function Bl(){throw new Error("Firebase未設定です。.envにAPIキーを設定してください。")}async function Wl(){}function Ul(){const i=document.getElementById("btn-google-login");i&&i.addEventListener("click",async()=>{i.disabled=!0,i.textContent="ログイン中...";try{await Bl()}catch(e){console.error("ログインエラー:",e),e.code==="auth/popup-closed-by-user"?R("ログインがキャンセルされました","warning"):R("ログインに失敗しました","error"),i.disabled=!1,i.innerHTML=`
        ...
        Googleアカウントでログイン
      `}})}const Ae={};function it(i){if(!Ae[i]){const e=localStorage.getItem(`careroute_${i}`);Ae[i]=e?JSON.parse(e):[]}return Ae[i]}function wi(i){localStorage.setItem(`careroute_${i}`,JSON.stringify(Ae[i]||[]))}async function ps(){localStorage.removeItem("careroute_staff"),localStorage.removeItem("careroute_clients"),localStorage.removeItem("careroute_visits"),localStorage.removeItem("careroute_routes"),Ae.staff=[],Ae.clients=[],Ae.visits=[],Ae.routes=[]}async function kn(i,e){{const n=to();return it(i).push({id:n,...e,createdAt:new Date().toISOString()}),wi(i),n}}async function An(i){return it(i)}async function On(i,e,n){{const r=it(i),o=r.findIndex(c=>c.id===e);o!==-1&&(r[o]={...r[o],...n,updatedAt:new Date().toISOString()},wi(i));return}}async function Dn(i,e){{const n=it(i),r=n.findIndex(o=>o.id===e);r!==-1&&(n.splice(r,1),wi(i));return}}async function no(i,e,n,r){return it(i).filter(c=>c[e]===r)}async function ge(){return An("staff")}async function ro(i){return kn("staff",i)}async function Fl(i,e){return On("staff",i,e)}async function Vl(i){return Dn("staff",i)}async function _e(){return An("clients")}async function so(i){return kn("clients",i)}async function jl(i,e){return On("clients",i,e)}async function ql(i){return Dn("clients",i)}async function oo(){return An("visits")}async function ze(i){return no("visits","date","==",i)}async function Pn(i){return kn("visits",i)}async function gs(i,e){return On("visits",i,e)}async function Hl(i){return Dn("visits",i)}async function Cn(i){return no("routes","date","==",i)}async function zl(i){{const e=it("routes");for(const n of i){const r=e.findIndex(o=>o.staffId===n.staffId&&o.date===n.date);r>=0?e[r]={...n,updatedAt:new Date().toISOString()}:e.push({id:to(),...n,createdAt:new Date().toISOString()})}wi("routes");return}}async function Gl(){const i=document.getElementById("page-container"),[e,n]=await Promise.all([ge().catch(()=>[]),_e().catch(()=>[])]),r=Bt(),o=await ze(r).catch(()=>[]),c=e.filter(p=>p.isActive),l=n.filter(p=>p.isActive),u=o.filter(p=>p.status!=="cancelled");i.innerHTML=`
  ...
  `,document.getElementById("btn-add-staff").addEventListener("click",()=>uo())}function ad(i){return i.length===0?`
  ...
  `}function uo(i=null){const e=!!i,n=e?"職員情報の編集":"新規職員登録",r=`
    <form id="staff-form">
      <div class="form-row">
  ...
  `),document.getElementById("sf-cancel").onclick=Ce,document.getElementById("sf-save").onclick=async()=>{const c=document.getElementById("sf-name").value.trim();if(!c){R("氏名を入力してください","warning");return}const l=document.getElementById("sf-save");l.disabled=!0,l.textContent="保存中...";const u=document.getElementById("sf-address").value.trim();let p=(i==null?void 0:i.lat)||Q.lat,_=(i==null?void 0:i.lng)||Q.lng;if(u)try{await Ct();const S=await co(u);S?(p=S.lat,_=S.lng):R("住所から座標を取得できませんでした","warning")}catch(S){console.warn("ジオコーディング失敗:",S)}const E={name:c,gender:document.getElementById("sf-gender").value,address:u,workStart:document.getElementById("sf-work-start").value,workEnd:document.getElementById("sf-work-end").value,lat:p,lng:_,skills:{},color:(i==null?void 0:i.color)||_s[Lt.length%_s.length],isActive:!0};for(const[S]of Object.entries(fi)){const w=document.querySelectorAll(`input[name="skill-${S}"]:checked`);E.skills[S]=Array.from(w).map(k=>k.value)}try{e?(await Fl(i.id,E),R("職員情報を更新しました","success")):(await ro(E),R("職員を登録しました","success")),Ce(),await Ln()}catch(S){R("保存に失敗しました: "+S.message,"error")}finally{l.disabled=!1,l.textContent=e?"更新":"登録"}}}document.addEventListener("click",async i=>{const e=i.target.closest("[data-edit-staff]");if(e){const r=Lt.find(o=>o.id===e.dataset.editStaff);r&&uo(r)}const n=i.target.closest("[data-delete-staff]");if(n){const r=Lt.find(o=>o.id===n.dataset.deleteStaff);if(r&&await Ti("削除確認",`${r.name} を削除しますか？`))try{await Vl(r.id),R(`${r.name} を削除しました`,"success"),await Ln()}catch{R("削除に失敗しました","error")}}});let pi=[],Is=[];async function xn(){const i=document.getElementById("page-container");try{const[e,n]=await Promise.all([_e().catch(()=>[]),oo().catch(()=>[])]);pi=e,Is=n}catch(e){console.error("データの取得に失敗",e)}i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
  ...
  `,document.getElementById("btn-add-client").addEventListener("click",()=>ho())}function cd(i,e){return i.length===0?`<div class="empty-state">
      <span class="material-icons-round">person_off</span>
      <h3>利用者が登録されていません</h3>
  ...
  `}function ho(i=null){var c,l;const e=!!i,n=[...fi.physical.options,...fi.special.options],r=`
    <form id="client-form">
      <div class="form-row">
        <div class="form-group">
          <label class="form-label">氏名 *</label>
      ...
      <div class="form-group">
        ...
        <div class="tags-container" style="gap:8px">
          ${lo.map(u=>{var p;return`<label style="display:flex;align-items:center;gap:4px;cursor:pointer;font-size:.85rem">
  ...
  `),document.getElementById("cf-cancel").onclick=Ce,document.getElementById("cf-save").onclick=async()=>{const u=document.getElementById("cf-name").value.trim();if(!u){R("氏名を入力してください","warning");return}const p=document.getElementById("cf-save");p.disabled=!0,p.textContent="保存中...";const _=document.getElementById("cf-address").value.trim();let E=(i==null?void 0:i.lat)||Q.lat,S=(i==null?void 0:i.lng)||Q.lng;if(_)try{await Ct();const k=await co(_);k?(E=k.lat,S=k.lng,R(`座標を取得しました: ${k.lat.toFixed(4)}, ${k.lng.toFixed(4)}`,"success")):R("住所から座標を取得できませんでした。事業所付近の座標を使用します。","warning")}catch(k){console.warn("ジオコーディング失敗:",k),R("座標取得に失敗。事業所付近の座標を使用します。","warning")}const w={name:u,careLevel:document.getElementById("cf-care-level").value,address:_,requiredServices:Array.from(document.querySelectorAll('input[name="cf-service"]:checked')).map(k=>k.value),requiredSkills:Array.from(document.querySelectorAll('input[name="cf-skill"]:checked')).map(k=>k.value),genderPreference:document.getElementById("cf-gender-pref").value,visitDuration:parseInt(document.getElementById("cf-duration").value)||60,timeWindow:{start:document.getElementById("cf-time-start").value,end:document.getElementById("cf-time-end").value},notes:document.getElementById("cf-notes").value.trim(),lat:E,lng:S,isActive:!0};try{e?(await jl(i.id,w),R("利用者情報を更新しました","success")):(await so(w),R("利用者を登録しました","success")),Ce(),await xn()}catch(k){R("保存に失敗しました: "+k.message,"error")}finally{p.disabled=!1,p.textContent=e?"更新":"登録"}}}document.addEventListener("click",async i=>{const e=i.target.closest("[data-edit-client]");if(e){const r=pi.find(o=>o.id===e.dataset.editClient);r&&ho(r)}const n=i.target.closest("[data-delete-client]");if(n){const r=pi.find(o=>o.id===n.dataset.deleteClient);if(r&&await Ti("削除確認",`${r.name} を削除しますか？`))try{await ql(r.id),R(`${r.name} を削除しました`,"success"),await xn()}catch{R("削除に失敗しました","error")}}});let Fe=Bt();async function ld(){const i=document.getElementById("page-container");i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
  ...
  `,document.getElementById("schedule-date").addEventListener("change",e=>{Fe=e.target.value,xt()}),document.getElementById("btn-add-visit").addEventListener("click",dd),document.getElementById("btn-generate-week").addEventListener("click",ud),await xt()}async function xt(){const i=document.getElementById("schedule-content"),[e,n,r,o]=await Promise.all([ge().catch(()=>[]),_e().catch(()=>[]),ze(Fe).catch(()=>[]),Cn(Fe).catch(()=>[])]);if(r.length===0){i.innerHTML=`
    ...
    `;return}const c={},l=[];let u=0,p=0,_=0;for(const w of r)w.staffId?(c[w.staffId]||(c[w.staffId]=[]),c[w.staffId].push(w)):l.push(w);l.sort((w,k)=>{const P=w.startTime||w.scheduledTime||"00:00",D=k.startTime||k.scheduledTime||"00:00";return P.localeCompare(D)});let E="";l.length>0&&(E=`
      <div class="card" style="border-left: 4px solid var(--danger); margin-bottom: 24px; background: rgba(239, 68, 68, 0.05);">
        ...
        <div class="grid grid-3" style="gap: 12px;">
          ${l.map(w=>{const k=n.find(P=>P.id===w.clientId);return`
    ...
    `);for(const[w,k]of Object.entries(c)){const P=e.find(A=>A.id===w);if(!P)continue;const D=o.find(A=>A.staffId===w),L=parseInt(P.wage)||2e3;if(D&&(_+=(D.totalDistance||0)*si),k.sort((A,C)=>{const N=A.optimizedArrivalTime||A.startTime||A.scheduledTime||"00:00",x=C.optimizedArrivalTime||C.startTime||C.scheduledTime||"00:00";return N.localeCompare(x)}),D&&D.schedule&&D.schedule.length>=2){const A=D.schedule[0].arrivalMinutes,N=(D.schedule[D.schedule.length-1].arrivalMinutes-A)/60;p+=N*L}else if(k.length>0){const A=k[0],C=k[k.length-1],N=A.startTime||A.scheduledTime||"09:00",x=C.startTime||C.scheduledTime||"17:00",B=te(N),g=(te(x)+(C.duration||60)-B)/60;p+=g*L}k.forEach((A,C)=>{A.income?u+=parseInt(A.income):u+=Ot(A.service||"身体介護",A.duration||60);let N=10,x=null;if(D&&D.schedule){const B=D.schedule.find(V=>V.clientId===A.clientId);B&&(N=B.travelTimeFromPrev||10,x=B.arrivalTime)}A.calculatedTravelTime=N,A.optimizedArrivalTime=x}),k.sort((A,C)=>{const N=A.optimizedArrivalTime||A.startTime||A.scheduledTime||"00:00",x=C.optimizedArrivalTime||C.startTime||C.scheduledTime||"00:00";return N.localeCompare(x)})}let S="";if(window.isAdmin){const w=u-p-_,k=u>0?Math.round(w/u*100):0;S=`
    ...
    <div class="grid grid-2">
      ${Object.entries(c).map(([w,k])=>{const P=e.find(D=>D.id===w);return`
          <div class="card" style="border-left:4px solid ${(P==null?void 0:P.color)||"#999"}">
            ...
            <div class="schedule-timeline">
              ${k.map((D,L)=>{const A=n.find(B=>B.id===D.clientId),C=D.optimizedArrivalTime||D.startTime||D.scheduledTime||"--:--";let N="",x="";if(L>0){const B=k[L-1],V=B.optimizedArrivalTime||B.startTime||B.scheduledTime,g=D.calculatedTravelTime||10;if(V&&C!=="--:--"){const[h,m]=V.split(":").map(Number),[y,v]=C.split(":").map(Number),I=h*60+m+(B.duration||60),z=y*60+v-I;z<g&&(x=`
  ...
  `);const r=()=>{const o=document.getElementById("vf-service").value,c=parseInt(document.getElementById("vf-duration").value)||60,l=Ot(o,c);document.getElementById("vf-income").value=l,document.getElementById("vf-income-hint").textContent=`↑ ${o} ${c}分 → ¥${l.toLocaleString()}（自動計算）`};document.getElementById("vf-service").addEventListener("change",r),document.getElementById("vf-duration").addEventListener("change",r),r(),document.getElementById("vf-cancel").onclick=Ce,document.getElementById("vf-save").onclick=async()=>{const o=document.getElementById("vf-client").value,c=document.getElementById("vf-staff").value;if(!o||!c){R("利用者と職員を選択してください","warning");return}try{const l=parseInt(document.getElementById("vf-duration").value)||60,u=document.getElementById("vf-service").value,p=document.getElementById("vf-time").value,_=te(p)+l,E=Math.floor(_/60),S=_%60,w=`${String(E).padStart(2,"0")}:${String(S).padStart(2,"0")}`;await Pn({date:Fe,clientId:o,staffId:c,startTime:p,endTime:w,scheduledTime:p,duration:l,service:u,income:parseInt(document.getElementById("vf-income").value)||Ot(u,l),status:"scheduled"}),R("訪問予定を追加しました","success"),Ce(),await xt()}catch{R("追加に失敗しました","error")}}}async function ud(){var e;if(await Ti("週間スケジュール自動生成",`利用者の曜日設定に基づいて、今週（月〜土）の訪問予定を自動生成します。
既存の予定がある日はスキップされます。

実行しますか？`))try{const[n,r]=await Promise.all([_e(),oo()]),o={月:1,火:2,水:3,木:4,金:5,土:6},c=new Date,l=c.getDay(),u=r.filter(S=>S.dayOfWeek&&o[S.dayOfWeek]!==void 0);let p=0,_=0;const E=new Map;for(const S of u){const w=o[S.dayOfWeek];if(w===void 0)continue;const k=w-l,P=new Date(c);P.setDate(c.getDate()+k);const D=Zs(P),L=`${D}_${S.clientId}`;if(E.has(L)){E.get(L).timeOptions.push({startTime:S.startTime||"09:00",duration:S.duration||60});continue}if((await ze(D)).some(C=>C.clientId===S.clientId)){E.set(L,null),_++;continue}E.set(L,{...S,date:D,timeOptions:[{startTime:S.startTime||"09:00",duration:S.duration||60}]})}for(const[S,w]of E){if(!w)continue;const k=n.find(V=>V.id===w.clientId),P=w.service||((e=k==null?void 0:k.requiredServices)==null?void 0:e[0])||"身体介護",D=w.duration||(k==null?void 0:k.visitDuration)||60,L=w.startTime||"09:00",A=Ot(P,D),C=te(L)+D,N=Math.floor(C/60),x=C%60,B=`${String(N).padStart(2,"0")}:${String(x).padStart(2,"0")}`;await Pn({date:w.date,clientId:w.clientId,clientName:w.clientName||(k==null?void 0:k.name)||"利用者",staffId:w.staffId||null,staffName:w.staffName||"未設定",startTime:L,endTime:B,scheduledTime:L,duration:D,service:P,income:A,dayOfWeek:w.dayOfWeek,status:"scheduled",timeOptions:w.timeOptions}),p++}p>0?R(`今週の訪問予定 ${p}件 を自動生成しました！${_>0?`（${_}件は既存のためスキップ）`:""}`,"success"):R(`生成する予定がありませんでした。${_>0?`（${_}件は既に登録済み）`:"利用者の曜日設定を確認してください。"}`,"warning"),await xt()}catch(n){console.error("週間スケジュール生成エラー:",n),R("スケジュール生成に失敗しました: "+n.message,"error")}}document.addEventListener("click",async i=>{const e=i.target.closest("[data-delete-visit]");if(e&&await Ti("削除確認","この訪問予定を削除しますか？"))try{await Hl(e.dataset.deleteVisit),R("訪問予定を削除しました","success"),await xt()}catch{R("削除に失敗しました","error")}});function hd(i,e){var l,u,p,_,E;let n=0;const r=[];let o=!0;for(const S of e.requiredServices||[])(u=(l=i.skills)==null?void 0:l.services)!=null&&u.includes(S)?(n+=_t.requiredSkill,r.push(`✅ ${S}対応可`)):(o=!1,r.push(`❌ ${S}に対応不可`));const c=[...((p=i.skills)==null?void 0:p.qualifications)||[],...((_=i.skills)==null?void 0:_.physical)||[],...((E=i.skills)==null?void 0:E.special)||[]];for(const S of e.requiredSkills||[])c.includes(S)?(n+=_t.requiredSkill,r.push(`✅ ${S}あり`)):(o=!1,r.push(`❌ ${S}なし`));if(e.genderPreference&&e.genderPreference!=="指定なし"){const S=e.genderPreference.replace("希望","");i.gender===S?(n+=_t.genderMatch,r.push(`✅ 性別希望合致（${S}）`)):(o=!1,r.push(`❌ 性別希望不一致（希望: ${S}）`))}if(i.type==="正社員"&&(n+=_t.staffType,r.push("✅ 正社員")),i.lat&&e.lat){const S=io(i.lat,i.lng,e.lat,e.lng),w=Math.max(0,_t.proximity*(1-S/10));n+=w}return{score:Math.round(n),reasons:r,eligible:o}}function fd(i,e,n=[],r=null,o=[]){const c=[],l=new Set,u={},p={};o.forEach((w,k)=>{p[w.id]=k});const _=(w,k)=>{if(!r)return 15;const P=p[w],D=p[k];return P!==void 0&&D!==void 0&&r[P][D]&&r[P][D].duration||15},E=[...e].sort((w,k)=>{const P=w.startTime||w.scheduledTime||"00:00",D=k.startTime||k.scheduledTime||"00:00";return P.localeCompare(D)});for(const w of E){const k=i.filter(A=>A.isActive).map(A=>{const C=n.find(g=>g.id===w.clientId),{score:N,eligible:x}=hd(A,C||w),B=w.timeOptions&&w.timeOptions.length>0?w.timeOptions:[{startTime:w.startTime||w.scheduledTime||"09:00",duration:w.duration||60}];let V=null;for(const g of B){let h=!0;const m=te(g.startTime),y=m+(g.duration||60),v=c.filter(I=>I.staffId===A.id);for(const I of v){const f=te(I.startTime),z=f+(I.duration||60);if(m<z&&y>f){h=!1;break}const ce=_(I.clientId,w.clientId);if(m>=z){if(m-z<ce){h=!1;break}}else if(y<=f&&f-y<ce){h=!1;break}}if(h){V=g;break}}return{staff:A,score:N,eligible:x&&!!V,chosenTime:V}}).filter(A=>A.eligible);if(k.length===0)continue;k.sort((A,C)=>{const N=u[A.staff.id]||0,x=u[C.staff.id]||0,B=A.staff.maxVisits||(A.staff.type==="パート"?5:10),V=C.staff.maxVisits||(C.staff.type==="パート"?5:10),g=N>=B,h=x>=V;return g!==h?g?1:-1:N!==x?N-x:A.staff.type!==C.staff.type?A.staff.type==="正社員"?-1:1:C.score-A.score});const P=k[0],D=u[P.staff.id]||0,L=P.staff.maxVisits||(P.staff.type==="パート"?5:10);if(D<L){const A=P.chosenTime.startTime,C=P.chosenTime.duration||60,N=te(A)+C;c.push({staffId:P.staff.id,staffName:P.staff.name,visitId:w.id,clientId:w.clientId,clientName:w.clientName||"利用者",score:P.score,startTime:A,endTime:eo(N),scheduledTime:A,duration:C}),l.add(w.id),u[P.staff.id]=D+1}}const S=e.filter(w=>!l.has(w.id)).map(w=>({visitId:w.id,clientName:w.clientName||"利用者",reason:"適格な職員なし、または上限超過"}));return{assignments:c,unassigned:S}}async function md(i,e,n,r=Q,o=null){const c={};for(const u of i)c[u.staffId]||(c[u.staffId]=[]),c[u.staffId].push(u.clientId);const l={};for(const[u,p]of Object.entries(c)){const _=e.find(A=>A.id===u),E=p.map(A=>n.find(C=>C.id===A)).filter(Boolean);if(E.length===0)continue;const S=[{id:"office",name:"事業所",lat:r.lat,lng:r.lng,isOffice:!0},...E.map(A=>{const C=i.find(N=>N.clientId===A.id&&N.staffId===u);return{id:A.id,name:A.name,lat:A.lat,lng:A.lng,duration:A.visitDuration||60,scheduledStart:C?C.startTime:null,timeWindow:A.timeWindow}})];let w=null;typeof o=="function"&&(w=await o(S));const k=pd(S,w);let P=gd(S,k);P=vd(P,k);const D=yd(P,k),L=_d(P,k,_,w,S);l[u]={staffId:u,staffName:(_==null?void 0:_.name)||"不明",staffColor:(_==null?void 0:_.color)||"#999",route:P,totalDistance:Math.round(D*10)/10,totalDuration:Id(L),schedule:L}}return l}function pd(i,e=null){const n=i.length,r=Array.from({length:n},()=>Array(n).fill(0));for(let o=0;o<n;o++)for(let c=0;c<n;c++)o!==c&&(e&&e[o]&&e[o][c]&&e[o][c].distance!==null?r[o][c]=e[o][c].distance:r[o][c]=io(i[o].lat,i[o].lng,i[c].lat,i[c].lng));return r}function gd(i,e){const n=i.length,r=new Set([0]),o=[0],c=[],l=[];for(let _=1;_<n;_++){const E=i[_];E.timeWindow&&E.timeWindow.start?c.push({index:_,start:te(E.timeWindow.start),end:te(E.timeWindow.end)}):l.push(_)}c.sort((_,E)=>_.start-E.start);const u=[...c.map(_=>_.index),...l];let p=0;for(;r.size<n;){let _=-1,E=1/0;for(const S of u)r.has(S)||e[p][S]<E&&(E=e[p][S],_=S);if(_===-1)break;o.push(_),r.add(_),p=_}return o.push(0),o}function vd(i,e){const n=i.length;let r=!0,o=[...i];for(;r;){r=!1;for(let c=1;c<n-2;c++)for(let l=c+1;l<n-1;l++){const u=e[o[c-1]][o[c]]+e[o[l]][o[l+1]];if(e[o[c-1]][o[l]]+e[o[c]][o[l+1]]<u-.001){const _=[...o];let E=c,S=l;for(;E<S;)[_[E],_[S]]=[_[S],_[E]],E++,S--;o=_,r=!0}}}return o}function yd(i,e){let n=0;for(let r=0;r<i.length-1;r++)n+=e[i[r]][i[r+1]];return n}function _d(i,e,n,r=null,o=[]){const c=[];let u=te((n==null?void 0:n.workStart)||"08:30");for(let p=0;p<i.length;p++){let _=0;if(p>0){const S=i[p-1],w=i[p];r&&r[S]&&r[S][w]&&r[S][w].duration!==null?_=r[S][w].duration:_=e[S][w]/20*60,u+=Math.ceil(_)}const E=o[i[p]];if(E){let S=0;E.timeWindow&&E.timeWindow.start?S=te(E.timeWindow.start):E.scheduledStart&&(S=te(E.scheduledStart)),u<S&&(u=S)}if(c.push({pointIndex:i[p],clientId:E?E.id:null,arrivalTime:eo(u),arrivalMinutes:u,travelTimeFromPrev:Math.ceil(_)}),p>0&&p<i.length-1){const S=E&&E.duration||60;u+=S}}return c}function Id(i){if(i.length<2)return 0;const e=i[0].arrivalMinutes;return i[i.length-1].arrivalMinutes-e}let vn=null,Td=null,qe=Bt();async function fo(){const i=document.getElementById("page-container"),e=await ge(),n=["日","月","火","水","木","金","土"][new Date(qe).getDay()];i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
        <span class="material-icons-round">auto_fix_high</span>
        マッチング＆ルート最適化
      ...
      ${Object.entries(c).map(([l,u])=>{var _,E,S;const p=o[l];return`
          <div class="card" style="border-left:4px solid ${((_=u.staff)==null?void 0:_.color)||"#999"}">
            ...
            <div style="display:flex;flex-direction:column;gap:6px">
              ...
              ${((p==null?void 0:p.schedule)||[]).filter(w=>w.pointIndex!==0||p.schedule.indexOf(w)===p.schedule.length-1).map((w,k,P)=>{var L,A;if(w.pointIndex===0&&k===P.length-1)return`<div style="font-size:.8rem;color:var(--text-muted);display:flex;align-items:center;gap:4px">
                      <span class="material-icons-round" style="font-size:16px;color:var(--secondary)">business</span>
                      ${w.arrivalTime} 事業所帰着
                    </div>`;const D=u.clients.find(C=>C.clientId===w.clientId);return`<div class="visit-card">
                    <div style="display:flex;justify-content:space-between;align-items:center">
                      <strong style="font-size:.85rem">${w.arrivalTime} ${((L=D==null?void 0:D.client)==null?void 0:L.name)||"利用者"}</strong>
  ...
  `,await sn(),(e=document.getElementById("revenue-date-picker"))==null||e.addEventListener("change",r=>{Et=r.target.value,sn()}),(n=document.getElementById("btn-refresh-revenue"))==null||n.addEventListener("click",()=>{sn()})}async function sn(){const i=document.getElementById("revenue-content");if(!i)return;const[e,n,r,o]=await Promise.all([ge(),_e(),ze(Et),Cn(Et)]);if(r.length===0){i.innerHTML=`
    ...
    `;return}let c=0,l=0,u=0,p=r.length;r.filter(w=>w.status==="completed").length;const _=e.map(w=>{const k=o.filter(x=>x.staffId===w.id),P=r.filter(x=>x.staffId===w.id);let D=0,L=0,A=0,C=0,N=0;if(P.forEach(x=>{x.income?D+=parseInt(x.income):D+=Ot(x.service||"身体介護",x.duration||60)}),k.forEach(x=>{if(C+=x.totalDistance||0,A+=(x.totalDistance||0)*si,x.schedule&&x.schedule.length>=2){const B=x.schedule[0].arrivalMinutes;N=x.schedule[x.schedule.length-1].arrivalMinutes-B,L=N/60*(parseInt(w.wage)||2e3)}}),k.length===0&&P.length>0){const x=[...P].sort((m,y)=>(m.startTime||"09:00").localeCompare(y.startTime||"09:00")),B=x[0],V=x[x.length-1],g=te(B.startTime||"09:00");N=te(V.startTime||"17:00")+(V.duration||60)-g,L=N/60*(parseInt(w.wage)||2e3)}return{...w,count:P.length,revenue:D,laborCost:L,vehicleCost:A,profit:D-L-A,workMinutes:N}}).filter(w=>w.count>0||w.revenue>0).sort((w,k)=>k.profit-w.profit);_.forEach(w=>{c+=w.revenue,l+=w.laborCost,u+=w.vehicleCost});const E=c-l-u,S=c>0?E/c*100:0;i.innerHTML=`
    <!-- メインKPI -->
    <div class="grid grid-4" style="margin-bottom:24px">
...
既存データには影響しません。`))){e&&(e.innerHTML=`
    ...
    `);try{const n=await ge(),r=await _e();if(n.length>0||r.length>0){if(!i&&!confirm("既存のデータを全て削除し、新しいエクセルデータを投入しますか？")){e&&(e.innerHTML=`
            <span class="material-icons-round" style="color:var(--secondary)">science</span>
            <span class="nav-label">デモデータ投入</span>
          `);return}typeof ps=="function"?await ps():(localStorage.removeItem("careroute_staff"),localStorage.removeItem("careroute_clients"),localStorage.removeItem("careroute_visits"))}for(const u of Ts)await ro(u);R(`職員 ${Ts.length}名 を登録しました`,"success");for(const u of ws)await so(u);R(`利用者 ${ws.length}名 を登録しました`,"success");const o=new Date,c=o.getDay(),l={日:0,月:1,火:2,水:3,木:4,金:5,土:6};for(const u of bs){let p=new Date(o);if(u.dayOfWeek&&l[u.dayOfWeek]!==void 0){const k=l[u.dayOfWeek]-c;p.setDate(o.getDate()+k)}const _=p.getFullYear(),E=String(p.getMonth()+1).padStart(2,"0"),S=String(p.getDate()).padStart(2,"0"),w=`${_}-${E}-${S}`;await Pn({...u,date:w,status:"scheduled"})}R(`予定 ${bs.length}件 を登録しました`,"success"),await gi("dashboard"),e.innerHTML=`
