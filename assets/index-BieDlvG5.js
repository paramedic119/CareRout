 ...
 */const Mr=function(i){const e=[];let n=0;for(let s=0;s<i.length;s++){let o=i.charCodeAt(s);o<128?e[n++]=o:o<2048?(e[n++]=o>>6|192,e[n++]=o&63|128):(o&64512)===55296&&s+1<i.length&&(i.charCodeAt(s+1)&64512)===56320?(o=65536+((o&1023)<<10)+(i.charCodeAt(++s)&1023),e[n++]=o>>18|240,e[n++]=o>>12&63|128,e[n++]=o>>6&63|128,e[n++]=o&63|128):(e[n++]=o>>12|224,e[n++]=o>>6&63|128,e[n++]=o&63|128)}return e},la=function(i){const e=[];let n=0,s=0;for(;n<i.length;){const o=i[n++];if(o<128)e[s++]=String.fromCharCode(o);else if(o>191&&o<224){const l=i[n++];e[s++]=String.fromCharCode((o&31)<<6|l&63)}else if(o>239&&o<365){const l=i[n++],c=i[n++],u=i[n++],p=((o&7)<<18|(l&63)<<12|(c&63)<<6|u&63)-65536;e[s++]=String.fromCharCode(55296+(p>>10)),e[s++]=String.fromCharCode(56320+(p&1023))}else{const l=i[n++],c=i[n++];e[s++]=String.fromCharCode((o&15)<<12|(l&63)<<6|c&63)}}return e.join("")},$r={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(i,e){if(!Array.isArray(i))throw Error("encodeByteArray takes an array as a parameter");this.init_();const n=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,s=[];for(let o=0;o<i.length;o+=3){const l=i[o],c=o+1<i.length,u=c?i[o+1]:0,p=o+2<i.length,v=p?i[o+2]:0,E=l>>2,I=(l&3)<<4|u>>4;let T=(u&15)<<2|v>>6,k=v&63;p||(k=64,c||(T=64)),s.push(n[E],n[I],n[T],n[k])}return s.join("")},encodeString(i,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(i):this.encodeByteArray(Mr(i),e)},decodeString(i,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(i):la(this.decodeStringToByteArray(i,e))},decodeStringToByteArray(i,e){this.init_();const n=e?this.charToByteMapWebSafe_:this.charToByteMap_,s=[];for(let o=0;o<i.length;){const l=n[i.charAt(o++)],u=o<i.length?n[i.charAt(o)]:0;++o;const v=o<i.length?n[i.charAt(o)]:64;++o;const I=o<i.length?n[i.charAt(o)]:64;if(++o,l==null||u==null||v==null||I==null)throw new ca;const T=l<<2|u>>4;if(s.push(T),v!==64){const k=u<<4&240|v>>2;if(s.push(k),I!==64){const D=v<<6&192|I;s.push(D)}}}return s},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let i=0;i<this.ENCODED_VALS.length;i++)this.byteToCharMap_[i]=this.ENCODED_VALS.charAt(i),this.charToByteMap_[this.byteToCharMap_[i]]=i,this.byteToCharMapWebSafe_[i]=this.ENCODED_VALS_WEBSAFE.charAt(i),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[i]]=i,i>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(i)]=i,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(i)]=i)}}};class ca extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const da=function(i){const e=Mr(i);return $r.encodeByteArray(e,!0)},Br=function(i){return da(i).replace(/\./g,"")},Wr=function(i){try{return $r.decodeString(i,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ha=()=>ua().__FIREBASE_DEFAULTS__,fa=()=>{if(typeof process>"u"||typeof Gs>"u")return;const i=Gs.__FIREBASE_DEFAULTS__;if(i)return JSON.parse(i)},ma=()=>{if(typeof document>"u")return;let i;try{i=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=i&&Wr(i[1]);return e&&JSON.parse(e)},pa=()=>{try{return aa()||ha()||fa()||ma()}catch(i){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${i}`);return}},ga=i=>{var e;return(e=pa())==null?void 0:e[`_${i}`]};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pe(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function va(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(pe())}function ya(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function _a(){const i=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof i=="object"&&i.id!==void 0}function Ia(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Ta(){try{return typeof indexedDB=="object"}catch{return!1}}function ba(){return new Promise((i,e)=>{try{let n=!0;const s="validate-browser-context-for-indexeddb-analytics-module",o=self.indexedDB.open(s);o.onsuccess=()=>{o.result.close(),n||self.indexedDB.deleteDatabase(s),i(!0)},o.onupgradeneeded=()=>{n=!1},o.onerror=()=>{var l;e(((l=o.error)==null?void 0:l.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wa="FirebaseError";class Ce extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=wa,Object.setPrototypeOf(this,Ce.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Vt.prototype.create)}}class Vt{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},o=`${this.service}/${e}`,l=this.errors[e],c=l?Sa(l,s):"Error",u=`${this.serviceName}: ${c} (${o}).`;return new Ce(o,u,s)}}function Sa(i,e){return i.replace(Ea,(n,s)=>{const o=e[s];return o!=null?String(o):`<${s}?>`})}const Ea=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fr(i){try{return(i.startsWith("http://")||i.startsWith("https://")?new URL(i).hostname:i).endsWith(".cloudworkstations.dev")}catch{return!1}}class at{constructor(e,n,s){this.name=e,this.instanceFactory=n,this.type=s,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var V;(function(i){i[i.DEBUG=0]="DEBUG",i[i.VERBOSE=1]="VERBOSE",i[i.INFO=2]="INFO",i[i.WARN=3]="WARN",i[i.ERROR=4]="ERROR",i[i.SILENT=5]="SILENT"})(V||(V={}));const Oa={debug:V.DEBUG,verbose:V.VERBOSE,info:V.INFO,warn:V.WARN,error:V.ERROR,silent:V.SILENT},Da=V.INFO,La={[V.DEBUG]:"log",[V.VERBOSE]:"log",[V.INFO]:"info",[V.WARN]:"warn",[V.ERROR]:"error"},Pa=(i,e,...n)=>{if(e<i.logLevel)return;const s=new Date().toISOString(),o=La[e];if(o)console[o](`[${s}]  ${i.name}:`,...n);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Pn{constructor(e){this.name=e,this._logLevel=Da,this._logHandler=Pa,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in V))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Oa[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,V.DEBUG,...e),this._logHandler(this,V.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,V.VERBOSE,...e),this._logHandler(this,V.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,V.INFO,...e),this._logHandler(this,V.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,V.WARN,...e),this._logHandler(this,V.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,V.ERROR,...e),this._logHandler(this,V.ERROR,...e)}}const Ca=(i,e)=>e.some(n=>i instanceof n);let Ks,Js;function Na(){return Ks||(Ks=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Ra(){return Js||(Js=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Vr=new WeakMap,yn=new WeakMap,jr=new WeakMap,on=new WeakMap,Cn=new WeakMap;function Ma(i){const e=new Promise((n,s)=>{const o=()=>{i.removeEventListener("success",l),i.removeEventListener("error",c)},l=()=>{n(De(i.result)),o()},c=()=>{s(i.error),o()};i.addEventListener("success",l),i.addEventListener("error",c)});return e.then(n=>{n instanceof IDBCursor&&Vr.set(n,i)}).catch(()=>{}),Cn.set(e,i),e}function $a(i){if(yn.has(i))return;const e=new Promise((n,s)=>{const o=()=>{i.removeEventListener("complete",l),i.removeEventListener("error",c),i.removeEventListener("abort",c)},l=()=>{n(),o()},c=()=>{s(i.error||new DOMException("AbortError","AbortError")),o()};i.addEventListener("complete",l),i.addEventListener("error",c),i.addEventListener("abort",c)});yn.set(i,e)}let _n={get(i,e,n){if(i instanceof IDBTransaction){if(e==="done")return yn.get(i);if(e==="objectStoreNames")return i.objectStoreNames||jr.get(i);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return De(i[e])},set(i,e,n){return i[e]=n,!0},has(i,e){return i instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in i}};function Ba(i){_n=i(_n)}function Wa(i){return i===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...n){const s=i.call(an(this),e,...n);return jr.set(s,e.sort?e.sort():[e]),De(s)}:Ra().includes(i)?function(...e){return i.apply(an(this),e),De(Vr.get(this))}:function(...e){return De(i.apply(an(this),e))}}function Ua(i){return typeof i=="function"?Wa(i):(i instanceof IDBTransaction&&$a(i),Ca(i,Na())?new Proxy(i,_n):i)}function De(i){if(i instanceof IDBRequest)return Ma(i);if(on.has(i))return on.get(i);const e=Ua(i);return e!==i&&(on.set(i,e),Cn.set(e,i)),e}const an=i=>Cn.get(i);function Fa(i,e,{blocked:n,upgrade:s,blocking:o,terminated:l}={}){const c=indexedDB.open(i,e),u=De(c);return s&&c.addEventListener("upgradeneeded",p=>{s(De(c.result),p.oldVersion,p.newVersion,De(c.transaction),p)}),n&&c.addEventListener("blocked",p=>n(p.oldVersion,p.newVersion,p)),u.then(p=>{l&&p.addEventListener("close",()=>l()),o&&p.addEventListener("versionchange",v=>o(v.oldVersion,v.newVersion,v))}).catch(()=>{}),u}const Va=["get","getKey","getAll","getAllKeys","count"],ja=["put","add","delete","clear"],ln=new Map;function Xs(i,e){if(!(i instanceof IDBDatabase&&!(e in i)&&typeof e=="string"))return;if(ln.get(e))return ln.get(e);const n=e.replace(/FromIndex$/,""),s=e!==n,o=ja.includes(n);if(!(n in(s?IDBIndex:IDBObjectStore).prototype)||!(o||Va.includes(n)))return;const l=async function(c,...u){const p=this.transaction(c,o?"readwrite":"readonly");let v=p.store;return s&&(v=v.index(u.shift())),(await Promise.all([v[n](...u),o&&p.done]))[0]};return ln.set(e,l),l}Ba(i=>({...i,get:(e,n,s)=>Xs(e,n)||i.get(e,n,s),has:(e,n)=>!!Xs(e,n)||i.has(e,n)}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qa{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(za(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function za(i){const e=i.getComponent();return(e==null?void 0:e.type)==="VERSION"}const In="@firebase/app",Ys="0.14.11";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _e=new Pn("@firebase/app"),Ha="@firebase/app-compat",Ga="@firebase/analytics-compat",Ka="@firebase/analytics",Ja="@firebase/app-check-compat",Xa="@firebase/app-check",Ya="@firebase/auth",Qa="@firebase/auth-compat",Za="@firebase/database",el="@firebase/data-connect",tl="@firebase/database-compat",il="@firebase/functions",nl="@firebase/functions-compat",sl="@firebase/installations",rl="@firebase/installations-compat",ol="@firebase/messaging",al="@firebase/messaging-compat",ll="@firebase/performance",cl="@firebase/performance-compat",dl="@firebase/remote-config",ul="@firebase/remote-config-compat",hl="@firebase/storage",fl="@firebase/storage-compat",ml="@firebase/firestore",pl="@firebase/ai",gl="@firebase/firestore-compat",vl="firebase",yl="12.12.0",_l={[In]:"fire-core",[Ha]:"fire-core-compat",[Ka]:"fire-analytics",[Ga]:"fire-analytics-compat",[Xa]:"fire-app-check",[Ja]:"fire-app-check-compat",[Ya]:"fire-auth",[Qa]:"fire-auth-compat",[Za]:"fire-rtdb",[el]:"fire-data-connect",[tl]:"fire-rtdb-compat",[il]:"fire-fn",[nl]:"fire-fn-compat",[sl]:"fire-iid",[rl]:"fire-iid-compat",[ol]:"fire-fcm",[al]:"fire-fcm-compat",[ll]:"fire-perf",[cl]:"fire-perf-compat",[dl]:"fire-rc",[ul]:"fire-rc-compat",[hl]:"fire-gcs",[fl]:"fire-gcs-compat",[ml]:"fire-fst",[gl]:"fire-fst-compat",[pl]:"fire-vertex","fire-js":"fire-js",[vl]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Il=new Map,Tl=new Map,Qs=new Map;function Zs(i,e){try{i.container.addComponent(e)}catch(n){_e.debug(`Component ${e.name} failed to register with FirebaseApp ${i.name}`,n)}}function lt(i){const e=i.name;if(Qs.has(e))return _e.debug(`There were multiple attempts to register component ${e}.`),!1;Qs.set(e,i);for(const n of Il.values())Zs(n,i);for(const n of Tl.values())Zs(n,i);return!0}function Fe(i){return i==null?!1:i.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ei=yl;function Le(i,e,n){let s=_l[i]??i;n&&(s+=`-${n}`);const o=s.match(/\s|\//),l=e.match(/\s|\//);if(o||l){const c=[`Unable to register library "${s}" with version "${e}":`];o&&c.push(`library name "${s}" contains illegal characters (whitespace or "/")`),o&&l&&c.push("and"),l&&c.push(`version name "${e}" contains illegal characters (whitespace or "/")`),_e.warn(c.join(" "));return}lt(new at(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wl="firebase-heartbeat-database",Sl=1,Mt="firebase-heartbeat-store";let cn=null;function qr(){return cn||(cn=Fa(wl,Sl,{upgrade:(i,e)=>{switch(e){case 0:try{i.createObjectStore(Mt)}catch(n){console.warn(n)}}}}).catch(i=>{throw Nn.create("idb-open",{originalErrorMessage:i.message})})),cn}async function El(i){try{const n=(await qr()).transaction(Mt),s=await n.objectStore(Mt).get(zr(i));return await n.done,s}catch(e){if(e instanceof Ce)_e.warn(e.message);else{const n=Nn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});_e.warn(n.message)}}}async function er(i,e){try{const s=(await qr()).transaction(Mt,"readwrite");await s.objectStore(Mt).put(e,zr(i)),await s.done}catch(n){if(n instanceof Ce)_e.warn(n.message);else{const s=Nn.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});_e.warn(s.message)}}}function zr(i){return`${i.name}!${i.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kl=1024,Al=30;class xl{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new Dl(n),this._heartbeatsCachePromise=this._storage.read().then(s=>(this._heartbeatsCache=s,s))}async triggerHeartbeat(){var e,n;try{const o=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),l=tr();if(((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((n=this._heartbeatsCache)==null?void 0:n.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===l||this._heartbeatsCache.heartbeats.some(c=>c.date===l))return;if(this._heartbeatsCache.heartbeats.push({date:l,agent:o}),this._heartbeatsCache.heartbeats.length>Al){const c=Ll(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(c,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(s){_e.warn(s)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const n=tr(),{heartbeatsToSend:s,unsentEntries:o}=Ol(this._heartbeatsCache.heartbeats),l=Br(JSON.stringify({version:2,heartbeats:s}));return this._heartbeatsCache.lastSentHeartbeatDate=n,o.length>0?(this._heartbeatsCache.heartbeats=o,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),l}catch(n){return _e.warn(n),""}}}function tr(){return new Date().toISOString().substring(0,10)}function Ol(i,e=kl){const n=[];let s=i.slice();for(const o of i){const l=n.find(c=>c.agent===o.agent);if(l){if(l.dates.push(o.date),ir(n)>e){l.dates.pop();break}}else if(n.push({agent:o.agent,dates:[o.date]}),ir(n)>e){n.pop();break}s=s.slice(1)}return{heartbeatsToSend:n,unsentEntries:s}}class Dl{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Ta()?ba().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const n=await El(this.app);return n!=null&&n.heartbeats?n:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const s=await this.read();return er(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??s.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const s=await this.read();return er(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??s.lastSentHeartbeatDate,heartbeats:[...s.heartbeats,...e.heartbeats]})}else return}}function ir(i){return Br(JSON.stringify({version:2,heartbeats:i})).length}function Ll(i){if(i.length===0)return-1;let e=0,n=i[0].date;for(let s=1;s<i.length;s++)i[s].date<n&&(n=i[s].date,e=s);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pl(i){lt(new at("platform-logger",e=>new qa(e),"PRIVATE")),lt(new at("heartbeat",e=>new xl(e),"PRIVATE")),Le(In,Ys,i),Le(In,Ys,"esm2020"),Le("fire-js","")}Pl("");var Cl="firebase",Nl="12.12.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Le(Cl,Nl,"app");var nr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var Rn;(function(){var i;/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(y,h){function m(){}m.prototype=h.prototype,y.F=h.prototype,y.prototype=new m,y.prototype.constructor=y,y.D=function(_,g,b){for(var f=Array(arguments.length-2),K=2;K<arguments.length;K++)f[K-2]=arguments[K];return h.prototype[g].apply(_,f)}}function n(){this.blockSize=-1}function s(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(s,n),s.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function o(y,h,m){m||(m=0);const _=Array(16);if(typeof h=="string")for(var g=0;g<16;++g)_[g]=h.charCodeAt(m++)|h.charCodeAt(m++)<<8|h.charCodeAt(m++)<<16|h.charCodeAt(m++)<<24;else for(g=0;g<16;++g)_[g]=h[m++]|h[m++]<<8|h[m++]<<16|h[m++]<<24;h=y.g[0],m=y.g[1],g=y.g[2];let b=y.g[3],f;f=h+(b^m&(g^b))+_[0]+3614090360&4294967295,h=m+(f<<7&4294967295|f>>>25),f=b+(g^h&(m^g))+_[1]+3905402710&4294967295,b=h+(f<<12&4294967295|f>>>20),f=g+(m^b&(h^m))+_[2]+606105819&4294967295,g=b+(f<<17&4294967295|f>>>15),f=m+(h^g&(b^h))+_[3]+3250441966&4294967295,m=g+(f<<22&4294967295|f>>>10),f=h+(b^m&(g^b))+_[4]+4118548399&4294967295,h=m+(f<<7&4294967295|f>>>25),f=b+(g^h&(m^g))+_[5]+1200080426&4294967295,b=h+(f<<12&4294967295|f>>>20),f=g+(m^b&(h^m))+_[6]+2821735955&4294967295,g=b+(f<<17&4294967295|f>>>15),f=m+(h^g&(b^h))+_[7]+4249261313&4294967295,m=g+(f<<22&4294967295|f>>>10),f=h+(b^m&(g^b))+_[8]+1770035416&4294967295,h=m+(f<<7&4294967295|f>>>25),f=b+(g^h&(m^g))+_[9]+2336552879&4294967295,b=h+(f<<12&4294967295|f>>>20),f=g+(m^b&(h^m))+_[10]+4294925233&4294967295,g=b+(f<<17&4294967295|f>>>15),f=m+(h^g&(b^h))+_[11]+2304563134&4294967295,m=g+(f<<22&4294967295|f>>>10),f=h+(b^m&(g^b))+_[12]+1804603682&4294967295,h=m+(f<<7&4294967295|f>>>25),f=b+(g^h&(m^g))+_[13]+4254626195&4294967295,b=h+(f<<12&4294967295|f>>>20),f=g+(m^b&(h^m))+_[14]+2792965006&4294967295,g=b+(f<<17&4294967295|f>>>15),f=m+(h^g&(b^h))+_[15]+1236535329&4294967295,m=g+(f<<22&4294967295|f>>>10),f=h+(g^b&(m^g))+_[1]+4129170786&4294967295,h=m+(f<<5&4294967295|f>>>27),f=b+(m^g&(h^m))+_[6]+3225465664&4294967295,b=h+(f<<9&4294967295|f>>>23),f=g+(h^m&(b^h))+_[11]+643717713&4294967295,g=b+(f<<14&4294967295|f>>>18),f=m+(b^h&(g^b))+_[0]+3921069994&4294967295,m=g+(f<<20&4294967295|f>>>12),f=h+(g^b&(m^g))+_[5]+3593408605&4294967295,h=m+(f<<5&4294967295|f>>>27),f=b+(m^g&(h^m))+_[10]+38016083&4294967295,b=h+(f<<9&4294967295|f>>>23),f=g+(h^m&(b^h))+_[15]+3634488961&4294967295,g=b+(f<<14&4294967295|f>>>18),f=m+(b^h&(g^b))+_[4]+3889429448&4294967295,m=g+(f<<20&4294967295|f>>>12),f=h+(g^b&(m^g))+_[9]+568446438&4294967295,h=m+(f<<5&4294967295|f>>>27),f=b+(m^g&(h^m))+_[14]+3275163606&4294967295,b=h+(f<<9&4294967295|f>>>23),f=g+(h^m&(b^h))+_[3]+4107603335&4294967295,g=b+(f<<14&4294967295|f>>>18),f=m+(b^h&(g^b))+_[8]+1163531501&4294967295,m=g+(f<<20&4294967295|f>>>12),f=h+(g^b&(m^g))+_[13]+2850285829&4294967295,h=m+(f<<5&4294967295|f>>>27),f=b+(m^g&(h^m))+_[2]+4243563512&4294967295,b=h+(f<<9&4294967295|f>>>23),f=g+(h^m&(b^h))+_[7]+1735328473&4294967295,g=b+(f<<14&4294967295|f>>>18),f=m+(b^h&(g^b))+_[12]+2368359562&4294967295,m=g+(f<<20&4294967295|f>>>12),f=h+(m^g^b)+_[5]+4294588738&4294967295,h=m+(f<<4&4294967295|f>>>28),f=b+(h^m^g)+_[8]+2272392833&4294967295,b=h+(f<<11&4294967295|f>>>21),f=g+(b^h^m)+_[11]+1839030562&4294967295,g=b+(f<<16&4294967295|f>>>16),f=m+(g^b^h)+_[14]+4259657740&4294967295,m=g+(f<<23&4294967295|f>>>9),f=h+(m^g^b)+_[1]+2763975236&4294967295,h=m+(f<<4&4294967295|f>>>28),f=b+(h^m^g)+_[4]+1272893353&4294967295,b=h+(f<<11&4294967295|f>>>21),f=g+(b^h^m)+_[7]+4139469664&4294967295,g=b+(f<<16&4294967295|f>>>16),f=m+(g^b^h)+_[10]+3200236656&4294967295,m=g+(f<<23&4294967295|f>>>9),f=h+(m^g^b)+_[13]+681279174&4294967295,h=m+(f<<4&4294967295|f>>>28),f=b+(h^m^g)+_[0]+3936430074&4294967295,b=h+(f<<11&4294967295|f>>>21),f=g+(b^h^m)+_[3]+3572445317&4294967295,g=b+(f<<16&4294967295|f>>>16),f=m+(g^b^h)+_[6]+76029189&4294967295,m=g+(f<<23&4294967295|f>>>9),f=h+(m^g^b)+_[9]+3654602809&4294967295,h=m+(f<<4&4294967295|f>>>28),f=b+(h^m^g)+_[12]+3873151461&4294967295,b=h+(f<<11&4294967295|f>>>21),f=g+(b^h^m)+_[15]+530742520&4294967295,g=b+(f<<16&4294967295|f>>>16),f=m+(g^b^h)+_[2]+3299628645&4294967295,m=g+(f<<23&4294967295|f>>>9),f=h+(g^(m|~b))+_[0]+4096336452&4294967295,h=m+(f<<6&4294967295|f>>>26),f=b+(m^(h|~g))+_[7]+1126891415&4294967295,b=h+(f<<10&4294967295|f>>>22),f=g+(h^(b|~m))+_[14]+2878612391&4294967295,g=b+(f<<15&4294967295|f>>>17),f=m+(b^(g|~h))+_[5]+4237533241&4294967295,m=g+(f<<21&4294967295|f>>>11),f=h+(g^(m|~b))+_[12]+1700485571&4294967295,h=m+(f<<6&4294967295|f>>>26),f=b+(m^(h|~g))+_[3]+2399980690&4294967295,b=h+(f<<10&4294967295|f>>>22),f=g+(h^(b|~m))+_[10]+4293915773&4294967295,g=b+(f<<15&4294967295|f>>>17),f=m+(b^(g|~h))+_[1]+2240044497&4294967295,m=g+(f<<21&4294967295|f>>>11),f=h+(g^(m|~b))+_[8]+1873313359&4294967295,h=m+(f<<6&4294967295|f>>>26),f=b+(m^(h|~g))+_[15]+4264355552&4294967295,b=h+(f<<10&4294967295|f>>>22),f=g+(h^(b|~m))+_[6]+2734768916&4294967295,g=b+(f<<15&4294967295|f>>>17),f=m+(b^(g|~h))+_[13]+1309151649&4294967295,m=g+(f<<21&4294967295|f>>>11),f=h+(g^(m|~b))+_[4]+4149444226&4294967295,h=m+(f<<6&4294967295|f>>>26),f=b+(m^(h|~g))+_[11]+3174756917&4294967295,b=h+(f<<10&4294967295|f>>>22),f=g+(h^(b|~m))+_[2]+718787259&4294967295,g=b+(f<<15&4294967295|f>>>17),f=m+(b^(g|~h))+_[9]+3951481745&4294967295,y.g[0]=y.g[0]+h&4294967295,y.g[1]=y.g[1]+(g+(f<<21&4294967295|f>>>11))&4294967295,y.g[2]=y.g[2]+g&4294967295,y.g[3]=y.g[3]+b&4294967295}s.prototype.v=function(y,h){h===void 0&&(h=y.length);const m=h-this.blockSize,_=this.C;let g=this.h,b=0;for(;b<h;){if(g==0)for(;b<=m;)o(this,y,b),b+=this.blockSize;if(typeof y=="string"){for(;b<h;)if(_[g++]=y.charCodeAt(b++),g==this.blockSize){o(this,_),g=0;break}}else for(;b<h;)if(_[g++]=y[b++],g==this.blockSize){o(this,_),g=0;break}}this.h=g,this.o+=h},s.prototype.A=function(){var y=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);y[0]=128;for(var h=1;h<y.length-8;++h)y[h]=0;h=this.o*8;for(var m=y.length-8;m<y.length;++m)y[m]=h&255,h/=256;for(this.v(y),y=Array(16),h=0,m=0;m<4;++m)for(let _=0;_<32;_+=8)y[h++]=this.g[m]>>>_&255;return y};function l(y,h){var m=u;return Object.prototype.hasOwnProperty.call(m,y)?m[y]:m[y]=h(y)}function c(y,h){this.h=h;const m=[];let _=!0;for(let g=y.length-1;g>=0;g--){const b=y[g]|0;_&&b==h||(m[g]=b,_=!1)}this.g=m}var u={};function p(y){return-128<=y&&y<128?l(y,function(h){return new c([h|0],h<0?-1:0)}):new c([y|0],y<0?-1:0)}function v(y){if(isNaN(y)||!isFinite(y))return I;if(y<0)return L(v(-y));const h=[];let m=1;for(let _=0;y>=m;_++)h[_]=y/m|0,m*=4294967296;return new c(h,0)}function E(y,h){if(y.length==0)throw Error("number format error: empty string");if(h=h||10,h<2||36<h)throw Error("radix out of range: "+h);if(y.charAt(0)=="-")return L(E(y.substring(1),h));if(y.indexOf("-")>=0)throw Error('number format error: interior "-" character');const m=v(Math.pow(h,8));let _=I;for(let b=0;b<y.length;b+=8){var g=Math.min(8,y.length-b);const f=parseInt(y.substring(b,b+g),h);g<8?(g=v(Math.pow(h,g)),_=_.j(g).add(v(f))):(_=_.j(m),_=_.add(v(f)))}return _}var I=p(0),T=p(1),k=p(16777216);i=c.prototype,i.m=function(){if(x(this))return-L(this).m();let y=0,h=1;for(let m=0;m<this.g.length;m++){const _=this.i(m);y+=(_>=0?_:4294967296+_)*h,h*=4294967296}return y},i.toString=function(y){if(y=y||10,y<2||36<y)throw Error("radix out of range: "+y);if(D(this))return"0";if(x(this))return"-"+L(this).toString(y);const h=v(Math.pow(y,6));var m=this;let _="";for(;;){const g=N(m,h).g;m=A(m,g.j(h));let b=((m.g.length>0?m.g[0]:m.h)>>>0).toString(y);if(m=g,D(m))return b+_;for(;b.length<6;)b="0"+b;_=b+_}},i.i=function(y){return y<0?0:y<this.g.length?this.g[y]:this.h};function D(y){if(y.h!=0)return!1;for(let h=0;h<y.g.length;h++)if(y.g[h]!=0)return!1;return!0}function x(y){return y.h==-1}i.l=function(y){return y=A(this,y),x(y)?-1:D(y)?0:1};function L(y){const h=y.g.length,m=[];for(let _=0;_<h;_++)m[_]=~y.g[_];return new c(m,~y.h).add(T)}i.abs=function(){return x(this)?L(this):this},i.add=function(y){const h=Math.max(this.g.length,y.g.length),m=[];let _=0;for(let g=0;g<=h;g++){let b=_+(this.i(g)&65535)+(y.i(g)&65535),f=(b>>>16)+(this.i(g)>>>16)+(y.i(g)>>>16);_=f>>>16,b&=65535,f&=65535,m[g]=f<<16|b}return new c(m,m[m.length-1]&-2147483648?-1:0)};function A(y,h){return y.add(L(h))}i.j=function(y){if(D(this)||D(y))return I;if(x(this))return x(y)?L(this).j(L(y)):L(L(this).j(y));if(x(y))return L(this.j(L(y)));if(this.l(k)<0&&y.l(k)<0)return v(this.m()*y.m());const h=this.g.length+y.g.length,m=[];for(var _=0;_<2*h;_++)m[_]=0;for(_=0;_<this.g.length;_++)for(let g=0;g<y.g.length;g++){const b=this.i(_)>>>16,f=this.i(_)&65535,K=y.i(g)>>>16,ve=y.i(g)&65535;m[2*_+2*g]+=f*ve,P(m,2*_+2*g),m[2*_+2*g+1]+=b*ve,P(m,2*_+2*g+1),m[2*_+2*g+1]+=f*K,P(m,2*_+2*g+1),m[2*_+2*g+2]+=b*K,P(m,2*_+2*g+2)}for(y=0;y<h;y++)m[y]=m[2*y+1]<<16|m[2*y];for(y=h;y<2*h;y++)m[y]=0;return new c(m,0)};function P(y,h){for(;(y[h]&65535)!=y[h];)y[h+1]+=y[h]>>>16,y[h]&=65535,h++}function R(y,h){this.g=y,this.h=h}function N(y,h){if(D(h))throw Error("division by zero");if(D(y))return new R(I,I);if(x(y))return h=N(L(y),h),new R(L(h.g),L(h.h));if(x(h))return h=N(y,L(h)),new R(L(h.g),h.h);if(y.g.length>30){if(x(y)||x(h))throw Error("slowDivide_ only works with positive integers.");for(var m=T,_=h;_.l(y)<=0;)m=B(m),_=B(_);var g=j(m,1),b=j(_,1);for(_=j(_,2),m=j(m,2);!D(_);){var f=b.add(_);f.l(y)<=0&&(g=g.add(m),b=f),_=j(_,1),m=j(m,1)}return h=A(y,g.j(h)),new R(g,h)}for(g=I;y.l(h)>=0;){for(m=Math.max(1,Math.floor(y.m()/h.m())),_=Math.ceil(Math.log(m)/Math.LN2),_=_<=48?1:Math.pow(2,_-48),b=v(m),f=b.j(h);x(f)||f.l(y)>0;)m-=_,b=v(m),f=b.j(h);D(b)&&(b=T),g=g.add(b),y=A(y,f)}return new R(g,y)}i.B=function(y){return N(this,y).h},i.and=function(y){const h=Math.max(this.g.length,y.g.length),m=[];for(let _=0;_<h;_++)m[_]=this.i(_)&y.i(_);return new c(m,this.h&y.h)},i.or=function(y){const h=Math.max(this.g.length,y.g.length),m=[];for(let _=0;_<h;_++)m[_]=this.i(_)|y.i(_);return new c(m,this.h|y.h)},i.xor=function(y){const h=Math.max(this.g.length,y.g.length),m=[];for(let _=0;_<h;_++)m[_]=this.i(_)^y.i(_);return new c(m,this.h^y.h)};function B(y){const h=y.g.length+1,m=[];for(let _=0;_<h;_++)m[_]=y.i(_)<<1|y.i(_-1)>>>31;return new c(m,y.h)}function j(y,h){const m=h>>5;h%=32;const _=y.g.length-m,g=[];for(let b=0;b<_;b++)g[b]=h>0?y.i(b+m)>>>h|y.i(b+m+1)<<32-h:y.i(b+m);return new c(g,y.h)}s.prototype.digest=s.prototype.A,s.prototype.reset=s.prototype.u,s.prototype.update=s.prototype.v,c.prototype.add=c.prototype.add,c.prototype.multiply=c.prototype.j,c.prototype.modulo=c.prototype.B,c.prototype.compare=c.prototype.l,c.prototype.toNumber=c.prototype.m,c.prototype.toString=c.prototype.toString,c.prototype.getBits=c.prototype.i,c.fromNumber=v,c.fromString=E,Rn=c}).apply(typeof nr<"u"?nr:typeof self<"u"?self:typeof window<"u"?window:{});var ni=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};(function(){var i,e=Object.defineProperty;function n(t){t=[typeof globalThis=="object"&&globalThis,t,typeof window=="object"&&window,typeof self=="object"&&self,typeof ni=="object"&&ni];for(var r=0;r<t.length;++r){var a=t[r];if(a&&a.Math==Math)return a}throw Error("Cannot find global object")}var s=n(this);function o(t,r){if(r)e:{var a=s;t=t.split(".");for(var d=0;d<t.length-1;d++){var w=t[d];if(!(w in a))break e;a=a[w]}t=t[t.length-1],d=a[t],r=r(d),r!=d&&r!=null&&e(a,t,{configurable:!0,writable:!0,value:r})}}o("Symbol.dispose",function(t){return t||Symbol("Symbol.dispose")}),o("Array.prototype.values",function(t){return t||function(){return this[Symbol.iterator]()}}),o("Object.entries",function(t){return t||function(r){var a=[],d;for(d in r)Object.prototype.hasOwnProperty.call(r,d)&&a.push([d,r[d]]);return a}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var l=l||{},c=this||self;function u(t){var r=typeof t;return r=="object"&&t!=null||r=="function"}function p(t,r,a){return t.call.apply(t.bind,arguments)}function v(t,r,a){return v=p,v.apply(null,arguments)}function E(t,r){var a=Array.prototype.slice.call(arguments,1);return function(){var d=a.slice();return d.push.apply(d,arguments),t.apply(this,d)}}function I(t,r){function a(){}a.prototype=r.prototype,t.Z=r.prototype,t.prototype=new a,t.prototype.constructor=t,t.Ob=function(d,w,S){for(var O=Array(arguments.length-2),M=2;M<arguments.length;M++)O[M-2]=arguments[M];return r.prototype[w].apply(d,O)}}var T=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?t=>t&&AsyncContext.Snapshot.wrap(t):t=>t;function k(t){const r=t.length;if(r>0){const a=Array(r);for(let d=0;d<r;d++)a[d]=t[d];return a}return[]}function D(t,r){for(let d=1;d<arguments.length;d++){const w=arguments[d];var a=typeof w;if(a=a!="object"?a:w?Array.isArray(w)?"array":a:"null",a=="array"||a=="object"&&typeof w.length=="number"){a=t.length||0;const S=w.length||0;t.length=a+S;for(let O=0;O<S;O++)t[a+O]=w[O]}else t.push(w)}}class x{constructor(r,a){this.i=r,this.j=a,this.h=0,this.g=null}get(){let r;return this.h>0?(this.h--,r=this.g,this.g=r.next,r.next=null):r=this.i(),r}}function L(t){c.setTimeout(()=>{throw t},0)}function A(){var t=y;let r=null;return t.g&&(r=t.g,t.g=t.g.next,t.g||(t.h=null),r.next=null),r}class P{constructor(){this.h=this.g=null}add(r,a){const d=R.get();d.set(r,a),this.h?this.h.next=d:this.g=d,this.h=d}}var R=new x(()=>new N,t=>t.reset());class N{constructor(){this.next=this.g=this.h=null}set(r,a){this.h=r,this.g=a,this.next=null}reset(){this.next=this.g=this.h=null}}let B,j=!1,y=new P,h=()=>{const t=Promise.resolve(void 0);B=()=>{t.then(m)}};function m(){for(var t;t=A();){try{t.h.call(t.g)}catch(a){L(a)}var r=R;r.j(t),r.h<100&&(r.h++,t.next=r.g,r.g=t)}j=!1}function _(){this.u=this.u,this.C=this.C}_.prototype.u=!1,_.prototype.dispose=function(){this.u||(this.u=!0,this.N())},_.prototype[Symbol.dispose]=function(){this.dispose()},_.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function g(t,r){this.type=t,this.g=this.target=r,this.defaultPrevented=!1}g.prototype.h=function(){this.defaultPrevented=!0};var b=function(){if(!c.addEventListener||!Object.defineProperty)return!1;var t=!1,r=Object.defineProperty({},"passive",{get:function(){t=!0}});try{const a=()=>{};c.addEventListener("test",a,r),c.removeEventListener("test",a,r)}catch{}return t}();function f(t){return/^[\s\xa0]*$/.test(t)}function K(t,r){g.call(this,t?t.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,t&&this.init(t,r)}I(K,g),K.prototype.init=function(t,r){const a=this.type=t.type,d=t.changedTouches&&t.changedTouches.length?t.changedTouches[0]:null;this.target=t.target||t.srcElement,this.g=r,r=t.relatedTarget,r||(a=="mouseover"?r=t.fromElement:a=="mouseout"&&(r=t.toElement)),this.relatedTarget=r,d?(this.clientX=d.clientX!==void 0?d.clientX:d.pageX,this.clientY=d.clientY!==void 0?d.clientY:d.pageY,this.screenX=d.screenX||0,this.screenY=d.screenY||0):(this.clientX=t.clientX!==void 0?t.clientX:t.pageX,this.clientY=t.clientY!==void 0?t.clientY:t.pageY,this.screenX=t.screenX||0,this.screenY=t.screenY||0),this.button=t.button,this.key=t.key||"",this.ctrlKey=t.ctrlKey,this.altKey=t.altKey,this.shiftKey=t.shiftKey,this.metaKey=t.metaKey,this.pointerId=t.pointerId||0,this.pointerType=t.pointerType,this.state=t.state,this.i=t,t.defaultPrevented&&K.Z.h.call(this)},K.prototype.h=function(){K.Z.h.call(this);const t=this.i;t.preventDefault?t.preventDefault():t.returnValue=!1};var ve="closure_listenable_"+(Math.random()*1e6|0),Re=0;function Qe(t,r,a,d,w){this.listener=t,this.proxy=null,this.src=r,this.type=a,this.capture=!!d,this.ha=w,this.key=++Re,this.da=this.fa=!1}function Te(t){t.da=!0,t.listener=null,t.proxy=null,t.src=null,t.ha=null}function Me(t,r,a){for(const d in t)r.call(a,t[d],d,t)}function Oo(t,r){for(const a in t)r.call(void 0,t[a],a,t)}function Kn(t){const r={};for(const a in t)r[a]=t[a];return r}const Jn="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Xn(t,r){let a,d;for(let w=1;w<arguments.length;w++){d=arguments[w];for(a in d)t[a]=d[a];for(let S=0;S<Jn.length;S++)a=Jn[S],Object.prototype.hasOwnProperty.call(d,a)&&(t[a]=d[a])}}function Gt(t){this.src=t,this.g={},this.h=0}Gt.prototype.add=function(t,r,a,d,w){const S=t.toString();t=this.g[S],t||(t=this.g[S]=[],this.h++);const O=Ci(t,r,d,w);return O>-1?(r=t[O],a||(r.fa=!1)):(r=new Qe(r,this.src,S,!!d,w),r.fa=a,t.push(r)),r};function Pi(t,r){const a=r.type;if(a in t.g){var d=t.g[a],w=Array.prototype.indexOf.call(d,r,void 0),S;(S=w>=0)&&Array.prototype.splice.call(d,w,1),S&&(Te(r),t.g[a].length==0&&(delete t.g[a],t.h--))}}function Ci(t,r,a,d){for(let w=0;w<t.length;++w){const S=t[w];if(!S.da&&S.listener==r&&S.capture==!!a&&S.ha==d)return w}return-1}var Ni="closure_lm_"+(Math.random()*1e6|0),Ri={};function Yn(t,r,a,d,w){if(Array.isArray(r)){for(let S=0;S<r.length;S++)Yn(t,r[S],a,d,w);return null}return a=es(a),t&&t[ve]?t.J(r,a,u(d)?!!d.capture:!1,w):Do(t,r,a,!1,d,w)}function Do(t,r,a,d,w,S){if(!r)throw Error("Invalid event type");const O=u(w)?!!w.capture:!!w;let M=$i(t);if(M||(t[Ni]=M=new Gt(t)),a=M.add(r,a,d,O,S),a.proxy)return a;if(d=Lo(),a.proxy=d,d.src=t,d.listener=a,t.addEventListener)b||(w=O),w===void 0&&(w=!1),t.addEventListener(r.toString(),d,w);else if(t.attachEvent)t.attachEvent(Zn(r.toString()),d);else if(t.addListener&&t.removeListener)t.addListener(d);else throw Error("addEventListener and attachEvent are unavailable.");return a}function Lo(){function t(a){return r.call(t.src,t.listener,a)}const r=Po;return t}function Qn(t,r,a,d,w){if(Array.isArray(r))for(var S=0;S<r.length;S++)Qn(t,r[S],a,d,w);else d=u(d)?!!d.capture:!!d,a=es(a),t&&t[ve]?(t=t.i,S=String(r).toString(),S in t.g&&(r=t.g[S],a=Ci(r,a,d,w),a>-1&&(Te(r[a]),Array.prototype.splice.call(r,a,1),r.length==0&&(delete t.g[S],t.h--)))):t&&(t=$i(t))&&(r=t.g[r.toString()],t=-1,r&&(t=Ci(r,a,d,w)),(a=t>-1?r[t]:null)&&Mi(a))}function Mi(t){if(typeof t!="number"&&t&&!t.da){var r=t.src;if(r&&r[ve])Pi(r.i,t);else{var a=t.type,d=t.proxy;r.removeEventListener?r.removeEventListener(a,d,t.capture):r.detachEvent?r.detachEvent(Zn(a),d):r.addListener&&r.removeListener&&r.removeListener(d),(a=$i(r))?(Pi(a,t),a.h==0&&(a.src=null,r[Ni]=null)):Te(t)}}}function Zn(t){return t in Ri?Ri[t]:Ri[t]="on"+t}function Po(t,r){if(t.da)t=!0;else{r=new K(r,this);const a=t.listener,d=t.ha||t.src;t.fa&&Mi(t),t=a.call(d,r)}return t}function $i(t){return t=t[Ni],t instanceof Gt?t:null}var Bi="__closure_events_fn_"+(Math.random()*1e9>>>0);function es(t){return typeof t=="function"?t:(t[Bi]||(t[Bi]=function(r){return t.handleEvent(r)}),t[Bi])}function ee(){_.call(this),this.i=new Gt(this),this.M=this,this.G=null}I(ee,_),ee.prototype[ve]=!0,ee.prototype.removeEventListener=function(t,r,a,d){Qn(this,t,r,a,d)};function te(t,r){var a,d=t.G;if(d)for(a=[];d;d=d.G)a.push(d);if(t=t.M,d=r.type||r,typeof r=="string")r=new g(r,t);else if(r instanceof g)r.target=r.target||t;else{var w=r;r=new g(d,t),Xn(r,w)}w=!0;let S,O;if(a)for(O=a.length-1;O>=0;O--)S=r.g=a[O],w=Kt(S,d,!0,r)&&w;if(S=r.g=t,w=Kt(S,d,!0,r)&&w,w=Kt(S,d,!1,r)&&w,a)for(O=0;O<a.length;O++)S=r.g=a[O],w=Kt(S,d,!1,r)&&w}ee.prototype.N=function(){if(ee.Z.N.call(this),this.i){var t=this.i;for(const r in t.g){const a=t.g[r];for(let d=0;d<a.length;d++)Te(a[d]);delete t.g[r],t.h--}}this.G=null},ee.prototype.J=function(t,r,a,d){return this.i.add(String(t),r,!1,a,d)},ee.prototype.K=function(t,r,a,d){return this.i.add(String(t),r,!0,a,d)};function Kt(t,r,a,d){if(r=t.i.g[String(r)],!r)return!0;r=r.concat();let w=!0;for(let S=0;S<r.length;++S){const O=r[S];if(O&&!O.da&&O.capture==a){const M=O.listener,J=O.ha||O.src;O.fa&&Pi(t.i,O),w=M.call(J,d)!==!1&&w}}return w&&!d.defaultPrevented}function Co(t,r){if(typeof t!="function")if(t&&typeof t.handleEvent=="function")t=v(t.handleEvent,t);else throw Error("Invalid listener argument");return Number(r)>2147483647?-1:c.setTimeout(t,r||0)}function ts(t){t.g=Co(()=>{t.g=null,t.i&&(t.i=!1,ts(t))},t.l);const r=t.h;t.h=null,t.m.apply(null,r)}class No extends _{constructor(r,a){super(),this.m=r,this.l=a,this.h=null,this.i=!1,this.g=null}j(r){this.h=arguments,this.g?this.i=!0:ts(this)}N(){super.N(),this.g&&(c.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function ht(t){_.call(this),this.h=t,this.g={}}I(ht,_);var is=[];function ns(t){Me(t.g,function(r,a){this.g.hasOwnProperty(a)&&Mi(r)},t),t.g={}}ht.prototype.N=function(){ht.Z.N.call(this),ns(this)},ht.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Wi=c.JSON.stringify,Ro=c.JSON.parse,Mo=class{stringify(t){return c.JSON.stringify(t,void 0)}parse(t){return c.JSON.parse(t,void 0)}};function ss(){}function $o(){}var ft={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function Ui(){g.call(this,"d")}I(Ui,g);function Fi(){g.call(this,"c")}I(Fi,g);var Ze={},rs=null;function Vi(){return rs=rs||new ee}Ze.Ia="serverreachability";function os(t){g.call(this,Ze.Ia,t)}I(os,g);function mt(t){const r=Vi();te(r,new os(r))}Ze.STAT_EVENT="statevent";function as(t,r){g.call(this,Ze.STAT_EVENT,t),this.stat=r}I(as,g);function ie(t){const r=Vi();te(r,new as(r,t))}Ze.Ja="timingevent";function ls(t,r){g.call(this,Ze.Ja,t),this.size=r}I(ls,g);function pt(t,r){if(typeof t!="function")throw Error("Fn must not be null and must be a function");return c.setTimeout(function(){t()},r)}function gt(){this.g=!0}gt.prototype.ua=function(){this.g=!1};function Bo(t,r,a,d,w,S){t.info(function(){if(t.g)if(S){var O="",M=S.split("&");for(let q=0;q<M.length;q++){var J=M[q].split("=");if(J.length>1){const X=J[0];J=J[1];const de=X.split("_");O=de.length>=2&&de[1]=="type"?O+(X+"="+J+"&"):O+(X+"=redacted&")}}}else O=null;else O=S;return"XMLHTTP REQ ("+d+") [attempt "+w+"]: "+r+`
`+a+`
`+O})}function Wo(t,r,a,d,w,S,O){t.info(function(){return"XMLHTTP RESP ("+d+") [ attempt "+w+"]: "+r+`
`+a+`
`+S+" "+O})}function et(t,r,a,d){t.info(function(){return"XMLHTTP TEXT ("+r+"): "+Fo(t,a)+(d?" "+d:"")})}function Uo(t,r){t.info(function(){return"TIMEOUT: "+r})}gt.prototype.info=function(){};function Fo(t,r){if(!t.g)return r;if(!r)return null;try{const S=JSON.parse(r);if(S){for(t=0;t<S.length;t++)if(Array.isArray(S[t])){var a=S[t];if(!(a.length<2)){var d=a[1];if(Array.isArray(d)&&!(d.length<1)){var w=d[0];if(w!="noop"&&w!="stop"&&w!="close")for(let O=1;O<d.length;O++)d[O]=""}}}}return Wi(S)}catch{return r}}var ji={NO_ERROR:0,TIMEOUT:8},Vo={},cs;function qi(){}I(qi,ss),qi.prototype.g=function(){return new XMLHttpRequest},cs=new qi;function vt(t){return encodeURIComponent(String(t))}function jo(t){var r=1;t=t.split(":");const a=[];for(;r>0&&t.length;)a.push(t.shift()),r--;return t.length&&a.push(t.join(":")),a}function be(t,r,a,d){this.j=t,this.i=r,this.l=a,this.S=d||1,this.V=new ht(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new ds}function ds(){this.i=null,this.g="",this.h=!1}var us={},zi={};function Hi(t,r,a){t.M=1,t.A=Xt(ce(r)),t.u=a,t.R=!0,hs(t,null)}function hs(t,r){t.F=Date.now(),Jt(t),t.B=ce(t.A);var a=t.B,d=t.S;Array.isArray(d)||(d=[String(d)]),Es(a.i,"t",d),t.C=0,a=t.j.L,t.h=new ds,t.g=js(t.j,a?r:null,!t.u),t.P>0&&(t.O=new No(v(t.Y,t,t.g),t.P)),r=t.V,a=t.g,d=t.ba;var w="readystatechange";Array.isArray(w)||(w&&(is[0]=w.toString()),w=is);for(let S=0;S<w.length;S++){const O=Yn(a,w[S],d||r.handleEvent,!1,r.h||r);if(!O)break;r.g[O.key]=O}r=t.J?Kn(t.J):{},t.u?(t.v||(t.v="POST"),r["Content-Type"]="application/x-www-form-urlencoded",t.g.ea(t.B,t.v,t.u,r)):(t.v="GET",t.g.ea(t.B,t.v,null,r)),mt(),Bo(t.i,t.v,t.B,t.l,t.S,t.u)}be.prototype.ba=function(t){t=t.target;const r=this.O;r&&Ee(t)==3?r.j():this.Y(t)},be.prototype.Y=function(t){try{if(t==this.g)e:{const M=Ee(this.g),J=this.g.ya(),q=this.g.ca();if(!(M<3)&&(M!=3||this.g&&(this.h.h||this.g.la()||Ps(this.g)))){this.K||M!=4||J==7||(J==8||q<=0?mt(3):mt(2)),Gi(this);var r=this.g.ca();this.X=r;var a=qo(this);if(this.o=r==200,Wo(this.i,this.v,this.B,this.l,this.S,M,r),this.o){if(this.U&&!this.L){t:{if(this.g){var d,w=this.g;if((d=w.g?w.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!f(d)){var S=d;break t}}S=null}if(t=S)et(this.i,this.l,t,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,Ki(this,t);else{this.o=!1,this.m=3,ie(12),$e(this),yt(this);break e}}if(this.R){t=!0;let X;for(;!this.K&&this.C<a.length;)if(X=zo(this,a),X==zi){M==4&&(this.m=4,ie(14),t=!1),et(this.i,this.l,null,"[Incomplete Response]");break}else if(X==us){this.m=4,ie(15),et(this.i,this.l,a,"[Invalid Chunk]"),t=!1;break}else et(this.i,this.l,X,null),Ki(this,X);if(fs(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),M!=4||a.length!=0||this.h.h||(this.m=1,ie(16),t=!1),this.o=this.o&&t,!t)et(this.i,this.l,a,"[Invalid Chunked Response]"),$e(this),yt(this);else if(a.length>0&&!this.W){this.W=!0;var O=this.j;O.g==this&&O.aa&&!O.P&&(O.j.info("Great, no buffering proxy detected. Bytes received: "+a.length),nn(O),O.P=!0,ie(11))}}else et(this.i,this.l,a,null),Ki(this,a);M==4&&$e(this),this.o&&!this.K&&(M==4?Ws(this.j,this):(this.o=!1,Jt(this)))}else ra(this.g),r==400&&a.indexOf("Unknown SID")>0?(this.m=3,ie(12)):(this.m=0,ie(13)),$e(this),yt(this)}}}catch{}finally{}};function qo(t){if(!fs(t))return t.g.la();const r=Ps(t.g);if(r==="")return"";let a="";const d=r.length,w=Ee(t.g)==4;if(!t.h.i){if(typeof TextDecoder>"u")return $e(t),yt(t),"";t.h.i=new c.TextDecoder}for(let S=0;S<d;S++)t.h.h=!0,a+=t.h.i.decode(r[S],{stream:!(w&&S==d-1)});return r.length=0,t.h.g+=a,t.C=0,t.h.g}function fs(t){return t.g?t.v=="GET"&&t.M!=2&&t.j.Aa:!1}function zo(t,r){var a=t.C,d=r.indexOf(`
`,a);return d==-1?zi:(a=Number(r.substring(a,d)),isNaN(a)?us:(d+=1,d+a>r.length?zi:(r=r.slice(d,d+a),t.C=d+a,r)))}be.prototype.cancel=function(){this.K=!0,$e(this)};function Jt(t){t.T=Date.now()+t.H,ms(t,t.H)}function ms(t,r){if(t.D!=null)throw Error("WatchDog timer not null");t.D=pt(v(t.aa,t),r)}function Gi(t){t.D&&(c.clearTimeout(t.D),t.D=null)}be.prototype.aa=function(){this.D=null;const t=Date.now();t-this.T>=0?(Uo(this.i,this.B),this.M!=2&&(mt(),ie(17)),$e(this),this.m=2,yt(this)):ms(this,this.T-t)};function yt(t){t.j.I==0||t.K||Ws(t.j,t)}function $e(t){Gi(t);var r=t.O;r&&typeof r.dispose=="function"&&r.dispose(),t.O=null,ns(t.V),t.g&&(r=t.g,t.g=null,r.abort(),r.dispose())}function Ki(t,r){try{var a=t.j;if(a.I!=0&&(a.g==t||Ji(a.h,t))){if(!t.L&&Ji(a.h,t)&&a.I==3){try{var d=a.Ba.g.parse(r)}catch{d=null}if(Array.isArray(d)&&d.length==3){var w=d;if(w[0]==0){e:if(!a.v){if(a.g)if(a.g.F+3e3<t.F)ti(a),Zt(a);else break e;tn(a),ie(18)}}else a.xa=w[1],0<a.xa-a.K&&w[2]<37500&&a.F&&a.A==0&&!a.C&&(a.C=pt(v(a.Va,a),6e3));vs(a.h)<=1&&a.ta&&(a.ta=void 0)}else We(a,11)}else if((t.L||a.g==t)&&ti(a),!f(r))for(w=a.Ba.g.parse(r),r=0;r<w.length;r++){let q=w[r];const X=q[0];if(!(X<=a.K))if(a.K=X,q=q[1],a.I==2)if(q[0]=="c"){a.M=q[1],a.ba=q[2];const de=q[3];de!=null&&(a.ka=de,a.j.info("VER="+a.ka));const Ue=q[4];Ue!=null&&(a.za=Ue,a.j.info("SVER="+a.za));const ke=q[5];ke!=null&&typeof ke=="number"&&ke>0&&(d=1.5*ke,a.O=d,a.j.info("backChannelRequestTimeoutMs_="+d)),d=a;const Ae=t.g;if(Ae){const ii=Ae.g?Ae.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(ii){var S=d.h;S.g||ii.indexOf("spdy")==-1&&ii.indexOf("quic")==-1&&ii.indexOf("h2")==-1||(S.j=S.l,S.g=new Set,S.h&&(Xi(S,S.h),S.h=null))}if(d.G){const sn=Ae.g?Ae.g.getResponseHeader("X-HTTP-Session-Id"):null;sn&&(d.wa=sn,z(d.J,d.G,sn))}}a.I=3,a.l&&a.l.ra(),a.aa&&(a.T=Date.now()-t.F,a.j.info("Handshake RTT: "+a.T+"ms")),d=a;var O=t;if(d.na=Vs(d,d.L?d.ba:null,d.W),O.L){ys(d.h,O);var M=O,J=d.O;J&&(M.H=J),M.D&&(Gi(M),Jt(M)),d.g=O}else $s(d);a.i.length>0&&ei(a)}else q[0]!="stop"&&q[0]!="close"||We(a,7);else a.I==3&&(q[0]=="stop"||q[0]=="close"?q[0]=="stop"?We(a,7):en(a):q[0]!="noop"&&a.l&&a.l.qa(q),a.A=0)}}mt(4)}catch{}}var Ho=class{constructor(t,r){this.g=t,this.map=r}};function ps(t){this.l=t||10,c.PerformanceNavigationTiming?(t=c.performance.getEntriesByType("navigation"),t=t.length>0&&(t[0].nextHopProtocol=="hq"||t[0].nextHopProtocol=="h2")):t=!!(c.chrome&&c.chrome.loadTimes&&c.chrome.loadTimes()&&c.chrome.loadTimes().wasFetchedViaSpdy),this.j=t?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function gs(t){return t.h?!0:t.g?t.g.size>=t.j:!1}function vs(t){return t.h?1:t.g?t.g.size:0}function Ji(t,r){return t.h?t.h==r:t.g?t.g.has(r):!1}function Xi(t,r){t.g?t.g.add(r):t.h=r}function ys(t,r){t.h&&t.h==r?t.h=null:t.g&&t.g.has(r)&&t.g.delete(r)}ps.prototype.cancel=function(){if(this.i=_s(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const t of this.g.values())t.cancel();this.g.clear()}};function _s(t){if(t.h!=null)return t.i.concat(t.h.G);if(t.g!=null&&t.g.size!==0){let r=t.i;for(const a of t.g.values())r=r.concat(a.G);return r}return k(t.i)}var Is=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Go(t,r){if(t){t=t.split("&");for(let a=0;a<t.length;a++){const d=t[a].indexOf("=");let w,S=null;d>=0?(w=t[a].substring(0,d),S=t[a].substring(d+1)):w=t[a],r(w,S?decodeURIComponent(S.replace(/\+/g," ")):"")}}}function we(t){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let r;t instanceof we?(this.l=t.l,_t(this,t.j),this.o=t.o,this.g=t.g,It(this,t.u),this.h=t.h,Yi(this,ks(t.i)),this.m=t.m):t&&(r=String(t).match(Is))?(this.l=!1,_t(this,r[1]||"",!0),this.o=Tt(r[2]||""),this.g=Tt(r[3]||"",!0),It(this,r[4]),this.h=Tt(r[5]||"",!0),Yi(this,r[6]||"",!0),this.m=Tt(r[7]||"")):(this.l=!1,this.i=new wt(null,this.l))}we.prototype.toString=function(){const t=[];var r=this.j;r&&t.push(bt(r,Ts,!0),":");var a=this.g;return(a||r=="file")&&(t.push("//"),(r=this.o)&&t.push(bt(r,Ts,!0),"@"),t.push(vt(a).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a=this.u,a!=null&&t.push(":",String(a))),(a=this.h)&&(this.g&&a.charAt(0)!="/"&&t.push("/"),t.push(bt(a,a.charAt(0)=="/"?Xo:Jo,!0))),(a=this.i.toString())&&t.push("?",a),(a=this.m)&&t.push("#",bt(a,Qo)),t.join("")},we.prototype.resolve=function(t){const r=ce(this);let a=!!t.j;a?_t(r,t.j):a=!!t.o,a?r.o=t.o:a=!!t.g,a?r.g=t.g:a=t.u!=null;var d=t.h;if(a)It(r,t.u);else if(a=!!t.h){if(d.charAt(0)!="/")if(this.g&&!this.h)d="/"+d;else{var w=r.h.lastIndexOf("/");w!=-1&&(d=r.h.slice(0,w+1)+d)}if(w=d,w==".."||w==".")d="";else if(w.indexOf("./")!=-1||w.indexOf("/.")!=-1){d=w.lastIndexOf("/",0)==0,w=w.split("/");const S=[];for(let O=0;O<w.length;){const M=w[O++];M=="."?d&&O==w.length&&S.push(""):M==".."?((S.length>1||S.length==1&&S[0]!="")&&S.pop(),d&&O==w.length&&S.push("")):(S.push(M),d=!0)}d=S.join("/")}else d=w}return a?r.h=d:a=t.i.toString()!=="",a?Yi(r,ks(t.i)):a=!!t.m,a&&(r.m=t.m),r};function ce(t){return new we(t)}function _t(t,r,a){t.j=a?Tt(r,!0):r,t.j&&(t.j=t.j.replace(/:$/,""))}function It(t,r){if(r){if(r=Number(r),isNaN(r)||r<0)throw Error("Bad port number "+r);t.u=r}else t.u=null}function Yi(t,r,a){r instanceof wt?(t.i=r,Zo(t.i,t.l)):(a||(r=bt(r,Yo)),t.i=new wt(r,t.l))}function z(t,r,a){t.i.set(r,a)}function Xt(t){return z(t,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),t}function Tt(t,r){return t?r?decodeURI(t.replace(/%25/g,"%2525")):decodeURIComponent(t):""}function bt(t,r,a){return typeof t=="string"?(t=encodeURI(t).replace(r,Ko),a&&(t=t.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),t):null}function Ko(t){return t=t.charCodeAt(0),"%"+(t>>4&15).toString(16)+(t&15).toString(16)}var Ts=/[#\/\?@]/g,Jo=/[#\?:]/g,Xo=/[#\?]/g,Yo=/[#\?@]/g,Qo=/#/g;function wt(t,r){this.h=this.g=null,this.i=t||null,this.j=!!r}function Be(t){t.g||(t.g=new Map,t.h=0,t.i&&Go(t.i,function(r,a){t.add(decodeURIComponent(r.replace(/\+/g," ")),a)}))}i=wt.prototype,i.add=function(t,r){Be(this),this.i=null,t=tt(this,t);let a=this.g.get(t);return a||this.g.set(t,a=[]),a.push(r),this.h+=1,this};function bs(t,r){Be(t),r=tt(t,r),t.g.has(r)&&(t.i=null,t.h-=t.g.get(r).length,t.g.delete(r))}function ws(t,r){return Be(t),r=tt(t,r),t.g.has(r)}i.forEach=function(t,r){Be(this),this.g.forEach(function(a,d){a.forEach(function(w){t.call(r,w,d,this)},this)},this)};function Ss(t,r){Be(t);let a=[];if(typeof r=="string")ws(t,r)&&(a=a.concat(t.g.get(tt(t,r))));else for(t=Array.from(t.g.values()),r=0;r<t.length;r++)a=a.concat(t[r]);return a}i.set=function(t,r){return Be(this),this.i=null,t=tt(this,t),ws(this,t)&&(this.h-=this.g.get(t).length),this.g.set(t,[r]),this.h+=1,this},i.get=function(t,r){return t?(t=Ss(this,t),t.length>0?String(t[0]):r):r};function Es(t,r,a){bs(t,r),a.length>0&&(t.i=null,t.g.set(tt(t,r),k(a)),t.h+=a.length)}i.toString=function(){if(this.i)return this.i;if(!this.g)return"";const t=[],r=Array.from(this.g.keys());for(let d=0;d<r.length;d++){var a=r[d];const w=vt(a);a=Ss(this,a);for(let S=0;S<a.length;S++){let O=w;a[S]!==""&&(O+="="+vt(a[S])),t.push(O)}}return this.i=t.join("&")};function ks(t){const r=new wt;return r.i=t.i,t.g&&(r.g=new Map(t.g),r.h=t.h),r}function tt(t,r){return r=String(r),t.j&&(r=r.toLowerCase()),r}function Zo(t,r){r&&!t.j&&(Be(t),t.i=null,t.g.forEach(function(a,d){const w=d.toLowerCase();d!=w&&(bs(this,d),Es(this,w,a))},t)),t.j=r}function ea(t,r){const a=new gt;if(c.Image){const d=new Image;d.onload=E(Se,a,"TestLoadImage: loaded",!0,r,d),d.onerror=E(Se,a,"TestLoadImage: error",!1,r,d),d.onabort=E(Se,a,"TestLoadImage: abort",!1,r,d),d.ontimeout=E(Se,a,"TestLoadImage: timeout",!1,r,d),c.setTimeout(function(){d.ontimeout&&d.ontimeout()},1e4),d.src=t}else r(!1)}function ta(t,r){const a=new gt,d=new AbortController,w=setTimeout(()=>{d.abort(),Se(a,"TestPingServer: timeout",!1,r)},1e4);fetch(t,{signal:d.signal}).then(S=>{clearTimeout(w),S.ok?Se(a,"TestPingServer: ok",!0,r):Se(a,"TestPingServer: server error",!1,r)}).catch(()=>{clearTimeout(w),Se(a,"TestPingServer: error",!1,r)})}function Se(t,r,a,d,w){try{w&&(w.onload=null,w.onerror=null,w.onabort=null,w.ontimeout=null),d(a)}catch{}}function ia(){this.g=new Mo}function Qi(t){this.i=t.Sb||null,this.h=t.ab||!1}I(Qi,ss),Qi.prototype.g=function(){return new Yt(this.i,this.h)};function Yt(t,r){ee.call(this),this.H=t,this.o=r,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}I(Yt,ee),i=Yt.prototype,i.open=function(t,r){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=t,this.D=r,this.readyState=1,Et(this)},i.send=function(t){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const r={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};t&&(r.body=t),(this.H||c).fetch(new Request(this.D,r)).then(this.Pa.bind(this),this.ga.bind(this))},i.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,St(this)),this.readyState=0},i.Pa=function(t){if(this.g&&(this.l=t,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=t.headers,this.readyState=2,Et(this)),this.g&&(this.readyState=3,Et(this),this.g)))if(this.responseType==="arraybuffer")t.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof c.ReadableStream<"u"&&"body"in t){if(this.j=t.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;As(this)}else t.text().then(this.Oa.bind(this),this.ga.bind(this))};function As(t){t.j.read().then(t.Ma.bind(t)).catch(t.ga.bind(t))}i.Ma=function(t){if(this.g){if(this.o&&t.value)this.response.push(t.value);else if(!this.o){var r=t.value?t.value:new Uint8Array(0);(r=this.B.decode(r,{stream:!t.done}))&&(this.response=this.responseText+=r)}t.done?St(this):Et(this),this.readyState==3&&As(this)}},i.Oa=function(t){this.g&&(this.response=this.responseText=t,St(this))},i.Na=function(t){this.g&&(this.response=t,St(this))},i.ga=function(){this.g&&St(this)};function St(t){t.readyState=4,t.l=null,t.j=null,t.B=null,Et(t)}i.setRequestHeader=function(t,r){this.A.append(t,r)},i.getResponseHeader=function(t){return this.h&&this.h.get(t.toLowerCase())||""},i.getAllResponseHeaders=function(){if(!this.h)return"";const t=[],r=this.h.entries();for(var a=r.next();!a.done;)a=a.value,t.push(a[0]+": "+a[1]),a=r.next();return t.join(`\r
`)};function Et(t){t.onreadystatechange&&t.onreadystatechange.call(t)}Object.defineProperty(Yt.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(t){this.m=t?"include":"same-origin"}});function xs(t){let r="";return Me(t,function(a,d){r+=d,r+=":",r+=a,r+=`\r
`}),r}function Zi(t,r,a){e:{for(d in a){var d=!1;break e}d=!0}d||(a=xs(a),typeof t=="string"?a!=null&&vt(a):z(t,r,a))}function H(t){ee.call(this),this.headers=new Map,this.L=t||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}I(H,ee);var na=/^https?$/i,sa=["POST","PUT"];i=H.prototype,i.Fa=function(t){this.H=t},i.ea=function(t,r,a,d){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+t);r=r?r.toUpperCase():"GET",this.D=t,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():cs.g(),this.g.onreadystatechange=T(v(this.Ca,this));try{this.B=!0,this.g.open(r,String(t),!0),this.B=!1}catch(S){Os(this,S);return}if(t=a||"",a=new Map(this.headers),d)if(Object.getPrototypeOf(d)===Object.prototype)for(var w in d)a.set(w,d[w]);else if(typeof d.keys=="function"&&typeof d.get=="function")for(const S of d.keys())a.set(S,d.get(S));else throw Error("Unknown input type for opt_headers: "+String(d));d=Array.from(a.keys()).find(S=>S.toLowerCase()=="content-type"),w=c.FormData&&t instanceof c.FormData,!(Array.prototype.indexOf.call(sa,r,void 0)>=0)||d||w||a.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[S,O]of a)this.g.setRequestHeader(S,O);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(t),this.v=!1}catch(S){Os(this,S)}};function Os(t,r){t.h=!1,t.g&&(t.j=!0,t.g.abort(),t.j=!1),t.l=r,t.o=5,Ds(t),Qt(t)}function Ds(t){t.A||(t.A=!0,te(t,"complete"),te(t,"error"))}i.abort=function(t){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=t||7,te(this,"complete"),te(this,"abort"),Qt(this))},i.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Qt(this,!0)),H.Z.N.call(this)},i.Ca=function(){this.u||(this.B||this.v||this.j?Ls(this):this.Xa())},i.Xa=function(){Ls(this)};function Ls(t){if(t.h&&typeof l<"u"){if(t.v&&Ee(t)==4)setTimeout(t.Ca.bind(t),0);else if(te(t,"readystatechange"),Ee(t)==4){t.h=!1;try{const S=t.ca();e:switch(S){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var r=!0;break e;default:r=!1}var a;if(!(a=r)){var d;if(d=S===0){let O=String(t.D).match(Is)[1]||null;!O&&c.self&&c.self.location&&(O=c.self.location.protocol.slice(0,-1)),d=!na.test(O?O.toLowerCase():"")}a=d}if(a)te(t,"complete"),te(t,"success");else{t.o=6;try{var w=Ee(t)>2?t.g.statusText:""}catch{w=""}t.l=w+" ["+t.ca()+"]",Ds(t)}}finally{Qt(t)}}}}function Qt(t,r){if(t.g){t.m&&(clearTimeout(t.m),t.m=null);const a=t.g;t.g=null,r||te(t,"ready");try{a.onreadystatechange=null}catch{}}}i.isActive=function(){return!!this.g};function Ee(t){return t.g?t.g.readyState:0}i.ca=function(){try{return Ee(this)>2?this.g.status:-1}catch{return-1}},i.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},i.La=function(t){if(this.g){var r=this.g.responseText;return t&&r.indexOf(t)==0&&(r=r.substring(t.length)),Ro(r)}};function Ps(t){try{if(!t.g)return null;if("response"in t.g)return t.g.response;switch(t.F){case"":case"text":return t.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in t.g)return t.g.mozResponseArrayBuffer}return null}catch{return null}}function ra(t){const r={};t=(t.g&&Ee(t)>=2&&t.g.getAllResponseHeaders()||"").split(`\r
`);for(let d=0;d<t.length;d++){if(f(t[d]))continue;var a=jo(t[d]);const w=a[0];if(a=a[1],typeof a!="string")continue;a=a.trim();const S=r[w]||[];r[w]=S,S.push(a)}Oo(r,function(d){return d.join(", ")})}i.ya=function(){return this.o},i.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function kt(t,r,a){return a&&a.internalChannelParams&&a.internalChannelParams[t]||r}function Cs(t){this.za=0,this.i=[],this.j=new gt,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=kt("failFast",!1,t),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=kt("baseRetryDelayMs",5e3,t),this.Za=kt("retryDelaySeedMs",1e4,t),this.Ta=kt("forwardChannelMaxRetries",2,t),this.va=kt("forwardChannelRequestTimeoutMs",2e4,t),this.ma=t&&t.xmlHttpFactory||void 0,this.Ua=t&&t.Rb||void 0,this.Aa=t&&t.useFetchStreams||!1,this.O=void 0,this.L=t&&t.supportsCrossDomainXhr||!1,this.M="",this.h=new ps(t&&t.concurrentRequestLimit),this.Ba=new ia,this.S=t&&t.fastHandshake||!1,this.R=t&&t.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=t&&t.Pb||!1,t&&t.ua&&this.j.ua(),t&&t.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&t&&t.detectBufferingProxy||!1,this.ia=void 0,t&&t.longPollingTimeout&&t.longPollingTimeout>0&&(this.ia=t.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}i=Cs.prototype,i.ka=8,i.I=1,i.connect=function(t,r,a,d){ie(0),this.W=t,this.H=r||{},a&&d!==void 0&&(this.H.OSID=a,this.H.OAID=d),this.F=this.X,this.J=Vs(this,null,this.W),ei(this)};function en(t){if(Ns(t),t.I==3){var r=t.V++,a=ce(t.J);if(z(a,"SID",t.M),z(a,"RID",r),z(a,"TYPE","terminate"),At(t,a),r=new be(t,t.j,r),r.M=2,r.A=Xt(ce(a)),a=!1,c.navigator&&c.navigator.sendBeacon)try{a=c.navigator.sendBeacon(r.A.toString(),"")}catch{}!a&&c.Image&&(new Image().src=r.A,a=!0),a||(r.g=js(r.j,null),r.g.ea(r.A)),r.F=Date.now(),Jt(r)}Fs(t)}function Zt(t){t.g&&(nn(t),t.g.cancel(),t.g=null)}function Ns(t){Zt(t),t.v&&(c.clearTimeout(t.v),t.v=null),ti(t),t.h.cancel(),t.m&&(typeof t.m=="number"&&c.clearTimeout(t.m),t.m=null)}function ei(t){if(!gs(t.h)&&!t.m){t.m=!0;var r=t.Ea;B||h(),j||(B(),j=!0),y.add(r,t),t.D=0}}function oa(t,r){return vs(t.h)>=t.h.j-(t.m?1:0)?!1:t.m?(t.i=r.G.concat(t.i),!0):t.I==1||t.I==2||t.D>=(t.Sa?0:t.Ta)?!1:(t.m=pt(v(t.Ea,t,r),Us(t,t.D)),t.D++,!0)}i.Ea=function(t){if(this.m)if(this.m=null,this.I==1){if(!t){this.V=Math.floor(Math.random()*1e5),t=this.V++;const w=new be(this,this.j,t);let S=this.o;if(this.U&&(S?(S=Kn(S),Xn(S,this.U)):S=this.U),this.u!==null||this.R||(w.J=S,S=null),this.S)e:{for(var r=0,a=0;a<this.i.length;a++){t:{var d=this.i[a];if("__data__"in d.map&&(d=d.map.__data__,typeof d=="string")){d=d.length;break t}d=void 0}if(d===void 0)break;if(r+=d,r>4096){r=a;break e}if(r===4096||a===this.i.length-1){r=a+1;break e}}r=1e3}else r=1e3;r=Ms(this,w,r),a=ce(this.J),z(a,"RID",t),z(a,"CVER",22),this.G&&z(a,"X-HTTP-Session-Id",this.G),At(this,a),S&&(this.R?r="headers="+vt(xs(S))+"&"+r:this.u&&Zi(a,this.u,S)),Xi(this.h,w),this.Ra&&z(a,"TYPE","init"),this.S?(z(a,"$req",r),z(a,"SID","null"),w.U=!0,Hi(w,a,null)):Hi(w,a,r),this.I=2}}else this.I==3&&(t?Rs(this,t):this.i.length==0||gs(this.h)||Rs(this))};function Rs(t,r){var a;r?a=r.l:a=t.V++;const d=ce(t.J);z(d,"SID",t.M),z(d,"RID",a),z(d,"AID",t.K),At(t,d),t.u&&t.o&&Zi(d,t.u,t.o),a=new be(t,t.j,a,t.D+1),t.u===null&&(a.J=t.o),r&&(t.i=r.G.concat(t.i)),r=Ms(t,a,1e3),a.H=Math.round(t.va*.5)+Math.round(t.va*.5*Math.random()),Xi(t.h,a),Hi(a,d,r)}function At(t,r){t.H&&Me(t.H,function(a,d){z(r,d,a)}),t.l&&Me({},function(a,d){z(r,d,a)})}function Ms(t,r,a){a=Math.min(t.i.length,a);const d=t.l?v(t.l.Ka,t.l,t):null;e:{var w=t.i;let M=-1;for(;;){const J=["count="+a];M==-1?a>0?(M=w[0].g,J.push("ofs="+M)):M=0:J.push("ofs="+M);let q=!0;for(let X=0;X<a;X++){var S=w[X].g;const de=w[X].map;if(S-=M,S<0)M=Math.max(0,w[X].g-100),q=!1;else try{S="req"+S+"_"||"";try{var O=de instanceof Map?de:Object.entries(de);for(const[Ue,ke]of O){let Ae=ke;u(ke)&&(Ae=Wi(ke)),J.push(S+Ue+"="+encodeURIComponent(Ae))}}catch(Ue){throw J.push(S+"type="+encodeURIComponent("_badmap")),Ue}}catch{d&&d(de)}}if(q){O=J.join("&");break e}}O=void 0}return t=t.i.splice(0,a),r.G=t,O}function $s(t){if(!t.g&&!t.v){t.Y=1;var r=t.Da;B||h(),j||(B(),j=!0),y.add(r,t),t.A=0}}function tn(t){return t.g||t.v||t.A>=3?!1:(t.Y++,t.v=pt(v(t.Da,t),Us(t,t.A)),t.A++,!0)}i.Da=function(){if(this.v=null,Bs(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var t=4*this.T;this.j.info("BP detection timer enabled: "+t),this.B=pt(v(this.Wa,this),t)}},i.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,ie(10),Zt(this),Bs(this))};function nn(t){t.B!=null&&(c.clearTimeout(t.B),t.B=null)}function Bs(t){t.g=new be(t,t.j,"rpc",t.Y),t.u===null&&(t.g.J=t.o),t.g.P=0;var r=ce(t.na);z(r,"RID","rpc"),z(r,"SID",t.M),z(r,"AID",t.K),z(r,"CI",t.F?"0":"1"),!t.F&&t.ia&&z(r,"TO",t.ia),z(r,"TYPE","xmlhttp"),At(t,r),t.u&&t.o&&Zi(r,t.u,t.o),t.O&&(t.g.H=t.O);var a=t.g;t=t.ba,a.M=1,a.A=Xt(ce(r)),a.u=null,a.R=!0,hs(a,t)}i.Va=function(){this.C!=null&&(this.C=null,Zt(this),tn(this),ie(19))};function ti(t){t.C!=null&&(c.clearTimeout(t.C),t.C=null)}function Ws(t,r){var a=null;if(t.g==r){ti(t),nn(t),t.g=null;var d=2}else if(Ji(t.h,r))a=r.G,ys(t.h,r),d=1;else return;if(t.I!=0){if(r.o)if(d==1){a=r.u?r.u.length:0,r=Date.now()-r.F;var w=t.D;d=Vi(),te(d,new ls(d,a)),ei(t)}else $s(t);else if(w=r.m,w==3||w==0&&r.X>0||!(d==1&&oa(t,r)||d==2&&tn(t)))switch(a&&a.length>0&&(r=t.h,r.i=r.i.concat(a)),w){case 1:We(t,5);break;case 4:We(t,10);break;case 3:We(t,6);break;default:We(t,2)}}}function Us(t,r){let a=t.Qa+Math.floor(Math.random()*t.Za);return t.isActive()||(a*=2),a*r}function We(t,r){if(t.j.info("Error code "+r),r==2){var a=v(t.bb,t),d=t.Ua;const w=!d;d=new we(d||"//www.google.com/images/cleardot.gif"),c.location&&c.location.protocol=="http"||_t(d,"https"),Xt(d),w?ea(d.toString(),a):ta(d.toString(),a)}else ie(2);t.I=0,t.l&&t.l.pa(r),Fs(t),Ns(t)}i.bb=function(t){t?(this.j.info("Successfully pinged google.com"),ie(2)):(this.j.info("Failed to ping google.com"),ie(1))};function Fs(t){if(t.I=0,t.ja=[],t.l){const r=_s(t.h);(r.length!=0||t.i.length!=0)&&(D(t.ja,r),D(t.ja,t.i),t.h.i.length=0,k(t.i),t.i.length=0),t.l.oa()}}function Vs(t,r,a){var d=a instanceof we?ce(a):new we(a);if(d.g!="")r&&(d.g=r+"."+d.g),It(d,d.u);else{var w=c.location;d=w.protocol,r=r?r+"."+w.hostname:w.hostname,w=+w.port;const S=new we(null);d&&_t(S,d),r&&(S.g=r),w&&It(S,w),a&&(S.h=a),d=S}return a=t.G,r=t.wa,a&&r&&z(d,a,r),z(d,"VER",t.ka),At(t,d),d}function js(t,r,a){if(r&&!t.L)throw Error("Can't create secondary domain capable XhrIo object.");return r=t.Aa&&!t.ma?new H(new Qi({ab:a})):new H(t.ma),r.Fa(t.L),r}i.isActive=function(){return!!this.l&&this.l.isActive(this)};function qs(){}i=qs.prototype,i.ra=function(){},i.qa=function(){},i.pa=function(){},i.oa=function(){},i.isActive=function(){return!0},i.Ka=function(){};function re(t,r){ee.call(this),this.g=new Cs(r),this.l=t,this.h=r&&r.messageUrlParams||null,t=r&&r.messageHeaders||null,r&&r.clientProtocolHeaderRequired&&(t?t["X-Client-Protocol"]="webchannel":t={"X-Client-Protocol":"webchannel"}),this.g.o=t,t=r&&r.initMessageHeaders||null,r&&r.messageContentType&&(t?t["X-WebChannel-Content-Type"]=r.messageContentType:t={"X-WebChannel-Content-Type":r.messageContentType}),r&&r.sa&&(t?t["X-WebChannel-Client-Profile"]=r.sa:t={"X-WebChannel-Client-Profile":r.sa}),this.g.U=t,(t=r&&r.Qb)&&!f(t)&&(this.g.u=t),this.A=r&&r.supportsCrossDomainXhr||!1,this.v=r&&r.sendRawJson||!1,(r=r&&r.httpSessionIdParam)&&!f(r)&&(this.g.G=r,t=this.h,t!==null&&r in t&&(t=this.h,r in t&&delete t[r])),this.j=new it(this)}I(re,ee),re.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},re.prototype.close=function(){en(this.g)},re.prototype.o=function(t){var r=this.g;if(typeof t=="string"){var a={};a.__data__=t,t=a}else this.v&&(a={},a.__data__=Wi(t),t=a);r.i.push(new Ho(r.Ya++,t)),r.I==3&&ei(r)},re.prototype.N=function(){this.g.l=null,delete this.j,en(this.g),delete this.g,re.Z.N.call(this)};function zs(t){Ui.call(this),t.__headers__&&(this.headers=t.__headers__,this.statusCode=t.__status__,delete t.__headers__,delete t.__status__);var r=t.__sm__;if(r){e:{for(const a in r){t=a;break e}t=void 0}(this.i=t)&&(t=this.i,r=r!==null&&t in r?r[t]:void 0),this.data=r}else this.data=t}I(zs,Ui);function Hs(){Fi.call(this),this.status=1}I(Hs,Fi);function it(t){this.g=t}I(it,qs),it.prototype.ra=function(){te(this.g,"a")},it.prototype.qa=function(t){te(this.g,new zs(t))},it.prototype.pa=function(t){te(this.g,new Hs)},it.prototype.oa=function(){te(this.g,"b")},re.prototype.send=re.prototype.o,re.prototype.open=re.prototype.m,re.prototype.close=re.prototype.close,ji.NO_ERROR=0,ji.TIMEOUT=8,ji.HTTP_ERROR=6,Vo.COMPLETE="complete",$o.EventType=ft,ft.OPEN="a",ft.CLOSE="b",ft.ERROR="c",ft.MESSAGE="d",ee.prototype.listen=ee.prototype.J,H.prototype.listenOnce=H.prototype.K,H.prototype.getLastError=H.prototype.Ha,H.prototype.getLastErrorCode=H.prototype.ya,H.prototype.getStatus=H.prototype.ca,H.prototype.getResponseJson=H.prototype.La,H.prototype.getResponseText=H.prototype.la,H.prototype.send=H.prototype.ea,H.prototype.setWithCredentials=H.prototype.Fa}).apply(typeof ni<"u"?ni:typeof self<"u"?self:typeof window<"u"?window:{});/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ki="12.12.0";function Rl(i){ki=i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hi=new Pn("@firebase/firestore");function ae(i,...e){if(hi.logLevel<=V.DEBUG){const n=e.map(Gr);hi.debug(`Firestore (${ki}): ${i}`,...n)}}function Hr(i,...e){if(hi.logLevel<=V.ERROR){const n=e.map(Gr);hi.error(`Firestore (${ki}): ${i}`,...n)}}function Gr(i){if(typeof i=="string")return i;try{return function(n){return JSON.stringify(n)}(i)}catch{return i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fi(i,e,n){let s="Unexpected state";typeof e=="string"?s=e:n=e,Kr(i,s,n)}function Kr(i,e,n){let s=`FIRESTORE (${ki}) INTERNAL ASSERTION FAILED: ${e} (ID: ${i.toString(16)})`;if(n!==void 0)try{s+=" CONTEXT: "+JSON.stringify(n)}catch{s+=" CONTEXT: "+n}throw Hr(s),new Error(s)}function Ot(i,e,n,s){let o="Unexpected state";typeof n=="string"?o=n:s=n,i||Kr(e,o,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vl(i){const e=typeof self<"u"&&(self.crypto||self.msCrypto),n=new Uint8Array(i);if(e&&typeof e.getRandomValues=="function")e.getRandomValues(n);else for(let s=0;s<i;s++)n[s]=Math.floor(256*Math.random());return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jl{static newId(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",n=62*Math.floor(4.129032258064516);let s="";for(;s.length<20;){const o=Vl(40);for(let l=0;l<o.length;++l)s.length<20&&o[l]<n&&(s+=e.charAt(o[l]%62))}return s}}function Pe(i,e){return i<e?-1:i>e?1:0}function ql(i,e){const n=Math.min(i.length,e.length);for(let s=0;s<n;s++){const o=i.charAt(s),l=e.charAt(s);if(o!==l)return dn(o)===dn(l)?Pe(o,l):dn(o)?1:-1}return Pe(i.length,e.length)}const zl=55296,Hl=57343;function dn(i){const e=i.charCodeAt(0);return e>=zl&&e<=Hl}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rr="__name__";class ue{constructor(e,n,s){n===void 0?n=0:n>e.length&&fi(637,{offset:n,range:e.length}),s===void 0?s=e.length-n:s>e.length-n&&fi(1746,{length:s,range:e.length-n}),this.segments=e,this.offset=n,this.len=s}get length(){return this.len}isEqual(e){return ue.comparator(this,e)===0}child(e){const n=this.segments.slice(this.offset,this.limit());return e instanceof ue?e.forEach(s=>{n.push(s)}):n.push(e),this.construct(n)}limit(){return this.offset+this.length}popFirst(e){return e=e===void 0?1:e,this.construct(this.segments,this.offset+e,this.length-e)}popLast(){return this.construct(this.segments,this.offset,this.length-1)}firstSegment(){return this.segments[this.offset]}lastSegment(){return this.get(this.length-1)}get(e){return this.segments[this.offset+e]}isEmpty(){return this.length===0}isPrefixOf(e){if(e.length<this.length)return!1;for(let n=0;n<this.length;n++)if(this.get(n)!==e.get(n))return!1;return!0}isImmediateParentOf(e){if(this.length+1!==e.length)return!1;for(let n=0;n<this.length;n++)if(this.get(n)!==e.get(n))return!1;return!0}forEach(e){for(let n=this.offset,s=this.limit();n<s;n++)e(this.segments[n])}toArray(){return this.segments.slice(this.offset,this.limit())}static comparator(e,n){const s=Math.min(e.length,n.length);for(let o=0;o<s;o++){const l=ue.compareSegments(e.get(o),n.get(o));if(l!==0)return l}return Pe(e.length,n.length)}static compareSegments(e,n){const s=ue.isNumericId(e),o=ue.isNumericId(n);return s&&!o?-1:!s&&o?1:s&&o?ue.extractNumericId(e).compare(ue.extractNumericId(n)):ql(e,n)}static isNumericId(e){return e.startsWith("__id")&&e.endsWith("__")}static extractNumericId(e){return Rn.fromString(e.substring(4,e.length-2))}}class oe extends ue{construct(e,n,s){return new oe(e,n,s)}canonicalString(){return this.toArray().join("/")}toString(){return this.canonicalString()}toUriEncodedString(){return this.toArray().map(encodeURIComponent).join("/")}static fromString(...e){const n=[];for(const s of e){if(s.indexOf("//")>=0)throw new F(U.INVALID_ARGUMENT,`Invalid segment (${s}). Paths must not contain // in them.`);n.push(...s.split("/").filter(o=>o.length>0))}return new oe(n)}static emptyPath(){return new oe([])}}const Gl=/^[_a-zA-Z][_a-zA-Z0-9]*$/;class Ve extends ue{construct(e,n,s){return new Ve(e,n,s)}static isValidIdentifier(e){return Gl.test(e)}canonicalString(){return this.toArray().map(e=>(e=e.replace(/\\/g,"\\\\").replace(/`/g,"\\`"),Ve.isValidIdentifier(e)||(e="`"+e+"`"),e)).join(".")}toString(){return this.canonicalString()}isKeyField(){return this.length===1&&this.get(0)===rr}static keyField(){return new Ve([rr])}static fromServerFormat(e){const n=[];let s="",o=0;const l=()=>{if(s.length===0)throw new F(U.INVALID_ARGUMENT,`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);n.push(s),s=""};let c=!1;for(;o<e.length;){const u=e[o];if(u==="\\"){if(o+1===e.length)throw new F(U.INVALID_ARGUMENT,"Path has trailing escape character: "+e);const p=e[o+1];if(p!=="\\"&&p!=="."&&p!=="`")throw new F(U.INVALID_ARGUMENT,"Path has invalid escape sequence: "+e);s+=p,o+=2}else u==="`"?(c=!c,o++):u!=="."||c?(s+=u,o++):(l(),o++)}if(l(),c)throw new F(U.INVALID_ARGUMENT,"Unterminated ` in path: "+e);return new Ve(n)}static emptyPath(){return new Ve([])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function G(i,e){const n={typeString:i};return e&&(n.value=e),n}function qt(i,e){if(!Jl(i))throw new F(U.INVALID_ARGUMENT,"JSON must be an object");let n;for(const s in e)if(e[s]){const o=e[s].typeString,l="value"in e[s]?{value:e[s].value}:void 0;if(!(s in i)){n=`JSON missing required field: '${s}'`;break}const c=i[s];if(o&&typeof c!==o){n=`JSON field '${s}' must be a ${o}.`;break}if(l!==void 0&&c!==l.value){n=`Expected '${s}' field to equal '${l.value}'`;break}}if(n)throw new F(U.INVALID_ARGUMENT,n);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const or=-62135596800,ar=1e6;class he{static now(){return he.fromMillis(Date.now())}static fromDate(e){return he.fromMillis(e.getTime())}static fromMillis(e){const n=Math.floor(e/1e3),s=Math.floor((e-1e3*n)*ar);return new he(n,s)}constructor(e,n){if(this.seconds=e,this.nanoseconds=n,n<0)throw new F(U.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+n);if(n>=1e9)throw new F(U.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+n);if(e<or)throw new F(U.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e);if(e>=253402300800)throw new F(U.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e)}toDate(){return new Date(this.toMillis())}toMillis(){return 1e3*this.seconds+this.nanoseconds/ar}_compareTo(e){return this.seconds===e.seconds?Pe(this.nanoseconds,e.nanoseconds):Pe(this.seconds,e.seconds)}isEqual(e){return e.seconds===this.seconds&&e.nanoseconds===this.nanoseconds}toString(){return"Timestamp(seconds="+this.seconds+", nanoseconds="+this.nanoseconds+")"}toJSON(){return{type:he._jsonSchemaVersion,seconds:this.seconds,nanoseconds:this.nanoseconds}}static fromJSON(e){if(qt(e,he._jsonSchema))return new he(e.seconds,e.nanoseconds)}valueOf(){const e=this.seconds-or;return String(e).padStart(12,"0")+"."+String(this.nanoseconds).padStart(9,"0")}}he._jsonSchemaVersion="firestore/timestamp/1.0",he._jsonSchema={type:G("string",he._jsonSchemaVersion),seconds:G("number"),nanoseconds:G("number")};function Xl(i){return i.name==="IndexedDbTransactionError"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zl{constructor(e,n=null,s=[],o=[],l=null,c="F",u=null,p=null){this.path=e,this.collectionGroup=n,this.explicitOrderBy=s,this.filters=o,this.limit=l,this.limitType=c,this.startAt=u,this.endAt=p,this.Ee=null,this.Ie=null,this.Re=null,this.startAt,this.endAt}}function ec(i){return new Zl(i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */new Rn([4294967295,4294967295],0);/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mn{constructor(e,n,s,o,l){this.asyncQueue=e,this.timerId=n,this.targetTimeMs=s,this.op=o,this.removalCallback=l,this.deferred=new Dt,this.then=this.deferred.promise.then.bind(this.deferred.promise),this.deferred.promise.catch(c=>{})}get promise(){return this.deferred.promise}static createAndSchedule(e,n,s,o,l){const c=Date.now()+s,u=new Mn(e,n,c,o,l);return u.start(s),u}start(e){this.timerHandle=setTimeout(()=>this.handleDelayElapsed(),e)}skipDelay(){return this.handleDelayElapsed()}cancel(e){this.timerHandle!==null&&(this.clearTimeout(),this.deferred.reject(new F(U.CANCELLED,"Operation cancelled"+(e?": "+e:""))))}handleDelayElapsed(){this.asyncQueue.enqueueAndForget(()=>this.timerHandle!==null?(this.clearTimeout(),this.op().then(e=>this.deferred.resolve(e))):Promise.resolve())}clearTimeout(){this.timerHandle!==null&&(this.removalCallback(this),clearTimeout(this.timerHandle),this.timerHandle=null)}}var dr,ur;(ur=dr||(dr={})).Ma="default",ur.Cache="cache";/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rc="ComponentProvider",hr=new Map;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oc="firestore.googleapis.com",fr=!0;class mr{constructor(e){if(e.host===void 0){if(e.ssl!==void 0)throw new F(U.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host=oc,this.ssl=fr}else this.host=e.host,this.ssl=e.ssl??fr;if(this.isUsingEmulator=e.emulatorOptions!==void 0,this.credentials=e.credentials,this.ignoreUndefinedProperties=!!e.ignoreUndefinedProperties,this.localCache=e.localCache,e.cacheSizeBytes===void 0)this.cacheSizeBytes=tc;else{if(e.cacheSizeBytes!==-1&&e.cacheSizeBytes<ic)throw new F(U.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=e.cacheSizeBytes}Kl("experimentalForceLongPolling",e.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",e.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!e.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:e.experimentalAutoDetectLongPolling===void 0?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!e.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=sc(e.experimentalLongPollingOptions??{}),function(s){if(s.timeoutSeconds!==void 0){if(isNaN(s.timeoutSeconds))throw new F(U.INVALID_ARGUMENT,`invalid long polling timeout: ${s.timeoutSeconds} (must not be NaN)`);if(s.timeoutSeconds<5)throw new F(U.INVALID_ARGUMENT,`invalid long polling timeout: ${s.timeoutSeconds} (minimum allowed value is 5)`);if(s.timeoutSeconds>30)throw new F(U.INVALID_ARGUMENT,`invalid long polling timeout: ${s.timeoutSeconds} (maximum allowed value is 30)`)}}(this.experimentalLongPollingOptions),this.useFetchStreams=!!e.useFetchStreams}isEqual(e){return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&function(s,o){return s.timeoutSeconds===o.timeoutSeconds}(this.experimentalLongPollingOptions,e.experimentalLongPollingOptions)&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams}}class ac{constructor(e,n,s,o){this._authCredentials=e,this._appCheckCredentials=n,this._databaseId=s,this._app=o,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new mr({}),this._settingsFrozen=!1,this._emulatorOptions={},this._terminateTask="notTerminated"}get app(){if(!this._app)throw new F(U.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return this._terminateTask!=="notTerminated"}_setSettings(e){if(this._settingsFrozen)throw new F(U.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new mr(e),this._emulatorOptions=e.emulatorOptions||{},e.credentials!==void 0&&(this._authCredentials=function(s){if(!s)return new $l;switch(s.type){case"firstParty":return new Ul(s.sessionIndex||"0",s.iamToken||null,s.authTokenFactory||null);case"provider":return s.client;default:throw new F(U.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}}(e.credentials))}_getSettings(){return this._settings}_getEmulatorOptions(){return this._emulatorOptions}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask==="notTerminated"&&(this._terminateTask=this._terminate()),this._terminateTask}async _restart(){this._terminateTask==="notTerminated"?await this._terminate():this._terminateTask="notTerminated"}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return function(n){const s=hr.get(n);s&&(ae(rc,"Removing Datastore"),hr.delete(n),s.terminate())}(this),Promise.resolve()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $n{constructor(e,n,s){this.converter=n,this._query=s,this.type="query",this.firestore=e}withConverter(e){return new $n(this.firestore,e,this._query)}}class fe{constructor(e,n,s){this.converter=n,this._key=s,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Bn(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new fe(this.firestore,e,this._key)}toJSON(){return{type:fe._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(e,n,s){if(qt(n,fe._jsonSchema))return new fe(e,s||null,new je(oe.fromString(n.referencePath)))}}fe._jsonSchemaVersion="firestore/documentReference/1.0",fe._jsonSchema={type:G("string",fe._jsonSchemaVersion),referencePath:G("string")};class Bn extends $n{constructor(e,n,s){super(e,n,ec(s)),this._path=s,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new fe(this.firestore,null,new je(e))}withConverter(e){return new Bn(this.firestore,e,this._path)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pr="AsyncQueue";class gr{constructor(e=Promise.resolve()){this.Yu=[],this.ec=!1,this.tc=[],this.nc=null,this.rc=!1,this.sc=!1,this.oc=[],this.M_=new nc(this,"async_queue_retry"),this._c=()=>{const s=un();s&&ae(pr,"Visibility state changed to "+s.visibilityState),this.M_.w_()},this.ac=e;const n=un();n&&typeof n.addEventListener=="function"&&n.addEventListener("visibilitychange",this._c)}get isShuttingDown(){return this.ec}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.uc(),this.cc(e)}enterRestrictedMode(e){if(!this.ec){this.ec=!0,this.sc=e||!1;const n=un();n&&typeof n.removeEventListener=="function"&&n.removeEventListener("visibilitychange",this._c)}}enqueue(e){if(this.uc(),this.ec)return new Promise(()=>{});const n=new Dt;return this.cc(()=>this.ec&&this.sc?Promise.resolve():(e().then(n.resolve,n.reject),n.promise)).then(()=>n.promise)}enqueueRetryable(e){this.enqueueAndForget(()=>(this.Yu.push(e),this.lc()))}async lc(){if(this.Yu.length!==0){try{await this.Yu[0](),this.Yu.shift(),this.M_.reset()}catch(e){if(!Xl(e))throw e;ae(pr,"Operation failed with retryable error: "+e)}this.Yu.length>0&&this.M_.p_(()=>this.lc())}}cc(e){const n=this.ac.then(()=>(this.rc=!0,e().catch(s=>{throw this.nc=s,this.rc=!1,Hr("INTERNAL UNHANDLED ERROR: ",vr(s)),s}).then(s=>(this.rc=!1,s))));return this.ac=n,n}enqueueAfterDelay(e,n,s){this.uc(),this.oc.indexOf(e)>-1&&(n=0);const o=Mn.createAndSchedule(this,e,n,s,l=>this.hc(l));return this.tc.push(o),o}uc(){this.nc&&fi(47125,{Pc:vr(this.nc)})}verifyOperationInProgress(){}async Tc(){let e;do e=this.ac,await e;while(e!==this.ac)}Ec(e){for(const n of this.tc)if(n.timerId===e)return!0;return!1}Ic(e){return this.Tc().then(()=>{this.tc.sort((n,s)=>n.targetTimeMs-s.targetTimeMs);for(const n of this.tc)if(n.skipDelay(),e!=="all"&&n.timerId===e)break;return this.Tc()})}Rc(e){this.oc.push(e)}hc(e){const n=this.tc.indexOf(e);this.tc.splice(n,1)}}function vr(i){let e=i.message||"";return i.stack&&(e=i.stack.includes(i.message)?i.stack:i.message+`
`+i.stack),e}class lc extends ac{constructor(e,n,s,o){super(e,n,s,o),this.type="firestore",this._queue=new gr,this._persistenceKey=(o==null?void 0:o.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new gr(e),this._firestoreClient=void 0,await e}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class He{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new F(U.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new F(U.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return Pe(this._lat,e._lat)||Pe(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:He._jsonSchemaVersion}}static fromJSON(e){if(qt(e,He._jsonSchema))return new He(e.latitude,e.longitude)}}He._jsonSchemaVersion="firestore/geoPoint/1.0",He._jsonSchema={type:G("string",He._jsonSchemaVersion),latitude:G("number"),longitude:G("number")};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Lt._jsonSchemaVersion="firestore/querySnapshot/1.0",Lt._jsonSchema={type:G("string",Lt._jsonSchemaVersion),bundleSource:G("string","QuerySnapshot"),bundleName:G("string"),bundle:G("string")};(function(e,n=!0){Rl(Ei),lt(new at("firestore",(s,{instanceIdentifier:o,options:l})=>{const c=s.getProvider("app").getImmediate(),u=new lc(new Bl(s.getProvider("auth-internal")),new Fl(c,s.getProvider("app-check-internal")),Ql(c,o),c);return l={useFetchStreams:n,...l},u._setSettings(l),u},"PUBLIC").setMultipleInstances(!0)),Le(yr,_r,e),Le(yr,_r,"esm2020")})();function Qr(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const fc=Qr,Zr=new Vt("auth","Firebase",Qr());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pi=new Pn("@firebase/auth");function mc(i,...e){pi.logLevel<=V.WARN&&pi.warn(`Auth (${Ei}): ${i}`,...e)}function ci(i,...e){pi.logLevel<=V.ERROR&&pi.error(`Auth (${Ei}): ${i}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ir(i,...e){throw Wn(i,...e)}function eo(i,...e){return Wn(i,...e)}function to(i,e,n){const s={...fc(),[e]:n};return new Vt("auth","Firebase",s).create(e,{appName:i.name})}function di(i){return to(i,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function Wn(i,...e){if(typeof i!="string"){const n=e[0],s=[...e.slice(1)];return s[0]&&(s[0].appName=i.name),i._errorFactory.create(n,...s)}return Zr.create(i,...e)}function W(i,e,...n){if(!i)throw Wn(e,...n)}function Pt(i){const e="INTERNAL ASSERTION FAILED: "+i;throw ci(e),new Error(e)}function gi(i,e){i||Pt(e)}function pc(){return Tr()==="http:"||Tr()==="https:"}function Tr(){var i;return typeof self<"u"&&((i=self.location)==null?void 0:i.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gc(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(pc()||_a()||"connection"in navigator)?navigator.onLine:!0}function vc(){if(typeof navigator>"u")return null;const i=navigator;return i.languages&&i.languages[0]||i.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zt{constructor(e,n){this.shortDelay=e,this.longDelay=n,gi(n>e,"Short delay should be less than long delay!"),this.isMobile=va()||Ia()}get(){return gc()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yc(i,e){gi(i.emulator,"Emulator should always be set here");const{url:n}=i.emulator;return e?`${n}${e.startsWith("/")?e.slice(1):e}`:n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class io{static initialize(e,n,s){this.fetchImpl=e,n&&(this.headersImpl=n),s&&(this.responseImpl=s)}static fetch(){if(this.fetchImpl)return this.fetchImpl;if(typeof self<"u"&&"fetch"in self)return self.fetch;if(typeof globalThis<"u"&&globalThis.fetch)return globalThis.fetch;if(typeof fetch<"u")return fetch;Pt("Could not find fetch implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill")}static headers(){if(this.headersImpl)return this.headersImpl;if(typeof self<"u"&&"Headers"in self)return self.Headers;if(typeof globalThis<"u"&&globalThis.Headers)return globalThis.Headers;if(typeof Headers<"u")return Headers;Pt("Could not find Headers implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill")}static response(){if(this.responseImpl)return this.responseImpl;if(typeof self<"u"&&"Response"in self)return self.Response;if(typeof globalThis<"u"&&globalThis.Response)return globalThis.Response;if(typeof Response<"u")return Response;Pt("Could not find Response implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ic=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],Tc=new zt(3e4,6e4);function no(i,e){return i.tenantId&&!e.tenantId?{...e,tenantId:i.tenantId}:e}async function Ai(i,e,n,s,o={}){return so(i,o,async()=>{let l={},c={};s&&(e==="GET"?c=s:l={body:JSON.stringify(s)});const u=Ur({key:i.config.apiKey,...c}).slice(1),p=await i._getAdditionalHeaders();p["Content-Type"]="application/json",i.languageCode&&(p["X-Firebase-Locale"]=i.languageCode);const v={method:e,headers:p,...l};return ya()||(v.referrerPolicy="no-referrer"),i.emulatorConfig&&Fr(i.emulatorConfig.host)&&(v.credentials="include"),io.fetch()(await ro(i,i.config.apiHost,n,u),v)})}async function so(i,e,n){i._canInitEmulator=!1;const s={..._c,...e};try{const o=new bc(i),l=await Promise.race([n(),o.promise]);o.clearNetworkTimeout();const c=await l.json();if("needConfirmation"in c)throw ri(i,"account-exists-with-different-credential",c);if(l.ok&&!("errorMessage"in c))return c;{const u=l.ok?c.errorMessage:c.error.message,[p,v]=u.split(" : ");if(p==="FEDERATED_USER_ID_ALREADY_LINKED")throw ri(i,"credential-already-in-use",c);if(p==="EMAIL_EXISTS")throw ri(i,"email-already-in-use",c);if(p==="USER_DISABLED")throw ri(i,"user-disabled",c);const E=s[p]||p.toLowerCase().replace(/[_\s]+/g,"-");if(v)throw to(i,E,v);Ir(i,E)}}catch(o){if(o instanceof Ce)throw o;Ir(i,"network-request-failed",{message:String(o)})}}async function ro(i,e,n,s){const o=`${e}${n}?${s}`,l=i,c=l.config.emulator?yc(i.config,o):`${i.config.apiScheme}://${o}`;return Ic.includes(n)&&(await l._persistenceManagerAvailable,l._getPersistenceType()==="COOKIE")?l._getPersistence()._getFinalTarget(c).toString():c}class bc{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,s)=>{this.timer=setTimeout(()=>s(eo(this.auth,"network-request-failed")),Tc.get())})}}function ri(i,e,n){const s={appName:i.name};n.email&&(s.email=n.email),n.phoneNumber&&(s.phoneNumber=n.phoneNumber);const o=eo(i,e,s);return o.customData._tokenResponse=n,o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wc(i,e){return Ai(i,"POST","/v1/accounts:delete",e)}async function vi(i,e){return Ai(i,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ct(i){if(i)try{const e=new Date(Number(i));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Sc(i,e=!1){const n=jt(i),s=await n.getIdToken(e),o=oo(s);W(o&&o.exp&&o.auth_time&&o.iat,n.auth,"internal-error");const l=typeof o.firebase=="object"?o.firebase:void 0,c=l==null?void 0:l.sign_in_provider;return{claims:o,token:s,authTime:Ct(hn(o.auth_time)),issuedAtTime:Ct(hn(o.iat)),expirationTime:Ct(hn(o.exp)),signInProvider:c||null,signInSecondFactor:(l==null?void 0:l.sign_in_second_factor)||null}}function hn(i){return Number(i)*1e3}function oo(i){const[e,n,s]=i.split(".");if(e===void 0||n===void 0||s===void 0)return ci("JWT malformed, contained fewer than 3 sections"),null;try{const o=Wr(n);return o?JSON.parse(o):(ci("Failed to decode base64 JWT payload"),null)}catch(o){return ci("Caught error parsing JWT payload as JSON",o==null?void 0:o.toString()),null}}function br(i){const e=oo(i);return W(e,"internal-error"),W(typeof e.exp<"u","internal-error"),W(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bn(i,e,n=!1){if(n)return e;try{return await e}catch(s){throw s instanceof Ce&&Ec(s)&&i.auth.currentUser===i&&await i.auth.signOut(),s}}function Ec({code:i}){return i==="auth/user-disabled"||i==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yi(i){var I;const e=i.auth,n=await i.getIdToken(),s=await bn(i,vi(e,{idToken:n}));W(s==null?void 0:s.users.length,e,"internal-error");const o=s.users[0];i._notifyReloadListener(o);const l=(I=o.providerUserInfo)!=null&&I.length?ao(o.providerUserInfo):[],c=xc(i.providerData,l),u=i.isAnonymous,p=!(i.email&&o.passwordHash)&&!(c!=null&&c.length),v=u?p:!1,E={uid:o.localId,displayName:o.displayName||null,photoURL:o.photoUrl||null,email:o.email||null,emailVerified:o.emailVerified||!1,phoneNumber:o.phoneNumber||null,tenantId:o.tenantId||null,providerData:c,metadata:new wn(o.createdAt,o.lastLoginAt),isAnonymous:v};Object.assign(i,E)}async function Ac(i){const e=jt(i);await yi(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function xc(i,e){return[...i.filter(s=>!e.some(o=>o.providerId===s.providerId)),...e]}function ao(i){return i.map(({providerId:e,...n})=>({providerId:e,uid:n.rawId||"",displayName:n.displayName||null,email:n.email||null,phoneNumber:n.phoneNumber||null,photoURL:n.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Oc(i,e){const n=await so(i,{},async()=>{const s=Ur({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:o,apiKey:l}=i.config,c=await ro(i,o,"/v1/token",`key=${l}`),u=await i._getAdditionalHeaders();u["Content-Type"]="application/x-www-form-urlencoded";const p={method:"POST",headers:u,body:s};return i.emulatorConfig&&Fr(i.emulatorConfig.host)&&(p.credentials="include"),io.fetch()(c,p)});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}async function Dc(i,e){return Ai(i,"POST","/v2/accounts:revokeToken",no(i,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rt{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){W(e.idToken,"internal-error"),W(typeof e.idToken<"u","internal-error"),W(typeof e.refreshToken<"u","internal-error");const n="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):br(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,n)}updateFromIdToken(e){W(e.length!==0,"internal-error");const n=br(e);this.updateTokensAndExpiration(e,null,n)}async getToken(e,n=!1){return!n&&this.accessToken&&!this.isExpired?this.accessToken:(W(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,n){const{accessToken:s,refreshToken:o,expiresIn:l}=await Oc(e,n);this.updateTokensAndExpiration(s,o,Number(l))}updateTokensAndExpiration(e,n,s){this.refreshToken=n||null,this.accessToken=e||null,this.expirationTime=Date.now()+s*1e3}static fromJSON(e,n){const{refreshToken:s,accessToken:o,expirationTime:l}=n,c=new rt;return s&&(W(typeof s=="string","internal-error",{appName:e}),c.refreshToken=s),o&&(W(typeof o=="string","internal-error",{appName:e}),c.accessToken=o),l&&(W(typeof l=="number","internal-error",{appName:e}),c.expirationTime=l),c}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new rt,this.toJSON())}_performRefresh(){return Pt("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xe(i,e){W(typeof i=="string"||typeof i>"u","internal-error",{appName:e})}class me{constructor({uid:e,auth:n,stsTokenManager:s,...o}){this.providerId="firebase",this.proactiveRefresh=new kc(this),this.reloadUserInfo=null,this.reloadListener=null,this.uid=e,this.auth=n,this.stsTokenManager=s,this.accessToken=s.accessToken,this.displayName=o.displayName||null,this.email=o.email||null,this.emailVerified=o.emailVerified||!1,this.phoneNumber=o.phoneNumber||null,this.photoURL=o.photoURL||null,this.isAnonymous=o.isAnonymous||!1,this.tenantId=o.tenantId||null,this.providerData=o.providerData?[...o.providerData]:[],this.metadata=new wn(o.createdAt||void 0,o.lastLoginAt||void 0)}async getIdToken(e){const n=await bn(this,this.stsTokenManager.getToken(this.auth,e));return W(n,this.auth,"internal-error"),this.accessToken!==n&&(this.accessToken=n,await this.auth._persistUserIfCurrent(this),this.auth._notifyListenersIfCurrent(this)),n}getIdTokenResult(e){return Sc(this,e)}reload(){return Ac(this)}_assign(e){this!==e&&(W(this.uid===e.uid,this.auth,"internal-error"),this.displayName=e.displayName,this.photoURL=e.photoURL,this.email=e.email,this.emailVerified=e.emailVerified,this.phoneNumber=e.phoneNumber,this.isAnonymous=e.isAnonymous,this.tenantId=e.tenantId,this.providerData=e.providerData.map(n=>({...n})),this.metadata._copy(e.metadata),this.stsTokenManager._assign(e.stsTokenManager))}_clone(e){const n=new me({...this,auth:e,stsTokenManager:this.stsTokenManager._clone()});return n.metadata._copy(this.metadata),n}_onReload(e){W(!this.reloadListener,this.auth,"internal-error"),this.reloadListener=e,this.reloadUserInfo&&(this._notifyReloadListener(this.reloadUserInfo),this.reloadUserInfo=null)}_notifyReloadListener(e){this.reloadListener?this.reloadListener(e):this.reloadUserInfo=e}_startProactiveRefresh(){this.proactiveRefresh._start()}_stopProactiveRefresh(){this.proactiveRefresh._stop()}async _updateTokensIfNecessary(e,n=!1){let s=!1;e.idToken&&e.idToken!==this.stsTokenManager.accessToken&&(this.stsTokenManager.updateFromServerResponse(e),s=!0),n&&await yi(this),await this.auth._persistUserIfCurrent(this),s&&this.auth._notifyListenersIfCurrent(this)}async delete(){if(Fe(this.auth.app))return Promise.reject(di(this.auth));const e=await this.getIdToken();return await bn(this,wc(this.auth,{idToken:e})),this.stsTokenManager.clearRefreshToken(),this.auth.signOut()}toJSON(){return{uid:this.uid,email:this.email||void 0,emailVerified:this.emailVerified,displayName:this.displayName||void 0,isAnonymous:this.isAnonymous,photoURL:this.photoURL||void 0,phoneNumber:this.phoneNumber||void 0,tenantId:this.tenantId||void 0,providerData:this.providerData.map(e=>({...e})),stsTokenManager:this.stsTokenManager.toJSON(),_redirectEventId:this._redirectEventId,...this.metadata.toJSON(),apiKey:this.auth.config.apiKey,appName:this.auth.name}}get refreshToken(){return this.stsTokenManager.refreshToken||""}static _fromJSON(e,n){const s=n.displayName??void 0,o=n.email??void 0,l=n.phoneNumber??void 0,c=n.photoURL??void 0,u=n.tenantId??void 0,p=n._redirectEventId??void 0,v=n.createdAt??void 0,E=n.lastLoginAt??void 0,{uid:I,emailVerified:T,isAnonymous:k,providerData:D,stsTokenManager:x}=n;W(I&&x,e,"internal-error");const L=rt.fromJSON(this.name,x);W(typeof I=="string",e,"internal-error"),xe(s,e.name),xe(o,e.name),W(typeof T=="boolean",e,"internal-error"),W(typeof k=="boolean",e,"internal-error"),xe(l,e.name),xe(c,e.name),xe(u,e.name),xe(p,e.name),xe(v,e.name),xe(E,e.name);const A=new me({uid:I,auth:e,email:o,emailVerified:T,displayName:s,isAnonymous:k,photoURL:c,phoneNumber:l,tenantId:u,stsTokenManager:L,createdAt:v,lastLoginAt:E});return D&&Array.isArray(D)&&(A.providerData=D.map(P=>({...P}))),p&&(A._redirectEventId=p),A}static async _fromIdTokenResponse(e,n,s=!1){const o=new rt;o.updateFromServerResponse(n);const l=new me({uid:n.localId,auth:e,stsTokenManager:o,isAnonymous:s});return await yi(l),l}static async _fromGetAccountInfoResponse(e,n,s){const o=n.users[0];W(o.localId!==void 0,"internal-error");const l=o.providerUserInfo!==void 0?ao(o.providerUserInfo):[],c=!(o.email&&o.passwordHash)&&!(l!=null&&l.length),u=new rt;u.updateFromIdToken(s);const p=new me({uid:o.localId,auth:e,stsTokenManager:u,isAnonymous:c}),v={uid:o.localId,displayName:o.displayName||null,photoURL:o.photoUrl||null,email:o.email||null,emailVerified:o.emailVerified||!1,phoneNumber:o.phoneNumber||null,tenantId:o.tenantId||null,providerData:l,metadata:new wn(o.createdAt,o.lastLoginAt),isAnonymous:!(o.email&&o.passwordHash)&&!(l!=null&&l.length)};return Object.assign(p,v),p}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wr=new Map;function qe(i){gi(i instanceof Function,"Expected a class definition");let e=wr.get(i);return e?(gi(e instanceof i,"Instance stored in cache mismatched with class"),e):(e=new i,wr.set(i,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lo{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,n){this.storage[e]=n}async _get(e){const n=this.storage[e];return n===void 0?null:n}async _remove(e){delete this.storage[e]}_addListener(e,n){}_removeListener(e,n){}}lo.type="NONE";const Sr=lo;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Er(i){const e=i.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Nc(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Lc(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Mc(e))return"Blackberry";if($c(e))return"Webos";if(Pc(e))return"Safari";if((e.includes("chrome/")||Cc(e))&&!e.includes("edge/"))return"Chrome";if(Rc(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=i.match(n);if((s==null?void 0:s.length)===2)return s[1]}return"Other"}function Lc(i=pe()){return/firefox\//i.test(i)}function Pc(i=pe()){const e=i.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Cc(i=pe()){return/crios\//i.test(i)}function Nc(i=pe()){return/iemobile/i.test(i)}function Rc(i=pe()){return/android/i.test(i)}function Mc(i=pe()){return/blackberry/i.test(i)}function $c(i=pe()){return/webos/i.test(i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function co(i,e=[]){let n;switch(i){case"Browser":n=Er(pe());break;case"Worker":n=`${Er(pe())}-${i}`;break;default:n=i}const s=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Ei}/${s}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bc{constructor(e){this.auth=e,this.queue=[]}pushCallback(e,n){const s=l=>new Promise((c,u)=>{try{const p=e(l);c(p)}catch(p){u(p)}});s.onAbort=n,this.queue.push(s);const o=this.queue.length-1;return()=>{this.queue[o]=()=>Promise.resolve()}}async runMiddleware(e){if(this.auth.currentUser===e)return;const n=[];try{for(const s of this.queue)await s(e),s.onAbort&&n.push(s.onAbort)}catch(s){n.reverse();for(const o of n)try{o()}catch{}throw this.auth._errorFactory.create("login-blocked",{originalMessage:s==null?void 0:s.message})}}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Wc(i,e={}){return Ai(i,"GET","/v2/passwordPolicy",no(i,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */new zt(5e3,15e3);var Ar="@firebase/auth",xr="1.13.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hc(i){switch(i){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Gc(i){lt(new at("auth",(e,{options:n})=>{const s=e.getProvider("app").getImmediate(),o=e.getProvider("heartbeat"),l=e.getProvider("app-check-internal"),{apiKey:c,authDomain:u}=s.options;W(c&&!c.includes(":"),"invalid-api-key",{appName:s.name});const p={apiKey:c,authDomain:u,clientPlatform:i,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:co(i)},v=new Vc(s,o,l,p);return qc(v,n),v},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,s)=>{e.getProvider("auth-internal").initialize()})),lt(new at("auth-internal",e=>{const n=jc(e.getProvider("auth").getImmediate());return(s=>new zc(s))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),Le(Ar,xr,Hc(i)),Le(Ar,xr,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const Kc=5*60;ga("authIdTokenMaxAge");Gc("Browser");console.warn("⚠️ Firebase未設定。.envファイルにAPIキーを設定してください。");function uo(i){const e=new Date(i),n=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${n}-${s}-${o}`}function ct(i){const e=new Date(i),n=["日","月","火","水","木","金","土"];return`${e.getMonth()+1}月${e.getDate()}日（${n[e.getDay()]}）`}function Ye(){return uo(new Date)}function $t(i){const e=Math.floor(i/60),n=i%60;return`${String(e).padStart(2,"0")}:${String(n).padStart(2,"0")}`}function Y(i){if(!i)return 0;const[e,n]=i.split(":").map(Number);return e*60+n}function ho(){return Date.now().toString(36)+Math.random().toString(36).slice(2,9)}function fo(i,e,n,s){const l=oi(n-i),c=oi(s-e),u=Math.sin(l/2)**2+Math.cos(oi(i))*Math.cos(oi(n))*Math.sin(c/2)**2;return 6371*2*Math.atan2(Math.sqrt(u),Math.sqrt(1-u))}function oi(i){return i*(Math.PI/180)}function Z(i){const e=document.createElement("div");return e.textContent=i,e.innerHTML}function C(i,e="info",n=3e3){const s=document.getElementById("toast-container"),o={success:"check_circle",error:"error",warning:"warning",info:"info"},l=document.createElement("div");l.className=`toast ${e}`,l.innerHTML=`
  ...
  `,s.appendChild(l),setTimeout(()=>{l.style.opacity="0",l.style.transform="translateX(40px)",l.style.transition="all .3s ease",setTimeout(()=>l.remove(),300)},n)}function Ht(i,e,n=""){const s=document.getElementById("modal-overlay");document.getElementById("modal-title").textContent=i,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=n,s.style.display="flex"}function ge(){document.getElementById("modal-overlay").style.display="none"}function xi(i,e){return new Promise(n=>{const s=`<p>${Z(e)}</p>`;Ht(i,s,`
    ...
    `),document.getElementById("confirm-ok").onclick=()=>{ge(),n(!0)},document.getElementById("confirm-cancel").onclick=()=>{ge(),n(!1)}})}function mo(i,e){if(!i)return 0;let n=1500;return i.type==="正社員"?i.name.includes("前川")?n=2500:n=1500:i.type==="パート"&&(n=parseInt(i.wage)||1500),Math.round(n*(e/60))}function Sn(i,e){const s={身体介護:{20:1670,30:2500,60:3960,90:5790,120:7630},生活援助:{20:1830,45:2250,60:2870},通院等乗降介助:{per_trip:990},医療的ケア:{30:3e3,60:5e3}}[i];if(!s)return 3e3;if(s.per_trip)return s.per_trip;const o=Object.keys(s).map(Number).sort((c,u)=>c-u);let l=o[0];for(const c of o)e>=c&&(l=c);return s[l]||3e3}function Jc(i){{console.warn("Firebase未設定のためログイン画面を表示します"),setTimeout(()=>i(null,null),100);return}}async function Xc(){throw new Error("Firebase未設定です。.envにAPIキーを設定してください。")}async function Yc(){}function Qc(){const i=document.getElementById("btn-google-login");i&&i.addEventListener("click",async()=>{i.disabled=!0,i.textContent="ログイン中...";try{await Xc()}catch(e){console.error("ログインエラー:",e),e.code==="auth/popup-closed-by-user"?C("ログインがキャンセルされました","warning"):C("ログインに失敗しました","error"),i.disabled=!1,i.innerHTML=`
        ...
        Googleアカウントでログイン
      `}})}const Oe={};function ut(i){if(!Oe[i]){const e=localStorage.getItem(`careroute_${i}`);Oe[i]=e?JSON.parse(e):[]}return Oe[i]}function Oi(i){localStorage.setItem(`careroute_${i}`,JSON.stringify(Oe[i]||[]))}async function Or(){localStorage.removeItem("careroute_staff"),localStorage.removeItem("careroute_clients"),localStorage.removeItem("careroute_visits"),localStorage.removeItem("careroute_routes"),Oe.staff=[],Oe.clients=[],Oe.visits=[],Oe.routes=[]}async function Un(i,e){{const n=ho();return ut(i).push({id:n,...e,createdAt:new Date().toISOString()}),Oi(i),n}}async function Fn(i){return ut(i)}async function Vn(i,e,n){{const s=ut(i),o=s.findIndex(l=>l.id===e);o!==-1&&(s[o]={...s[o],...n,updatedAt:new Date().toISOString()},Oi(i));return}}async function jn(i,e){{const n=ut(i),s=n.findIndex(o=>o.id===e);s!==-1&&(n.splice(s,1),Oi(i));return}}async function po(i,e,n,s){return ut(i).filter(l=>l[e]===s)}async function le(){return Fn("staff")}async function go(i){return Un("staff",i)}async function Zc(i,e){return Vn("staff",i,e)}async function ed(i){return jn("staff",i)}async function Ie(){return Fn("clients")}async function vo(i){return Un("clients",i)}async function td(i,e){return Vn("clients",i,e)}async function id(i){return jn("clients",i)}async function yo(){return Fn("visits")}async function Ne(i){return po("visits","date","==",i)}async function Di(i){return Un("visits",i)}async function _i(i,e){return Vn("visits",i,e)}async function _o(i){return jn("visits",i)}async function qn(i){return po("routes","date","==",i)}async function nd(i){{const e=ut("routes");for(const n of i){const s=e.findIndex(o=>o.staffId===n.staffId&&o.date===n.date);s>=0?e[s]={...n,updatedAt:new Date().toISOString()}:e.push({id:ho(),...n,createdAt:new Date().toISOString()})}Oi("routes");return}}async function sd(){const i=document.getElementById("page-container"),[e,n]=await Promise.all([le().catch(()=>[]),Ie().catch(()=>[])]),s=Ye(),o=await Ne(s).catch(()=>[]),l=e.filter(I=>I.isActive);n.filter(I=>I.isActive);const c=o.filter(I=>I.type!=="sales");c.filter(I=>I.status==="scheduled"||!I.status);const u=c.filter(I=>I.status==="completed"),p=c.filter(I=>I.status==="cancelled"),v=o.filter(I=>I.type==="sales"),E={};p.forEach(I=>{const T=I.cancelReason||"理由なし";E[T]=(E[T]||0)+1}),i.innerHTML=`
    ...
    <div class="grid grid-2">
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        <div>
          ${l.length===0?'<p style="color:var(--text-muted);text-align:center;padding:20px">職員が登録されていません</p>':l.map(I=>{const T=c.filter(L=>L.staffId===I.id),k=T.filter(L=>L.status==="completed").length,D=T.filter(L=>L.status==="cancelled").length,x=v.filter(L=>L.staffId===I.id).length;return`
  ...
  `}let se=null,Bt=[],En=[],Wt=null,kn=null,An=[];function dt(){return new Promise((i,e)=>{if(window.google&&window.google.maps){i();return}const n="AIzaSyCXFNBQjeiYpRYFdbs6VhISqlFZhrybM74",s=document.createElement("script");s.src=`https://maps.googleapis.com/maps/api/js?key=${n}&libraries=geometry,places&language=ja`,s.async=!0,s.defer=!0,s.onload=i,s.onerror=()=>e(new Error("Google Maps APIの読み込みに失敗しました")),document.head.appendChild(s)})}function rd(i,e={lat:35.6938,lng:139.7034},n=14){const s=document.getElementById(i);return s?!window.google||!window.google.maps?(s.innerHTML=`
    ...
    `,null):(se=new google.maps.Map(s,{center:e,zoom:n,mapTypeControl:!0,streetViewControl:!1,fullscreenControl:!0,styles:ud()}),Wt=new google.maps.InfoWindow,kn=new google.maps.DirectionsService,se):null}function Io(i,e={}){if(!se)return null;const n=new google.maps.Marker({map:se,position:i,title:e.title||"",icon:e.icon||void 0,label:e.label||void 0});return e.infoContent&&n.addListener("click",()=>{Wt.setContent(e.infoContent),Wt.open(se,n)}),Bt.push(n),n}function Dr(i,e,n,s){if(!se)return null;const o={path:"M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z",fillColor:e,fillOpacity:1,strokeColor:"#fff",strokeWeight:2,scale:1.8,anchor:new google.maps.Point(12,22),labelOrigin:new google.maps.Point(12,9)};return Io(i,{icon:o,label:void 0,infoContent:s})}function od(i,e){return se?Io(i,{title:e,icon:{path:"M12 2L2 7v10l10 5 10-5V7L12 2z",fillColor:"#F59E0B",fillOpacity:1,strokeColor:"#fff",strokeWeight:2,scale:2,anchor:new google.maps.Point(12,12)},infoContent:`<div style="color:#333;padding:4px"><strong>🏢 ${e}</strong><br>（出発地点）</div>`}):null}function ad(i,e,n){if(!se)return null;const s=i.map(l=>({lat:l.lat,lng:l.lng})),o=new google.maps.Polyline({path:s,geodesic:!0,strokeColor:e,strokeOpacity:.8,strokeWeight:4,map:se});return En.push(o),o}async function ld(i,e){if(!se||!kn||i.length<2)return;const n=i[0],s=i[i.length-1],o=i.slice(1,-1).map(l=>({location:new google.maps.LatLng(l.lat,l.lng),stopover:!0}));try{const l=await new Promise((u,p)=>{kn.route({origin:new google.maps.LatLng(n.lat,n.lng),destination:new google.maps.LatLng(s.lat,s.lng),waypoints:o,travelMode:google.maps.TravelMode.DRIVING,optimizeWaypoints:!1},(v,E)=>{E==="OK"?u(v):p(new Error(`Directions API: ${E}`))})}),c=new google.maps.DirectionsRenderer({map:se,directions:l,suppressMarkers:!0,polylineOptions:{strokeColor:e,strokeWeight:4,strokeOpacity:.8}});return An.push(c),c}catch(l){return console.warn("Directions API呼び出し失敗。直線ポリラインで代替:",l),ad(i,e)}}async function xn(i){if(!window.google||!window.google.maps)return null;const e=new google.maps.DistanceMatrixService,n=i.map(s=>new google.maps.LatLng(s.lat,s.lng));try{return(await new Promise((l,c)=>{e.getDistanceMatrix({origins:n,destinations:n,travelMode:google.maps.TravelMode.DRIVING,unitSystem:google.maps.UnitSystem.METRIC},(u,p)=>{p==="OK"?l(u):c(new Error(`Distance Matrix API: ${p}`))})})).rows.map(l=>l.elements.map(c=>({distance:c.status==="OK"?c.distance.value/1e3:null,duration:c.status==="OK"?Math.ceil(c.duration.value/60):null})))}catch(s){return console.error("Distance Matrix取得失敗:",s),null}}function cd(){Bt.forEach(i=>i.setMap(null)),Bt=[],En.forEach(i=>i.setMap(null)),En=[],An.forEach(i=>i.setMap(null)),An=[],Wt&&Wt.close()}function dd(){if(!se||Bt.length===0)return;const i=new google.maps.LatLngBounds;Bt.forEach(e=>i.extend(e.getPosition())),se.fitBounds(i,50)}async function To(i){if(!i||i.trim()==="")return null;if(!window.google||!window.google.maps)return console.warn("ジオコーディング: Google Maps APIが未読み込みです"),null;const e=new google.maps.Geocoder;try{return await new Promise((s,o)=>{e.geocode({address:i,region:"jp"},(l,c)=>{if(c==="OK"&&l[0]){const u=l[0].geometry.location;s({lat:u.lat(),lng:u.lng()})}else o(new Error(`ジオコーディング失敗: ${c}`))})})}catch(n){return console.warn("住所の座標変換に失敗:",n.message),null}}function ud(){return[{elementType:"geometry",stylers:[{color:"#1d2c4d"}]},{elementType:"labels.text.fill",stylers:[{color:"#8ec3b9"}]},{elementType:"labels.text.stroke",stylers:[{color:"#1a3646"}]},{featureType:"road",elementType:"geometry",stylers:[{color:"#304a7d"}]},{featureType:"road",elementType:"geometry.stroke",stylers:[{color:"#255763"}]},{featureType:"road.highway",elementType:"geometry",stylers:[{color:"#2c6675"}]},{featureType:"water",elementType:"geometry",stylers:[{color:"#17263c"}]},{featureType:"poi",elementType:"labels",stylers:[{visibility:"off"}]}]}const Ii={qualifications:{label:"資格",options:["介護福祉士","実務者研修修了","初任者研修修了","看護師","ヘルパー2級"]},services:{label:"対応可能サービス",options:["身体介護","生活援助","通院等乗降介助","医療的ケア"]},physical:{label:"身体的対応力",options:["重介護対応可","移乗介助可","入浴介助可","二人介助対応可"]},special:{label:"特別スキル",options:["認知症ケア","ターミナルケア","精神障害対応","障害児支援"]}},hd=["要支援1","要支援2","要介護1","要介護2","要介護3","要介護4","要介護5"],bo=["身体介護","生活援助","通院等乗降介助","医療的ケア"],fd=["男性","女性"],md=["指定なし","男性希望","女性希望"],pd=["利用者の体調不良","利用者の入院","家族の都合","不在・応答なし","その他"],gd=["居宅介護支援事業所（ケアマネ）","地域包括支援センター","医療機関（退院調整室）","その他"],vd=["08:00","08:30","09:00","09:30","10:00","10:30","11:00","11:30","12:00","12:30","13:00","13:30","14:00","14:30","15:00","15:30","16:00","16:30","17:00"],Lr=["#4A90D9","#E74C3C","#2ECC71","#F39C12","#9B59B6","#1ABC9C","#E67E22","#3498DB","#E91E63","#00BCD4","#8BC34A","#FF5722"],xt={requiredSkill:1e3,genderMatch:2e3,staffType:500,proximity:30},ui=25,Q={name:"事業所（拠点）",address:"〒501-3304 岐阜県加茂郡富加町高畑２９１",lat:35.497,lng:136.993};let On="all",Ti=Ye();async function yd(){var n,s,o;const i=document.getElementById("page-container");i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
        <span class="material-icons-round">map</span>
        マップビュー
  ...
  `;try{await dt()}catch(l){console.warn("Maps APIの読み込みスキップ:",l)}const e=rd("map-canvas",{lat:Q.lat,lng:Q.lng});await ai(e),(n=document.getElementById("map-date-picker"))==null||n.addEventListener("change",l=>{Ti=l.target.value,ai(e)}),(s=document.getElementById("staff-filter"))==null||s.addEventListener("change",l=>{On=l.target.value,ai(e)}),(o=document.getElementById("btn-refresh-map"))==null||o.addEventListener("click",()=>{ai(e)})}async function ai(i){const[e,n,s]=await Promise.all([le().catch(()=>[]),Ie().catch(()=>[]),Ne(Ti).catch(()=>[])]),o=document.getElementById("staff-filter");if(o&&o.options.length<=1&&e.forEach(c=>{const u=document.createElement("option");u.value=c.id,u.textContent=c.name,o.appendChild(u)}),!i){Id(e,n);return}cd(),od({lat:Q.lat,lng:Q.lng},Q.name);const l=await qn(Ti).catch(()=>[]);if(l.length>0)for(const c of l){if(On!=="all"&&c.staffId!==On)continue;const u=e.find(E=>E.id===c.staffId),p=(u==null?void 0:u.color)||"#999",v=[{lat:Q.lat,lng:Q.lng}];for(const E of c.clientIds||[]){const I=n.find(T=>T.id===E);I&&(v.push({lat:I.lat,lng:I.lng}),Dr({lat:I.lat,lng:I.lng},p,"",`<div style="color:#333;padding:4px">
              <strong>${I.name}</strong><br>
              ${I.careLevel} | ${(I.requiredServices||[]).join(", ")}<br>
              <small>担当: ${(u==null?void 0:u.name)||"未定"}</small>
            </div>`))}v.push({lat:Q.lat,lng:Q.lng}),await ld(v,p)}else{const c=n.filter(u=>u.isActive&&s.some(p=>p.clientId===u.id));for(const u of c){const p=s.filter(v=>v.clientId===u.id).map(v=>`${v.startTime}〜${v.endTime}`).join(", ");Dr({lat:u.lat,lng:u.lng},"#94A3B8","",`<div style="color:#333;padding:4px">
          <strong>${u.name}</strong><br>
          予定: ${p}<br>
          ${u.careLevel} | ${(u.requiredServices||[]).join(", ")}
        </div>`)}}dd(),_d(e,l,s)}function _d(i,e,n=[]){const s=document.getElementById("route-legend");if(s){if(e.length===0){s.innerHTML=`
      <p style="color:var(--text-muted);font-size:.85rem">
  ...
  `}}function Id(i,e){const n=document.getElementById("route-legend");n&&(n.innerHTML=`
    ...
    `)}let Ut=[];async function zn(){const i=document.getElementById("page-container");Ut=await le().catch(()=>[]),i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
  ...
  `,document.getElementById("btn-add-staff").addEventListener("click",()=>wo())}function Td(i){return i.length===0?`
  ...
  `}function wo(i=null){const e=!!i,n=e?"職員情報の編集":"新規職員登録",s=`
    <form id="staff-form">
      <div class="form-row">
        ...
        <div class="form-group">
          ...
          <select class="form-select" id="sf-gender">
            ${fd.map(l=>`<option value="${l}" ${(i==null?void 0:i.gender)===l?"selected":""}>${l}</option>`).join("")}
          </select>
        </div>
      </div>
      <div class="form-group">
  ...
  `),document.getElementById("sf-cancel").onclick=ge,document.getElementById("sf-save").onclick=async()=>{const l=document.getElementById("sf-name").value.trim();if(!l){C("氏名を入力してください","warning");return}const c=document.getElementById("sf-save");c.disabled=!0,c.textContent="保存中...";const u=document.getElementById("sf-address").value.trim();let p=(i==null?void 0:i.lat)||Q.lat,v=(i==null?void 0:i.lng)||Q.lng;if(u)try{await dt();const I=await To(u);I?(p=I.lat,v=I.lng):C("住所から座標を取得できませんでした","warning")}catch(I){console.warn("ジオコーディング失敗:",I)}const E={name:l,gender:document.getElementById("sf-gender").value,address:u,workStart:document.getElementById("sf-work-start").value,workEnd:document.getElementById("sf-work-end").value,lat:p,lng:v,skills:{},color:(i==null?void 0:i.color)||Lr[Ut.length%Lr.length],isActive:!0};for(const[I]of Object.entries(Ii)){const T=document.querySelectorAll(`input[name="skill-${I}"]:checked`);E.skills[I]=Array.from(T).map(k=>k.value)}try{e?(await Zc(i.id,E),C("職員情報を更新しました","success")):(await go(E),C("職員を登録しました","success")),ge(),await zn()}catch(I){C("保存に失敗しました: "+I.message,"error")}finally{c.disabled=!1,c.textContent=e?"更新":"登録"}}}document.addEventListener("click",async i=>{const e=i.target.closest("[data-edit-staff]");if(e){const s=Ut.find(o=>o.id===e.dataset.editStaff);s&&wo(s)}const n=i.target.closest("[data-delete-staff]");if(n){const s=Ut.find(o=>o.id===n.dataset.deleteStaff);if(s&&await xi("削除確認",`${s.name} を削除しますか？`))try{await ed(s.id),C(`${s.name} を削除しました`,"success"),await zn()}catch{C("削除に失敗しました","error")}}});let bi=[],Pr=[];async function Hn(){const i=document.getElementById("page-container");try{const[e,n]=await Promise.all([Ie().catch(()=>[]),yo().catch(()=>[])]);bi=e,Pr=n}catch(e){console.error("データの取得に失敗",e)}i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
  ...
  `,document.getElementById("btn-add-client").addEventListener("click",()=>So())}function bd(i,e){return i.length===0?`<div class="empty-state">
      <span class="material-icons-round">person_off</span>
      <h3>利用者が登録されていません</h3>
  ...
  `}function So(i=null){var l,c;const e=!!i,n=[...Ii.physical.options,...Ii.special.options],s=`
    <form id="client-form">
      <div class="form-row">
        <div class="form-group">
          <label class="form-label">氏名 *</label>
        ...
        <div class="form-group">
          ...
          <select class="form-select" id="cf-care-level">
            ${hd.map(u=>`<option ${(i==null?void 0:i.careLevel)===u?"selected":""}>${u}</option>`).join("")}
          </select>
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="tags-container" style="gap:8px">
          ${bo.map(u=>{var p;return`<label style="display:flex;align-items:center;gap:4px;cursor:pointer;font-size:.85rem">
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <select class="form-select" id="cf-gender-pref">
            ${md.map(u=>`<option ${(i==null?void 0:i.genderPreference)===u?"selected":""}>${u}</option>`).join("")}
          </select>
        </div>
        <div class="form-group">
  ...
  `),document.getElementById("cf-cancel").onclick=ge,document.getElementById("cf-save").onclick=async()=>{const u=document.getElementById("cf-name").value.trim();if(!u){C("氏名を入力してください","warning");return}const p=document.getElementById("cf-save");p.disabled=!0,p.textContent="保存中...";const v=document.getElementById("cf-address").value.trim();let E=(i==null?void 0:i.lat)||Q.lat,I=(i==null?void 0:i.lng)||Q.lng;if(v)try{await dt();const k=await To(v);k?(E=k.lat,I=k.lng,C(`座標を取得しました: ${k.lat.toFixed(4)}, ${k.lng.toFixed(4)}`,"success")):C("住所から座標を取得できませんでした。事業所付近の座標を使用します。","warning")}catch(k){console.warn("ジオコーディング失敗:",k),C("座標取得に失敗。事業所付近の座標を使用します。","warning")}const T={name:u,careLevel:document.getElementById("cf-care-level").value,address:v,requiredServices:Array.from(document.querySelectorAll('input[name="cf-service"]:checked')).map(k=>k.value),requiredSkills:Array.from(document.querySelectorAll('input[name="cf-skill"]:checked')).map(k=>k.value),genderPreference:document.getElementById("cf-gender-pref").value,visitDuration:parseInt(document.getElementById("cf-duration").value)||60,timeWindow:{start:document.getElementById("cf-time-start").value,end:document.getElementById("cf-time-end").value},notes:document.getElementById("cf-notes").value.trim(),lat:E,lng:I,isActive:!0};try{e?(await td(i.id,T),C("利用者情報を更新しました","success")):(await vo(T),C("利用者を登録しました","success")),ge(),await Hn()}catch(k){C("保存に失敗しました: "+k.message,"error")}finally{p.disabled=!1,p.textContent=e?"更新":"登録"}}}document.addEventListener("click",async i=>{const e=i.target.closest("[data-edit-client]");if(e){const s=bi.find(o=>o.id===e.dataset.editClient);s&&So(s)}const n=i.target.closest("[data-delete-client]");if(n){const s=bi.find(o=>o.id===n.dataset.deleteClient);if(s&&await xi("削除確認",`${s.name} を削除しますか？`))try{await id(s.id),C(`${s.name} を削除しました`,"success"),await Hn()}catch{C("削除に失敗しました","error")}}});let ze=Ye();async function wd(){const i=document.getElementById("page-container");i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
  ...
  `,document.getElementById("schedule-date").addEventListener("change",e=>{ze=e.target.value,Ft()}),document.getElementById("btn-add-visit").addEventListener("click",Sd),document.getElementById("btn-generate-week").addEventListener("click",Ed),await Ft()}async function Ft(){const i=document.getElementById("schedule-content"),[e,n,s,o]=await Promise.all([le().catch(()=>[]),Ie().catch(()=>[]),Ne(ze).catch(()=>[]),qn(ze).catch(()=>[])]);if(s.length===0){i.innerHTML=`
      <div class="empty-state">
        <span class="material-icons-round">event_busy</span>
        <h3>${ct(ze)} の訪問予定はありません</h3>
        <p>「訪問追加」ボタンから予定を登録するか、マッチング＆最適化を実行してください</p>
      </div>
    `;return}const l={},c=[];let u=0,p=0,v=0;for(const T of s)T.staffId?(l[T.staffId]||(l[T.staffId]=[]),l[T.staffId].push(T)):c.push(T);c.sort((T,k)=>{const D=T.startTime||T.scheduledTime||"00:00",x=k.startTime||k.scheduledTime||"00:00";return D.localeCompare(x)});let E="";c.length>0&&(E=`
    ...
    `);for(const[T,k]of Object.entries(l)){const D=e.find(A=>A.id===T);if(!D)continue;const x=o.find(A=>A.staffId===T),L=parseInt(D.wage)||2e3;if(x&&(v+=(x.totalDistance||0)*ui),k.sort((A,P)=>{const R=A.optimizedArrivalTime||A.startTime||A.scheduledTime||"00:00",N=P.optimizedArrivalTime||P.startTime||P.scheduledTime||"00:00";return R.localeCompare(N)}),x&&x.schedule&&x.schedule.length>=2){const A=x.schedule[0].arrivalMinutes,R=(x.schedule[x.schedule.length-1].arrivalMinutes-A)/60;p+=R*L}else if(k.length>0){const A=k[0],P=k[k.length-1],R=A.startTime||A.scheduledTime||"09:00",N=P.startTime||P.scheduledTime||"17:00",B=Y(R),y=(Y(N)+(P.duration||60)-B)/60;p+=y*L}k.forEach((A,P)=>{u+=mo(D,A.duration||60);let R=10,N=null;if(x&&x.schedule){const B=x.schedule.find(j=>j.clientId===A.clientId);B&&(R=B.travelTimeFromPrev||10,N=B.arrivalTime)}A.calculatedTravelTime=R,A.optimizedArrivalTime=N}),k.sort((A,P)=>{const R=A.optimizedArrivalTime||A.startTime||A.scheduledTime||"00:00",N=P.optimizedArrivalTime||P.startTime||P.scheduledTime||"00:00";return R.localeCompare(N)})}let I="";if(window.isAdmin){const T=u-p-v,k=u>0?Math.round(T/u*100):0;I=`
      ...
      ${Object.entries(l).map(([T,k])=>{const D=e.find(x=>x.id===T);return`
          <div class="card" style="border-left:4px solid ${(D==null?void 0:D.color)||"#999"}">
            ...
            <div class="schedule-timeline">
              ${k.map((x,L)=>{const A=n.find(B=>B.id===x.clientId),P=x.optimizedArrivalTime||x.startTime||x.scheduledTime||"--:--";let R="",N="";if(L>0){const B=k[L-1],j=B.optimizedArrivalTime||B.startTime||B.scheduledTime,y=x.calculatedTravelTime||10;if(j&&P!=="--:--"){const[h,m]=j.split(":").map(Number),[_,g]=P.split(":").map(Number),b=h*60+m+(B.duration||60),K=_*60+g-b;K<y&&(N=`
  ...
  `}async function Sd(){const[i,e]=await Promise.all([le().catch(()=>[]),Ie().catch(()=>[])]),n=`
    <form id="visit-form">
      <div class="form-group">
  ...
  `);const s=()=>{const o=document.getElementById("vf-service").value,l=parseInt(document.getElementById("vf-duration").value)||60,c=Sn(o,l);document.getElementById("vf-income").value=c,document.getElementById("vf-income-hint").textContent=`↑ ${o} ${l}分 → ¥${c.toLocaleString()}（自動計算）`};document.getElementById("vf-service").addEventListener("change",s),document.getElementById("vf-duration").addEventListener("change",s),s(),document.getElementById("vf-cancel").onclick=ge,document.getElementById("vf-save").onclick=async()=>{const o=document.getElementById("vf-client").value,l=document.getElementById("vf-staff").value;if(!o||!l){C("利用者と職員を選択してください","warning");return}try{const c=parseInt(document.getElementById("vf-duration").value)||60,u=document.getElementById("vf-service").value,p=document.getElementById("vf-time").value,v=Y(p)+c,E=Math.floor(v/60),I=v%60,T=`${String(E).padStart(2,"0")}:${String(I).padStart(2,"0")}`;await Di({date:ze,clientId:o,staffId:l,startTime:p,endTime:T,scheduledTime:p,duration:c,service:u,income:parseInt(document.getElementById("vf-income").value)||Sn(u,c),status:"scheduled"}),C("訪問予定を追加しました","success"),ge(),await Ft()}catch{C("追加に失敗しました","error")}}}async function Ed(){var e;if(await xi("週間スケジュール自動生成",`利用者の曜日設定に基づいて、今週（月〜土）の訪問予定を自動生成します。
既存の予定がある日はスキップされます。

実行しますか？`))try{const[n,s]=await Promise.all([Ie(),yo()]),o={月:1,火:2,水:3,木:4,金:5,土:6},l=new Date,c=l.getDay(),u=s.filter(I=>I.dayOfWeek&&o[I.dayOfWeek]!==void 0);let p=0,v=0;const E=new Map;for(const I of u){const T=o[I.dayOfWeek];if(T===void 0)continue;const k=T-c,D=new Date(l);D.setDate(l.getDate()+k);const x=uo(D),L=`${x}_${I.clientId}`;if(E.has(L)){E.get(L).timeOptions.push({startTime:I.startTime||"09:00",duration:I.duration||60});continue}if((await Ne(x)).some(P=>P.clientId===I.clientId)){E.set(L,null),v++;continue}E.set(L,{...I,date:x,timeOptions:[{startTime:I.startTime||"09:00",duration:I.duration||60}]})}for(const[I,T]of E){if(!T)continue;const k=n.find(j=>j.id===T.clientId),D=T.service||((e=k==null?void 0:k.requiredServices)==null?void 0:e[0])||"身体介護",x=T.duration||(k==null?void 0:k.visitDuration)||60,L=T.startTime||"09:00",A=Sn(D,x),P=Y(L)+x,R=Math.floor(P/60),N=P%60,B=`${String(R).padStart(2,"0")}:${String(N).padStart(2,"0")}`;await Di({date:T.date,clientId:T.clientId,clientName:T.clientName||(k==null?void 0:k.name)||"利用者",staffId:T.staffId||null,staffName:T.staffName||"未設定",startTime:L,endTime:B,scheduledTime:L,duration:x,service:D,income:A,dayOfWeek:T.dayOfWeek,status:"scheduled",timeOptions:T.timeOptions}),p++}p>0?C(`今週の訪問予定 ${p}件 を自動生成しました！${v>0?`（${v}件は既存のためスキップ）`:""}`,"success"):C(`生成する予定がありませんでした。${v>0?`（${v}件は既に登録済み）`:"利用者の曜日設定を確認してください。"}`,"warning"),await Ft()}catch(n){console.error("週間スケジュール生成エラー:",n),C("スケジュール生成に失敗しました: "+n.message,"error")}}document.addEventListener("click",async i=>{const e=i.target.closest("[data-delete-visit]");if(e&&await xi("削除確認","この訪問予定を削除しますか？"))try{await _o(e.dataset.deleteVisit),C("訪問予定を削除しました","success"),await Ft()}catch{C("削除に失敗しました","error")}});function kd(i,e){const n=Y(i),s=[{startTime:i,duration:e}],o=n+15;o+e<=18*60&&s.push({startTime:$t(o),duration:e});const l=n-15;return l>=7*60&&s.push({startTime:$t(l),duration:e}),s}function Ad(i,e){var c,u,p,v,E;let n=0;const s=[];let o=!0;for(const I of e.requiredServices||[])(u=(c=i.skills)==null?void 0:c.services)!=null&&u.includes(I)?(n+=xt.requiredSkill,s.push(`✅ ${I}対応可`)):(o=!1,s.push(`❌ ${I}に対応不可`));const l=[...((p=i.skills)==null?void 0:p.qualifications)||[],...((v=i.skills)==null?void 0:v.physical)||[],...((E=i.skills)==null?void 0:E.special)||[]];for(const I of e.requiredSkills||[])l.includes(I)?(n+=xt.requiredSkill,s.push(`✅ ${I}あり`)):(o=!1,s.push(`❌ ${I}なし`));if(e.genderPreference&&e.genderPreference!=="指定なし"){const I=e.genderPreference.replace("希望","");i.gender===I?(n+=xt.genderMatch,s.push(`✅ 性別希望合致（${I}）`)):(o=!1,s.push(`❌ 性別希望不一致（希望: ${I}）`))}if(i.type==="正社員"&&(n+=xt.staffType,s.push("✅ 正社員")),i.lat&&e.lat){const I=fo(i.lat,i.lng,e.lat,e.lng),T=Math.max(0,xt.proximity*(1-I/10));n+=T}return{score:Math.round(n),reasons:s,eligible:o}}function mn(i){var e;return(e=i.name)!=null&&e.includes("前川")?3:i.maxVisits||(i.type==="パート"?5:10)}function xd(i,e,n=[],s=null,o=[]){const l=[],c=new Set,u={},p={};o.forEach((T,k)=>{p[T.id]=k});const v=(T,k)=>{if(!s)return 15;const D=p[T],x=p[k];return D!==void 0&&x!==void 0&&s[D][x]&&s[D][x].duration||15},E=[...e].sort((T,k)=>{const D=T.startTime||T.scheduledTime||"00:00",x=k.startTime||k.scheduledTime||"00:00";return D.localeCompare(x)});for(const T of E){if(l.some(A=>A.clientId===T.clientId)){c.add(T.id);continue}const k=i.filter(A=>A.isActive).map(A=>{const P=n.find(m=>m.id===T.clientId),{score:R,eligible:N}=Ad(A,P||T),B=T.startTime||T.scheduledTime||"09:00",j=T.duration||60,y=T.timeOptions&&T.timeOptions.length>0?T.timeOptions:kd(B,j);let h=null;for(const m of y){let _=!0;const g=Y(m.startTime),b=g+(m.duration||60),f=Y(A.workStart||"07:00"),K=Y(A.workEnd||"18:00");if(g<f||b>K){_=!1;continue}const ve=l.filter(Re=>Re.staffId===A.id);for(const Re of ve){const Qe=Y(Re.startTime),Te=Qe+(Re.duration||60);if(g<Te&&b>Qe){_=!1;break}const Me=v(Re.clientId,T.clientId);if(g>=Te){if(g-Te<Me){_=!1;break}}else if(b<=Qe&&Qe-b<Me){_=!1;break}}if(_){h=m;break}}return{staff:A,score:R,eligible:N&&!!h,chosenTime:h}}).filter(A=>A.eligible);if(k.length===0)continue;k.sort((A,P)=>{var b,f;const R=u[A.staff.id]||0,N=u[P.staff.id]||0,B=mn(A.staff),j=mn(P.staff),y=R>=B,h=N>=j;if(y!==h)return y?1:-1;const m=7,_=A.staff.type==="正社員"&&!((b=A.staff.name)!=null&&b.includes("前川"))&&R<m,g=P.staff.type==="正社員"&&!((f=P.staff.name)!=null&&f.includes("前川"))&&N<m;return _!==g?_?-1:1:R!==N?R-N:A.staff.type!==P.staff.type?A.staff.type==="正社員"?-1:1:P.score-A.score});const D=k[0],x=u[D.staff.id]||0,L=mn(D.staff);if(x<L){const A=D.chosenTime.startTime,P=D.chosenTime.duration||60,R=Y(A)+P;l.push({staffId:D.staff.id,staffName:D.staff.name,visitId:T.id,clientId:T.clientId,clientName:T.clientName||"利用者",score:D.score,startTime:A,endTime:$t(R),scheduledTime:A,duration:P}),c.add(T.id),u[D.staff.id]=x+1}}const I=e.filter(T=>!c.has(T.id)).map(T=>({visitId:T.id,clientName:T.clientName||"利用者",reason:"適格な職員なし、または上限超過",visit:T}));return{assignments:l,unassigned:I}}async function Eo(i,e,n,s=Q,o=null){const l={};for(const u of i)l[u.staffId]||(l[u.staffId]=[]),l[u.staffId].push(u.clientId);const c={};for(const[u,p]of Object.entries(l)){const v=e.find(A=>A.id===u),E=p.map(A=>n.find(P=>P.id===A)).filter(Boolean);if(E.length===0)continue;const I=[{id:"office",name:"事業所",lat:s.lat,lng:s.lng,isOffice:!0},...E.map(A=>{const P=i.find(R=>R.clientId===A.id&&R.staffId===u);return{id:A.id,name:A.name,lat:A.lat,lng:A.lng,duration:A.visitDuration||60,scheduledStart:P?P.startTime:null,timeWindow:A.timeWindow}})];let T=null;typeof o=="function"&&(T=await o(I));const k=Od(I,T);let D=Dd(I,k);D=Ld(D,k);const x=Pd(D,k),L=Cd(D,k,v,T,I);c[u]={staffId:u,staffName:(v==null?void 0:v.name)||"不明",staffColor:(v==null?void 0:v.color)||"#999",route:D,totalDistance:Math.round(x*10)/10,totalDuration:Nd(L),schedule:L}}return c}function Od(i,e=null){const n=i.length,s=Array.from({length:n},()=>Array(n).fill(0));for(let o=0;o<n;o++)for(let l=0;l<n;l++)o!==l&&(e&&e[o]&&e[o][l]&&e[o][l].distance!==null?s[o][l]=e[o][l].distance:s[o][l]=fo(i[o].lat,i[o].lng,i[l].lat,i[l].lng));return s}function Dd(i,e){const n=i.length,s=new Set([0]),o=[0],l=[],c=[];for(let v=1;v<n;v++){const E=i[v];E.timeWindow&&E.timeWindow.start?l.push({index:v,start:Y(E.timeWindow.start),end:Y(E.timeWindow.end)}):c.push(v)}l.sort((v,E)=>v.start-E.start);const u=[...l.map(v=>v.index),...c];let p=0;for(;s.size<n;){let v=-1,E=1/0;for(const I of u)s.has(I)||e[p][I]<E&&(E=e[p][I],v=I);if(v===-1)break;o.push(v),s.add(v),p=v}return o.push(0),o}function Ld(i,e){const n=i.length;let s=!0,o=[...i];for(;s;){s=!1;for(let l=1;l<n-2;l++)for(let c=l+1;c<n-1;c++){const u=e[o[l-1]][o[l]]+e[o[c]][o[c+1]];if(e[o[l-1]][o[c]]+e[o[l]][o[c+1]]<u-.001){const v=[...o];let E=l,I=c;for(;E<I;)[v[E],v[I]]=[v[I],v[E]],E++,I--;o=v,s=!0}}}return o}function Pd(i,e){let n=0;for(let s=0;s<i.length-1;s++)n+=e[i[s]][i[s+1]];return n}function Cd(i,e,n,s=null,o=[]){const l=[];let u=Y((n==null?void 0:n.workStart)||"08:30");for(let p=0;p<i.length;p++){let v=0;if(p>0){const I=i[p-1],T=i[p];s&&s[I]&&s[I][T]&&s[I][T].duration!==null?v=s[I][T].duration:v=e[I][T]/20*60,u+=Math.ceil(v)}const E=o[i[p]];if(E){let I=0;E.timeWindow&&E.timeWindow.start?I=Y(E.timeWindow.start):E.scheduledStart&&(I=Y(E.scheduledStart)),u<I&&(u=I)}if(l.push({pointIndex:i[p],clientId:E?E.id:null,arrivalTime:$t(u),arrivalMinutes:u,travelTimeFromPrev:Math.ceil(v)}),p>0&&p<i.length-1){const I=E&&E.duration||60;u+=I}}return l}function Nd(i){if(i.length<2)return 0;const e=i[0].arrivalMinutes;return i[i.length-1].arrivalMinutes-e}let Ke=null,wi=null,Je=Ye(),Si=null,Gn=null,Dn=null,nt=null;async function ko(){const i=document.getElementById("page-container"),e=await le(),n=["日","月","火","水","木","金","土"][new Date(Je).getDay()];i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
        <span class="material-icons-round">auto_fix_high</span>
        マッチング＆ルート最適化
      ...
      ${Object.entries(l).map(([c,u])=>{var v,E,I;const p=o[c];return`
          <div class="card" style="border-left:4px solid ${((v=u.staff)==null?void 0:v.color)||"#999"}">
            ...
            <div style="display:flex;flex-direction:column;gap:6px">
              ...
              ${((p==null?void 0:p.schedule)||[]).filter(T=>T.pointIndex!==0||p.schedule.indexOf(T)===p.schedule.length-1).map((T,k,D)=>{var L,A;if(T.pointIndex===0&&k===D.length-1)return`<div style="font-size:.8rem;color:var(--text-muted);display:flex;align-items:center;gap:4px">
                      <span class="material-icons-round" style="font-size:16px;color:var(--secondary)">business</span>
                      ${T.arrivalTime} 事業所帰着
                    </div>`;const x=u.clients.find(P=>P.clientId===T.clientId);return`<div class="visit-card">
                    <div style="display:flex;justify-content:space-between;align-items:center">
                      <strong style="font-size:.85rem">${T.arrivalTime} ${((L=x==null?void 0:x.client)==null?void 0:L.name)||"利用者"}</strong>
  ...
  `}async function Md(i,e){try{const n=Object.entries(e).map(([l,c])=>{const u=Ke.filter(p=>p.staffId===l).map(p=>p.clientId);return{staffId:l,date:Je,clientIds:u,totalDistance:c.totalDistance,totalDuration:c.totalDuration,schedule:c.schedule}}),s=await Ne(Je),o=new Set;for(const l of s){const c=Ke.find(u=>u.visitId===l.id);c&&(await _i(l.id,{staffId:c.staffId,staffName:c.staffName,startTime:c.startTime,endTime:c.endTime,scheduledTime:c.scheduledTime}),o.add(l.clientId))}for(const l of s)Ke.find(u=>u.visitId===l.id)||(o.has(l.clientId)?await _o(l.id):await _i(l.id,{staffId:null,staffName:"未設定"}));await nd(n),C("スケジュールとルートを保存しました！","success")}catch(n){C("保存に失敗しました: "+n.message,"error")}}function xo(){var i;(i=document.getElementById("btn-save-routes"))==null||i.addEventListener("click",async()=>{await Md(Gn,wi)}),document.querySelectorAll(".btn-manual-assign").forEach(e=>{e.addEventListener("click",n=>{const s=n.target.closest(".btn-manual-assign").dataset.visitId;$d(s)})})}function $d(i){const e=nt.find(c=>c.visitId===i);if(!e)return;const n=e.visit,s=Si.map(c=>`<option value="${c.id}">${Z(c.name)}</option>`).join(""),o=`
  ...
  `),document.getElementById("manual-cancel").onclick=()=>{ge()},document.getElementById("manual-ok").onclick=async()=>{const c=document.getElementById("manual-staff-select").value,u=document.getElementById("manual-time-input").value;ge(),await Bd(i,c,u)}}async function Bd(i,e,n){const s=nt.findIndex(E=>E.visitId===i);if(s===-1)return;const l=nt[s].visit,c=Si.find(E=>E.id===e),u=l.duration||60,p=Y(n)+u;Ke.push({staffId:c.id,staffName:c.name,visitId:l.id,clientId:l.clientId,clientName:l.clientName||"利用者",score:9999,startTime:n,endTime:$t(p),scheduledTime:n,duration:u}),nt.splice(s,1);const v=document.getElementById("optimization-results");v.innerHTML='<div style="text-align:center;padding:32px;"><span class="material-icons-round" style="animation:spin 1s linear infinite">sync</span> ルート再計算中...</div>';try{wi=await Eo(Ke,Si,Dn,Q,async I=>{try{return await dt(),await xn(I)}catch{return null}}),v.innerHTML=Ao(Gn,Dn,Ke,nt,wi),xo(),C(`${c.name}さんに手動割り当てし、ルートを再計算しました`,"success")}catch(E){C("ルート再計算に失敗しました","error"),console.error(E)}}let Nt=Ye();async function Wd(){var e,n;const i=document.getElementById("page-container");if(!window.isAdmin){i.innerHTML=`
      <div class="empty-state">
  ...
  `,await pn(),(e=document.getElementById("revenue-date-picker"))==null||e.addEventListener("change",s=>{Nt=s.target.value,pn()}),(n=document.getElementById("btn-refresh-revenue"))==null||n.addEventListener("click",()=>{pn()})}async function pn(){const i=document.getElementById("revenue-content");if(!i)return;const[e,n,s,o]=await Promise.all([le(),Ie(),Ne(Nt),qn(Nt)]);if(s.length===0){i.innerHTML=`
      <div class="empty-state">
        <span class="material-icons-round" style="font-size:48px;opacity:.2">event_busy</span>
        <p>${ct(Nt)} の訪問予定データがありません。</p>
      </div>
    `;return}let l=0,c=0,u=0,p=s.length;s.filter(T=>T.status==="completed").length;const v=e.map(T=>{const k=o.filter(N=>N.staffId===T.id),D=s.filter(N=>N.staffId===T.id);let x=0,L=0,A=0,P=0,R=0;if(D.forEach(N=>{x+=mo(T,N.duration||60)}),k.forEach(N=>{if(P+=N.totalDistance||0,A+=(N.totalDistance||0)*ui,N.schedule&&N.schedule.length>=2){const B=N.schedule[0].arrivalMinutes;R=N.schedule[N.schedule.length-1].arrivalMinutes-B,L=R/60*(parseInt(T.wage)||2e3)}}),k.length===0&&D.length>0){const N=[...D].sort((m,_)=>(m.startTime||"09:00").localeCompare(_.startTime||"09:00")),B=N[0],j=N[N.length-1],y=Y(B.startTime||"09:00");R=Y(j.startTime||"17:00")+(j.duration||60)-y,L=R/60*(parseInt(T.wage)||2e3)}return{...T,count:D.length,revenue:x,laborCost:L,vehicleCost:A,profit:x-L-A,workMinutes:R}}).filter(T=>T.count>0||T.revenue>0).sort((T,k)=>k.profit-T.profit);v.forEach(T=>{l+=T.revenue,c+=T.laborCost,u+=T.vehicleCost});const E=l-c-u,I=l>0?E/l*100:0;i.innerHTML=`
    <!-- メインKPI -->
    <div class="grid grid-4" style="margin-bottom:24px">
      ...
      <div class="card">
        ...
        <div style="overflow-x:auto">
          <table class="data-table">
            ...
            <tbody>
              ${v.map(T=>{const k=T.revenue>0?T.profit/T.revenue*100:0;return`
                  <tr>
                    <td>
  ...
  `}async function Ud(){const i=document.getElementById("page-container"),e=Ye();i.innerHTML=`
  ...
  `,document.getElementById("btn-add-sales").addEventListener("click",Vd),await Li(e)}async function Li(i){try{const e=await Ne(i),n="staff_1",s=e.filter(v=>v.staffId===n);s.sort((v,E)=>(v.scheduledTime||v.startTime||"").localeCompare(E.scheduledTime||E.startTime||""));const o=document.getElementById("my-schedule-list"),l=s.length,c=s.filter(v=>v.status==="completed").length,u=s.filter(v=>v.status==="cancelled").length;if(document.getElementById("my-schedule-summary").innerHTML=`
    ...
    `,s.forEach((v,E)=>{const I=v.type==="sales",T=v.duration||60,k=v.status||"scheduled";let D="var(--primary)",x="",L="",A="";k==="completed"?(D="var(--success)",x='<span class="material-icons-round" style="color:var(--success)">check_circle</span>',A='<span class="tag" style="background:var(--success); color:white;">完了</span>'):k==="cancelled"?(D="var(--danger)",x='<span class="material-icons-round" style="color:var(--danger)">cancel</span>',A=`<span class="tag" style="background:var(--danger); color:white;">キャンセル: ${Z(v.cancelReason||"理由なし")}</span>`):L=`
        ...
        <div style="display:flex; align-items:flex-start; gap: 12px;">
          <div style="display:flex; flex-direction:column; align-items:center; width: 40px;">
            ...
            <div style="width: 16px; height: 16px; border-radius: 50%; background: ${P}; z-index: 1; border: 3px solid #fff; box-shadow: 0 0 0 1px ${P};"></div>
            <div style="width: 2px; height: 100px; background: var(--border); margin-top: -2px; margin-bottom: -2px;"></div>
          </div>
          <div class="card" style="flex: 1; padding: 16px; border-radius: 12px; border-left: 4px solid ${P}; position: relative; opacity: ${k!=="scheduled"?"0.7":"1"};">
    ...
    `,o.innerHTML=p,document.querySelectorAll(".btn-complete-visit").forEach(v=>{v.addEventListener("click",async E=>{const I=E.currentTarget.dataset.id;if(confirm("この訪問を「完了」にしてよろしいですか？"))try{await _i(I,{status:"completed"}),C("訪問を完了しました","success"),Li(i)}catch{C("更新に失敗しました","error")}})}),document.querySelectorAll(".btn-cancel-visit").forEach(v=>{v.addEventListener("click",E=>{const I=E.currentTarget.dataset.id;Fd(I,i)})})}catch(e){console.error("マイスケジュール取得エラー:",e),document.getElementById("my-schedule-list").innerHTML=`
      <div class="empty-state" style="color: var(--danger);">
        <span class="material-icons-round">error</span>
        <p>スケジュールの取得に失敗しました</p>
      </div>
    `}}function Fd(i,e){const n=document.getElementById("modal-overlay"),s=document.getElementById("modal-title"),o=document.getElementById("modal-body"),l=document.getElementById("modal-footer");s.textContent="キャンセルの登録",s.innerHTML='<span class="material-icons-round" style="color:var(--danger)">cancel</span> キャンセルの登録',o.innerHTML=`
    <div class="form-group">
      ...
      <select id="cancel-reason-select" class="form-input">
        <option value="">選択してください...</option>
        ${pd.map(c=>`<option value="${c}">${c}</option>`).join("")}
      </select>
    </div>
  ...
  `,e.style.display="flex",document.getElementById("btn-submit-sales").addEventListener("click",async()=>{const l=document.getElementById("sales-client-name").value.trim();if(!l){C("訪問先名を入力してください","warning");return}const c=document.getElementById("sales-target-select").value,u=document.getElementById("sales-start-time").value,p=parseInt(document.getElementById("sales-duration").value,10);try{await Di({staffId:"staff_1",staffName:"佐藤 看護師",clientId:"sales_"+Date.now(),clientName:l,date:i,startTime:u,scheduledTime:u,duration:p,type:"sales",salesTarget:c,status:"scheduled"}),C("営業予定を追加しました","success"),e.style.display="none",Li(i)}catch(v){console.error(v),C("追加に失敗しました","error")}})}const jd={dashboard:{render:sd,title:"ダッシュボード"},map:{render:yd,title:"マップビュー"},staff:{render:zn,title:"職員管理"},client:{render:Hn,title:"利用者管理"},schedule:{render:wd,title:"スケジュール"},matching:{render:ko,title:"マッチング＆最適化"},revenue:{render:Wd,title:"収支シミュレーション"},"my-schedule":{render:Ud,title:"マイスケジュール"}};function qd(){var o,l,c,u;document.querySelectorAll(".nav-item").forEach(p=>{p.addEventListener("click",()=>{const v=p.dataset.page;v&&Rt(v)})}),(o=document.getElementById("btn-sidebar-toggle"))==null||o.addEventListener("click",()=>{document.getElementById("sidebar").classList.toggle("collapsed")});const e=document.getElementById("sidebar"),n=document.getElementById("sidebar-overlay"),s=()=>{e.classList.toggle("open"),n.classList.toggle("open")};(l=document.getElementById("btn-mobile-menu"))==null||l.addEventListener("click",s),n==null||n.addEventListener("click",s),(c=document.getElementById("btn-modal-close"))==null||c.addEventListener("click",()=>{document.getElementById("modal-overlay").style.display="none"}),(u=document.getElementById("modal-overlay"))==null||u.addEventListener("click",p=>{p.target===p.currentTarget&&(p.currentTarget.style.display="none")})}async function Rt(i){var s,o;const e=jd[i];if(!e)return;if(window.isAdmin===!1&&i!=="my-schedule"){console.warn("アクセス権限がありません:",i);return}document.querySelectorAll(".nav-item").forEach(l=>{l.classList.toggle("active",l.dataset.page===i)}),(s=document.getElementById("sidebar"))==null||s.classList.remove("open"),(o=document.getElementById("sidebar-overlay"))==null||o.classList.remove("open"),document.title=`${e.title} - CareRoute`;const n=document.getElementById("page-container");n.innerHTML='<div class="loading"><div class="spinner"></div></div>';try{await e.render()}catch(l){console.error(`ページ「${e.title}」の表示エラー:`,l),n.innerHTML=`
      <div class="empty-state">
...
既存データには影響しません。`))){e&&(e.innerHTML=`
    ...
    `);try{const n=await le(),s=await Ie();if(n.length>0||s.length>0){if(!i&&!confirm("既存のデータを全て削除し、新しいエクセルデータを投入しますか？")){e&&(e.innerHTML=`
            <span class="material-icons-round" style="color:var(--secondary)">science</span>
            <span class="nav-label">デモデータ投入</span>
          `);return}typeof Or=="function"?await Or():(localStorage.removeItem("careroute_staff"),localStorage.removeItem("careroute_clients"),localStorage.removeItem("careroute_visits"))}for(const u of Cr)await go(u);C(`職員 ${Cr.length}名 を登録しました`,"success");for(const u of Nr)await vo(u);C(`利用者 ${Nr.length}名 を登録しました`,"success");const o=new Date,l=o.getDay(),c={日:0,月:1,火:2,水:3,木:4,金:5,土:6};for(const u of Rr){let p=new Date(o);if(u.dayOfWeek&&c[u.dayOfWeek]!==void 0){const k=c[u.dayOfWeek]-l;p.setDate(o.getDate()+k)}const v=p.getFullYear(),E=String(p.getMonth()+1).padStart(2,"0"),I=String(p.getDate()).padStart(2,"0"),T=`${v}-${E}-${I}`;await Di({...u,date:T,status:"scheduled"})}C(`予定 ${Rr.length}件 を登録しました`,"success"),await Rt("dashboard"),e.innerHTML=`
