 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _a=()=>ya().__FIREBASE_DEFAULTS__,Ia=()=>{if(typeof process>"u"||typeof er>"u")return;const i=er.__FIREBASE_DEFAULTS__;if(i)return JSON.parse(i)},Ta=()=>{if(typeof document>"u")return;let i;try{i=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=i&&Jr(i[1]);return e&&JSON.parse(e)},ba=()=>{try{return ma()||_a()||Ia()||Ta()}catch(i){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${i}`);return}},wa=i=>{var e;return(e=ba())==null?void 0:e[`_${i}`]};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ye(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Sa(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(ye())}function Ea(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function ka(){const i=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof i=="object"&&i.id!==void 0}function Aa(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function xa(){try{return typeof indexedDB=="object"}catch{return!1}}function Oa(){return new Promise((i,e)=>{try{let n=!0;const s="validate-browser-context-for-indexeddb-analytics-module",o=self.indexedDB.open(s);o.onsuccess=()=>{o.result.close(),n||self.indexedDB.deleteDatabase(s),i(!0)},o.onupgradeneeded=()=>{n=!1},o.onerror=()=>{var l;e(((l=o.error)==null?void 0:l.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Da="FirebaseError";class Me extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=Da,Object.setPrototypeOf(this,Me.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Qt.prototype.create)}}class Qt{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},o=`${this.service}/${e}`,l=this.errors[e],c=l?La(l,s):"Error",u=`${this.serviceName}: ${c} (${o}).`;return new Me(o,u,s)}}function La(i,e){return i.replace(Pa,(n,s)=>{const o=e[s];return o!=null?String(o):`<${s}?>`})}const Pa=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yr(i){try{return(i.startsWith("http://")||i.startsWith("https://")?new URL(i).hostname:i).endsWith(".cloudworkstations.dev")}catch{return!1}}class ft{constructor(e,n,s){this.name=e,this.instanceFactory=n,this.type=s,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var q;(function(i){i[i.DEBUG=0]="DEBUG",i[i.VERBOSE=1]="VERBOSE",i[i.INFO=2]="INFO",i[i.WARN=3]="WARN",i[i.ERROR=4]="ERROR",i[i.SILENT=5]="SILENT"})(q||(q={}));const Ra={debug:q.DEBUG,verbose:q.VERBOSE,info:q.INFO,warn:q.WARN,error:q.ERROR,silent:q.SILENT},$a=q.INFO,Ba={[q.DEBUG]:"log",[q.VERBOSE]:"log",[q.INFO]:"info",[q.WARN]:"warn",[q.ERROR]:"error"},Wa=(i,e,...n)=>{if(e<i.logLevel)return;const s=new Date().toISOString(),o=Ba[e];if(o)console[o](`[${s}]  ${i.name}:`,...n);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Un{constructor(e){this.name=e,this._logLevel=$a,this._logHandler=Wa,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in q))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Ra[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,q.DEBUG,...e),this._logHandler(this,q.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,q.VERBOSE,...e),this._logHandler(this,q.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,q.INFO,...e),this._logHandler(this,q.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,q.WARN,...e),this._logHandler(this,q.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,q.ERROR,...e),this._logHandler(this,q.ERROR,...e)}}const Ua=(i,e)=>e.some(n=>i instanceof n);let tr,ir;function Fa(){return tr||(tr=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Va(){return ir||(ir=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Qr=new WeakMap,xn=new WeakMap,Zr=new WeakMap,gn=new WeakMap,Fn=new WeakMap;function ja(i){const e=new Promise((n,s)=>{const o=()=>{i.removeEventListener("success",l),i.removeEventListener("error",c)},l=()=>{n(Le(i.result)),o()},c=()=>{s(i.error),o()};i.addEventListener("success",l),i.addEventListener("error",c)});return e.then(n=>{n instanceof IDBCursor&&Qr.set(n,i)}).catch(()=>{}),Fn.set(e,i),e}function qa(i){if(xn.has(i))return;const e=new Promise((n,s)=>{const o=()=>{i.removeEventListener("complete",l),i.removeEventListener("error",c),i.removeEventListener("abort",c)},l=()=>{n(),o()},c=()=>{s(i.error||new DOMException("AbortError","AbortError")),o()};i.addEventListener("complete",l),i.addEventListener("error",c),i.addEventListener("abort",c)});xn.set(i,e)}let On={get(i,e,n){if(i instanceof IDBTransaction){if(e==="done")return xn.get(i);if(e==="objectStoreNames")return i.objectStoreNames||Zr.get(i);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return Le(i[e])},set(i,e,n){return i[e]=n,!0},has(i,e){return i instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in i}};function za(i){On=i(On)}function Ha(i){return i===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...n){const s=i.call(vn(this),e,...n);return Zr.set(s,e.sort?e.sort():[e]),Le(s)}:Va().includes(i)?function(...e){return i.apply(vn(this),e),Le(Qr.get(this))}:function(...e){return Le(i.apply(vn(this),e))}}function Ga(i){return typeof i=="function"?Ha(i):(i instanceof IDBTransaction&&qa(i),Ua(i,Fa())?new Proxy(i,On):i)}function Le(i){if(i instanceof IDBRequest)return ja(i);if(gn.has(i))return gn.get(i);const e=Ga(i);return e!==i&&(gn.set(i,e),Fn.set(e,i)),e}const vn=i=>Fn.get(i);function Ka(i,e,{blocked:n,upgrade:s,blocking:o,terminated:l}={}){const c=indexedDB.open(i,e),u=Le(c);return s&&c.addEventListener("upgradeneeded",m=>{s(Le(c.result),m.oldVersion,m.newVersion,Le(c.transaction),m)}),n&&c.addEventListener("blocked",m=>n(m.oldVersion,m.newVersion,m)),u.then(m=>{l&&m.addEventListener("close",()=>l()),o&&m.addEventListener("versionchange",p=>o(p.oldVersion,p.newVersion,p))}).catch(()=>{}),u}const Ja=["get","getKey","getAll","getAllKeys","count"],Xa=["put","add","delete","clear"],yn=new Map;function nr(i,e){if(!(i instanceof IDBDatabase&&!(e in i)&&typeof e=="string"))return;if(yn.get(e))return yn.get(e);const n=e.replace(/FromIndex$/,""),s=e!==n,o=Xa.includes(n);if(!(n in(s?IDBIndex:IDBObjectStore).prototype)||!(o||Ja.includes(n)))return;const l=async function(c,...u){const m=this.transaction(c,o?"readwrite":"readonly");let p=m.store;return s&&(p=p.index(u.shift())),(await Promise.all([p[n](...u),o&&m.done]))[0]};return yn.set(e,l),l}za(i=>({...i,get:(e,n,s)=>nr(e,n)||i.get(e,n,s),has:(e,n)=>!!nr(e,n)||i.has(e,n)}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ya{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Qa(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function Qa(i){const e=i.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Dn="@firebase/app",sr="0.14.11";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ie=new Un("@firebase/app"),Za="@firebase/app-compat",el="@firebase/analytics-compat",tl="@firebase/analytics",il="@firebase/app-check-compat",nl="@firebase/app-check",sl="@firebase/auth",rl="@firebase/auth-compat",ol="@firebase/database",al="@firebase/data-connect",ll="@firebase/database-compat",cl="@firebase/functions",dl="@firebase/functions-compat",ul="@firebase/installations",hl="@firebase/installations-compat",fl="@firebase/messaging",ml="@firebase/messaging-compat",pl="@firebase/performance",gl="@firebase/performance-compat",vl="@firebase/remote-config",yl="@firebase/remote-config-compat",_l="@firebase/storage",Il="@firebase/storage-compat",Tl="@firebase/firestore",bl="@firebase/ai",wl="@firebase/firestore-compat",Sl="firebase",El="12.12.0",kl={[Dn]:"fire-core",[Za]:"fire-core-compat",[tl]:"fire-analytics",[el]:"fire-analytics-compat",[nl]:"fire-app-check",[il]:"fire-app-check-compat",[sl]:"fire-auth",[rl]:"fire-auth-compat",[ol]:"fire-rtdb",[al]:"fire-data-connect",[ll]:"fire-rtdb-compat",[cl]:"fire-fn",[dl]:"fire-fn-compat",[ul]:"fire-iid",[hl]:"fire-iid-compat",[fl]:"fire-fcm",[ml]:"fire-fcm-compat",[pl]:"fire-perf",[gl]:"fire-perf-compat",[vl]:"fire-rc",[yl]:"fire-rc-compat",[_l]:"fire-gcs",[Il]:"fire-gcs-compat",[Tl]:"fire-fst",[wl]:"fire-fst-compat",[bl]:"fire-vertex","fire-js":"fire-js",[Sl]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ri=El;function Pe(i,e,n){let s=kl[i]??i;n&&(s+=`-${n}`);const o=s.match(/\s|\//),l=e.match(/\s|\//);if(o||l){const c=[`Unable to register library "${s}" with version "${e}":`];o&&c.push(`library name "${s}" contains illegal characters (whitespace or "/")`),o&&l&&c.push("and"),l&&c.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Ie.warn(c.join(" "));return}mt(new ft(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dl="firebase-heartbeat-database",Ll=1,zt="firebase-heartbeat-store";let _n=null;function eo(){return _n||(_n=Ka(Dl,Ll,{upgrade:(i,e)=>{switch(e){case 0:try{i.createObjectStore(zt)}catch(n){console.warn(n)}}}}).catch(i=>{throw Vn.create("idb-open",{originalErrorMessage:i.message})})),_n}async function Pl(i){try{const n=(await eo()).transaction(zt),s=await n.objectStore(zt).get(to(i));return await n.done,s}catch(e){if(e instanceof Me)Ie.warn(e.message);else{const n=Vn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Ie.warn(n.message)}}}async function ar(i,e){try{const s=(await eo()).transaction(zt,"readwrite");await s.objectStore(zt).put(e,to(i)),await s.done}catch(n){if(n instanceof Me)Ie.warn(n.message);else{const s=Vn.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Ie.warn(s.message)}}}function to(i){return`${i.name}!${i.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wl(i){mt(new ft("platform-logger",e=>new Ya(e),"PRIVATE")),mt(new ft("heartbeat",e=>new Nl(e),"PRIVATE")),Pe(Dn,sr,i),Pe(Dn,sr,"esm2020"),Pe("fire-js","")}Wl("");var Ul="firebase",Fl="12.12.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Pe(Ul,Fl,"app");var dr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
*/var jn;(function(){var i;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(y,f){function g(){}g.prototype=f.prototype,y.F=f.prototype,y.prototype=new g,y.prototype.constructor=y,y.D=function(_,v,T){for(var h=Array(arguments.length-2),W=2;W<arguments.length;W++)h[W-2]=arguments[W];return f.prototype[v].apply(_,h)}}function n(){this.blockSize=-1}function s(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(s,n),s.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function o(y,f,g){g||(g=0);const _=Array(16);if(typeof f=="string")for(var v=0;v<16;++v)_[v]=f.charCodeAt(g++)|f.charCodeAt(g++)<<8|f.charCodeAt(g++)<<16|f.charCodeAt(g++)<<24;else for(v=0;v<16;++v)_[v]=f[g++]|f[g++]<<8|f[g++]<<16|f[g++]<<24;f=y.g[0],g=y.g[1],v=y.g[2];let T=y.g[3],h;h=f+(T^g&(v^T))+_[0]+3614090360&4294967295,f=g+(h<<7&4294967295|h>>>25),h=T+(v^f&(g^v))+_[1]+3905402710&4294967295,T=f+(h<<12&4294967295|h>>>20),h=v+(g^T&(f^g))+_[2]+606105819&4294967295,v=T+(h<<17&4294967295|h>>>15),h=g+(f^v&(T^f))+_[3]+3250441966&4294967295,g=v+(h<<22&4294967295|h>>>10),h=f+(T^g&(v^T))+_[4]+4118548399&4294967295,f=g+(h<<7&4294967295|h>>>25),h=T+(v^f&(g^v))+_[5]+1200080426&4294967295,T=f+(h<<12&4294967295|h>>>20),h=v+(g^T&(f^g))+_[6]+2821735955&4294967295,v=T+(h<<17&4294967295|h>>>15),h=g+(f^v&(T^f))+_[7]+4249261313&4294967295,g=v+(h<<22&4294967295|h>>>10),h=f+(T^g&(v^T))+_[8]+1770035416&4294967295,f=g+(h<<7&4294967295|h>>>25),h=T+(v^f&(g^v))+_[9]+2336552879&4294967295,T=f+(h<<12&4294967295|h>>>20),h=v+(g^T&(f^g))+_[10]+4294925233&4294967295,v=T+(h<<17&4294967295|h>>>15),h=g+(f^v&(T^f))+_[11]+2304563134&4294967295,g=v+(h<<22&4294967295|h>>>10),h=f+(T^g&(v^T))+_[12]+1804603682&4294967295,f=g+(h<<7&4294967295|h>>>25),h=T+(v^f&(g^v))+_[13]+4254626195&4294967295,T=f+(h<<12&4294967295|h>>>20),h=v+(g^T&(f^g))+_[14]+2792965006&4294967295,v=T+(h<<17&4294967295|h>>>15),h=g+(f^v&(T^f))+_[15]+1236535329&4294967295,g=v+(h<<22&4294967295|h>>>10),h=f+(v^T&(g^v))+_[1]+4129170786&4294967295,f=g+(h<<5&4294967295|h>>>27),h=T+(g^v&(f^g))+_[6]+3225465664&4294967295,T=f+(h<<9&4294967295|h>>>23),h=v+(f^g&(T^f))+_[11]+643717713&4294967295,v=T+(h<<14&4294967295|h>>>18),h=g+(T^f&(v^T))+_[0]+3921069994&4294967295,g=v+(h<<20&4294967295|h>>>12),h=f+(v^T&(g^v))+_[5]+3593408605&4294967295,f=g+(h<<5&4294967295|h>>>27),h=T+(g^v&(f^g))+_[10]+38016083&4294967295,T=f+(h<<9&4294967295|h>>>23),h=v+(f^g&(T^f))+_[15]+3634488961&4294967295,v=T+(h<<14&4294967295|h>>>18),h=g+(T^f&(v^T))+_[4]+3889429448&4294967295,g=v+(h<<20&4294967295|h>>>12),h=f+(v^T&(g^v))+_[9]+568446438&4294967295,f=g+(h<<5&4294967295|h>>>27),h=T+(g^v&(f^g))+_[14]+3275163606&4294967295,T=f+(h<<9&4294967295|h>>>23),h=v+(f^g&(T^f))+_[3]+4107603335&4294967295,v=T+(h<<14&4294967295|h>>>18),h=g+(T^f&(v^T))+_[8]+1163531501&4294967295,g=v+(h<<20&4294967295|h>>>12),h=f+(v^T&(g^v))+_[13]+2850285829&4294967295,f=g+(h<<5&4294967295|h>>>27),h=T+(g^v&(f^g))+_[2]+4243563512&4294967295,T=f+(h<<9&4294967295|h>>>23),h=v+(f^g&(T^f))+_[7]+1735328473&4294967295,v=T+(h<<14&4294967295|h>>>18),h=g+(T^f&(v^T))+_[12]+2368359562&4294967295,g=v+(h<<20&4294967295|h>>>12),h=f+(g^v^T)+_[5]+4294588738&4294967295,f=g+(h<<4&4294967295|h>>>28),h=T+(f^g^v)+_[8]+2272392833&4294967295,T=f+(h<<11&4294967295|h>>>21),h=v+(T^f^g)+_[11]+1839030562&4294967295,v=T+(h<<16&4294967295|h>>>16),h=g+(v^T^f)+_[14]+4259657740&4294967295,g=v+(h<<23&4294967295|h>>>9),h=f+(g^v^T)+_[1]+2763975236&4294967295,f=g+(h<<4&4294967295|h>>>28),h=T+(f^g^v)+_[4]+1272893353&4294967295,T=f+(h<<11&4294967295|h>>>21),h=v+(T^f^g)+_[7]+4139469664&4294967295,v=T+(h<<16&4294967295|h>>>16),h=g+(v^T^f)+_[10]+3200236656&4294967295,g=v+(h<<23&4294967295|h>>>9),h=f+(g^v^T)+_[13]+681279174&4294967295,f=g+(h<<4&4294967295|h>>>28),h=T+(f^g^v)+_[0]+3936430074&4294967295,T=f+(h<<11&4294967295|h>>>21),h=v+(T^f^g)+_[3]+3572445317&4294967295,v=T+(h<<16&4294967295|h>>>16),h=g+(v^T^f)+_[6]+76029189&4294967295,g=v+(h<<23&4294967295|h>>>9),h=f+(g^v^T)+_[9]+3654602809&4294967295,f=g+(h<<4&4294967295|h>>>28),h=T+(f^g^v)+_[12]+3873151461&4294967295,T=f+(h<<11&4294967295|h>>>21),h=v+(T^f^g)+_[15]+530742520&4294967295,v=T+(h<<16&4294967295|h>>>16),h=g+(v^T^f)+_[2]+3299628645&4294967295,g=v+(h<<23&4294967295|h>>>9),h=f+(v^(g|~T))+_[0]+4096336452&4294967295,f=g+(h<<6&4294967295|h>>>26),h=T+(g^(f|~v))+_[7]+1126891415&4294967295,T=f+(h<<10&4294967295|h>>>22),h=v+(f^(T|~g))+_[14]+2878612391&4294967295,v=T+(h<<15&4294967295|h>>>17),h=g+(T^(v|~f))+_[5]+4237533241&4294967295,g=v+(h<<21&4294967295|h>>>11),h=f+(v^(g|~T))+_[12]+1700485571&4294967295,f=g+(h<<6&4294967295|h>>>26),h=T+(g^(f|~v))+_[3]+2399980690&4294967295,T=f+(h<<10&4294967295|h>>>22),h=v+(f^(T|~g))+_[10]+4293915773&4294967295,v=T+(h<<15&4294967295|h>>>17),h=g+(T^(v|~f))+_[1]+2240044497&4294967295,g=v+(h<<21&4294967295|h>>>11),h=f+(v^(g|~T))+_[8]+1873313359&4294967295,f=g+(h<<6&4294967295|h>>>26),h=T+(g^(f|~v))+_[15]+4264355552&4294967295,T=f+(h<<10&4294967295|h>>>22),h=v+(f^(T|~g))+_[6]+2734768916&4294967295,v=T+(h<<15&4294967295|h>>>17),h=g+(T^(v|~f))+_[13]+1309151649&4294967295,g=v+(h<<21&4294967295|h>>>11),h=f+(v^(g|~T))+_[4]+4149444226&4294967295,f=g+(h<<6&4294967295|h>>>26),h=T+(g^(f|~v))+_[11]+3174756917&4294967295,T=f+(h<<10&4294967295|h>>>22),h=v+(f^(T|~g))+_[2]+718787259&4294967295,v=T+(h<<15&4294967295|h>>>17),h=g+(T^(v|~f))+_[9]+3951481745&4294967295,y.g[0]=y.g[0]+f&4294967295,y.g[1]=y.g[1]+(v+(h<<21&4294967295|h>>>11))&4294967295,y.g[2]=y.g[2]+v&4294967295,y.g[3]=y.g[3]+T&4294967295}s.prototype.v=function(y,f){f===void 0&&(f=y.length);const g=f-this.blockSize,_=this.C;let v=this.h,T=0;for(;T<f;){if(v==0)for(;T<=g;)o(this,y,T),T+=this.blockSize;if(typeof y=="string"){for(;T<f;)if(_[v++]=y.charCodeAt(T++),v==this.blockSize){o(this,_),v=0;break}}else for(;T<f;)if(_[v++]=y[T++],v==this.blockSize){o(this,_),v=0;break}}this.h=v,this.o+=f},s.prototype.A=function(){var y=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);y[0]=128;for(var f=1;f<y.length-8;++f)y[f]=0;f=this.o*8;for(var g=y.length-8;g<y.length;++g)y[g]=f&255,f/=256;for(this.v(y),y=Array(16),f=0,g=0;g<4;++g)for(let _=0;_<32;_+=8)y[f++]=this.g[g]>>>_&255;return y};function l(y,f){var g=u;return Object.prototype.hasOwnProperty.call(g,y)?g[y]:g[y]=f(y)}function c(y,f){this.h=f;const g=[];let _=!0;for(let v=y.length-1;v>=0;v--){const T=y[v]|0;_&&T==f||(g[v]=T,_=!1)}this.g=g}var u={};function m(y){return-128<=y&&y<128?l(y,function(f){return new c([f|0],f<0?-1:0)}):new c([y|0],y<0?-1:0)}function p(y){if(isNaN(y)||!isFinite(y))return b;if(y<0)return D(p(-y));const f=[];let g=1;for(let _=0;y>=g;_++)f[_]=y/g|0,g*=4294967296;return new c(f,0)}function S(y,f){if(y.length==0)throw Error("number format error: empty string");if(f=f||10,f<2||36<f)throw Error("radix out of range: "+f);if(y.charAt(0)=="-")return D(S(y.substring(1),f));if(y.indexOf("-")>=0)throw Error('number format error: interior "-" character');const g=p(Math.pow(f,8));let _=b;for(let T=0;T<y.length;T+=8){var v=Math.min(8,y.length-T);const h=parseInt(y.substring(T,T+v),f);v<8?(v=p(Math.pow(f,v)),_=_.j(v).add(p(h))):(_=_.j(g),_=_.add(p(h)))}return _}var b=m(0),I=m(1),k=m(16777216);i=c.prototype,i.m=function(){if(A(this))return-D(this).m();let y=0,f=1;for(let g=0;g<this.g.length;g++){const _=this.i(g);y+=(_>=0?_:4294967296+_)*f,f*=4294967296}return y},i.toString=function(y){if(y=y||10,y<2||36<y)throw Error("radix out of range: "+y);if(x(this))return"0";if(A(this))return"-"+D(this).toString(y);const f=p(Math.pow(y,6));var g=this;let _="";for(;;){const v=M(g,f).g;g=P(g,v.j(f));let T=((g.g.length>0?g.g[0]:g.h)>>>0).toString(y);if(g=v,x(g))return T+_;for(;T.length<6;)T="0"+T;_=T+_}},i.i=function(y){return y<0?0:y<this.g.length?this.g[y]:this.h};function x(y){if(y.h!=0)return!1;for(let f=0;f<y.g.length;f++)if(y.g[f]!=0)return!1;return!0}function A(y){return y.h==-1}i.l=function(y){return y=P(this,y),A(y)?-1:x(y)?0:1};function D(y){const f=y.g.length,g=[];for(let _=0;_<f;_++)g[_]=~y.g[_];return new c(g,~y.h).add(I)}i.abs=function(){return A(this)?D(this):this},i.add=function(y){const f=Math.max(this.g.length,y.g.length),g=[];let _=0;for(let v=0;v<=f;v++){let T=_+(this.i(v)&65535)+(y.i(v)&65535),h=(T>>>16)+(this.i(v)>>>16)+(y.i(v)>>>16);_=h>>>16,T&=65535,h&=65535,g[v]=h<<16|T}return new c(g,g[g.length-1]&-2147483648?-1:0)};function P(y,f){return y.add(D(f))}i.j=function(y){if(x(this)||x(y))return b;if(A(this))return A(y)?D(this).j(D(y)):D(D(this).j(y));if(A(y))return D(this.j(D(y)));if(this.l(k)<0&&y.l(k)<0)return p(this.m()*y.m());const f=this.g.length+y.g.length,g=[];for(var _=0;_<2*f;_++)g[_]=0;for(_=0;_<this.g.length;_++)for(let v=0;v<y.g.length;v++){const T=this.i(_)>>>16,h=this.i(_)&65535,W=y.i(v)>>>16,X=y.i(v)&65535;g[2*_+2*v]+=h*X,L(g,2*_+2*v),g[2*_+2*v+1]+=T*X,L(g,2*_+2*v+1),g[2*_+2*v+1]+=h*W,L(g,2*_+2*v+1),g[2*_+2*v+2]+=T*W,L(g,2*_+2*v+2)}for(y=0;y<f;y++)g[y]=g[2*y+1]<<16|g[2*y];for(y=f;y<2*f;y++)g[y]=0;return new c(g,0)};function L(y,f){for(;(y[f]&65535)!=y[f];)y[f+1]+=y[f]>>>16,y[f]&=65535,f++}function C(y,f){this.g=y,this.h=f}function M(y,f){if(x(f))throw Error("division by zero");if(x(y))return new C(b,b);if(A(y))return f=M(D(y),f),new C(D(f.g),D(f.h));if(A(f))return f=M(y,D(f)),new C(D(f.g),f.h);if(y.g.length>30){if(A(y)||A(f))throw Error("slowDivide_ only works with positive integers.");for(var g=I,_=f;_.l(y)<=0;)g=R(g),_=R(_);var v=B(g,1),T=B(_,1);for(_=B(_,2),g=B(g,2);!x(_);){var h=T.add(_);h.l(y)<=0&&(v=v.add(g),T=h),_=B(_,1),g=B(g,1)}return f=P(y,v.j(f)),new C(v,f)}for(v=b;y.l(f)>=0;){for(g=Math.max(1,Math.floor(y.m()/f.m())),_=Math.ceil(Math.log(g)/Math.LN2),_=_<=48?1:Math.pow(2,_-48),T=p(g),h=T.j(f);A(h)||h.l(y)>0;)g-=_,T=p(g),h=T.j(f);x(T)&&(T=I),v=v.add(T),y=P(y,h)}return new C(v,y)}i.B=function(y){return M(this,y).h},i.and=function(y){const f=Math.max(this.g.length,y.g.length),g=[];for(let _=0;_<f;_++)g[_]=this.i(_)&y.i(_);return new c(g,this.h&y.h)},i.or=function(y){const f=Math.max(this.g.length,y.g.length),g=[];for(let _=0;_<f;_++)g[_]=this.i(_)|y.i(_);return new c(g,this.h|y.h)},i.xor=function(y){const f=Math.max(this.g.length,y.g.length),g=[];for(let _=0;_<f;_++)g[_]=this.i(_)^y.i(_);return new c(g,this.h^y.h)};function R(y){const f=y.g.length+1,g=[];for(let _=0;_<f;_++)g[_]=y.i(_)<<1|y.i(_-1)>>>31;return new c(g,y.h)}function B(y,f){const g=f>>5;f%=32;const _=y.g.length-g,v=[];for(let T=0;T<_;T++)v[T]=f>0?y.i(T+g)>>>f|y.i(T+g+1)<<32-f:y.i(T+g);return new c(v,y.h)}s.prototype.digest=s.prototype.A,s.prototype.reset=s.prototype.u,s.prototype.update=s.prototype.v,c.prototype.add=c.prototype.add,c.prototype.multiply=c.prototype.j,c.prototype.modulo=c.prototype.B,c.prototype.compare=c.prototype.l,c.prototype.toNumber=c.prototype.m,c.prototype.toString=c.prototype.toString,c.prototype.getBits=c.prototype.i,c.fromNumber=p,c.fromString=S,jn=c}).apply(typeof dr<"u"?dr:typeof self<"u"?self:typeof window<"u"?window:{});var mi=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};(function(){var i,e=Object.defineProperty;function n(t){t=[typeof globalThis=="object"&&globalThis,t,typeof window=="object"&&window,typeof self=="object"&&self,typeof mi=="object"&&mi];for(var r=0;r<t.length;++r){var a=t[r];if(a&&a.Math==Math)return a}throw Error("Cannot find global object")}var s=n(this);function o(t,r){if(r)e:{var a=s;t=t.split(".");for(var d=0;d<t.length-1;d++){var w=t[d];if(!(w in a))break e;a=a[w]}t=t[t.length-1],d=a[t],r=r(d),r!=d&&r!=null&&e(a,t,{configurable:!0,writable:!0,value:r})}}o("Symbol.dispose",function(t){return t||Symbol("Symbol.dispose")}),o("Array.prototype.values",function(t){return t||function(){return this[Symbol.iterator]()}}),o("Object.entries",function(t){return t||function(r){var a=[],d;for(d in r)Object.prototype.hasOwnProperty.call(r,d)&&a.push([d,r[d]]);return a}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var l=l||{},c=this||self;function u(t){var r=typeof t;return r=="object"&&t!=null||r=="function"}function m(t,r,a){return t.call.apply(t.bind,arguments)}function p(t,r,a){return p=m,p.apply(null,arguments)}function S(t,r){var a=Array.prototype.slice.call(arguments,1);return function(){var d=a.slice();return d.push.apply(d,arguments),t.apply(this,d)}}function b(t,r){function a(){}a.prototype=r.prototype,t.Z=r.prototype,t.prototype=new a,t.prototype.constructor=t,t.Ob=function(d,w,E){for(var O=Array(arguments.length-2),$=2;$<arguments.length;$++)O[$-2]=arguments[$];return r.prototype[w].apply(d,O)}}var I=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?t=>t&&AsyncContext.Snapshot.wrap(t):t=>t;function k(t){const r=t.length;if(r>0){const a=Array(r);for(let d=0;d<r;d++)a[d]=t[d];return a}return[]}function x(t,r){for(let d=1;d<arguments.length;d++){const w=arguments[d];var a=typeof w;if(a=a!="object"?a:w?Array.isArray(w)?"array":a:"null",a=="array"||a=="object"&&typeof w.length=="number"){a=t.length||0;const E=w.length||0;t.length=a+E;for(let O=0;O<E;O++)t[a+O]=w[O]}else t.push(w)}}class A{constructor(r,a){this.i=r,this.j=a,this.h=0,this.g=null}get(){let r;return this.h>0?(this.h--,r=this.g,this.g=r.next,r.next=null):r=this.i(),r}}function D(t){c.setTimeout(()=>{throw t},0)}function P(){var t=y;let r=null;return t.g&&(r=t.g,t.g=t.g.next,t.g||(t.h=null),r.next=null),r}class L{constructor(){this.h=this.g=null}add(r,a){const d=C.get();d.set(r,a),this.h?this.h.next=d:this.g=d,this.h=d}}var C=new A(()=>new M,t=>t.reset());class M{constructor(){this.next=this.g=this.h=null}set(r,a){this.h=r,this.g=a,this.next=null}reset(){this.next=this.g=this.h=null}}let R,B=!1,y=new L,f=()=>{const t=Promise.resolve(void 0);R=()=>{t.then(g)}};function g(){for(var t;t=P();){try{t.h.call(t.g)}catch(a){D(a)}var r=C;r.j(t),r.h<100&&(r.h++,t.next=r.g,r.g=t)}B=!1}function _(){this.u=this.u,this.C=this.C}_.prototype.u=!1,_.prototype.dispose=function(){this.u||(this.u=!0,this.N())},_.prototype[Symbol.dispose]=function(){this.dispose()},_.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function v(t,r){this.type=t,this.g=this.target=r,this.defaultPrevented=!1}v.prototype.h=function(){this.defaultPrevented=!0};var T=function(){if(!c.addEventListener||!Object.defineProperty)return!1;var t=!1,r=Object.defineProperty({},"passive",{get:function(){t=!0}});try{const a=()=>{};c.addEventListener("test",a,r),c.removeEventListener("test",a,r)}catch{}return t}();function h(t){return/^[\s\xa0]*$/.test(t)}function W(t,r){v.call(this,t?t.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,t&&this.init(t,r)}b(W,v),W.prototype.init=function(t,r){const a=this.type=t.type,d=t.changedTouches&&t.changedTouches.length?t.changedTouches[0]:null;this.target=t.target||t.srcElement,this.g=r,r=t.relatedTarget,r||(a=="mouseover"?r=t.fromElement:a=="mouseout"&&(r=t.toElement)),this.relatedTarget=r,d?(this.clientX=d.clientX!==void 0?d.clientX:d.pageX,this.clientY=d.clientY!==void 0?d.clientY:d.pageY,this.screenX=d.screenX||0,this.screenY=d.screenY||0):(this.clientX=t.clientX!==void 0?t.clientX:t.pageX,this.clientY=t.clientY!==void 0?t.clientY:t.pageY,this.screenX=t.screenX||0,this.screenY=t.screenY||0),this.button=t.button,this.key=t.key||"",this.ctrlKey=t.ctrlKey,this.altKey=t.altKey,this.shiftKey=t.shiftKey,this.metaKey=t.metaKey,this.pointerId=t.pointerId||0,this.pointerType=t.pointerType,this.state=t.state,this.i=t,t.defaultPrevented&&W.Z.h.call(this)},W.prototype.h=function(){W.Z.h.call(this);const t=this.i;t.preventDefault?t.preventDefault():t.returnValue=!1};var X="closure_listenable_"+(Math.random()*1e6|0),et=0;function Fi(t,r,a,d,w){this.listener=t,this.proxy=null,this.src=r,this.type=a,this.capture=!!d,this.ha=w,this.key=++et,this.da=this.fa=!1}function tt(t){t.da=!0,t.listener=null,t.proxy=null,t.src=null,t.ha=null}function it(t,r,a){for(const d in t)r.call(a,t[d],d,t)}function Re(t,r){for(const a in t)r.call(void 0,t[a],a,t)}function $e(t){const r={};for(const a in t)r[a]=t[a];return r}const nt="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Tt(t,r){let a,d;for(let w=1;w<arguments.length;w++){d=arguments[w];for(a in d)t[a]=d[a];for(let E=0;E<nt.length;E++)a=nt[E],Object.prototype.hasOwnProperty.call(d,a)&&(t[a]=d[a])}}function si(t){this.src=t,this.g={},this.h=0}si.prototype.add=function(t,r,a,d,w){const E=t.toString();t=this.g[E],t||(t=this.g[E]=[],this.h++);const O=ji(t,r,d,w);return O>-1?(r=t[O],a||(r.fa=!1)):(r=new Fi(r,this.src,E,!!d,w),r.fa=a,t.push(r)),r};function Vi(t,r){const a=r.type;if(a in t.g){var d=t.g[a],w=Array.prototype.indexOf.call(d,r,void 0),E;(E=w>=0)&&Array.prototype.splice.call(d,w,1),E&&(tt(r),t.g[a].length==0&&(delete t.g[a],t.h--))}}function ji(t,r,a,d){for(let w=0;w<t.length;++w){const E=t[w];if(!E.da&&E.listener==r&&E.capture==!!a&&E.ha==d)return w}return-1}var qi="closure_lm_"+(Math.random()*1e6|0),zi={};function ss(t,r,a,d,w){if(Array.isArray(r)){for(let E=0;E<r.length;E++)ss(t,r[E],a,d,w);return null}return a=as(a),t&&t[X]?t.J(r,a,u(d)?!!d.capture:!1,w):$o(t,r,a,!1,d,w)}function $o(t,r,a,d,w,E){if(!r)throw Error("Invalid event type");const O=u(w)?!!w.capture:!!w;let $=Gi(t);if($||(t[qi]=$=new si(t)),a=$.add(r,a,d,O,E),a.proxy)return a;if(d=Bo(),a.proxy=d,d.src=t,d.listener=a,t.addEventListener)T||(w=O),w===void 0&&(w=!1),t.addEventListener(r.toString(),d,w);else if(t.attachEvent)t.attachEvent(os(r.toString()),d);else if(t.addListener&&t.removeListener)t.addListener(d);else throw Error("addEventListener and attachEvent are unavailable.");return a}function Bo(){function t(a){return r.call(t.src,t.listener,a)}const r=Wo;return t}function rs(t,r,a,d,w){if(Array.isArray(r))for(var E=0;E<r.length;E++)rs(t,r[E],a,d,w);else d=u(d)?!!d.capture:!!d,a=as(a),t&&t[X]?(t=t.i,E=String(r).toString(),E in t.g&&(r=t.g[E],a=ji(r,a,d,w),a>-1&&(tt(r[a]),Array.prototype.splice.call(r,a,1),r.length==0&&(delete t.g[E],t.h--)))):t&&(t=Gi(t))&&(r=t.g[r.toString()],t=-1,r&&(t=ji(r,a,d,w)),(a=t>-1?r[t]:null)&&Hi(a))}function Hi(t){if(typeof t!="number"&&t&&!t.da){var r=t.src;if(r&&r[X])Vi(r.i,t);else{var a=t.type,d=t.proxy;r.removeEventListener?r.removeEventListener(a,d,t.capture):r.detachEvent?r.detachEvent(os(a),d):r.addListener&&r.removeListener&&r.removeListener(d),(a=Gi(r))?(Vi(a,t),a.h==0&&(a.src=null,r[qi]=null)):tt(t)}}}function os(t){return t in zi?zi[t]:zi[t]="on"+t}function Wo(t,r){if(t.da)t=!0;else{r=new W(r,this);const a=t.listener,d=t.ha||t.src;t.fa&&Hi(t),t=a.call(d,r)}return t}function Gi(t){return t=t[qi],t instanceof si?t:null}var Ki="__closure_events_fn_"+(Math.random()*1e9>>>0);function as(t){return typeof t=="function"?t:(t[Ki]||(t[Ki]=function(r){return t.handleEvent(r)}),t[Ki])}function te(){_.call(this),this.i=new si(this),this.M=this,this.G=null}b(te,_),te.prototype[X]=!0,te.prototype.removeEventListener=function(t,r,a,d){rs(this,t,r,a,d)};function ie(t,r){var a,d=t.G;if(d)for(a=[];d;d=d.G)a.push(d);if(t=t.M,d=r.type||r,typeof r=="string")r=new v(r,t);else if(r instanceof v)r.target=r.target||t;else{var w=r;r=new v(d,t),Tt(r,w)}w=!0;let E,O;if(a)for(O=a.length-1;O>=0;O--)E=r.g=a[O],w=ri(E,d,!0,r)&&w;if(E=r.g=t,w=ri(E,d,!0,r)&&w,w=ri(E,d,!1,r)&&w,a)for(O=0;O<a.length;O++)E=r.g=a[O],w=ri(E,d,!1,r)&&w}te.prototype.N=function(){if(te.Z.N.call(this),this.i){var t=this.i;for(const r in t.g){const a=t.g[r];for(let d=0;d<a.length;d++)tt(a[d]);delete t.g[r],t.h--}}this.G=null},te.prototype.J=function(t,r,a,d){return this.i.add(String(t),r,!1,a,d)},te.prototype.K=function(t,r,a,d){return this.i.add(String(t),r,!0,a,d)};function ri(t,r,a,d){if(r=t.i.g[String(r)],!r)return!0;r=r.concat();let w=!0;for(let E=0;E<r.length;++E){const O=r[E];if(O&&!O.da&&O.capture==a){const $=O.listener,Y=O.ha||O.src;O.fa&&Vi(t.i,O),w=$.call(Y,d)!==!1&&w}}return w&&!d.defaultPrevented}function Uo(t,r){if(typeof t!="function")if(t&&typeof t.handleEvent=="function")t=p(t.handleEvent,t);else throw Error("Invalid listener argument");return Number(r)>2147483647?-1:c.setTimeout(t,r||0)}function ls(t){t.g=Uo(()=>{t.g=null,t.i&&(t.i=!1,ls(t))},t.l);const r=t.h;t.h=null,t.m.apply(null,r)}class Fo extends _{constructor(r,a){super(),this.m=r,this.l=a,this.h=null,this.i=!1,this.g=null}j(r){this.h=arguments,this.g?this.i=!0:ls(this)}N(){super.N(),this.g&&(c.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function bt(t){_.call(this),this.h=t,this.g={}}b(bt,_);var cs=[];function ds(t){it(t.g,function(r,a){this.g.hasOwnProperty(a)&&Hi(r)},t),t.g={}}bt.prototype.N=function(){bt.Z.N.call(this),ds(this)},bt.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Ji=c.JSON.stringify,Vo=c.JSON.parse,jo=class{stringify(t){return c.JSON.stringify(t,void 0)}parse(t){return c.JSON.parse(t,void 0)}};function us(){}function qo(){}var wt={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function Xi(){v.call(this,"d")}b(Xi,v);function Yi(){v.call(this,"c")}b(Yi,v);var st={},hs=null;function Qi(){return hs=hs||new te}st.Ia="serverreachability";function fs(t){v.call(this,st.Ia,t)}b(fs,v);function St(t){const r=Qi();ie(r,new fs(r))}st.STAT_EVENT="statevent";function ms(t,r){v.call(this,st.STAT_EVENT,t),this.stat=r}b(ms,v);function ne(t){const r=Qi();ie(r,new ms(r,t))}st.Ja="timingevent";function ps(t,r){v.call(this,st.Ja,t),this.size=r}b(ps,v);function Et(t,r){if(typeof t!="function")throw Error("Fn must not be null and must be a function");return c.setTimeout(function(){t()},r)}function kt(){this.g=!0}kt.prototype.ua=function(){this.g=!1};function zo(t,r,a,d,w,E){t.info(function(){if(t.g)if(E){var O="",$=E.split("&");for(let z=0;z<$.length;z++){var Y=$[z].split("=");if(Y.length>1){const ee=Y[0];Y=Y[1];const fe=ee.split("_");O=fe.length>=2&&fe[1]=="type"?O+(ee+"="+Y+"&"):O+(ee+"=redacted&")}}}else O=null;else O=E;return"XMLHTTP REQ ("+d+") [attempt "+w+"]: "+r+`
`+a+`
`+O})}function Ho(t,r,a,d,w,E,O){t.info(function(){return"XMLHTTP RESP ("+d+") [ attempt "+w+"]: "+r+`
`+a+`
`+E+" "+O})}function rt(t,r,a,d){t.info(function(){return"XMLHTTP TEXT ("+r+"): "+Ko(t,a)+(d?" "+d:"")})}function Go(t,r){t.info(function(){return"TIMEOUT: "+r})}kt.prototype.info=function(){};function Ko(t,r){if(!t.g)return r;if(!r)return null;try{const E=JSON.parse(r);if(E){for(t=0;t<E.length;t++)if(Array.isArray(E[t])){var a=E[t];if(!(a.length<2)){var d=a[1];if(Array.isArray(d)&&!(d.length<1)){var w=d[0];if(w!="noop"&&w!="stop"&&w!="close")for(let O=1;O<d.length;O++)d[O]=""}}}}return Ji(E)}catch{return r}}var Zi={NO_ERROR:0,TIMEOUT:8},Jo={},gs;function en(){}b(en,us),en.prototype.g=function(){return new XMLHttpRequest},gs=new en;function At(t){return encodeURIComponent(String(t))}function Xo(t){var r=1;t=t.split(":");const a=[];for(;r>0&&t.length;)a.push(t.shift()),r--;return t.length&&a.push(t.join(":")),a}function Te(t,r,a,d){this.j=t,this.i=r,this.l=a,this.S=d||1,this.V=new bt(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new vs}function vs(){this.i=null,this.g="",this.h=!1}var ys={},tn={};function nn(t,r,a){t.M=1,t.A=ai(he(r)),t.u=a,t.R=!0,_s(t,null)}function _s(t,r){t.F=Date.now(),oi(t),t.B=he(t.A);var a=t.B,d=t.S;Array.isArray(d)||(d=[String(d)]),Ps(a.i,"t",d),t.C=0,a=t.j.L,t.h=new vs,t.g=Xs(t.j,a?r:null,!t.u),t.P>0&&(t.O=new Fo(p(t.Y,t,t.g),t.P)),r=t.V,a=t.g,d=t.ba;var w="readystatechange";Array.isArray(w)||(w&&(cs[0]=w.toString()),w=cs);for(let E=0;E<w.length;E++){const O=ss(a,w[E],d||r.handleEvent,!1,r.h||r);if(!O)break;r.g[O.key]=O}r=t.J?$e(t.J):{},t.u?(t.v||(t.v="POST"),r["Content-Type"]="application/x-www-form-urlencoded",t.g.ea(t.B,t.v,t.u,r)):(t.v="GET",t.g.ea(t.B,t.v,null,r)),St(),zo(t.i,t.v,t.B,t.l,t.S,t.u)}Te.prototype.ba=function(t){t=t.target;const r=this.O;r&&Se(t)==3?r.j():this.Y(t)},Te.prototype.Y=function(t){try{if(t==this.g)e:{const $=Se(this.g),Y=this.g.ya(),z=this.g.ca();if(!($<3)&&($!=3||this.g&&(this.h.h||this.g.la()||Ws(this.g)))){this.K||$!=4||Y==7||(Y==8||z<=0?St(3):St(2)),sn(this);var r=this.g.ca();this.X=r;var a=Yo(this);if(this.o=r==200,Ho(this.i,this.v,this.B,this.l,this.S,$,r),this.o){if(this.U&&!this.L){t:{if(this.g){var d,w=this.g;if((d=w.g?w.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!h(d)){var E=d;break t}}E=null}if(t=E)rt(this.i,this.l,t,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,rn(this,t);else{this.o=!1,this.m=3,ne(12),Be(this),xt(this);break e}}if(this.R){t=!0;let ee;for(;!this.K&&this.C<a.length;)if(ee=Qo(this,a),ee==tn){$==4&&(this.m=4,ne(14),t=!1),rt(this.i,this.l,null,"[Incomplete Response]");break}else if(ee==ys){this.m=4,ne(15),rt(this.i,this.l,a,"[Invalid Chunk]"),t=!1;break}else rt(this.i,this.l,ee,null),rn(this,ee);if(Is(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),$!=4||a.length!=0||this.h.h||(this.m=1,ne(16),t=!1),this.o=this.o&&t,!t)rt(this.i,this.l,a,"[Invalid Chunked Response]"),Be(this),xt(this);else if(a.length>0&&!this.W){this.W=!0;var O=this.j;O.g==this&&O.aa&&!O.P&&(O.j.info("Great, no buffering proxy detected. Bytes received: "+a.length),fn(O),O.P=!0,ne(11))}}else rt(this.i,this.l,a,null),rn(this,a);$==4&&Be(this),this.o&&!this.K&&($==4?Hs(this.j,this):(this.o=!1,oi(this)))}else ha(this.g),r==400&&a.indexOf("Unknown SID")>0?(this.m=3,ne(12)):(this.m=0,ne(13)),Be(this),xt(this)}}}catch{}finally{}};function Yo(t){if(!Is(t))return t.g.la();const r=Ws(t.g);if(r==="")return"";let a="";const d=r.length,w=Se(t.g)==4;if(!t.h.i){if(typeof TextDecoder>"u")return Be(t),xt(t),"";t.h.i=new c.TextDecoder}for(let E=0;E<d;E++)t.h.h=!0,a+=t.h.i.decode(r[E],{stream:!(w&&E==d-1)});return r.length=0,t.h.g+=a,t.C=0,t.h.g}function Is(t){return t.g?t.v=="GET"&&t.M!=2&&t.j.Aa:!1}function Qo(t,r){var a=t.C,d=r.indexOf(`
`,a);return d==-1?tn:(a=Number(r.substring(a,d)),isNaN(a)?ys:(d+=1,d+a>r.length?tn:(r=r.slice(d,d+a),t.C=d+a,r)))}Te.prototype.cancel=function(){this.K=!0,Be(this)};function oi(t){t.T=Date.now()+t.H,Ts(t,t.H)}function Ts(t,r){if(t.D!=null)throw Error("WatchDog timer not null");t.D=Et(p(t.aa,t),r)}function sn(t){t.D&&(c.clearTimeout(t.D),t.D=null)}Te.prototype.aa=function(){this.D=null;const t=Date.now();t-this.T>=0?(Go(this.i,this.B),this.M!=2&&(St(),ne(17)),Be(this),this.m=2,xt(this)):Ts(this,this.T-t)};function xt(t){t.j.I==0||t.K||Hs(t.j,t)}function Be(t){sn(t);var r=t.O;r&&typeof r.dispose=="function"&&r.dispose(),t.O=null,ds(t.V),t.g&&(r=t.g,t.g=null,r.abort(),r.dispose())}function rn(t,r){try{var a=t.j;if(a.I!=0&&(a.g==t||on(a.h,t))){if(!t.L&&on(a.h,t)&&a.I==3){try{var d=a.Ba.g.parse(r)}catch{d=null}if(Array.isArray(d)&&d.length==3){var w=d;if(w[0]==0){e:if(!a.v){if(a.g)if(a.g.F+3e3<t.F)hi(a),di(a);else break e;hn(a),ne(18)}}else a.xa=w[1],0<a.xa-a.K&&w[2]<37500&&a.F&&a.A==0&&!a.C&&(a.C=Et(p(a.Va,a),6e3));Ss(a.h)<=1&&a.ta&&(a.ta=void 0)}else Ue(a,11)}else if((t.L||a.g==t)&&hi(a),!h(r))for(w=a.Ba.g.parse(r),r=0;r<w.length;r++){let z=w[r];const ee=z[0];if(!(ee<=a.K))if(a.K=ee,z=z[1],a.I==2)if(z[0]=="c"){a.M=z[1],a.ba=z[2];const fe=z[3];fe!=null&&(a.ka=fe,a.j.info("VER="+a.ka));const Fe=z[4];Fe!=null&&(a.za=Fe,a.j.info("SVER="+a.za));const Ee=z[5];Ee!=null&&typeof Ee=="number"&&Ee>0&&(d=1.5*Ee,a.O=d,a.j.info("backChannelRequestTimeoutMs_="+d)),d=a;const ke=t.g;if(ke){const fi=ke.g?ke.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(fi){var E=d.h;E.g||fi.indexOf("spdy")==-1&&fi.indexOf("quic")==-1&&fi.indexOf("h2")==-1||(E.j=E.l,E.g=new Set,E.h&&(an(E,E.h),E.h=null))}if(d.G){const mn=ke.g?ke.g.getResponseHeader("X-HTTP-Session-Id"):null;mn&&(d.wa=mn,H(d.J,d.G,mn))}}a.I=3,a.l&&a.l.ra(),a.aa&&(a.T=Date.now()-t.F,a.j.info("Handshake RTT: "+a.T+"ms")),d=a;var O=t;if(d.na=Js(d,d.L?d.ba:null,d.W),O.L){Es(d.h,O);var $=O,Y=d.O;Y&&($.H=Y),$.D&&(sn($),oi($)),d.g=O}else qs(d);a.i.length>0&&ui(a)}else z[0]!="stop"&&z[0]!="close"||Ue(a,7);else a.I==3&&(z[0]=="stop"||z[0]=="close"?z[0]=="stop"?Ue(a,7):un(a):z[0]!="noop"&&a.l&&a.l.qa(z),a.A=0)}}St(4)}catch{}}var Zo=class{constructor(t,r){this.g=t,this.map=r}};function bs(t){this.l=t||10,c.PerformanceNavigationTiming?(t=c.performance.getEntriesByType("navigation"),t=t.length>0&&(t[0].nextHopProtocol=="hq"||t[0].nextHopProtocol=="h2")):t=!!(c.chrome&&c.chrome.loadTimes&&c.chrome.loadTimes()&&c.chrome.loadTimes().wasFetchedViaSpdy),this.j=t?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function ws(t){return t.h?!0:t.g?t.g.size>=t.j:!1}function Ss(t){return t.h?1:t.g?t.g.size:0}function on(t,r){return t.h?t.h==r:t.g?t.g.has(r):!1}function an(t,r){t.g?t.g.add(r):t.h=r}function Es(t,r){t.h&&t.h==r?t.h=null:t.g&&t.g.has(r)&&t.g.delete(r)}bs.prototype.cancel=function(){if(this.i=ks(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const t of this.g.values())t.cancel();this.g.clear()}};function ks(t){if(t.h!=null)return t.i.concat(t.h.G);if(t.g!=null&&t.g.size!==0){let r=t.i;for(const a of t.g.values())r=r.concat(a.G);return r}return k(t.i)}var As=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function ea(t,r){if(t){t=t.split("&");for(let a=0;a<t.length;a++){const d=t[a].indexOf("=");let w,E=null;d>=0?(w=t[a].substring(0,d),E=t[a].substring(d+1)):w=t[a],r(w,E?decodeURIComponent(E.replace(/\+/g," ")):"")}}}function be(t){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let r;t instanceof be?(this.l=t.l,Ot(this,t.j),this.o=t.o,this.g=t.g,Dt(this,t.u),this.h=t.h,ln(this,Cs(t.i)),this.m=t.m):t&&(r=String(t).match(As))?(this.l=!1,Ot(this,r[1]||"",!0),this.o=Lt(r[2]||""),this.g=Lt(r[3]||"",!0),Dt(this,r[4]),this.h=Lt(r[5]||"",!0),ln(this,r[6]||"",!0),this.m=Lt(r[7]||"")):(this.l=!1,this.i=new Ct(null,this.l))}be.prototype.toString=function(){const t=[];var r=this.j;r&&t.push(Pt(r,xs,!0),":");var a=this.g;return(a||r=="file")&&(t.push("//"),(r=this.o)&&t.push(Pt(r,xs,!0),"@"),t.push(At(a).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a=this.u,a!=null&&t.push(":",String(a))),(a=this.h)&&(this.g&&a.charAt(0)!="/"&&t.push("/"),t.push(Pt(a,a.charAt(0)=="/"?na:ia,!0))),(a=this.i.toString())&&t.push("?",a),(a=this.m)&&t.push("#",Pt(a,ra)),t.join("")},be.prototype.resolve=function(t){const r=he(this);let a=!!t.j;a?Ot(r,t.j):a=!!t.o,a?r.o=t.o:a=!!t.g,a?r.g=t.g:a=t.u!=null;var d=t.h;if(a)Dt(r,t.u);else if(a=!!t.h){if(d.charAt(0)!="/")if(this.g&&!this.h)d="/"+d;else{var w=r.h.lastIndexOf("/");w!=-1&&(d=r.h.slice(0,w+1)+d)}if(w=d,w==".."||w==".")d="";else if(w.indexOf("./")!=-1||w.indexOf("/.")!=-1){d=w.lastIndexOf("/",0)==0,w=w.split("/");const E=[];for(let O=0;O<w.length;){const $=w[O++];$=="."?d&&O==w.length&&E.push(""):$==".."?((E.length>1||E.length==1&&E[0]!="")&&E.pop(),d&&O==w.length&&E.push("")):(E.push($),d=!0)}d=E.join("/")}else d=w}return a?r.h=d:a=t.i.toString()!=="",a?ln(r,Cs(t.i)):a=!!t.m,a&&(r.m=t.m),r};function he(t){return new be(t)}function Ot(t,r,a){t.j=a?Lt(r,!0):r,t.j&&(t.j=t.j.replace(/:$/,""))}function Dt(t,r){if(r){if(r=Number(r),isNaN(r)||r<0)throw Error("Bad port number "+r);t.u=r}else t.u=null}function ln(t,r,a){r instanceof Ct?(t.i=r,oa(t.i,t.l)):(a||(r=Pt(r,sa)),t.i=new Ct(r,t.l))}function H(t,r,a){t.i.set(r,a)}function ai(t){return H(t,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),t}function Lt(t,r){return t?r?decodeURI(t.replace(/%25/g,"%2525")):decodeURIComponent(t):""}function Pt(t,r,a){return typeof t=="string"?(t=encodeURI(t).replace(r,ta),a&&(t=t.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),t):null}function ta(t){return t=t.charCodeAt(0),"%"+(t>>4&15).toString(16)+(t&15).toString(16)}var xs=/[#\/\?@]/g,ia=/[#\?:]/g,na=/[#\?]/g,sa=/[#\?@]/g,ra=/#/g;function Ct(t,r){this.h=this.g=null,this.i=t||null,this.j=!!r}function We(t){t.g||(t.g=new Map,t.h=0,t.i&&ea(t.i,function(r,a){t.add(decodeURIComponent(r.replace(/\+/g," ")),a)}))}i=Ct.prototype,i.add=function(t,r){We(this),this.i=null,t=ot(this,t);let a=this.g.get(t);return a||this.g.set(t,a=[]),a.push(r),this.h+=1,this};function Os(t,r){We(t),r=ot(t,r),t.g.has(r)&&(t.i=null,t.h-=t.g.get(r).length,t.g.delete(r))}function Ds(t,r){return We(t),r=ot(t,r),t.g.has(r)}i.forEach=function(t,r){We(this),this.g.forEach(function(a,d){a.forEach(function(w){t.call(r,w,d,this)},this)},this)};function Ls(t,r){We(t);let a=[];if(typeof r=="string")Ds(t,r)&&(a=a.concat(t.g.get(ot(t,r))));else for(t=Array.from(t.g.values()),r=0;r<t.length;r++)a=a.concat(t[r]);return a}i.set=function(t,r){return We(this),this.i=null,t=ot(this,t),Ds(this,t)&&(this.h-=this.g.get(t).length),this.g.set(t,[r]),this.h+=1,this},i.get=function(t,r){return t?(t=Ls(this,t),t.length>0?String(t[0]):r):r};function Ps(t,r,a){Os(t,r),a.length>0&&(t.i=null,t.g.set(ot(t,r),k(a)),t.h+=a.length)}i.toString=function(){if(this.i)return this.i;if(!this.g)return"";const t=[],r=Array.from(this.g.keys());for(let d=0;d<r.length;d++){var a=r[d];const w=At(a);a=Ls(this,a);for(let E=0;E<a.length;E++){let O=w;a[E]!==""&&(O+="="+At(a[E])),t.push(O)}}return this.i=t.join("&")};function Cs(t){const r=new Ct;return r.i=t.i,t.g&&(r.g=new Map(t.g),r.h=t.h),r}function ot(t,r){return r=String(r),t.j&&(r=r.toLowerCase()),r}function oa(t,r){r&&!t.j&&(We(t),t.i=null,t.g.forEach(function(a,d){const w=d.toLowerCase();d!=w&&(Os(this,d),Ps(this,w,a))},t)),t.j=r}function aa(t,r){const a=new kt;if(c.Image){const d=new Image;d.onload=S(we,a,"TestLoadImage: loaded",!0,r,d),d.onerror=S(we,a,"TestLoadImage: error",!1,r,d),d.onabort=S(we,a,"TestLoadImage: abort",!1,r,d),d.ontimeout=S(we,a,"TestLoadImage: timeout",!1,r,d),c.setTimeout(function(){d.ontimeout&&d.ontimeout()},1e4),d.src=t}else r(!1)}function la(t,r){const a=new kt,d=new AbortController,w=setTimeout(()=>{d.abort(),we(a,"TestPingServer: timeout",!1,r)},1e4);fetch(t,{signal:d.signal}).then(E=>{clearTimeout(w),E.ok?we(a,"TestPingServer: ok",!0,r):we(a,"TestPingServer: server error",!1,r)}).catch(()=>{clearTimeout(w),we(a,"TestPingServer: error",!1,r)})}function we(t,r,a,d,w){try{w&&(w.onload=null,w.onerror=null,w.onabort=null,w.ontimeout=null),d(a)}catch{}}function ca(){this.g=new jo}function cn(t){this.i=t.Sb||null,this.h=t.ab||!1}b(cn,us),cn.prototype.g=function(){return new li(this.i,this.h)};function li(t,r){te.call(this),this.H=t,this.o=r,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}b(li,te),i=li.prototype,i.open=function(t,r){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=t,this.D=r,this.readyState=1,Nt(this)},i.send=function(t){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const r={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};t&&(r.body=t),(this.H||c).fetch(new Request(this.D,r)).then(this.Pa.bind(this),this.ga.bind(this))},i.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,Mt(this)),this.readyState=0},i.Pa=function(t){if(this.g&&(this.l=t,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=t.headers,this.readyState=2,Nt(this)),this.g&&(this.readyState=3,Nt(this),this.g)))if(this.responseType==="arraybuffer")t.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof c.ReadableStream<"u"&&"body"in t){if(this.j=t.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;Ms(this)}else t.text().then(this.Oa.bind(this),this.ga.bind(this))};function Ms(t){t.j.read().then(t.Ma.bind(t)).catch(t.ga.bind(t))}i.Ma=function(t){if(this.g){if(this.o&&t.value)this.response.push(t.value);else if(!this.o){var r=t.value?t.value:new Uint8Array(0);(r=this.B.decode(r,{stream:!t.done}))&&(this.response=this.responseText+=r)}t.done?Mt(this):Nt(this),this.readyState==3&&Ms(this)}},i.Oa=function(t){this.g&&(this.response=this.responseText=t,Mt(this))},i.Na=function(t){this.g&&(this.response=t,Mt(this))},i.ga=function(){this.g&&Mt(this)};function Mt(t){t.readyState=4,t.l=null,t.j=null,t.B=null,Nt(t)}i.setRequestHeader=function(t,r){this.A.append(t,r)},i.getResponseHeader=function(t){return this.h&&this.h.get(t.toLowerCase())||""},i.getAllResponseHeaders=function(){if(!this.h)return"";const t=[],r=this.h.entries();for(var a=r.next();!a.done;)a=a.value,t.push(a[0]+": "+a[1]),a=r.next();return t.join(`\r
`)};function Nt(t){t.onreadystatechange&&t.onreadystatechange.call(t)}Object.defineProperty(li.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(t){this.m=t?"include":"same-origin"}});function Ns(t){let r="";return it(t,function(a,d){r+=d,r+=":",r+=a,r+=`\r
`}),r}function dn(t,r,a){e:{for(d in a){var d=!1;break e}d=!0}d||(a=Ns(a),typeof t=="string"?a!=null&&At(a):H(t,r,a))}function K(t){te.call(this),this.headers=new Map,this.L=t||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}b(K,te);var da=/^https?$/i,ua=["POST","PUT"];i=K.prototype,i.Fa=function(t){this.H=t},i.ea=function(t,r,a,d){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+t);r=r?r.toUpperCase():"GET",this.D=t,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():gs.g(),this.g.onreadystatechange=I(p(this.Ca,this));try{this.B=!0,this.g.open(r,String(t),!0),this.B=!1}catch(E){Rs(this,E);return}if(t=a||"",a=new Map(this.headers),d)if(Object.getPrototypeOf(d)===Object.prototype)for(var w in d)a.set(w,d[w]);else if(typeof d.keys=="function"&&typeof d.get=="function")for(const E of d.keys())a.set(E,d.get(E));else throw Error("Unknown input type for opt_headers: "+String(d));d=Array.from(a.keys()).find(E=>E.toLowerCase()=="content-type"),w=c.FormData&&t instanceof c.FormData,!(Array.prototype.indexOf.call(ua,r,void 0)>=0)||d||w||a.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[E,O]of a)this.g.setRequestHeader(E,O);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(t),this.v=!1}catch(E){Rs(this,E)}};function Rs(t,r){t.h=!1,t.g&&(t.j=!0,t.g.abort(),t.j=!1),t.l=r,t.o=5,$s(t),ci(t)}function $s(t){t.A||(t.A=!0,ie(t,"complete"),ie(t,"error"))}i.abort=function(t){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=t||7,ie(this,"complete"),ie(this,"abort"),ci(this))},i.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),ci(this,!0)),K.Z.N.call(this)},i.Ca=function(){this.u||(this.B||this.v||this.j?Bs(this):this.Xa())},i.Xa=function(){Bs(this)};function Bs(t){if(t.h&&typeof l<"u"){if(t.v&&Se(t)==4)setTimeout(t.Ca.bind(t),0);else if(ie(t,"readystatechange"),Se(t)==4){t.h=!1;try{const E=t.ca();e:switch(E){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var r=!0;break e;default:r=!1}var a;if(!(a=r)){var d;if(d=E===0){let O=String(t.D).match(As)[1]||null;!O&&c.self&&c.self.location&&(O=c.self.location.protocol.slice(0,-1)),d=!da.test(O?O.toLowerCase():"")}a=d}if(a)ie(t,"complete"),ie(t,"success");else{t.o=6;try{var w=Se(t)>2?t.g.statusText:""}catch{w=""}t.l=w+" ["+t.ca()+"]",$s(t)}}finally{ci(t)}}}}function ci(t,r){if(t.g){t.m&&(clearTimeout(t.m),t.m=null);const a=t.g;t.g=null,r||ie(t,"ready");try{a.onreadystatechange=null}catch{}}}i.isActive=function(){return!!this.g};function Se(t){return t.g?t.g.readyState:0}i.ca=function(){try{return Se(this)>2?this.g.status:-1}catch{return-1}},i.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},i.La=function(t){if(this.g){var r=this.g.responseText;return t&&r.indexOf(t)==0&&(r=r.substring(t.length)),Vo(r)}};function Ws(t){try{if(!t.g)return null;if("response"in t.g)return t.g.response;switch(t.F){case"":case"text":return t.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in t.g)return t.g.mozResponseArrayBuffer}return null}catch{return null}}function ha(t){const r={};t=(t.g&&Se(t)>=2&&t.g.getAllResponseHeaders()||"").split(`\r
`);for(let d=0;d<t.length;d++){if(h(t[d]))continue;var a=Xo(t[d]);const w=a[0];if(a=a[1],typeof a!="string")continue;a=a.trim();const E=r[w]||[];r[w]=E,E.push(a)}Re(r,function(d){return d.join(", ")})}i.ya=function(){return this.o},i.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function Rt(t,r,a){return a&&a.internalChannelParams&&a.internalChannelParams[t]||r}function Us(t){this.za=0,this.i=[],this.j=new kt,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=Rt("failFast",!1,t),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=Rt("baseRetryDelayMs",5e3,t),this.Za=Rt("retryDelaySeedMs",1e4,t),this.Ta=Rt("forwardChannelMaxRetries",2,t),this.va=Rt("forwardChannelRequestTimeoutMs",2e4,t),this.ma=t&&t.xmlHttpFactory||void 0,this.Ua=t&&t.Rb||void 0,this.Aa=t&&t.useFetchStreams||!1,this.O=void 0,this.L=t&&t.supportsCrossDomainXhr||!1,this.M="",this.h=new bs(t&&t.concurrentRequestLimit),this.Ba=new ca,this.S=t&&t.fastHandshake||!1,this.R=t&&t.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=t&&t.Pb||!1,t&&t.ua&&this.j.ua(),t&&t.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&t&&t.detectBufferingProxy||!1,this.ia=void 0,t&&t.longPollingTimeout&&t.longPollingTimeout>0&&(this.ia=t.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}i=Us.prototype,i.ka=8,i.I=1,i.connect=function(t,r,a,d){ne(0),this.W=t,this.H=r||{},a&&d!==void 0&&(this.H.OSID=a,this.H.OAID=d),this.F=this.X,this.J=Js(this,null,this.W),ui(this)};function un(t){if(Fs(t),t.I==3){var r=t.V++,a=he(t.J);if(H(a,"SID",t.M),H(a,"RID",r),H(a,"TYPE","terminate"),$t(t,a),r=new Te(t,t.j,r),r.M=2,r.A=ai(he(a)),a=!1,c.navigator&&c.navigator.sendBeacon)try{a=c.navigator.sendBeacon(r.A.toString(),"")}catch{}!a&&c.Image&&(new Image().src=r.A,a=!0),a||(r.g=Xs(r.j,null),r.g.ea(r.A)),r.F=Date.now(),oi(r)}Ks(t)}function di(t){t.g&&(fn(t),t.g.cancel(),t.g=null)}function Fs(t){di(t),t.v&&(c.clearTimeout(t.v),t.v=null),hi(t),t.h.cancel(),t.m&&(typeof t.m=="number"&&c.clearTimeout(t.m),t.m=null)}function ui(t){if(!ws(t.h)&&!t.m){t.m=!0;var r=t.Ea;R||f(),B||(R(),B=!0),y.add(r,t),t.D=0}}function fa(t,r){return Ss(t.h)>=t.h.j-(t.m?1:0)?!1:t.m?(t.i=r.G.concat(t.i),!0):t.I==1||t.I==2||t.D>=(t.Sa?0:t.Ta)?!1:(t.m=Et(p(t.Ea,t,r),Gs(t,t.D)),t.D++,!0)}i.Ea=function(t){if(this.m)if(this.m=null,this.I==1){if(!t){this.V=Math.floor(Math.random()*1e5),t=this.V++;const w=new Te(this,this.j,t);let E=this.o;if(this.U&&(E?(E=$e(E),Tt(E,this.U)):E=this.U),this.u!==null||this.R||(w.J=E,E=null),this.S)e:{for(var r=0,a=0;a<this.i.length;a++){t:{var d=this.i[a];if("__data__"in d.map&&(d=d.map.__data__,typeof d=="string")){d=d.length;break t}d=void 0}if(d===void 0)break;if(r+=d,r>4096){r=a;break e}if(r===4096||a===this.i.length-1){r=a+1;break e}}r=1e3}else r=1e3;r=js(this,w,r),a=he(this.J),H(a,"RID",t),H(a,"CVER",22),this.G&&H(a,"X-HTTP-Session-Id",this.G),$t(this,a),E&&(this.R?r="headers="+At(Ns(E))+"&"+r:this.u&&dn(a,this.u,E)),an(this.h,w),this.Ra&&H(a,"TYPE","init"),this.S?(H(a,"$req",r),H(a,"SID","null"),w.U=!0,nn(w,a,null)):nn(w,a,r),this.I=2}}else this.I==3&&(t?Vs(this,t):this.i.length==0||ws(this.h)||Vs(this))};function Vs(t,r){var a;r?a=r.l:a=t.V++;const d=he(t.J);H(d,"SID",t.M),H(d,"RID",a),H(d,"AID",t.K),$t(t,d),t.u&&t.o&&dn(d,t.u,t.o),a=new Te(t,t.j,a,t.D+1),t.u===null&&(a.J=t.o),r&&(t.i=r.G.concat(t.i)),r=js(t,a,1e3),a.H=Math.round(t.va*.5)+Math.round(t.va*.5*Math.random()),an(t.h,a),nn(a,d,r)}function $t(t,r){t.H&&it(t.H,function(a,d){H(r,d,a)}),t.l&&it({},function(a,d){H(r,d,a)})}function js(t,r,a){a=Math.min(t.i.length,a);const d=t.l?p(t.l.Ka,t.l,t):null;e:{var w=t.i;let $=-1;for(;;){const Y=["count="+a];$==-1?a>0?($=w[0].g,Y.push("ofs="+$)):$=0:Y.push("ofs="+$);let z=!0;for(let ee=0;ee<a;ee++){var E=w[ee].g;const fe=w[ee].map;if(E-=$,E<0)$=Math.max(0,w[ee].g-100),z=!1;else try{E="req"+E+"_"||"";try{var O=fe instanceof Map?fe:Object.entries(fe);for(const[Fe,Ee]of O){let ke=Ee;u(Ee)&&(ke=Ji(Ee)),Y.push(E+Fe+"="+encodeURIComponent(ke))}}catch(Fe){throw Y.push(E+"type="+encodeURIComponent("_badmap")),Fe}}catch{d&&d(fe)}}if(z){O=Y.join("&");break e}}O=void 0}return t=t.i.splice(0,a),r.G=t,O}function qs(t){if(!t.g&&!t.v){t.Y=1;var r=t.Da;R||f(),B||(R(),B=!0),y.add(r,t),t.A=0}}function hn(t){return t.g||t.v||t.A>=3?!1:(t.Y++,t.v=Et(p(t.Da,t),Gs(t,t.A)),t.A++,!0)}i.Da=function(){if(this.v=null,zs(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var t=4*this.T;this.j.info("BP detection timer enabled: "+t),this.B=Et(p(this.Wa,this),t)}},i.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,ne(10),di(this),zs(this))};function fn(t){t.B!=null&&(c.clearTimeout(t.B),t.B=null)}function zs(t){t.g=new Te(t,t.j,"rpc",t.Y),t.u===null&&(t.g.J=t.o),t.g.P=0;var r=he(t.na);H(r,"RID","rpc"),H(r,"SID",t.M),H(r,"AID",t.K),H(r,"CI",t.F?"0":"1"),!t.F&&t.ia&&H(r,"TO",t.ia),H(r,"TYPE","xmlhttp"),$t(t,r),t.u&&t.o&&dn(r,t.u,t.o),t.O&&(t.g.H=t.O);var a=t.g;t=t.ba,a.M=1,a.A=ai(he(r)),a.u=null,a.R=!0,_s(a,t)}i.Va=function(){this.C!=null&&(this.C=null,di(this),hn(this),ne(19))};function hi(t){t.C!=null&&(c.clearTimeout(t.C),t.C=null)}function Hs(t,r){var a=null;if(t.g==r){hi(t),fn(t),t.g=null;var d=2}else if(on(t.h,r))a=r.G,Es(t.h,r),d=1;else return;if(t.I!=0){if(r.o)if(d==1){a=r.u?r.u.length:0,r=Date.now()-r.F;var w=t.D;d=Qi(),ie(d,new ps(d,a)),ui(t)}else qs(t);else if(w=r.m,w==3||w==0&&r.X>0||!(d==1&&fa(t,r)||d==2&&hn(t)))switch(a&&a.length>0&&(r=t.h,r.i=r.i.concat(a)),w){case 1:Ue(t,5);break;case 4:Ue(t,10);break;case 3:Ue(t,6);break;default:Ue(t,2)}}}function Gs(t,r){let a=t.Qa+Math.floor(Math.random()*t.Za);return t.isActive()||(a*=2),a*r}function Ue(t,r){if(t.j.info("Error code "+r),r==2){var a=p(t.bb,t),d=t.Ua;const w=!d;d=new be(d||"//www.google.com/images/cleardot.gif"),c.location&&c.location.protocol=="http"||Ot(d,"https"),ai(d),w?aa(d.toString(),a):la(d.toString(),a)}else ne(2);t.I=0,t.l&&t.l.pa(r),Ks(t),Fs(t)}i.bb=function(t){t?(this.j.info("Successfully pinged google.com"),ne(2)):(this.j.info("Failed to ping google.com"),ne(1))};function Ks(t){if(t.I=0,t.ja=[],t.l){const r=ks(t.h);(r.length!=0||t.i.length!=0)&&(x(t.ja,r),x(t.ja,t.i),t.h.i.length=0,k(t.i),t.i.length=0),t.l.oa()}}function Js(t,r,a){var d=a instanceof be?he(a):new be(a);if(d.g!="")r&&(d.g=r+"."+d.g),Dt(d,d.u);else{var w=c.location;d=w.protocol,r=r?r+"."+w.hostname:w.hostname,w=+w.port;const E=new be(null);d&&Ot(E,d),r&&(E.g=r),w&&Dt(E,w),a&&(E.h=a),d=E}return a=t.G,r=t.wa,a&&r&&H(d,a,r),H(d,"VER",t.ka),$t(t,d),d}function Xs(t,r,a){if(r&&!t.L)throw Error("Can't create secondary domain capable XhrIo object.");return r=t.Aa&&!t.ma?new K(new cn({ab:a})):new K(t.ma),r.Fa(t.L),r}i.isActive=function(){return!!this.l&&this.l.isActive(this)};function Ys(){}i=Ys.prototype,i.ra=function(){},i.qa=function(){},i.pa=function(){},i.oa=function(){},i.isActive=function(){return!0},i.Ka=function(){};function le(t,r){te.call(this),this.g=new Us(r),this.l=t,this.h=r&&r.messageUrlParams||null,t=r&&r.messageHeaders||null,r&&r.clientProtocolHeaderRequired&&(t?t["X-Client-Protocol"]="webchannel":t={"X-Client-Protocol":"webchannel"}),this.g.o=t,t=r&&r.initMessageHeaders||null,r&&r.messageContentType&&(t?t["X-WebChannel-Content-Type"]=r.messageContentType:t={"X-WebChannel-Content-Type":r.messageContentType}),r&&r.sa&&(t?t["X-WebChannel-Client-Profile"]=r.sa:t={"X-WebChannel-Client-Profile":r.sa}),this.g.U=t,(t=r&&r.Qb)&&!h(t)&&(this.g.u=t),this.A=r&&r.supportsCrossDomainXhr||!1,this.v=r&&r.sendRawJson||!1,(r=r&&r.httpSessionIdParam)&&!h(r)&&(this.g.G=r,t=this.h,t!==null&&r in t&&(t=this.h,r in t&&delete t[r])),this.j=new at(this)}b(le,te),le.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},le.prototype.close=function(){un(this.g)},le.prototype.o=function(t){var r=this.g;if(typeof t=="string"){var a={};a.__data__=t,t=a}else this.v&&(a={},a.__data__=Ji(t),t=a);r.i.push(new Zo(r.Ya++,t)),r.I==3&&ui(r)},le.prototype.N=function(){this.g.l=null,delete this.j,un(this.g),delete this.g,le.Z.N.call(this)};function Qs(t){Xi.call(this),t.__headers__&&(this.headers=t.__headers__,this.statusCode=t.__status__,delete t.__headers__,delete t.__status__);var r=t.__sm__;if(r){e:{for(const a in r){t=a;break e}t=void 0}(this.i=t)&&(t=this.i,r=r!==null&&t in r?r[t]:void 0),this.data=r}else this.data=t}b(Qs,Xi);function Zs(){Yi.call(this),this.status=1}b(Zs,Yi);function at(t){this.g=t}b(at,Ys),at.prototype.ra=function(){ie(this.g,"a")},at.prototype.qa=function(t){ie(this.g,new Qs(t))},at.prototype.pa=function(t){ie(this.g,new Zs)},at.prototype.oa=function(){ie(this.g,"b")},le.prototype.send=le.prototype.o,le.prototype.open=le.prototype.m,le.prototype.close=le.prototype.close,Zi.NO_ERROR=0,Zi.TIMEOUT=8,Zi.HTTP_ERROR=6,Jo.COMPLETE="complete",qo.EventType=wt,wt.OPEN="a",wt.CLOSE="b",wt.ERROR="c",wt.MESSAGE="d",te.prototype.listen=te.prototype.J,K.prototype.listenOnce=K.prototype.K,K.prototype.getLastError=K.prototype.Ha,K.prototype.getLastErrorCode=K.prototype.ya,K.prototype.getStatus=K.prototype.ca,K.prototype.getResponseJson=K.prototype.La,K.prototype.getResponseText=K.prototype.la,K.prototype.send=K.prototype.ea,K.prototype.setWithCredentials=K.prototype.Fa}).apply(typeof mi<"u"?mi:typeof self<"u"?self:typeof window<"u"?window:{});/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let $i="12.12.0";function Vl(i){$i=i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wi=new Un("@firebase/firestore");function ue(i,...e){if(wi.logLevel<=q.DEBUG){const n=e.map(no);wi.debug(`Firestore (${$i}): ${i}`,...n)}}function io(i,...e){if(wi.logLevel<=q.ERROR){const n=e.map(no);wi.error(`Firestore (${$i}): ${i}`,...n)}}function no(i){if(typeof i=="string")return i;try{return function(n){return JSON.stringify(n)}(i)}catch{return i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Si(i,e,n){let s="Unexpected state";typeof e=="string"?s=e:n=e,so(i,s,n)}function so(i,e,n){let s=`FIRESTORE (${$i}) INTERNAL ASSERTION FAILED: ${e} (ID: ${i.toString(16)})`;if(n!==void 0)try{s+=" CONTEXT: "+JSON.stringify(n)}catch{s+=" CONTEXT: "+n}throw io(s),new Error(s)}function Wt(i,e,n,s){let o="Unexpected state";typeof n=="string"?o=n:s=n,i||so(e,o,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const V={CANCELLED:"cancelled",INVALID_ARGUMENT:"invalid-argument",FAILED_PRECONDITION:"failed-precondition"};class j extends Me{constructor(e,n){super(e,n),this.code=e,this.message=n,this.toString=()=>`${this.name}: [code=${this.code}]: ${this.message}`}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jl{constructor(e,n){this.user=n,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class ql{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,n){e.enqueueRetryable(()=>n(re.UNAUTHENTICATED))}shutdown(){}}class zl{constructor(e){this.t=e,this.currentUser=re.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,n){Wt(this.o===void 0,42304);let s=this.i;const o=m=>this.i!==s?(s=this.i,n(m)):Promise.resolve();let l=new Ut;this.o=()=>{this.i++,this.currentUser=this.u(),l.resolve(),l=new Ut,e.enqueueRetryable(()=>o(this.currentUser))};const c=()=>{const m=l;e.enqueueRetryable(async()=>{await m.promise,await o(this.currentUser)})},u=m=>{ue("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=m,this.o&&(this.auth.addAuthTokenListener(this.o),c())};this.t.onInit(m=>u(m)),setTimeout(()=>{if(!this.auth){const m=this.t.getImmediate({optional:!0});m?u(m):(ue("FirebaseAuthCredentialsProvider","Auth not yet detected"),l.resolve(),l=new Ut)}},0),c()}getToken(){const e=this.i,n=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(n).then(s=>this.i!==e?(ue("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):s?(Wt(typeof s.accessToken=="string",31837,{l:s}),new jl(s.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return Wt(e===null||typeof e=="string",2055,{h:e}),new re(e)}}class Hl{constructor(e,n,s){this.P=e,this.T=n,this.I=s,this.type="FirstParty",this.user=re.FIRST_PARTY,this.R=new Map}A(){return this.I?this.I():null}get headers(){this.R.set("X-Goog-AuthUser",this.P);const e=this.A();return e&&this.R.set("Authorization",e),this.T&&this.R.set("X-Goog-Iam-Authorization-Token",this.T),this.R}}class Gl{constructor(e,n,s){this.P=e,this.T=n,this.I=s}getToken(){return Promise.resolve(new Hl(this.P,this.T,this.I))}start(e,n){e.enqueueRetryable(()=>n(re.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class ur{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class Kl{constructor(e,n){this.V=n,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,Ve(e)&&e.settings.appCheckToken&&(this.p=e.settings.appCheckToken)}start(e,n){Wt(this.o===void 0,3512);const s=l=>{l.error!=null&&ue("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${l.error.message}`);const c=l.token!==this.m;return this.m=l.token,ue("FirebaseAppCheckTokenProvider",`Received ${c?"new":"existing"} token.`),c?n(l.token):Promise.resolve()};this.o=l=>{e.enqueueRetryable(()=>s(l))};const o=l=>{ue("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=l,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit(l=>o(l)),setTimeout(()=>{if(!this.appCheck){const l=this.V.getImmediate({optional:!0});l?o(l):ue("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){if(this.p)return Promise.resolve(new ur(this.p));const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(n=>n?(Wt(typeof n.token=="string",44558,{tokenResult:n}),this.m=n.token,new ur(n.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hr="__name__";class me{constructor(e,n,s){n===void 0?n=0:n>e.length&&Si(637,{offset:n,range:e.length}),s===void 0?s=e.length-n:s>e.length-n&&Si(1746,{length:s,range:e.length-n}),this.segments=e,this.offset=n,this.len=s}get length(){return this.len}isEqual(e){return me.comparator(this,e)===0}child(e){const n=this.segments.slice(this.offset,this.limit());return e instanceof me?e.forEach(s=>{n.push(s)}):n.push(e),this.construct(n)}limit(){return this.offset+this.length}popFirst(e){return e=e===void 0?1:e,this.construct(this.segments,this.offset+e,this.length-e)}popLast(){return this.construct(this.segments,this.offset,this.length-1)}firstSegment(){return this.segments[this.offset]}lastSegment(){return this.get(this.length-1)}get(e){return this.segments[this.offset+e]}isEmpty(){return this.length===0}isPrefixOf(e){if(e.length<this.length)return!1;for(let n=0;n<this.length;n++)if(this.get(n)!==e.get(n))return!1;return!0}isImmediateParentOf(e){if(this.length+1!==e.length)return!1;for(let n=0;n<this.length;n++)if(this.get(n)!==e.get(n))return!1;return!0}forEach(e){for(let n=this.offset,s=this.limit();n<s;n++)e(this.segments[n])}toArray(){return this.segments.slice(this.offset,this.limit())}static comparator(e,n){const s=Math.min(e.length,n.length);for(let o=0;o<s;o++){const l=me.compareSegments(e.get(o),n.get(o));if(l!==0)return l}return Ce(e.length,n.length)}static compareSegments(e,n){const s=me.isNumericId(e),o=me.isNumericId(n);return s&&!o?-1:!s&&o?1:s&&o?me.extractNumericId(e).compare(me.extractNumericId(n)):Yl(e,n)}static isNumericId(e){return e.startsWith("__id")&&e.endsWith("__")}static extractNumericId(e){return jn.fromString(e.substring(4,e.length-2))}}class de extends me{construct(e,n,s){return new de(e,n,s)}canonicalString(){return this.toArray().join("/")}toString(){return this.canonicalString()}toUriEncodedString(){return this.toArray().map(encodeURIComponent).join("/")}static fromString(...e){const n=[];for(const s of e){if(s.indexOf("//")>=0)throw new j(V.INVALID_ARGUMENT,`Invalid segment (${s}). Paths must not contain // in them.`);n.push(...s.split("/").filter(o=>o.length>0))}return new de(n)}static emptyPath(){return new de([])}}const ec=/^[_a-zA-Z][_a-zA-Z0-9]*$/;class je extends me{construct(e,n,s){return new je(e,n,s)}static isValidIdentifier(e){return ec.test(e)}canonicalString(){return this.toArray().map(e=>(e=e.replace(/\\/g,"\\\\").replace(/`/g,"\\`"),je.isValidIdentifier(e)||(e="`"+e+"`"),e)).join(".")}toString(){return this.canonicalString()}isKeyField(){return this.length===1&&this.get(0)===hr}static keyField(){return new je([hr])}static fromServerFormat(e){const n=[];let s="",o=0;const l=()=>{if(s.length===0)throw new j(V.INVALID_ARGUMENT,`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);n.push(s),s=""};let c=!1;for(;o<e.length;){const u=e[o];if(u==="\\"){if(o+1===e.length)throw new j(V.INVALID_ARGUMENT,"Path has trailing escape character: "+e);const m=e[o+1];if(m!=="\\"&&m!=="."&&m!=="`")throw new j(V.INVALID_ARGUMENT,"Path has invalid escape sequence: "+e);s+=m,o+=2}else u==="`"?(c=!c,o++):u!=="."||c?(s+=u,o++):(l(),o++)}if(l(),c)throw new j(V.INVALID_ARGUMENT,"Unterminated ` in path: "+e);return new je(n)}static emptyPath(){return new je([])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qe{constructor(e){this.path=e}static fromPath(e){return new qe(de.fromString(e))}static fromName(e){return new qe(de.fromString(e).popFirst(5))}static empty(){return new qe(de.emptyPath())}get collectionGroup(){return this.path.popLast().lastSegment()}hasCollectionId(e){return this.path.length>=2&&this.path.get(this.path.length-2)===e}getCollectionGroup(){return this.path.get(this.path.length-2)}getCollectionPath(){return this.path.popLast()}isEqual(e){return e!==null&&de.comparator(this.path,e.path)===0}toString(){return this.path.toString()}static comparator(e,n){return de.comparator(e.path,n.path)}static isDocumentKey(e){return e.length%2==0}static fromSegments(e){return new qe(new de(e.slice()))}}function tc(i,e,n,s){if(e===!0&&s===!0)throw new j(V.INVALID_ARGUMENT,`${i} and ${n} cannot be used together.`)}function ic(i){return typeof i=="object"&&i!==null&&(Object.getPrototypeOf(i)===Object.prototype||Object.getPrototypeOf(i)===null)}/**
 * @license
 * Copyright 2025 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function J(i,e){const n={typeString:i};return e&&(n.value=e),n}function ei(i,e){if(!ic(i))throw new j(V.INVALID_ARGUMENT,"JSON must be an object");let n;for(const s in e)if(e[s]){const o=e[s].typeString,l="value"in e[s]?{value:e[s].value}:void 0;if(!(s in i)){n=`JSON missing required field: '${s}'`;break}const c=i[s];if(o&&typeof c!==o){n=`JSON field '${s}' must be a ${o}.`;break}if(l!==void 0&&c!==l.value){n=`Expected '${s}' field to equal '${l.value}'`;break}}if(n)throw new j(V.INVALID_ARGUMENT,n);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const br="AsyncQueue";class wr{constructor(e=Promise.resolve()){this.Yu=[],this.ec=!1,this.tc=[],this.nc=null,this.rc=!1,this.sc=!1,this.oc=[],this.M_=new dc(this,"async_queue_retry"),this._c=()=>{const s=Tn();s&&ue(br,"Visibility state changed to "+s.visibilityState),this.M_.w_()},this.ac=e;const n=Tn();n&&typeof n.addEventListener=="function"&&n.addEventListener("visibilitychange",this._c)}get isShuttingDown(){return this.ec}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.uc(),this.cc(e)}enterRestrictedMode(e){if(!this.ec){this.ec=!0,this.sc=e||!1;const n=Tn();n&&typeof n.removeEventListener=="function"&&n.removeEventListener("visibilitychange",this._c)}}enqueue(e){if(this.uc(),this.ec)return new Promise(()=>{});const n=new Ut;return this.cc(()=>this.ec&&this.sc?Promise.resolve():(e().then(n.resolve,n.reject),n.promise)).then(()=>n.promise)}enqueueRetryable(e){this.enqueueAndForget(()=>(this.Yu.push(e),this.lc()))}async lc(){if(this.Yu.length!==0){try{await this.Yu[0](),this.Yu.shift(),this.M_.reset()}catch(e){if(!nc(e))throw e;ue(br,"Operation failed with retryable error: "+e)}this.Yu.length>0&&this.M_.p_(()=>this.lc())}}cc(e){const n=this.ac.then(()=>(this.rc=!0,e().catch(s=>{throw this.nc=s,this.rc=!1,io("INTERNAL UNHANDLED ERROR: ",Sr(s)),s}).then(s=>(this.rc=!1,s))));return this.ac=n,n}enqueueAfterDelay(e,n,s){this.uc(),this.oc.indexOf(e)>-1&&(n=0);const o=qn.createAndSchedule(this,e,n,s,l=>this.hc(l));return this.tc.push(o),o}uc(){this.nc&&Si(47125,{Pc:Sr(this.nc)})}verifyOperationInProgress(){}async Tc(){let e;do e=this.ac,await e;while(e!==this.ac)}Ec(e){for(const n of this.tc)if(n.timerId===e)return!0;return!1}Ic(e){return this.Tc().then(()=>{this.tc.sort((n,s)=>n.targetTimeMs-s.targetTimeMs);for(const n of this.tc)if(n.skipDelay(),e!=="all"&&n.timerId===e)break;return this.Tc()})}Rc(e){this.oc.push(e)}hc(e){const n=this.tc.indexOf(e);this.tc.splice(n,1)}}function Sr(i){let e=i.message||"";return i.stack&&(e=i.stack.includes(i.message)?i.stack:i.message+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ro{constructor(...e){for(let n=0;n<e.length;++n)if(e[n].length===0)throw new j(V.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new je(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class He{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new j(V.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new j(V.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return Ce(this._lat,e._lat)||Ce(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:He._jsonSchemaVersion}}static fromJSON(e){if(ei(e,He._jsonSchema))return new He(e.latitude,e.longitude)}}He._jsonSchemaVersion="firestore/geoPoint/1.0",He._jsonSchema={type:J("string",He._jsonSchemaVersion),latitude:J("number"),longitude:J("number")};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ge{constructor(e){this._values=(e||[]).map(n=>n)}toArray(){return this._values.map(e=>e)}isEqual(e){return function(s,o){if(s.length!==o.length)return!1;for(let l=0;l<s.length;++l)if(s[l]!==o[l])return!1;return!0}(this._values,e._values)}toJSON(){return{type:Ge._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(ei(e,Ge._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every(n=>typeof n=="number"))return new Ge(e.vectorValues);throw new j(V.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}Ge._jsonSchemaVersion="firestore/vectorValue/1.0",Ge._jsonSchema={type:J("string",Ge._jsonSchemaVersion),vectorValues:J("object")};function oo(i,e,n){if((e=Zt(e))instanceof ro)return e._internalPath;if(typeof e=="string")return vc(i,e);throw Ln("Field path arguments must be of type string or ",i)}const gc=new RegExp("[~\\*/\\[\\]]");function vc(i,e,n){if(e.search(gc)>=0)throw Ln(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,i);try{return new ro(...e.split("."))._internalPath}catch{throw Ln(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,i)}}function Ln(i,e,n,s,o){let l=`Function ${e}() called with invalid data`;l+=". ";let c="";return new j(V.INVALID_ARGUMENT,l+i+c)}const Er="@firebase/firestore",kr="4.14.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ao{constructor(e,n,s,o,l){this._firestore=e,this._userDataWriter=n,this._key=s,this._document=o,this._converter=l}get id(){return this._key.path.lastSegment()}get ref(){return new ge(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const e=new yc(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}_fieldsProto(){var e;return((e=this._document)==null?void 0:e.data.clone().value.mapValue.fields)??void 0}get(e){if(this._document){const n=this._document.data.field(oo("DocumentSnapshot.get",e));if(n!==null)return this._userDataWriter.convertValue(n)}}}class yc extends ao{data(){return super.data()}}class pi{constructor(e,n){this.hasPendingWrites=e,this.fromCache=n}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class ct extends ao{constructor(e,n,s,o,l,c){super(e,n,s,o,c),this._firestore=e,this._firestoreImpl=e,this.metadata=l}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const n=new _i(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(n,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,n={}){if(this._document){const s=this._document.data.field(oo("DocumentSnapshot.get",e));if(s!==null)return this._userDataWriter.convertValue(s,n.serverTimestamps)}}toJSON(){if(this.metadata.hasPendingWrites)throw new j(V.FAILED_PRECONDITION,"DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const e=this._document,n={};return n.type=ct._jsonSchemaVersion,n.bundle="",n.bundleSource="DocumentSnapshot",n.bundleName=this._key.toString(),!e||!e.isValidDocument()||!e.isFoundDocument()?n:(this._userDataWriter.convertObjectMap(e.data.value.mapValue.fields,"previous"),n.bundle=(this._firestore,this.ref.path,"NOT SUPPORTED"),n)}}ct._jsonSchemaVersion="firestore/documentSnapshot/1.0",ct._jsonSchema={type:J("string",ct._jsonSchemaVersion),bundleSource:J("string","DocumentSnapshot"),bundleName:J("string"),bundle:J("string")};class _i extends ct{data(e={}){return super.data(e)}}class Ft{constructor(e,n,s,o){this._firestore=e,this._userDataWriter=n,this._snapshot=o,this.metadata=new pi(o.hasPendingWrites,o.fromCache),this.query=s}get docs(){const e=[];return this.forEach(n=>e.push(n)),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,n){this._snapshot.docs.forEach(s=>{e.call(n,new _i(this._firestore,this._userDataWriter,s.key,s,new pi(this._snapshot.mutatedKeys.has(s.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){const n=!!e.includeMetadataChanges;if(n&&this._snapshot.excludesMetadataChanges)throw new j(V.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===n||(this._cachedChanges=function(o,l){if(o._snapshot.oldDocs.isEmpty()){let c=0;return o._snapshot.docChanges.map(u=>{const m=new _i(o._firestore,o._userDataWriter,u.doc.key,u.doc,new pi(o._snapshot.mutatedKeys.has(u.doc.key),o._snapshot.fromCache),o.query.converter);return u.doc,{type:"added",doc:m,oldIndex:-1,newIndex:c++}})}{let c=o._snapshot.oldDocs;return o._snapshot.docChanges.filter(u=>l||u.type!==3).map(u=>{const m=new _i(o._firestore,o._userDataWriter,u.doc.key,u.doc,new pi(o._snapshot.mutatedKeys.has(u.doc.key),o._snapshot.fromCache),o.query.converter);let p=-1,S=-1;return u.type!==0&&(p=c.indexOf(u.doc.key),c=c.delete(u.doc.key)),u.type!==1&&(c=c.add(u.doc),S=c.indexOf(u.doc.key)),{type:_c(u.type),doc:m,oldIndex:p,newIndex:S}})}}(this,n),this._cachedChangesIncludeMetadataChanges=n),this._cachedChanges}toJSON(){if(this.metadata.hasPendingWrites)throw new j(V.FAILED_PRECONDITION,"QuerySnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const e={};e.type=Ft._jsonSchemaVersion,e.bundleSource="QuerySnapshot",e.bundleName=Xl.newId(),this._firestore._databaseId.database,this._firestore._databaseId.projectId;const n=[],s=[],o=[];return this.docs.forEach(l=>{l._document!==null&&(n.push(l._document),s.push(this._userDataWriter.convertObjectMap(l._document.data.value.mapValue.fields,"previous")),o.push(l.ref.path))}),e.bundle=(this._firestore,this.query._query,e.bundleName,"NOT SUPPORTED"),e}}function _c(i){switch(i){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return Si(61501,{type:i})}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Ft._jsonSchemaVersion="firestore/querySnapshot/1.0",Ft._jsonSchema={type:J("string",Ft._jsonSchemaVersion),bundleSource:J("string","QuerySnapshot"),bundleName:J("string"),bundle:J("string")};(function(e,n=!0){Vl(Ri),mt(new ft("firestore",(s,{instanceIdentifier:o,options:l})=>{const c=s.getProvider("app").getImmediate(),u=new pc(new zl(s.getProvider("auth-internal")),new Kl(c,s.getProvider("app-check-internal")),rc(c,o),c);return l={useFetchStreams:n,...l},u._setSettings(l),u},"PUBLIC").setMultipleInstances(!0)),Pe(Er,kr,e),Pe(Er,kr,"esm2020")})();function lo(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Ic=lo,co=new Qt("auth","Firebase",lo());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ki=new Un("@firebase/auth");function Tc(i,...e){ki.logLevel<=q.WARN&&ki.warn(`Auth (${Ri}): ${i}`,...e)}function Ii(i,...e){ki.logLevel<=q.ERROR&&ki.error(`Auth (${Ri}): ${i}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ar(i,...e){throw Gn(i,...e)}function uo(i,...e){return Gn(i,...e)}function ho(i,e,n){const s={...Ic(),[e]:n};return new Qt("auth","Firebase",s).create(e,{appName:i.name})}function Ti(i){return ho(i,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function Gn(i,...e){if(typeof i!="string"){const n=e[0],s=[...e.slice(1)];return s[0]&&(s[0].appName=i.name),i._errorFactory.create(n,...s)}return co.create(i,...e)}function F(i,e,...n){if(!i)throw Gn(e,...n)}function Vt(i){const e="INTERNAL ASSERTION FAILED: "+i;throw Ii(e),new Error(e)}function Ai(i,e){i||Vt(e)}function bc(){return xr()==="http:"||xr()==="https:"}function xr(){var i;return typeof self<"u"&&((i=self.location)==null?void 0:i.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wc(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(bc()||ka()||"connection"in navigator)?navigator.onLine:!0}function Sc(){if(typeof navigator>"u")return null;const i=navigator;return i.languages&&i.languages[0]||i.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ti{constructor(e,n){this.shortDelay=e,this.longDelay=n,Ai(n>e,"Short delay should be less than long delay!"),this.isMobile=Sa()||Aa()}get(){return wc()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ec(i,e){Ai(i.emulator,"Emulator should always be set here");const{url:n}=i.emulator;return e?`${n}${e.startsWith("/")?e.slice(1):e}`:n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ac=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],xc=new ti(3e4,6e4);function mo(i,e){return i.tenantId&&!e.tenantId?{...e,tenantId:i.tenantId}:e}async function Bi(i,e,n,s,o={}){return po(i,o,async()=>{let l={},c={};s&&(e==="GET"?c=s:l={body:JSON.stringify(s)});const u=Xr({key:i.config.apiKey,...c}).slice(1),m=await i._getAdditionalHeaders();m["Content-Type"]="application/json",i.languageCode&&(m["X-Firebase-Locale"]=i.languageCode);const p={method:e,headers:m,...l};return Ea()||(p.referrerPolicy="no-referrer"),i.emulatorConfig&&Yr(i.emulatorConfig.host)&&(p.credentials="include"),fo.fetch()(await go(i,i.config.apiHost,n,u),p)})}async function po(i,e,n){i._canInitEmulator=!1;const s={...kc,...e};try{const o=new Oc(i),l=await Promise.race([n(),o.promise]);o.clearNetworkTimeout();const c=await l.json();if("needConfirmation"in c)throw gi(i,"account-exists-with-different-credential",c);if(l.ok&&!("errorMessage"in c))return c;{const u=l.ok?c.errorMessage:c.error.message,[m,p]=u.split(" : ");if(m==="FEDERATED_USER_ID_ALREADY_LINKED")throw gi(i,"credential-already-in-use",c);if(m==="EMAIL_EXISTS")throw gi(i,"email-already-in-use",c);if(m==="USER_DISABLED")throw gi(i,"user-disabled",c);const S=s[m]||m.toLowerCase().replace(/[_\s]+/g,"-");if(p)throw ho(i,S,p);Ar(i,S)}}catch(o){if(o instanceof Me)throw o;Ar(i,"network-request-failed",{message:String(o)})}}async function go(i,e,n,s){const o=`${e}${n}?${s}`,l=i,c=l.config.emulator?Ec(i.config,o):`${i.config.apiScheme}://${o}`;return Ac.includes(n)&&(await l._persistenceManagerAvailable,l._getPersistenceType()==="COOKIE")?l._getPersistence()._getFinalTarget(c).toString():c}class Oc{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,s)=>{this.timer=setTimeout(()=>s(uo(this.auth,"network-request-failed")),xc.get())})}}function gi(i,e,n){const s={appName:i.name};n.email&&(s.email=n.email),n.phoneNumber&&(s.phoneNumber=n.phoneNumber);const o=uo(i,e,s);return o.customData._tokenResponse=n,o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Dc(i,e){return Bi(i,"POST","/v1/accounts:delete",e)}async function xi(i,e){return Bi(i,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jt(i){if(i)try{const e=new Date(Number(i));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Lc(i,e=!1){const n=Zt(i),s=await n.getIdToken(e),o=vo(s);F(o&&o.exp&&o.auth_time&&o.iat,n.auth,"internal-error");const l=typeof o.firebase=="object"?o.firebase:void 0,c=l==null?void 0:l.sign_in_provider;return{claims:o,token:s,authTime:jt(bn(o.auth_time)),issuedAtTime:jt(bn(o.iat)),expirationTime:jt(bn(o.exp)),signInProvider:c||null,signInSecondFactor:(l==null?void 0:l.sign_in_second_factor)||null}}function bn(i){return Number(i)*1e3}function vo(i){const[e,n,s]=i.split(".");if(e===void 0||n===void 0||s===void 0)return Ii("JWT malformed, contained fewer than 3 sections"),null;try{const o=Jr(n);return o?JSON.parse(o):(Ii("Failed to decode base64 JWT payload"),null)}catch(o){return Ii("Caught error parsing JWT payload as JSON",o==null?void 0:o.toString()),null}}function Or(i){const e=vo(i);return F(e,"internal-error"),F(typeof e.exp<"u","internal-error"),F(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Pn(i,e,n=!1){if(n)return e;try{return await e}catch(s){throw s instanceof Me&&Pc(s)&&i.auth.currentUser===i&&await i.auth.signOut(),s}}function Pc({code:i}){return i==="auth/user-disabled"||i==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Oi(i){var b;const e=i.auth,n=await i.getIdToken(),s=await Pn(i,xi(e,{idToken:n}));F(s==null?void 0:s.users.length,e,"internal-error");const o=s.users[0];i._notifyReloadListener(o);const l=(b=o.providerUserInfo)!=null&&b.length?yo(o.providerUserInfo):[],c=Nc(i.providerData,l),u=i.isAnonymous,m=!(i.email&&o.passwordHash)&&!(c!=null&&c.length),p=u?m:!1,S={uid:o.localId,displayName:o.displayName||null,photoURL:o.photoUrl||null,email:o.email||null,emailVerified:o.emailVerified||!1,phoneNumber:o.phoneNumber||null,tenantId:o.tenantId||null,providerData:c,metadata:new Cn(o.createdAt,o.lastLoginAt),isAnonymous:p};Object.assign(i,S)}async function Mc(i){const e=Zt(i);await Oi(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Nc(i,e){return[...i.filter(s=>!e.some(o=>o.providerId===s.providerId)),...e]}function yo(i){return i.map(({providerId:e,...n})=>({providerId:e,uid:n.rawId||"",displayName:n.displayName||null,email:n.email||null,phoneNumber:n.phoneNumber||null,photoURL:n.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ae(i,e){F(typeof i=="string"||typeof i>"u","internal-error",{appName:e})}class ve{constructor({uid:e,auth:n,stsTokenManager:s,...o}){this.providerId="firebase",this.proactiveRefresh=new Cc(this),this.reloadUserInfo=null,this.reloadListener=null,this.uid=e,this.auth=n,this.stsTokenManager=s,this.accessToken=s.accessToken,this.displayName=o.displayName||null,this.email=o.email||null,this.emailVerified=o.emailVerified||!1,this.phoneNumber=o.phoneNumber||null,this.photoURL=o.photoURL||null,this.isAnonymous=o.isAnonymous||!1,this.tenantId=o.tenantId||null,this.providerData=o.providerData?[...o.providerData]:[],this.metadata=new Cn(o.createdAt||void 0,o.lastLoginAt||void 0)}async getIdToken(e){const n=await Pn(this,this.stsTokenManager.getToken(this.auth,e));return F(n,this.auth,"internal-error"),this.accessToken!==n&&(this.accessToken=n,await this.auth._persistUserIfCurrent(this),this.auth._notifyListenersIfCurrent(this)),n}getIdTokenResult(e){return Lc(this,e)}reload(){return Mc(this)}_assign(e){this!==e&&(F(this.uid===e.uid,this.auth,"internal-error"),this.displayName=e.displayName,this.photoURL=e.photoURL,this.email=e.email,this.emailVerified=e.emailVerified,this.phoneNumber=e.phoneNumber,this.isAnonymous=e.isAnonymous,this.tenantId=e.tenantId,this.providerData=e.providerData.map(n=>({...n})),this.metadata._copy(e.metadata),this.stsTokenManager._assign(e.stsTokenManager))}_clone(e){const n=new ve({...this,auth:e,stsTokenManager:this.stsTokenManager._clone()});return n.metadata._copy(this.metadata),n}_onReload(e){F(!this.reloadListener,this.auth,"internal-error"),this.reloadListener=e,this.reloadUserInfo&&(this._notifyReloadListener(this.reloadUserInfo),this.reloadUserInfo=null)}_notifyReloadListener(e){this.reloadListener?this.reloadListener(e):this.reloadUserInfo=e}_startProactiveRefresh(){this.proactiveRefresh._start()}_stopProactiveRefresh(){this.proactiveRefresh._stop()}async _updateTokensIfNecessary(e,n=!1){let s=!1;e.idToken&&e.idToken!==this.stsTokenManager.accessToken&&(this.stsTokenManager.updateFromServerResponse(e),s=!0),n&&await Oi(this),await this.auth._persistUserIfCurrent(this),s&&this.auth._notifyListenersIfCurrent(this)}async delete(){if(Ve(this.auth.app))return Promise.reject(Ti(this.auth));const e=await this.getIdToken();return await Pn(this,Dc(this.auth,{idToken:e})),this.stsTokenManager.clearRefreshToken(),this.auth.signOut()}toJSON(){return{uid:this.uid,email:this.email||void 0,emailVerified:this.emailVerified,displayName:this.displayName||void 0,isAnonymous:this.isAnonymous,photoURL:this.photoURL||void 0,phoneNumber:this.phoneNumber||void 0,tenantId:this.tenantId||void 0,providerData:this.providerData.map(e=>({...e})),stsTokenManager:this.stsTokenManager.toJSON(),_redirectEventId:this._redirectEventId,...this.metadata.toJSON(),apiKey:this.auth.config.apiKey,appName:this.auth.name}}get refreshToken(){return this.stsTokenManager.refreshToken||""}static _fromJSON(e,n){const s=n.displayName??void 0,o=n.email??void 0,l=n.phoneNumber??void 0,c=n.photoURL??void 0,u=n.tenantId??void 0,m=n._redirectEventId??void 0,p=n.createdAt??void 0,S=n.lastLoginAt??void 0,{uid:b,emailVerified:I,isAnonymous:k,providerData:x,stsTokenManager:A}=n;F(b&&A,e,"internal-error");const D=dt.fromJSON(this.name,A);F(typeof b=="string",e,"internal-error"),Ae(s,e.name),Ae(o,e.name),F(typeof I=="boolean",e,"internal-error"),F(typeof k=="boolean",e,"internal-error"),Ae(l,e.name),Ae(c,e.name),Ae(u,e.name),Ae(m,e.name),Ae(p,e.name),Ae(S,e.name);const P=new ve({uid:b,auth:e,email:o,emailVerified:I,displayName:s,isAnonymous:k,photoURL:c,phoneNumber:l,tenantId:u,stsTokenManager:D,createdAt:p,lastLoginAt:S});return x&&Array.isArray(x)&&(P.providerData=x.map(L=>({...L}))),m&&(P._redirectEventId=m),P}static async _fromIdTokenResponse(e,n,s=!1){const o=new dt;o.updateFromServerResponse(n);const l=new ve({uid:n.localId,auth:e,stsTokenManager:o,isAnonymous:s});return await Oi(l),l}static async _fromGetAccountInfoResponse(e,n,s){const o=n.users[0];F(o.localId!==void 0,"internal-error");const l=o.providerUserInfo!==void 0?yo(o.providerUserInfo):[],c=!(o.email&&o.passwordHash)&&!(l!=null&&l.length),u=new dt;u.updateFromIdToken(s);const m=new ve({uid:o.localId,auth:e,stsTokenManager:u,isAnonymous:c}),p={uid:o.localId,displayName:o.displayName||null,photoURL:o.photoUrl||null,email:o.email||null,emailVerified:o.emailVerified||!1,phoneNumber:o.phoneNumber||null,tenantId:o.tenantId||null,providerData:l,metadata:new Cn(o.createdAt,o.lastLoginAt),isAnonymous:!(o.email&&o.passwordHash)&&!(l!=null&&l.length)};return Object.assign(m,p),m}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dr=new Map;function ze(i){Ai(i instanceof Function,"Expected a class definition");let e=Dr.get(i);return e?(Ai(e instanceof i,"Instance stored in cache mismatched with class"),e):(e=new i,Dr.set(i,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pr(i){const e=i.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Fc(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Bc(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(jc(e))return"Blackberry";if(qc(e))return"Webos";if(Wc(e))return"Safari";if((e.includes("chrome/")||Uc(e))&&!e.includes("edge/"))return"Chrome";if(Vc(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=i.match(n);if((s==null?void 0:s.length)===2)return s[1]}return"Other"}function Bc(i=ye()){return/firefox\//i.test(i)}function Wc(i=ye()){const e=i.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Uc(i=ye()){return/crios\//i.test(i)}function Fc(i=ye()){return/iemobile/i.test(i)}function Vc(i=ye()){return/android/i.test(i)}function jc(i=ye()){return/blackberry/i.test(i)}function qc(i=ye()){return/webos/i.test(i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Io(i,e=[]){let n;switch(i){case"Browser":n=Pr(ye());break;case"Worker":n=`${Pr(ye())}-${i}`;break;default:n=i}const s=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Ri}/${s}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Hc(i,e={}){return Bi(i,"GET","/v2/passwordPolicy",mo(i,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zc(i){switch(i){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function ed(i){mt(new ft("auth",(e,{options:n})=>{const s=e.getProvider("app").getImmediate(),o=e.getProvider("heartbeat"),l=e.getProvider("app-check-internal"),{apiKey:c,authDomain:u}=s.options;F(c&&!c.includes(":"),"invalid-api-key",{appName:s.name});const m={apiKey:c,authDomain:u,clientPlatform:i,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Io(i)},p=new Jc(s,o,l,m);return Yc(p,n),p},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,s)=>{e.getProvider("auth-internal").initialize()})),mt(new ft("auth-internal",e=>{const n=Xc(e.getProvider("auth").getImmediate());return(s=>new Qc(s))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),Pe(Mr,Nr,Zc(i)),Pe(Mr,Nr,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const td=5*60;wa("authIdTokenMaxAge");ed("Browser");console.warn("⚠️ Firebase未設定。.envファイルにAPIキーを設定してください。");function pt(i){const e=new Date(i),n=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${n}-${s}-${o}`}function gt(i){const e=new Date(i),n=["日","月","火","水","木","金","土"];return`${e.getMonth()+1}月${e.getDate()}日（${n[e.getDay()]}）`}function Qe(){return pt(new Date)}function Ht(i){const e=Math.floor(i/60),n=i%60;return`${String(e).padStart(2,"0")}:${String(n).padStart(2,"0")}`}function G(i){if(!i)return 0;const[e,n]=i.split(":").map(Number);return e*60+n}function To(){return Date.now().toString(36)+Math.random().toString(36).slice(2,9)}function bo(i,e,n,s){const l=vi(n-i),c=vi(s-e),u=Math.sin(l/2)**2+Math.cos(vi(i))*Math.cos(vi(n))*Math.sin(c/2)**2;return 6371*2*Math.atan2(Math.sqrt(u),Math.sqrt(1-u))}function vi(i){return i*(Math.PI/180)}function Z(i){const e=document.createElement("div");return e.textContent=i,e.innerHTML}function N(i,e="info",n=3e3){const s=document.getElementById("toast-container"),o={success:"check_circle",error:"error",warning:"warning",info:"info"},l=document.createElement("div");l.className=`toast ${e}`,l.innerHTML=`
  ...
  `,s.appendChild(l),setTimeout(()=>{l.style.opacity="0",l.style.transform="translateX(40px)",l.style.transition="all .3s ease",setTimeout(()=>l.remove(),300)},n)}function _t(i,e,n=""){const s=document.getElementById("modal-overlay");document.getElementById("modal-title").textContent=i,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=n,s.style.display="flex"}function se(){document.getElementById("modal-overlay").style.display="none"}function Ze(i,e){return new Promise(n=>{const s=`<p>${Z(e)}</p>`;_t(i,s,`
    ...
    `),document.getElementById("confirm-ok").onclick=()=>{se(),n(!0)},document.getElementById("confirm-cancel").onclick=()=>{se(),n(!1)}})}function wo(i,e){if(!i)return 0;let n=1500;return i.type==="正社員"?i.name.includes("前川")?n=2500:n=1500:i.type==="パート"&&(n=parseInt(i.wage)||1500),Math.round(n*(e/60))}function Di(i,e){const s={身体介護:{20:1670,30:2500,60:3960,90:5790,120:7630},生活援助:{20:1830,45:2250,60:2870},通院等乗降介助:{per_trip:990},医療的ケア:{30:3e3,60:5e3}}[i];if(!s)return 3e3;if(s.per_trip)return s.per_trip;const o=Object.keys(s).map(Number).sort((c,u)=>c-u);let l=o[0];for(const c of o)e>=c&&(l=c);return s[l]||3e3}function id(i){{console.warn("Firebase未設定のためログイン画面を表示します"),setTimeout(()=>i(null,null),100);return}}async function nd(){throw new Error("Firebase未設定です。.envにAPIキーを設定してください。")}async function sd(){}function rd(){const i=document.getElementById("btn-google-login");i&&i.addEventListener("click",async()=>{i.disabled=!0,i.textContent="ログイン中...";try{await nd()}catch(e){console.error("ログインエラー:",e),e.code==="auth/popup-closed-by-user"?N("ログインがキャンセルされました","warning"):N("ログインに失敗しました","error"),i.disabled=!1,i.innerHTML=`
        ...
        Googleアカウントでログイン
      `}})}const Oe={};function It(i){if(!Oe[i]){const e=localStorage.getItem(`careroute_${i}`);Oe[i]=e?JSON.parse(e):[]}return Oe[i]}function Wi(i){localStorage.setItem(`careroute_${i}`,JSON.stringify(Oe[i]||[]))}async function Rr(){localStorage.removeItem("careroute_staff"),localStorage.removeItem("careroute_clients"),localStorage.removeItem("careroute_visits"),localStorage.removeItem("careroute_routes"),Oe.staff=[],Oe.clients=[],Oe.visits=[],Oe.routes=[]}async function Kn(i,e){{const n=To();return It(i).push({id:n,...e,createdAt:new Date().toISOString()}),Wi(i),n}}async function Jn(i){return It(i)}async function Xn(i,e,n){{const s=It(i),o=s.findIndex(l=>l.id===e);o!==-1&&(s[o]={...s[o],...n,updatedAt:new Date().toISOString()},Wi(i));return}}async function Yn(i,e){{const n=It(i),s=n.findIndex(o=>o.id===e);s!==-1&&(n.splice(s,1),Wi(i));return}}async function So(i,e,n,s){return It(i).filter(l=>l[e]===s)}async function ae(){return Jn("staff")}async function Eo(i){return Kn("staff",i)}async function od(i,e){return Xn("staff",i,e)}async function ad(i){return Yn("staff",i)}async function ce(){return Jn("clients")}async function ko(i){return Kn("clients",i)}async function ld(i,e){return Xn("clients",i,e)}async function cd(i){return Yn("clients",i)}async function ii(){return Jn("visits")}async function Ne(i){return So("visits","date","==",i)}async function ni(i){return Kn("visits",i)}async function vt(i,e){return Xn("visits",i,e)}async function Qn(i){return Yn("visits",i)}async function Zn(i){return So("routes","date","==",i)}async function Ao(i){{const e=It("routes");for(const n of i){const s=e.findIndex(o=>o.staffId===n.staffId&&o.date===n.date);s>=0?e[s]={...n,updatedAt:new Date().toISOString()}:e.push({id:To(),...n,createdAt:new Date().toISOString()})}Wi("routes");return}}async function dd(){const i=document.getElementById("page-container"),[e,n]=await Promise.all([ae().catch(()=>[]),ce().catch(()=>[])]),s=Qe(),o=await Ne(s).catch(()=>[]),l=e.filter(b=>b.isActive);n.filter(b=>b.isActive);const c=o.filter(b=>b.type!=="sales");c.filter(b=>b.status==="scheduled"||!b.status);const u=c.filter(b=>b.status==="completed"),m=c.filter(b=>b.status==="cancelled"),p=o.filter(b=>b.type==="sales"),S={};m.forEach(b=>{const I=b.cancelReason||"理由なし";S[I]=(S[I]||0)+1}),i.innerHTML=`
    ...
    <div class="grid grid-2">
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        <div>
          ${l.length===0?'<p style="color:var(--text-muted);text-align:center;padding:20px">職員が登録されていません</p>':l.map(b=>{const I=c.filter(D=>D.staffId===b.id),k=I.filter(D=>D.status==="completed").length,x=I.filter(D=>D.status==="cancelled").length,A=p.filter(D=>D.staffId===b.id).length;return`
  ...
  `}let oe=null,Gt=[],Mn=[],Kt=null,Nn=null,Rn=[];function Ye(){return new Promise((i,e)=>{if(window.google&&window.google.maps){i();return}const n="AIzaSyCXFNBQjeiYpRYFdbs6VhISqlFZhrybM74",s=document.createElement("script");s.src=`https://maps.googleapis.com/maps/api/js?key=${n}&libraries=geometry,places&language=ja`,s.async=!0,s.defer=!0,s.onload=i,s.onerror=()=>e(new Error("Google Maps APIの読み込みに失敗しました")),document.head.appendChild(s)})}function ud(i,e={lat:35.6938,lng:139.7034},n=14){const s=document.getElementById(i);return s?!window.google||!window.google.maps?(s.innerHTML=`
    ...
    `,null):(oe=new google.maps.Map(s,{center:e,zoom:n,mapTypeControl:!0,streetViewControl:!1,fullscreenControl:!0,styles:vd()}),Kt=new google.maps.InfoWindow,Nn=new google.maps.DirectionsService,oe):null}function xo(i,e={}){if(!oe)return null;const n=new google.maps.Marker({map:oe,position:i,title:e.title||"",icon:e.icon||void 0,label:e.label||void 0});return e.infoContent&&n.addListener("click",()=>{Kt.setContent(e.infoContent),Kt.open(oe,n)}),Gt.push(n),n}function $r(i,e,n,s){if(!oe)return null;const o={path:"M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z",fillColor:e,fillOpacity:1,strokeColor:"#fff",strokeWeight:2,scale:1.8,anchor:new google.maps.Point(12,22),labelOrigin:new google.maps.Point(12,9)};return xo(i,{icon:o,label:void 0,infoContent:s})}function hd(i,e){return oe?xo(i,{title:e,icon:{path:"M12 2L2 7v10l10 5 10-5V7L12 2z",fillColor:"#F59E0B",fillOpacity:1,strokeColor:"#fff",strokeWeight:2,scale:2,anchor:new google.maps.Point(12,12)},infoContent:`<div style="color:#333;padding:4px"><strong>🏢 ${e}</strong><br>（出発地点）</div>`}):null}function fd(i,e,n){if(!oe)return null;const s=i.map(l=>({lat:l.lat,lng:l.lng})),o=new google.maps.Polyline({path:s,geodesic:!0,strokeColor:e,strokeOpacity:.8,strokeWeight:4,map:oe});return Mn.push(o),o}async function md(i,e){if(!oe||!Nn||i.length<2)return;const n=i[0],s=i[i.length-1],o=i.slice(1,-1).map(l=>({location:new google.maps.LatLng(l.lat,l.lng),stopover:!0}));try{const l=await new Promise((u,m)=>{Nn.route({origin:new google.maps.LatLng(n.lat,n.lng),destination:new google.maps.LatLng(s.lat,s.lng),waypoints:o,travelMode:google.maps.TravelMode.DRIVING,optimizeWaypoints:!1},(p,S)=>{S==="OK"?u(p):m(new Error(`Directions API: ${S}`))})}),c=new google.maps.DirectionsRenderer({map:oe,directions:l,suppressMarkers:!0,polylineOptions:{strokeColor:e,strokeWeight:4,strokeOpacity:.8}});return Rn.push(c),c}catch(l){return console.warn("Directions API呼び出し失敗。直線ポリラインで代替:",l),fd(i,e)}}async function Li(i){if(!window.google||!window.google.maps)return null;const e=new google.maps.DistanceMatrixService,n=i.map(s=>new google.maps.LatLng(s.lat,s.lng));try{return(await new Promise((l,c)=>{e.getDistanceMatrix({origins:n,destinations:n,travelMode:google.maps.TravelMode.DRIVING,unitSystem:google.maps.UnitSystem.METRIC},(u,m)=>{m==="OK"?l(u):c(new Error(`Distance Matrix API: ${m}`))})})).rows.map(l=>l.elements.map(c=>({distance:c.status==="OK"?c.distance.value/1e3:null,duration:c.status==="OK"?Math.ceil(c.duration.value/60):null})))}catch(s){return console.error("Distance Matrix取得失敗:",s),null}}function pd(){Gt.forEach(i=>i.setMap(null)),Gt=[],Mn.forEach(i=>i.setMap(null)),Mn=[],Rn.forEach(i=>i.setMap(null)),Rn=[],Kt&&Kt.close()}function gd(){if(!oe||Gt.length===0)return;const i=new google.maps.LatLngBounds;Gt.forEach(e=>i.extend(e.getPosition())),oe.fitBounds(i,50)}async function Oo(i){if(!i||i.trim()==="")return null;if(!window.google||!window.google.maps)return console.warn("ジオコーディング: Google Maps APIが未読み込みです"),null;const e=new google.maps.Geocoder;try{return await new Promise((s,o)=>{e.geocode({address:i,region:"jp"},(l,c)=>{if(c==="OK"&&l[0]){const u=l[0].geometry.location;s({lat:u.lat(),lng:u.lng()})}else o(new Error(`ジオコーディング失敗: ${c}`))})})}catch(n){return console.warn("住所の座標変換に失敗:",n.message),null}}function vd(){return[{elementType:"geometry",stylers:[{color:"#1d2c4d"}]},{elementType:"labels.text.fill",stylers:[{color:"#8ec3b9"}]},{elementType:"labels.text.stroke",stylers:[{color:"#1a3646"}]},{featureType:"road",elementType:"geometry",stylers:[{color:"#304a7d"}]},{featureType:"road",elementType:"geometry.stroke",stylers:[{color:"#255763"}]},{featureType:"road.highway",elementType:"geometry",stylers:[{color:"#2c6675"}]},{featureType:"water",elementType:"geometry",stylers:[{color:"#17263c"}]},{featureType:"poi",elementType:"labels",stylers:[{visibility:"off"}]}]}const Pi={qualifications:{label:"資格",options:["介護福祉士","実務者研修修了","初任者研修修了","看護師","ヘルパー2級"]},services:{label:"対応可能サービス",options:["身体介護","生活援助","通院等乗降介助","医療的ケア"]},physical:{label:"身体的対応力",options:["重介護対応可","移乗介助可","入浴介助可","二人介助対応可"]},special:{label:"特別スキル",options:["認知症ケア","ターミナルケア","精神障害対応","障害児支援"]}},yd=["要支援1","要支援2","要介護1","要介護2","要介護3","要介護4","要介護5"],Do=["身体介護","生活援助","通院等乗降介助","医療的ケア"],_d=["男性","女性"],Id=["指定なし","男性希望","女性希望"],Td=["利用者の体調不良","利用者の入院","家族の都合","不在・応答なし","その他"],bd=["居宅介護支援事業所（ケアマネ）","地域包括支援センター","医療機関（退院調整室）","その他"],wd=["08:00","08:30","09:00","09:30","10:00","10:30","11:00","11:30","12:00","12:30","13:00","13:30","14:00","14:30","15:00","15:30","16:00","16:30","17:00"],Br=["#4A90D9","#E74C3C","#2ECC71","#F39C12","#9B59B6","#1ABC9C","#E67E22","#3498DB","#E91E63","#00BCD4","#8BC34A","#FF5722"],Bt={requiredSkill:1e3,genderMatch:2e3,staffType:500,proximity:500},bi=25,Q={name:"事業所（拠点）",address:"〒501-3304 岐阜県加茂郡富加町高畑２９１",lat:35.497,lng:136.993};let $n="all",Jt=Qe();const Wr=localStorage.getItem("navDate");Wr&&(Jt=Wr,localStorage.removeItem("navDate"));async function Sd(){var n,s,o;const i=document.getElementById("page-container");i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
        <span class="material-icons-round">map</span>
        マップビュー
  ...
  `;try{await Ye()}catch(l){console.warn("Maps APIの読み込みスキップ:",l)}const e=ud("map-canvas",{lat:Q.lat,lng:Q.lng});await yi(e),(n=document.getElementById("map-date-picker"))==null||n.addEventListener("change",l=>{Jt=l.target.value,yi(e)}),(s=document.getElementById("staff-filter"))==null||s.addEventListener("change",l=>{$n=l.target.value,yi(e)}),(o=document.getElementById("btn-refresh-map"))==null||o.addEventListener("click",()=>{yi(e)})}async function yi(i){const[e,n,s]=await Promise.all([ae().catch(()=>[]),ce().catch(()=>[]),Ne(Jt).catch(()=>[])]),o=document.getElementById("staff-filter");if(o&&o.options.length<=1&&e.forEach(c=>{const u=document.createElement("option");u.value=c.id,u.textContent=c.name,o.appendChild(u)}),!i){kd(e,n);return}pd(),hd({lat:Q.lat,lng:Q.lng},Q.name);const l=await Zn(Jt).catch(()=>[]);if(l.length>0)for(const c of l){if($n!=="all"&&c.staffId!==$n)continue;const u=e.find(S=>S.id===c.staffId),m=(u==null?void 0:u.color)||"#999",p=[{lat:Q.lat,lng:Q.lng}];for(const S of c.clientIds||[]){const b=n.find(I=>I.id===S);b&&(p.push({lat:b.lat,lng:b.lng}),$r({lat:b.lat,lng:b.lng},m,"",`<div style="color:#333;padding:4px">
              <strong>${b.name}</strong><br>
              ${b.careLevel} | ${(b.requiredServices||[]).join(", ")}<br>
              <small>担当: ${(u==null?void 0:u.name)||"未定"}</small>
            </div>`))}p.push({lat:Q.lat,lng:Q.lng}),await md(p,m)}else{const c=n.filter(u=>u.isActive&&s.some(m=>m.clientId===u.id));for(const u of c){const m=s.filter(p=>p.clientId===u.id).map(p=>`${p.startTime}〜${p.endTime}`).join(", ");$r({lat:u.lat,lng:u.lng},"#94A3B8","",`<div style="color:#333;padding:4px">
          <strong>${u.name}</strong><br>
          予定: ${m}<br>
          ${u.careLevel} | ${(u.requiredServices||[]).join(", ")}
        </div>`)}}gd(),Ed(e,l,s)}function Ed(i,e,n=[]){const s=document.getElementById("route-legend");if(s){if(e.length===0){s.innerHTML=`
      <p style="color:var(--text-muted);font-size:.85rem">
  ...
  `}}function kd(i,e){const n=document.getElementById("route-legend");n&&(n.innerHTML=`
    ...
    `)}let Xt=[];async function es(){const i=document.getElementById("page-container");Xt=await ae().catch(()=>[]),i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
      ...
      ${Object.entries(Pi).map(([l,c])=>`
        <div class="form-group">
          ...
          <div class="tags-container" style="gap:8px">
            ${c.options.map(u=>{var p,S;const m=(S=(p=i==null?void 0:i.skills)==null?void 0:p[l])!=null&&S.includes(u)?"checked":"";return`<label style="display:flex;align-items:center;gap:4px;cursor:pointer;font-size:.85rem">
  ...
  `),document.getElementById("sf-cancel").onclick=se,document.getElementById("sf-save").onclick=async()=>{const l=document.getElementById("sf-name").value.trim();if(!l){N("氏名を入力してください","warning");return}const c=document.getElementById("sf-save");c.disabled=!0,c.textContent="保存中...";const u=document.getElementById("sf-address").value.trim();let m=(i==null?void 0:i.lat)||Q.lat,p=(i==null?void 0:i.lng)||Q.lng;if(u)try{await Ye();const b=await Oo(u);b?(m=b.lat,p=b.lng):N("住所から座標を取得できませんでした","warning")}catch(b){console.warn("ジオコーディング失敗:",b)}const S={name:l,gender:document.getElementById("sf-gender").value,address:u,workStart:document.getElementById("sf-work-start").value,workEnd:document.getElementById("sf-work-end").value,lat:m,lng:p,skills:{},color:(i==null?void 0:i.color)||Br[Xt.length%Br.length],isActive:!0};for(const[b]of Object.entries(Pi)){const I=document.querySelectorAll(`input[name="skill-${b}"]:checked`);S.skills[b]=Array.from(I).map(k=>k.value)}try{e?(await od(i.id,S),N("職員情報を更新しました","success")):(await Eo(S),N("職員を登録しました","success")),se(),await es()}catch(b){N("保存に失敗しました: "+b.message,"error")}finally{c.disabled=!1,c.textContent=e?"更新":"登録"}}}document.addEventListener("click",async i=>{const e=i.target.closest("[data-edit-staff]");if(e){const s=Xt.find(o=>o.id===e.dataset.editStaff);s&&Lo(s)}const n=i.target.closest("[data-delete-staff]");if(n){const s=Xt.find(o=>o.id===n.dataset.deleteStaff);if(s&&await Ze("削除確認",`${s.name} を削除しますか？`))try{await ad(s.id),N(`${s.name} を削除しました`,"success"),await es()}catch{N("削除に失敗しました","error")}}});let Ci=[],Ur=[];async function ts(){const i=document.getElementById("page-container");try{const[e,n]=await Promise.all([ce().catch(()=>[]),ii().catch(()=>[])]);Ci=e,Ur=n}catch(e){console.error("データの取得に失敗",e)}i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
  ...
  `,document.getElementById("btn-add-client").addEventListener("click",()=>Po())}function xd(i,e){return i.length===0?`<div class="empty-state">
    ...
    <div class="table-wrapper card">
      <table class="data-table">
        ...
        <tbody>
          ${i.map(n=>{var c,u;const s={月:1,火:2,水:3,木:4,金:5,土:6,日:7},o=e.filter(m=>m.clientId===n.id).sort((m,p)=>{const S=s[m.dayOfWeek]||99,b=s[p.dayOfWeek]||99;return S-b}),l=o.length>0?o.map(m=>`<div style="font-size:0.85rem;margin-bottom:2px;">
  ...
  `}function Po(i=null){var l,c;const e=!!i,n=[...Pi.physical.options,...Pi.special.options],s=`
    <form id="client-form">
      <div class="form-row">
        <div class="form-group">
          <label class="form-label">氏名 *</label>
  ...
  `),document.getElementById("cf-cancel").onclick=se,document.getElementById("cf-save").onclick=async()=>{const u=document.getElementById("cf-name").value.trim();if(!u){N("氏名を入力してください","warning");return}const m=document.getElementById("cf-save");m.disabled=!0,m.textContent="保存中...";const p=document.getElementById("cf-address").value.trim();let S=(i==null?void 0:i.lat)||Q.lat,b=(i==null?void 0:i.lng)||Q.lng;if(p)try{await Ye();const k=await Oo(p);k?(S=k.lat,b=k.lng,N(`座標を取得しました: ${k.lat.toFixed(4)}, ${k.lng.toFixed(4)}`,"success")):N("住所から座標を取得できませんでした。事業所付近の座標を使用します。","warning")}catch(k){console.warn("ジオコーディング失敗:",k),N("座標取得に失敗。事業所付近の座標を使用します。","warning")}const I={name:u,careLevel:document.getElementById("cf-care-level").value,address:p,requiredServices:Array.from(document.querySelectorAll('input[name="cf-service"]:checked')).map(k=>k.value),requiredSkills:Array.from(document.querySelectorAll('input[name="cf-skill"]:checked')).map(k=>k.value),genderPreference:document.getElementById("cf-gender-pref").value,visitDuration:parseInt(document.getElementById("cf-duration").value)||60,timeWindow:{start:document.getElementById("cf-time-start").value,end:document.getElementById("cf-time-end").value},notes:document.getElementById("cf-notes").value.trim(),lat:S,lng:b,isActive:!0};try{e?(await ld(i.id,I),N("利用者情報を更新しました","success")):(await ko(I),N("利用者を登録しました","success")),se(),await ts()}catch(k){N("保存に失敗しました: "+k.message,"error")}finally{m.disabled=!1,m.textContent=e?"更新":"登録"}}}document.addEventListener("click",async i=>{const e=i.target.closest("[data-edit-client]");if(e){const s=Ci.find(o=>o.id===e.dataset.editClient);s&&Po(s)}const n=i.target.closest("[data-delete-client]");if(n){const s=Ci.find(o=>o.id===n.dataset.deleteClient);if(s&&await Ze("削除確認",`${s.name} を削除しますか？`))try{await cd(s.id),N(`${s.name} を削除しました`,"success"),await ts()}catch{N("削除に失敗しました","error")}}});let De=Qe();const Fr=localStorage.getItem("navDate");Fr&&(De=Fr,localStorage.removeItem("navDate"));async function Od(){const i=document.getElementById("page-container");i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
  ...
  `,document.getElementById("schedule-date").addEventListener("change",e=>{De=e.target.value,Yt()}),document.getElementById("btn-add-visit").addEventListener("click",Dd),document.getElementById("btn-generate-week").addEventListener("click",Ld),await Yt()}async function Yt(){const i=document.getElementById("schedule-content"),[e,n,s,o]=await Promise.all([ae().catch(()=>[]),ce().catch(()=>[]),Ne(De).catch(()=>[]),Zn(De).catch(()=>[])]);if(s.length===0){i.innerHTML=`
      <div class="empty-state">
        <span class="material-icons-round">event_busy</span>
        <h3>${gt(De)} の訪問予定はありません</h3>
        <p>「訪問追加」ボタンから予定を登録するか、マッチング＆最適化を実行してください</p>
      </div>
    `;return}const l={},c=[];let u=0,m=0,p=0;for(const I of s)I.staffId?(l[I.staffId]||(l[I.staffId]=[]),l[I.staffId].push(I)):c.push(I);c.sort((I,k)=>{const x=I.startTime||I.scheduledTime||"00:00",A=k.startTime||k.scheduledTime||"00:00";return x.localeCompare(A)});let S="";c.length>0&&(S=`
    ...
    `);for(const[I,k]of Object.entries(l)){const x=e.find(P=>P.id===I);if(!x)continue;const A=o.find(P=>P.staffId===I),D=parseInt(x.wage)||2e3;if(A&&(p+=(A.totalDistance||0)*bi),k.sort((P,L)=>{const C=P.optimizedArrivalTime||P.startTime||P.scheduledTime||"00:00",M=L.optimizedArrivalTime||L.startTime||L.scheduledTime||"00:00";return C.localeCompare(M)}),A&&A.schedule&&A.schedule.length>=2){const P=A.schedule[0].arrivalMinutes,C=(A.schedule[A.schedule.length-1].arrivalMinutes-P)/60;m+=C*D}else if(k.length>0){const P=k[0],L=k[k.length-1],C=P.startTime||P.scheduledTime||"09:00",M=L.startTime||L.scheduledTime||"17:00",R=G(C),y=(G(M)+(L.duration||60)-R)/60;m+=y*D}k.forEach((P,L)=>{u+=wo(x,P.duration||60);let C=10,M=null;if(A&&A.schedule){const R=A.schedule.find(B=>B.clientId===P.clientId);R&&(C=R.travelTimeFromPrev||10,M=R.arrivalTime)}P.calculatedTravelTime=C,P.optimizedArrivalTime=M}),k.sort((P,L)=>{const C=P.optimizedArrivalTime||P.startTime||P.scheduledTime||"00:00",M=L.optimizedArrivalTime||L.startTime||L.scheduledTime||"00:00";return C.localeCompare(M)})}let b="";if(window.isAdmin){const I=u-m-p,k=u>0?Math.round(I/u*100):0;b=`
  ...
  `}async function Dd(){const[i,e]=await Promise.all([ae().catch(()=>[]),ce().catch(()=>[])]),n=`
    <form id="visit-form">
      <div class="form-group">
  ...
  `);const s=()=>{const o=document.getElementById("vf-service").value,l=parseInt(document.getElementById("vf-duration").value)||60,c=Di(o,l);document.getElementById("vf-income").value=c,document.getElementById("vf-income-hint").textContent=`↑ ${o} ${l}分 → ¥${c.toLocaleString()}（自動計算）`};document.getElementById("vf-service").addEventListener("change",s),document.getElementById("vf-duration").addEventListener("change",s),s(),document.getElementById("vf-cancel").onclick=se,document.getElementById("vf-save").onclick=async()=>{const o=document.getElementById("vf-client").value,l=document.getElementById("vf-staff").value;if(!o||!l){N("利用者と職員を選択してください","warning");return}try{const c=parseInt(document.getElementById("vf-duration").value)||60,u=document.getElementById("vf-service").value,m=document.getElementById("vf-time").value,p=G(m)+c,S=Math.floor(p/60),b=p%60,I=`${String(S).padStart(2,"0")}:${String(b).padStart(2,"0")}`;await ni({date:De,clientId:o,staffId:l,startTime:m,endTime:I,scheduledTime:m,duration:c,service:u,income:parseInt(document.getElementById("vf-income").value)||Di(u,c),status:"scheduled"}),N("訪問予定を追加しました","success"),se(),await Yt()}catch{N("追加に失敗しました","error")}}}async function Ld(){var e;if(await Ze("週間スケジュール自動生成",`利用者の曜日設定に基づいて、今週（月〜土）の訪問予定を自動生成します。
既存の予定がある日はスキップされます。

実行しますか？`))try{const[n,s]=await Promise.all([ce(),ii()]),o={月:1,火:2,水:3,木:4,金:5,土:6},l=new Date,c=l.getDay(),u=s.filter(b=>b.dayOfWeek&&o[b.dayOfWeek]!==void 0);let m=0,p=0;const S=new Map;for(const b of u){const I=o[b.dayOfWeek];if(I===void 0)continue;const k=I-c,x=new Date(l);x.setDate(l.getDate()+k);const A=pt(x),D=`${A}_${b.clientId}`;if(S.has(D)){const L=S.get(D);L&&L.timeOptions.push({startTime:b.startTime||"09:00",duration:b.duration||60});continue}if((await Ne(A)).some(L=>L.clientId===b.clientId)){S.set(D,null),p++;continue}S.set(D,{...b,date:A,timeOptions:[{startTime:b.startTime||"09:00",duration:b.duration||60}]})}for(const[b,I]of S){if(!I)continue;const k=n.find(B=>B.id===I.clientId),x=I.service||((e=k==null?void 0:k.requiredServices)==null?void 0:e[0])||"身体介護",A=I.duration||(k==null?void 0:k.visitDuration)||60,D=I.startTime||"09:00",P=Di(x,A),L=G(D)+A,C=Math.floor(L/60),M=L%60,R=`${String(C).padStart(2,"0")}:${String(M).padStart(2,"0")}`;await ni({date:I.date,clientId:I.clientId,clientName:I.clientName||(k==null?void 0:k.name)||"利用者",staffId:I.staffId||null,staffName:I.staffName||"未設定",startTime:D,endTime:R,scheduledTime:D,duration:A,service:x,income:P,dayOfWeek:I.dayOfWeek,status:"scheduled",timeOptions:I.timeOptions}),m++}m>0?N(`今週の訪問予定 ${m}件 を自動生成しました！${p>0?`（${p}件は既存のためスキップ）`:""}`,"success"):N(`生成する予定がありませんでした。${p>0?`（${p}件は既に登録済み）`:"利用者の曜日設定を確認してください。"}`,"warning"),await Yt()}catch(n){console.error("週間スケジュール生成エラー:",n),N("スケジュール生成に失敗しました: "+n.message,"error")}}document.addEventListener("click",async i=>{const e=i.target.closest("[data-delete-visit]");if(e&&await Ze("削除確認","この訪問予定を削除しますか？"))try{await Qn(e.dataset.deleteVisit),N("訪問予定を削除しました","success"),await Yt()}catch{N("削除に失敗しました","error")}});function Pd(i,e){const n=G(i),s=[{startTime:i,duration:e}],o=n+15;o+e<=18*60&&s.push({startTime:Ht(o),duration:e});const l=n-15;return l>=7*60&&s.push({startTime:Ht(l),duration:e}),s}function Vr(i){return i?G(i)<12*60+30?"AM":"PM":"AM"}function Cd(i,e,n=null){var p,S,b,I,k;let s=0;const o=[];let l=!0;for(const x of e.requiredServices||[])(S=(p=i.skills)==null?void 0:p.services)!=null&&S.includes(x)?(s+=Bt.requiredSkill,o.push(`✅ ${x}対応可`)):(l=!1,o.push(`❌ ${x}に対応不可`));const c=[...((b=i.skills)==null?void 0:b.qualifications)||[],...((I=i.skills)==null?void 0:I.physical)||[],...((k=i.skills)==null?void 0:k.special)||[]];for(const x of e.requiredSkills||[])c.includes(x)?(s+=Bt.requiredSkill,o.push(`✅ ${x}あり`)):(l=!1,o.push(`❌ ${x}なし`));if(e.genderPreference&&e.genderPreference!=="指定なし"){const x=e.genderPreference.replace("希望","");i.gender===x?(s+=Bt.genderMatch,o.push(`✅ 性別希望合致（${x}）`)):(l=!1,o.push(`❌ 性別希望不一致（希望: ${x}）`))}i.type==="正社員"&&(s+=Bt.staffType,o.push("✅ 正社員"));const u=(n==null?void 0:n.lat)||i.lat,m=(n==null?void 0:n.lng)||i.lng;if(u&&e.lat){const x=bo(u,m,e.lat,e.lng);let A=Bt.proximity;n!=null&&n.isTransition&&(A=A*.2,o.push("ℹ️ ブロック移動（エリア移動許容）"));const D=Math.max(0,A*(1-x/10));s+=D,D>A*.8&&o.push(`✅ 近距離ボーナス (+${Math.round(D)})`)}return{score:Math.round(s),reasons:o,eligible:l}}function Sn(i){var e;return(e=i.name)!=null&&e.includes("前川")?3:i.maxVisits||(i.type==="パート"?5:10)}function Co(i,e,n=[],s=null,o=[]){const l=[],c=new Set,u={},m={};o.forEach((I,k)=>{m[I.id]=k});const p=(I,k)=>{if(!s)return 15;const x=m[I],A=m[k];return x!==void 0&&A!==void 0&&s[x][A]&&s[x][A].duration||15},S=[...e].sort((I,k)=>{const x=I.startTime||I.scheduledTime||"00:00",A=k.startTime||k.scheduledTime||"00:00";return x.localeCompare(A)});for(const I of S){if(l.some(L=>{if(L.clientId!==I.clientId)return!1;const C=G(L.startTime),M=C+(L.duration||60),R=G(I.startTime||I.scheduledTime||"09:00"),B=R+(I.duration||60);return R<M&&B>C})){c.add(I.id);continue}const x=i.filter(L=>L.isActive).map(L=>{const C=n.find(h=>h.id===I.clientId),M=l.filter(h=>h.staffId===L.id),R=M.length>0?M[M.length-1]:null;let B=null;if(R){const h=n.find(W=>W.id===R.clientId);if(h){const W=I.startTime||I.scheduledTime||"09:00",X=Vr(R.startTime)!==Vr(W);B={lat:h.lat,lng:h.lng,isTransition:X}}}const{score:y,eligible:f}=Cd(L,C||I,B),g=I.startTime||I.scheduledTime||"09:00",_=I.duration||60,v=I.timeOptions&&I.timeOptions.length>0?I.timeOptions:Pd(g,_);let T=null;for(const h of v){let W=!0;const X=G(h.startTime),et=X+(h.duration||60),Fi=G(L.workStart||"07:00"),tt=G(L.workEnd||"18:00");if(X<Fi||et>tt){W=!1;continue}const it=l.filter(Re=>Re.staffId===L.id);for(const Re of it){const $e=G(Re.startTime),nt=$e+(Re.duration||60);if(X<nt&&et>$e){W=!1;break}const Tt=p(Re.clientId,I.clientId);if(X>=nt){if(X-nt<Tt){W=!1;break}}else if(et<=$e&&$e-et<Tt){W=!1;break}}if(W){T=h;break}}return{staff:L,score:y,eligible:f&&!!T,chosenTime:T}}).filter(L=>L.eligible);if(x.length===0)continue;x.sort((L,C)=>{var h,W;const M=u[L.staff.id]||0,R=u[C.staff.id]||0,B=Sn(L.staff),y=Sn(C.staff),f=M>=B,g=R>=y;if(f!==g)return f?1:-1;const _=7,v=L.staff.type==="正社員"&&!((h=L.staff.name)!=null&&h.includes("前川"))&&M<_,T=C.staff.type==="正社員"&&!((W=C.staff.name)!=null&&W.includes("前川"))&&R<_;return v!==T?v?-1:1:M!==R?M-R:L.staff.type!==C.staff.type?L.staff.type==="正社員"?-1:1:C.score-L.score});const A=x[0],D=u[A.staff.id]||0,P=Sn(A.staff);if(D<P){const L=A.chosenTime.startTime,C=A.chosenTime.duration||60,M=G(L)+C;l.push({staffId:A.staff.id,staffName:A.staff.name,visitId:I.id,clientId:I.clientId,clientName:I.clientName||"利用者",score:A.score,startTime:L,endTime:Ht(M),scheduledTime:L,duration:C}),c.add(I.id),u[A.staff.id]=D+1}}const b=e.filter(I=>!c.has(I.id)).map(I=>({visitId:I.id,clientName:I.clientName||"利用者",reason:"適格な職員なし、または上限超過",visit:I}));return{assignments:l,unassigned:b}}async function is(i,e,n,s=Q,o=null){const l={};for(const u of i)l[u.staffId]||(l[u.staffId]=[]),l[u.staffId].push(u.clientId);const c={};for(const[u,m]of Object.entries(l)){const p=e.find(P=>P.id===u),S=m.map(P=>n.find(L=>L.id===P)).filter(Boolean);if(S.length===0)continue;const b=[{id:"office",name:"事業所",lat:s.lat,lng:s.lng,isOffice:!0},...S.map(P=>{const L=i.find(C=>C.clientId===P.id&&C.staffId===u);return{id:P.id,name:P.name,lat:P.lat,lng:P.lng,duration:P.visitDuration||60,scheduledStart:L?L.startTime:null,timeWindow:P.timeWindow}})];let I=null;typeof o=="function"&&(I=await o(b));const k=Md(b,I);let x=Nd(b,k);x=Rd(x,k);const A=$d(x,k),D=Bd(x,k,p,I,b);c[u]={staffId:u,staffName:(p==null?void 0:p.name)||"不明",staffColor:(p==null?void 0:p.color)||"#999",route:x,totalDistance:Math.round(A*10)/10,totalDuration:Wd(D),schedule:D}}return c}function Md(i,e=null){const n=i.length,s=Array.from({length:n},()=>Array(n).fill(0));for(let o=0;o<n;o++)for(let l=0;l<n;l++)o!==l&&(e&&e[o]&&e[o][l]&&e[o][l].distance!==null?s[o][l]=e[o][l].distance:s[o][l]=bo(i[o].lat,i[o].lng,i[l].lat,i[l].lng));return s}function Nd(i,e){const n=i.length,s=new Set([0]),o=[0],l=[],c=[];for(let p=1;p<n;p++){const S=i[p];S.timeWindow&&S.timeWindow.start?l.push({index:p,start:G(S.timeWindow.start),end:G(S.timeWindow.end)}):c.push(p)}l.sort((p,S)=>p.start-S.start);const u=[...l.map(p=>p.index),...c];let m=0;for(;s.size<n;){let p=-1,S=1/0;for(const b of u)s.has(b)||e[m][b]<S&&(S=e[m][b],p=b);if(p===-1)break;o.push(p),s.add(p),m=p}return o.push(0),o}function Rd(i,e){const n=i.length;let s=!0,o=[...i];for(;s;){s=!1;for(let l=1;l<n-2;l++)for(let c=l+1;c<n-1;c++){const u=e[o[l-1]][o[l]]+e[o[c]][o[c+1]];if(e[o[l-1]][o[c]]+e[o[l]][o[c+1]]<u-.001){const p=[...o];let S=l,b=c;for(;S<b;)[p[S],p[b]]=[p[b],p[S]],S++,b--;o=p,s=!0}}}return o}function $d(i,e){let n=0;for(let s=0;s<i.length-1;s++)n+=e[i[s]][i[s+1]];return n}function Bd(i,e,n,s=null,o=[]){const l=[];let u=G((n==null?void 0:n.workStart)||"08:30");for(let m=0;m<i.length;m++){let p=0;if(m>0){const b=i[m-1],I=i[m];s&&s[b]&&s[b][I]&&s[b][I].duration!==null?p=s[b][I].duration:p=e[b][I]/20*60,u+=Math.ceil(p)}const S=o[i[m]];if(S){let b=0;S.timeWindow&&S.timeWindow.start?b=G(S.timeWindow.start):S.scheduledStart&&(b=G(S.scheduledStart)),u<b&&(u=b)}if(l.push({pointIndex:i[m],clientId:S?S.id:null,arrivalTime:Ht(u),arrivalMinutes:u,travelTimeFromPrev:Math.ceil(p)}),m>0&&m<i.length-1){const b=S&&S.duration||60;u+=b}}return l}function Wd(i){if(i.length<2)return 0;const e=i[0].arrivalMinutes;return i[i.length-1].arrivalMinutes-e}let xe=new Date;async function yt(){const i=document.getElementById("page-container"),e=xe.getFullYear(),n=xe.getMonth(),s=new Date(e,n,1),o=new Date(e,n+1,0),l=s.getDay(),c=o.getDate(),u=await ii().catch(()=>[]),[m,p]=await Promise.all([ce().catch(()=>[]),ae().catch(()=>[])]);let S=`
    <div class="page-header">
      <h1 class="page-title">
        <span class="material-icons-round">calendar_month</span>
        月間カレンダー
    ...
    <div class="card">
      <div style="display: grid; grid-template-columns: repeat(7, 1fr); gap: 1px; background: var(--border); border: 1px solid var(--border); border-radius: 8px; overflow: hidden;">
        ...
        `).join("")}
  `;for(let k=0;k<l;k++)S+='<div style="background: var(--bg-main); padding: 10px; min-height: 100px;"></div>';const b=pt(new Date);for(let k=1;k<=c;k++){const x=new Date(e,n,k),A=pt(x),D=x.getDay(),P=A===b,C=u.filter(M=>M.date===A).filter(M=>M.status==="scheduled");S+=`
  ...
  `,i.innerHTML=S,document.getElementById("cal-prev-month").addEventListener("click",()=>{xe.setMonth(xe.getMonth()-1),yt()}),document.getElementById("cal-next-month").addEventListener("click",()=>{xe.setMonth(xe.getMonth()+1),yt()}),document.getElementById("cal-generate-month").addEventListener("click",Vd),document.getElementById("cal-weekly-opt").addEventListener("click",Fd),document.querySelectorAll(".calendar-day").forEach(k=>{k.addEventListener("click",x=>{const A=x.currentTarget.dataset.date;Ud(A,u,m,p)})})}function Ud(i,e,n,s){const o=e.filter(u=>u.date===i);let l="";o.length===0?l='<div style="color:var(--text-muted); text-align:center; padding: 20px;">予定はありません</div>':(o.sort((u,m)=>(u.startTime||"00:00").localeCompare(m.startTime||"00:00")),l=o.map(u=>{const m=n.find(S=>S.id===u.clientId),p=s.find(S=>S.id===u.staffId);return`
        <div class="visit-card" style="margin-bottom: 8px; border-left: 4px solid ${(p==null?void 0:p.color)||"#ccc"}; display: flex; justify-content: space-between; align-items: center;">
          <div>
            ...
            <div style="font-size: 0.8rem; color: var(--text-muted);">
              担当: ${Z(u.staffName||(p==null?void 0:p.name)||"未設定")}
            </div>
          </div>
  ...
  `),document.getElementById("modal-close-btn").addEventListener("click",se),document.getElementById("modal-add-visit-btn").addEventListener("click",u=>{se(),N(`${u.currentTarget.dataset.date}の予定追加（※デモ用）`,"info")}),document.querySelectorAll(".btn-nav").forEach(u=>{u.addEventListener("click",m=>{const p=m.currentTarget.dataset.target,S=m.currentTarget.dataset.date;localStorage.setItem("navDate",S),se(),ht(p)})}),document.querySelectorAll(".btn-cancel-visit").forEach(u=>{u.addEventListener("click",async m=>{const p=m.currentTarget.dataset.id;if(await Ze("予定の削除","この予定をキャンセル（削除）しますか？<br>※再マッチング時には除外されます。"))try{await Qn(p),N("予定を削除しました","success"),se(),yt()}catch{N("削除に失敗しました","error")}})}),document.getElementById("modal-add-visit-btn").addEventListener("click",u=>{se(),N("予定の追加は「日別スケジュール」画面から行ってください。","info")})}async function Fd(){const i=new Date,e=(8-i.getDay())%7||7,n=new Date(i.getFullYear(),i.getMonth(),i.getDate()+e),s=[];for(let p=0;p<7;p++){const S=new Date(n);S.setDate(S.getDate()+p),s.push(pt(S))}const o=s[0],l=s[6];if(!await Ze("来週分の再マッチング",`【対象期間】<br><b>${o} 〜 ${l}</b><br><br>カレンダー上で削除した「お休み」を反映し、担当者をリセットした上で、一番効率の良いルートに一括で再計算します。<br>実行しますか？`))return;const u=document.getElementById("cal-weekly-opt"),m=u.innerHTML;u.innerHTML='<span class="material-icons-round" style="animation:spin 1s linear infinite">sync</span> 最適化中...',u.disabled=!0;try{const[p,S,b]=await Promise.all([ae(),ce(),ii()]),I=[{id:"office",...Q},...S.map(D=>({id:D.id,lat:D.lat,lng:D.lng}))];let k=null;const x=["日","月","火","水","木","金","土"];let A=0;for(const D of s){const[P,L,C]=D.split("-"),M=new Date(P,L-1,C),R=x[M.getDay()],B=b.filter(T=>T.date===D);if(B.length===0)continue;const y=p.filter(T=>T.isActive&&Array.isArray(T.days)&&T.days.includes(R));if(y.length===0)continue;const{assignments:f}=Co(y,B,S,k,I),g=await is(f,y,S,Q,async T=>{try{return await Ye(),await Li(T)}catch{return null}}),_=Object.entries(g).map(([T,h])=>{const W=f.filter(X=>X.staffId===T).map(X=>X.clientId);return{staffId:T,date:D,clientIds:W,totalDistance:h.totalDistance,totalDuration:h.totalDuration,schedule:h.schedule}}),v=new Set;for(const T of B){const h=f.find(W=>W.visitId===T.id);h?(await vt(T.id,{staffId:h.staffId,staffName:h.staffName,startTime:h.startTime,endTime:h.endTime,scheduledTime:h.scheduledTime}),v.add(T.clientId)):v.has(T.clientId)||await vt(T.id,{staffId:null,staffName:"未設定"})}await Ao(_),A++}A>0?(N(`来週 ${A}日分 のルート最適化が完了しました！`,"success"),yt()):N("最適化する予定が見つかりませんでした。","warning")}catch(p){console.error(p),N("一括最適化中にエラーが発生しました: "+p.message,"error")}finally{u.innerHTML=m,u.disabled=!1}}async function Vd(){var l;const i=xe.getFullYear(),e=xe.getMonth();if(!await Ze("月間予定のベース生成",`<b>${i}年${e+1}月</b> の基本スケジュールを利用者の基本曜日から自動生成しますか？<br><br>※すでにカレンダー上に存在する日の予定は上書きされずスキップされます。`))return;const s=document.getElementById("cal-generate-month"),o=s.innerHTML;s.innerHTML='<span class="material-icons-round" style="animation:spin 1s linear infinite">sync</span> 生成中...',s.disabled=!0;try{const[c,u]=await Promise.all([ce(),ii()]),m={日:0,月:1,火:2,水:3,木:4,金:5,土:6},p=u.filter(I=>I.dayOfWeek&&m[I.dayOfWeek]!==void 0);if(p.length===0){N("ベースとなる予定テンプレート（曜日設定）がありません。デモデータを登録してください。","warning");return}let S=0;const b=new Date(i,e+1,0).getDate();for(let I=1;I<=b;I++){const k=new Date(i,e,I),x=pt(k),A=k.getDay(),D=p.filter(C=>m[C.dayOfWeek]===A);if(D.length===0)continue;const P=u.filter(C=>C.date===x),L=new Set(P.map(C=>C.clientId));for(const C of D){if(L.has(C.clientId))continue;const M=c.find(h=>h.id===C.clientId),R=C.service||((l=M==null?void 0:M.requiredServices)==null?void 0:l[0])||"身体介護",B=C.duration||(M==null?void 0:M.visitDuration)||60,y=C.startTime||"09:00";let f=0;try{f=Di(R,B)}catch{f=4e3}const g=G(y)+B,_=Math.floor(g/60),v=g%60,T=`${String(_).padStart(2,"0")}:${String(v).padStart(2,"0")}`;await ni({date:x,clientId:C.clientId,clientName:C.clientName||(M==null?void 0:M.name)||"利用者",staffId:null,staffName:"未設定",startTime:y,endTime:T,scheduledTime:y,duration:B,service:R,income:f,dayOfWeek:C.dayOfWeek,status:"scheduled"}),S++}}S>0?(N(`${i}年${e+1}月の予定を ${S}件 生成しました！`,"success"),yt()):N("新しく生成する予定がありませんでした（既存の予定が設定済み）。","info")}catch(c){console.error("月間スケジュール生成エラー:",c),N("スケジュールの生成に失敗しました: "+c.message,"error")}finally{s.innerHTML=o,s.disabled=!1}}let Ke=null,Mi=null,Je=Qe(),Ni=null,ns=null,Bn=null,lt=null;async function Mo(){const i=document.getElementById("page-container"),e=await ae(),n=["日","月","火","水","木","金","土"][new Date(Je).getDay()];i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
        <span class="material-icons-round">auto_fix_high</span>
        マッチング＆ルート最適化
  ...
  `,document.getElementById("match-date-picker").addEventListener("change",s=>{Je=s.target.value,Mo()}),document.getElementById("btn-run-optimization").addEventListener("click",jd)}async function jd(){const i=document.getElementById("btn-run-optimization"),e=document.getElementById("optimization-results");i.disabled=!0,i.innerHTML='<span class="material-icons-round" style="animation:spin 1s linear infinite">sync</span> 最適化中...',e.innerHTML="";try{const[n,s,o]=await Promise.all([ae(),ce(),Ne(Je)]),l=Array.from(document.querySelectorAll(".staff-attendance-checkbox:checked")).map(I=>I.dataset.staffId),c=n.filter(I=>l.includes(I.id));if(c.length===0){N("出勤する職員を少なくとも1名選択してください","warning"),i.disabled=!1,i.innerHTML='<span class="material-icons-round">play_arrow</span> 最適化を実行';return}if(o.length===0){N(`${gt(new Date(Je))} の訪問予定がありません。`,"warning"),i.disabled=!1,i.innerHTML='<span class="material-icons-round">play_arrow</span> 最適化を実行';return}const u=[{id:"office",...Q},...s.map(I=>({id:I.id,lat:I.lat,lng:I.lng}))];let m=null;try{await Ye(),m=await Li(u)}catch(I){console.warn("全体距離行列の取得に失敗:",I)}const{assignments:p,unassigned:S}=Co(c,o,s,m,u);Ke=p,lt=S,Ni=c,ns=n,Bn=s;const b=await is(p,c,s,Q,async I=>{try{return await Ye(),await Li(I)}catch(k){return console.warn("実走行データの取得に失敗:",k),null}});Mi=b,e.innerHTML=No(n,s,p,S,b),Ro(),N("最適化が完了しました！","success")}catch(n){N("最適化に失敗しました: "+n.message,"error"),console.error(n)}finally{i.disabled=!1,i.innerHTML='<span class="material-icons-round">play_arrow</span> 最適化を実行'}}function No(i,e,n,s,o){const l={};for(const c of n)l[c.staffId]||(l[c.staffId]={staff:i.find(u=>u.id===c.staffId),clients:[]}),l[c.staffId].clients.push({...c,client:e.find(u=>u.id===c.clientId)});return`
    ...
    <div class="grid grid-2" style="margin-bottom:24px">
      ${Object.entries(l).map(([c,u])=>{var p,S,b;const m=o[c];return`
          <div class="card" style="border-left:4px solid ${((p=u.staff)==null?void 0:p.color)||"#999"}">
            <div class="card-header">
  ...
  `}async function qd(i,e){try{const n=Object.entries(e).map(([l,c])=>{const u=Ke.filter(m=>m.staffId===l).map(m=>m.clientId);return{staffId:l,date:Je,clientIds:u,totalDistance:c.totalDistance,totalDuration:c.totalDuration,schedule:c.schedule}}),s=await Ne(Je),o=new Set;for(const l of s){const c=Ke.find(u=>u.visitId===l.id);c&&(await vt(l.id,{staffId:c.staffId,staffName:c.staffName,startTime:c.startTime,endTime:c.endTime,scheduledTime:c.scheduledTime}),o.add(l.clientId))}for(const l of s)Ke.find(u=>u.visitId===l.id)||(o.has(l.clientId)?await Qn(l.id):await vt(l.id,{staffId:null,staffName:"未設定"}));await Ao(n),N("スケジュールとルートを保存しました！","success")}catch(n){N("保存に失敗しました: "+n.message,"error")}}function Ro(){var i;(i=document.getElementById("btn-save-routes"))==null||i.addEventListener("click",async()=>{await qd(ns,Mi)}),document.querySelectorAll(".btn-manual-assign").forEach(e=>{e.addEventListener("click",n=>{const s=n.target.closest(".btn-manual-assign").dataset.visitId;zd(s)})})}function zd(i){const e=lt.find(c=>c.visitId===i);if(!e)return;const n=e.visit,s=Ni.map(c=>`<option value="${c.id}">${Z(c.name)}</option>`).join(""),o=`
    <div style="margin-bottom: 16px;">
  ...
  `),document.getElementById("manual-cancel").onclick=()=>{se()},document.getElementById("manual-ok").onclick=async()=>{const c=document.getElementById("manual-staff-select").value,u=document.getElementById("manual-time-input").value;se(),await Hd(i,c,u)}}async function Hd(i,e,n){const s=lt.findIndex(S=>S.visitId===i);if(s===-1)return;const l=lt[s].visit,c=Ni.find(S=>S.id===e),u=l.duration||60,m=G(n)+u;Ke.push({staffId:c.id,staffName:c.name,visitId:l.id,clientId:l.clientId,clientName:l.clientName||"利用者",score:9999,startTime:n,endTime:Ht(m),scheduledTime:n,duration:u}),lt.splice(s,1);const p=document.getElementById("optimization-results");p.innerHTML='<div style="text-align:center;padding:32px;"><span class="material-icons-round" style="animation:spin 1s linear infinite">sync</span> ルート再計算中...</div>';try{Mi=await is(Ke,Ni,Bn,Q,async b=>{try{return await Ye(),await Li(b)}catch{return null}}),p.innerHTML=No(ns,Bn,Ke,lt,Mi),Ro(),N(`${c.name}さんに手動割り当てし、ルートを再計算しました`,"success")}catch(S){N("ルート再計算に失敗しました","error"),console.error(S)}}let qt=Qe();async function Gd(){var e,n;const i=document.getElementById("page-container");if(!window.isAdmin){i.innerHTML=`
      <div class="empty-state">
  ...
  `,await En(),(e=document.getElementById("revenue-date-picker"))==null||e.addEventListener("change",s=>{qt=s.target.value,En()}),(n=document.getElementById("btn-refresh-revenue"))==null||n.addEventListener("click",()=>{En()})}async function En(){const i=document.getElementById("revenue-content");if(!i)return;const[e,n,s,o]=await Promise.all([ae(),ce(),Ne(qt),Zn(qt)]);if(s.length===0){i.innerHTML=`
      <div class="empty-state">
        <span class="material-icons-round" style="font-size:48px;opacity:.2">event_busy</span>
        <p>${gt(qt)} の訪問予定データがありません。</p>
      </div>
    `;return}let l=0,c=0,u=0,m=s.length;s.filter(I=>I.status==="completed").length;const p=e.map(I=>{const k=o.filter(M=>M.staffId===I.id),x=s.filter(M=>M.staffId===I.id);let A=0,D=0,P=0,L=0,C=0;if(x.forEach(M=>{A+=wo(I,M.duration||60)}),k.forEach(M=>{if(L+=M.totalDistance||0,P+=(M.totalDistance||0)*bi,M.schedule&&M.schedule.length>=2){const R=M.schedule[0].arrivalMinutes;C=M.schedule[M.schedule.length-1].arrivalMinutes-R,D=C/60*(parseInt(I.wage)||2e3)}}),k.length===0&&x.length>0){const M=[...x].sort((g,_)=>(g.startTime||"09:00").localeCompare(_.startTime||"09:00")),R=M[0],B=M[M.length-1],y=G(R.startTime||"09:00");C=G(B.startTime||"17:00")+(B.duration||60)-y,D=C/60*(parseInt(I.wage)||2e3)}return{...I,count:x.length,revenue:A,laborCost:D,vehicleCost:P,profit:A-D-P,workMinutes:C}}).filter(I=>I.count>0||I.revenue>0).sort((I,k)=>k.profit-I.profit);p.forEach(I=>{l+=I.revenue,c+=I.laborCost,u+=I.vehicleCost});const S=l-c-u,b=l>0?S/l*100:0;i.innerHTML=`
    <!-- メインKPI -->
    <div class="grid grid-4" style="margin-bottom:24px">
      ...
      <div class="card stat-card" style="border-top: 4px solid var(--warning)">
        ...
        <div style="font-size:.8rem;color:var(--text-muted);margin-top:4px">平均人件費/人: ¥${p.length>0?Math.round(c/p.length).toLocaleString():0}</div>
      </div>
      ...
      <div class="card">
        ...
        <div style="overflow-x:auto">
          <table class="data-table">
            ...
            <tbody>
              ${p.map(I=>{const k=I.revenue>0?I.profit/I.revenue*100:0;return`
                  <tr>
                    <td>
  ...
  `}async function Kd(){const i=document.getElementById("page-container"),e=Qe();i.innerHTML=`
  ...
  `,document.getElementById("btn-add-sales").addEventListener("click",Xd),await Ui(e)}async function Ui(i){try{const e=await Ne(i),n="staff_1",s=e.filter(p=>p.staffId===n);s.sort((p,S)=>(p.scheduledTime||p.startTime||"").localeCompare(S.scheduledTime||S.startTime||""));const o=document.getElementById("my-schedule-list"),l=s.length,c=s.filter(p=>p.status==="completed").length,u=s.filter(p=>p.status==="cancelled").length;if(document.getElementById("my-schedule-summary").innerHTML=`
      <div class="card stat-card" style="padding: 12px; border-radius: 12px;">
        <div style="font-size: 0.75rem; color: var(--text-muted);">本日の予定</div>
    ...
    `,s.forEach((p,S)=>{const b=p.type==="sales",I=p.duration||60,k=p.status||"scheduled";let x="var(--primary)",A="",D="",P="";k==="completed"?(x="var(--success)",A='<span class="material-icons-round" style="color:var(--success)">check_circle</span>',P='<span class="tag" style="background:var(--success); color:white;">完了</span>'):k==="cancelled"?(x="var(--danger)",A='<span class="material-icons-round" style="color:var(--danger)">cancel</span>',P=`<span class="tag" style="background:var(--danger); color:white;">キャンセル: ${Z(p.cancelReason||"理由なし")}</span>`):D=`
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-top: 12px; padding-top: 12px; border-top: 1px solid var(--border);">
            <button class="btn btn-secondary btn-cancel-visit" data-id="${p.id}" style="padding: 8px; justify-content: center; font-size: 0.85rem;">
              <span class="material-icons-round" style="font-size: 18px;">cancel</span>
              キャンセル
            </button>
            <button class="btn btn-primary btn-complete-visit" data-id="${p.id}" style="padding: 8px; justify-content: center; font-size: 0.85rem; background: var(--success); border-color: var(--success);">
        ...
        <div style="display:flex; align-items:flex-start; gap: 12px;">
          <div style="display:flex; flex-direction:column; align-items:center; width: 40px;">
            <div style="font-size: 0.8rem; font-weight: 600; margin-bottom: 4px; color: ${k!=="scheduled"?"var(--text-muted)":"inherit"};">${p.scheduledTime||p.startTime||"--:--"}</div>
    ...
    `,o.innerHTML=m,document.querySelectorAll(".btn-complete-visit").forEach(p=>{p.addEventListener("click",async S=>{const b=S.currentTarget.dataset.id;if(confirm("この訪問を「完了」にしてよろしいですか？"))try{await vt(b,{status:"completed"}),N("訪問を完了しました","success"),Ui(i)}catch{N("更新に失敗しました","error")}})}),document.querySelectorAll(".btn-cancel-visit").forEach(p=>{p.addEventListener("click",S=>{const b=S.currentTarget.dataset.id;Jd(b,i)})})}catch(e){console.error("マイスケジュール取得エラー:",e),document.getElementById("my-schedule-list").innerHTML=`
  ...
  `,n.style.display="flex",document.getElementById("btn-submit-cancel").addEventListener("click",async()=>{const c=document.getElementById("cancel-reason-select").value;if(!c){N("キャンセル理由を選択してください","warning");return}const u=document.getElementById("cancel-notes").value;try{await vt(i,{status:"cancelled",cancelReason:c,cancelNotes:u}),N("キャンセルを登録しました","success"),n.style.display="none",Ui(e)}catch{N("更新に失敗しました","error")}})}function Xd(){const i=Qe(),e=document.getElementById("modal-overlay"),n=document.getElementById("modal-title"),s=document.getElementById("modal-body"),o=document.getElementById("modal-footer");n.innerHTML='<span class="material-icons-round" style="color:var(--warning)">storefront</span> 営業予定の追加',s.innerHTML=`
    ...
    <div class="form-group">
      ...
      <select id="sales-target-select" class="form-input">
        ${bd.map(l=>`<option value="${l}">${l}</option>`).join("")}
      </select>
    </div>
  ...
  `,e.style.display="flex",document.getElementById("btn-submit-sales").addEventListener("click",async()=>{const l=document.getElementById("sales-client-name").value.trim();if(!l){N("訪問先名を入力してください","warning");return}const c=document.getElementById("sales-target-select").value,u=document.getElementById("sales-start-time").value,m=parseInt(document.getElementById("sales-duration").value,10);try{await ni({staffId:"staff_1",staffName:"佐藤 看護師",clientId:"sales_"+Date.now(),clientName:l,date:i,startTime:u,scheduledTime:u,duration:m,type:"sales",salesTarget:c,status:"scheduled"}),N("営業予定を追加しました","success"),e.style.display="none",Ui(i)}catch(p){console.error(p),N("追加に失敗しました","error")}})}const Yd={dashboard:{render:dd,title:"ダッシュボード"},map:{render:Sd,title:"マップビュー"},staff:{render:es,title:"職員管理"},client:{render:ts,title:"利用者管理"},schedule:{render:Od,title:"日別スケジュール"},calendar:{render:yt,title:"月間カレンダー"},matching:{render:Mo,title:"マッチング＆最適化"},revenue:{render:Gd,title:"収支シミュレーション"},"my-schedule":{render:Kd,title:"マイスケジュール"}};function Qd(){var o,l,c,u;document.querySelectorAll(".nav-item").forEach(m=>{m.addEventListener("click",()=>{const p=m.dataset.page;p&&ht(p)})}),(o=document.getElementById("btn-sidebar-toggle"))==null||o.addEventListener("click",()=>{document.getElementById("sidebar").classList.toggle("collapsed")});const e=document.getElementById("sidebar"),n=document.getElementById("sidebar-overlay"),s=()=>{e.classList.toggle("open"),n.classList.toggle("open")};(l=document.getElementById("btn-mobile-menu"))==null||l.addEventListener("click",s),n==null||n.addEventListener("click",s),(c=document.getElementById("btn-modal-close"))==null||c.addEventListener("click",()=>{document.getElementById("modal-overlay").style.display="none"}),(u=document.getElementById("modal-overlay"))==null||u.addEventListener("click",m=>{m.target===m.currentTarget&&(m.currentTarget.style.display="none")})}async function ht(i){var s,o;const e=Yd[i];if(!e)return;if(window.isAdmin===!1&&i!=="my-schedule"){console.warn("アクセス権限がありません:",i);return}document.querySelectorAll(".nav-item").forEach(l=>{l.classList.toggle("active",l.dataset.page===i)}),(s=document.getElementById("sidebar"))==null||s.classList.remove("open"),(o=document.getElementById("sidebar-overlay"))==null||o.classList.remove("open"),document.title=`${e.title} - CareRoute`;const n=document.getElementById("page-container");n.innerHTML='<div class="loading"><div class="spinner"></div></div>';try{await e.render()}catch(l){console.error(`ページ「${e.title}」の表示エラー:`,l),n.innerHTML=`
      <div class="empty-state">
...
既存データには影響しません。`))){e&&(e.innerHTML=`
    ...
    `);try{const n=await ae(),s=await ce();if(n.length>0||s.length>0){if(!i&&!confirm("既存のデータを全て削除し、新しいエクセルデータを投入しますか？")){e&&(e.innerHTML=`
            <span class="material-icons-round" style="color:var(--secondary)">science</span>
            <span class="nav-label">デモデータ投入</span>
          `);return}typeof Rr=="function"?await Rr():(localStorage.removeItem("careroute_staff"),localStorage.removeItem("careroute_clients"),localStorage.removeItem("careroute_visits"))}for(const u of jr)await Eo(u);N(`職員 ${jr.length}名 を登録しました`,"success");for(const u of qr)await ko(u);N(`利用者 ${qr.length}名 を登録しました`,"success");const o=new Date,l=o.getDay(),c={日:0,月:1,火:2,水:3,木:4,金:5,土:6};for(const u of zr){let m=new Date(o);if(u.dayOfWeek&&c[u.dayOfWeek]!==void 0){const k=c[u.dayOfWeek]-l;m.setDate(o.getDate()+k)}const p=m.getFullYear(),S=String(m.getMonth()+1).padStart(2,"0"),b=String(m.getDate()).padStart(2,"0"),I=`${p}-${S}-${b}`;await ni({...u,date:I,status:"scheduled"})}N(`予定 ${zr.length}件 を登録しました`,"success"),await ht("dashboard"),e.innerHTML=`
