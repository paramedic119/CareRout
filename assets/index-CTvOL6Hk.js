 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pe(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function ra(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(pe())}function sa(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function oa(){const i=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof i=="object"&&i.id!==void 0}function aa(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function ca(){try{return typeof indexedDB=="object"}catch{return!1}}function la(){return new Promise((i,e)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",o=self.indexedDB.open(r);o.onsuccess=()=>{o.result.close(),n||self.indexedDB.deleteDatabase(r),i(!0)},o.onupgradeneeded=()=>{n=!1},o.onerror=()=>{var c;e(((c=o.error)==null?void 0:c.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const da="FirebaseError";class Le extends Error{constructor(e,n,r){super(n),this.code=e,this.customData=r,this.name=da,Object.setPrototypeOf(this,Le.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Nt.prototype.create)}}class Nt{constructor(e,n,r){this.service=e,this.serviceName=n,this.errors=r}create(e,...n){const r=n[0]||{},o=`${this.service}/${e}`,c=this.errors[e],l=c?ua(c,r):"Error",u=`${this.serviceName}: ${l} (${o}).`;return new Le(o,u,r)}}function ua(i,e){return i.replace(ha,(n,r)=>{const o=e[r];return o!=null?String(o):`<${r}?>`})}const ha=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dc="firebase-heartbeat-database",uc=1,kt="firebase-heartbeat-store";let Zi=null;function xs(){return Zi||(Zi=Oa(dc,uc,{upgrade:(i,e)=>{switch(e){case 0:try{i.createObjectStore(kt)}catch(n){console.warn(n)}}}}).catch(i=>{throw In.create("idb-open",{originalErrorMessage:i.message})})),Zi}async function hc(i){try{const n=(await xs()).transaction(kt),r=await n.objectStore(kt).get(Ns(i));return await n.done,r}catch(e){if(e instanceof Le)ye.warn(e.message);else{const n=In.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});ye.warn(n.message)}}}async function Ur(i,e){try{const r=(await xs()).transaction(kt,"readwrite");await r.objectStore(kt).put(e,Ns(i)),await r.done}catch(n){if(n instanceof Le)ye.warn(n.message);else{const r=In.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});ye.warn(r.message)}}}function Ns(i){return`${i.name}!${i.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _c(i){tt(new et("platform-logger",e=>new Ca(e),"PRIVATE")),tt(new et("heartbeat",e=>new pc(e),"PRIVATE")),De(ln,$r,i),De(ln,$r,"esm2020"),De("fire-js","")}_c("");var Ic="firebase",Tc="12.12.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */De(Ic,Tc,"app");var jr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
`}),s}function qi(t,s,a){e:{for(d in a){var d=!1;break e}d=!0}d||(a=mr(a),typeof t=="string"?a!=null&&ct(a):H(t,s,a))}function G(t){Y.call(this),this.headers=new Map,this.L=t||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}S(G,Y);var qo=/^https?$/i,Ho=["POST","PUT"];i=G.prototype,i.Fa=function(t){this.H=t},i.ea=function(t,s,a,d){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+t);s=s?s.toUpperCase():"GET",this.D=t,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():Jn.g(),this.g.onreadystatechange=b(_(this.Ca,this));try{this.B=!0,this.g.open(s,String(t),!0),this.B=!1}catch(w){pr(this,w);return}if(t=a||"",a=new Map(this.headers),d)if(Object.getPrototypeOf(d)===Object.prototype)for(var T in d)a.set(T,d[T]);else if(typeof d.keys=="function"&&typeof d.get=="function")for(const w of d.keys())a.set(w,d.get(w));else throw Error("Unknown input type for opt_headers: "+String(d));d=Array.from(a.keys()).find(w=>w.toLowerCase()=="content-type"),T=l.FormData&&t instanceof l.FormData,!(Array.prototype.indexOf.call(Ho,s,void 0)>=0)||d||T||a.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[w,A]of a)this.g.setRequestHeader(w,A);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(t),this.v=!1}catch(w){pr(this,w)}};function pr(t,s){t.h=!1,t.g&&(t.j=!0,t.g.abort(),t.j=!1),t.l=s,t.o=5,gr(t),zt(t)}function gr(t){t.A||(t.A=!0,Z(t,"complete"),Z(t,"error"))}i.abort=function(t){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=t||7,Z(this,"complete"),Z(this,"abort"),zt(this))},i.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),zt(this,!0)),G.Z.N.call(this)},i.Ca=function(){this.u||(this.B||this.v||this.j?vr(this):this.Xa())},i.Xa=function(){vr(this)};function vr(t){if(t.h&&typeof c<"u"){if(t.v&&be(t)==4)setTimeout(t.Ca.bind(t),0);else if(Z(t,"readystatechange"),be(t)==4){t.h=!1;try{const w=t.ca();e:switch(w){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var s=!0;break e;default:s=!1}var a;if(!(a=s)){var d;if(d=w===0){let A=String(t.D).match(or)[1]||null;!A&&l.self&&l.self.location&&(A=l.self.location.protocol.slice(0,-1)),d=!qo.test(A?A.toLowerCase():"")}a=d}if(a)Z(t,"complete"),Z(t,"success");else{t.o=6;try{var T=be(t)>2?t.g.statusText:""}catch{T=""}t.l=T+" ["+t.ca()+"]",gr(t)}}finally{zt(t)}}}}function zt(t,s){if(t.g){t.m&&(clearTimeout(t.m),t.m=null);const a=t.g;t.g=null,s||Z(t,"ready");try{a.onreadystatechange=null}catch{}}}i.isActive=function(){return!!this.g};function be(t){return t.g?t.g.readyState:0}i.ca=function(){try{return be(this)>2?this.g.status:-1}catch{return-1}},i.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},i.La=function(t){if(this.g){var s=this.g.responseText;return t&&s.indexOf(t)==0&&(s=s.substring(t.length)),wo(s)}};function yr(t){try{if(!t.g)return null;if("response"in t.g)return t.g.response;switch(t.F){case"":case"text":return t.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in t.g)return t.g.mozResponseArrayBuffer}return null}catch{return null}}function zo(t){const s={};t=(t.g&&be(t)>=2&&t.g.getAllResponseHeaders()||"").split(`\r
`);for(let d=0;d<t.length;d++){if(f(t[d]))continue;var a=Po(t[d]);const T=a[0];if(a=a[1],typeof a!="string")continue;a=a.trim();const w=s[T]||[];s[T]=w,w.push(a)}go(s,function(d){return d.join(", ")})}i.ya=function(){return this.o},i.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function vt(t,s,a){return a&&a.internalChannelParams&&a.internalChannelParams[t]||s}function _r(t){this.za=0,this.i=[],this.j=new at,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=vt("failFast",!1,t),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=vt("baseRetryDelayMs",5e3,t),this.Za=vt("retryDelaySeedMs",1e4,t),this.Ta=vt("forwardChannelMaxRetries",2,t),this.va=vt("forwardChannelRequestTimeoutMs",2e4,t),this.ma=t&&t.xmlHttpFactory||void 0,this.Ua=t&&t.Rb||void 0,this.Aa=t&&t.useFetchStreams||!1,this.O=void 0,this.L=t&&t.supportsCrossDomainXhr||!1,this.M="",this.h=new tr(t&&t.concurrentRequestLimit),this.Ba=new jo,this.S=t&&t.fastHandshake||!1,this.R=t&&t.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=t&&t.Pb||!1,t&&t.ua&&this.j.ua(),t&&t.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&t&&t.detectBufferingProxy||!1,this.ia=void 0,t&&t.longPollingTimeout&&t.longPollingTimeout>0&&(this.ia=t.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}i=_r.prototype,i.ka=8,i.I=1,i.connect=function(t,s,a,d){ee(0),this.W=t,this.H=s||{},a&&d!==void 0&&(this.H.OSID=a,this.H.OAID=d),this.F=this.X,this.J=Or(this,null,this.W),Kt(this)};function Hi(t){if(Ir(t),t.I==3){var s=t.V++,a=le(t.J);if(H(a,"SID",t.M),H(a,"RID",s),H(a,"TYPE","terminate"),yt(t,a),s=new Ie(t,t.j,s),s.M=2,s.A=qt(le(a)),a=!1,l.navigator&&l.navigator.sendBeacon)try{a=l.navigator.sendBeacon(s.A.toString(),"")}catch{}!a&&l.Image&&(new Image().src=s.A,a=!0),a||(s.g=Dr(s.j,null),s.g.ea(s.A)),s.F=Date.now(),jt(s)}Ar(t)}function Gt(t){t.g&&(Gi(t),t.g.cancel(),t.g=null)}function Ir(t){Gt(t),t.v&&(l.clearTimeout(t.v),t.v=null),Jt(t),t.h.cancel(),t.m&&(typeof t.m=="number"&&l.clearTimeout(t.m),t.m=null)}function Kt(t){if(!ir(t.h)&&!t.m){t.m=!0;var s=t.Ea;B||h(),V||(B(),V=!0),g.add(s,t),t.D=0}}function Go(t,s){return nr(t.h)>=t.h.j-(t.m?1:0)?!1:t.m?(t.i=s.G.concat(t.i),!0):t.I==1||t.I==2||t.D>=(t.Sa?0:t.Ta)?!1:(t.m=ot(_(t.Ea,t,s),kr(t,t.D)),t.D++,!0)}i.Ea=function(t){if(this.m)if(this.m=null,this.I==1){if(!t){this.V=Math.floor(Math.random()*1e5),t=this.V++;const T=new Ie(this,this.j,t);let w=this.o;if(this.U&&(w?(w=Nn(w),Mn(w,this.U)):w=this.U),this.u!==null||this.R||(T.J=w,w=null),this.S)e:{for(var s=0,a=0;a<this.i.length;a++){t:{var d=this.i[a];if("__data__"in d.map&&(d=d.map.__data__,typeof d=="string")){d=d.length;break t}d=void 0}if(d===void 0)break;if(s+=d,s>4096){s=a;break e}if(s===4096||a===this.i.length-1){s=a+1;break e}}s=1e3}else s=1e3;s=wr(this,T,s),a=le(this.J),H(a,"RID",t),H(a,"CVER",22),this.G&&H(a,"X-HTTP-Session-Id",this.G),yt(this,a),w&&(this.R?s="headers="+ct(mr(w))+"&"+s:this.u&&qi(a,this.u,w)),Fi(this.h,T),this.Ra&&H(a,"TYPE","init"),this.S?(H(a,"$req",s),H(a,"SID","null"),T.U=!0,$i(T,a,null)):$i(T,a,s),this.I=2}}else this.I==3&&(t?Tr(this,t):this.i.length==0||ir(this.h)||Tr(this))};function Tr(t,s){var a;s?a=s.l:a=t.V++;const d=le(t.J);H(d,"SID",t.M),H(d,"RID",a),H(d,"AID",t.K),yt(t,d),t.u&&t.o&&qi(d,t.u,t.o),a=new Ie(t,t.j,a,t.D+1),t.u===null&&(a.J=t.o),s&&(t.i=s.G.concat(t.i)),s=wr(t,a,1e3),a.H=Math.round(t.va*.5)+Math.round(t.va*.5*Math.random()),Fi(t.h,a),$i(a,d,s)}function yt(t,s){t.H&&Ut(t.H,function(a,d){H(s,d,a)}),t.l&&Ut({},function(a,d){H(s,d,a)})}function wr(t,s,a){a=Math.min(t.i.length,a);const d=t.l?_(t.l.Ka,t.l,t):null;e:{var T=t.i;let R=-1;for(;;){const J=["count="+a];R==-1?a>0?(R=T[0].g,J.push("ofs="+R)):R=0:J.push("ofs="+R);let q=!0;for(let X=0;X<a;X++){var w=T[X].g;const de=T[X].map;if(w-=R,w<0)R=Math.max(0,T[X].g-100),q=!1;else try{w="req"+w+"_"||"";try{var A=de instanceof Map?de:Object.entries(de);for(const[Me,Se]of A){let Ee=Se;u(Se)&&(Ee=Pi(Se)),J.push(w+Me+"="+encodeURIComponent(Ee))}}catch(Me){throw J.push(w+"type="+encodeURIComponent("_badmap")),Me}}catch{d&&d(de)}}if(q){A=J.join("&");break e}}A=void 0}return t=t.i.splice(0,a),s.G=t,A}function br(t){if(!t.g&&!t.v){t.Y=1;var s=t.Da;B||h(),V||(B(),V=!0),g.add(s,t),t.A=0}}function zi(t){return t.g||t.v||t.A>=3?!1:(t.Y++,t.v=ot(_(t.Da,t),kr(t,t.A)),t.A++,!0)}i.Da=function(){if(this.v=null,Sr(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var t=4*this.T;this.j.info("BP detection timer enabled: "+t),this.B=ot(_(this.Wa,this),t)}},i.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,ee(10),Gt(this),Sr(this))};function Gi(t){t.B!=null&&(l.clearTimeout(t.B),t.B=null)}function Sr(t){t.g=new Ie(t,t.j,"rpc",t.Y),t.u===null&&(t.g.J=t.o),t.g.P=0;var s=le(t.na);H(s,"RID","rpc"),H(s,"SID",t.M),H(s,"AID",t.K),H(s,"CI",t.F?"0":"1"),!t.F&&t.ia&&H(s,"TO",t.ia),H(s,"TYPE","xmlhttp"),yt(t,s),t.u&&t.o&&qi(s,t.u,t.o),t.O&&(t.g.H=t.O);var a=t.g;t=t.ba,a.M=1,a.A=qt(le(s)),a.u=null,a.R=!0,Qn(a,t)}i.Va=function(){this.C!=null&&(this.C=null,Gt(this),zi(this),ee(19))};function Jt(t){t.C!=null&&(l.clearTimeout(t.C),t.C=null)}function Er(t,s){var a=null;if(t.g==s){Jt(t),Gi(t),t.g=null;var d=2}else if(Ui(t.h,s))a=s.G,rr(t.h,s),d=1;else return;if(t.I!=0){if(s.o)if(d==1){a=s.u?s.u.length:0,s=Date.now()-s.F;var T=t.D;d=xi(),Z(d,new Kn(d,a)),Kt(t)}else br(t);else if(T=s.m,T==3||T==0&&s.X>0||!(d==1&&Go(t,s)||d==2&&zi(t)))switch(a&&a.length>0&&(s=t.h,s.i=s.i.concat(a)),T){case 1:Re(t,5);break;case 4:Re(t,10);break;case 3:Re(t,6);break;default:Re(t,2)}}}function kr(t,s){let a=t.Qa+Math.floor(Math.random()*t.Za);return t.isActive()||(a*=2),a*s}function Re(t,s){if(t.j.info("Error code "+s),s==2){var a=_(t.bb,t),d=t.Ua;const T=!d;d=new Te(d||"//www.google.com/images/cleardot.gif"),l.location&&l.location.protocol=="http"||dt(d,"https"),qt(d),T?Fo(d.toString(),a):Vo(d.toString(),a)}else ee(2);t.I=0,t.l&&t.l.pa(s),Ar(t),Ir(t)}i.bb=function(t){t?(this.j.info("Successfully pinged google.com"),ee(2)):(this.j.info("Failed to ping google.com"),ee(1))};function Ar(t){if(t.I=0,t.ja=[],t.l){const s=sr(t.h);(s.length!=0||t.i.length!=0)&&(P(t.ja,s),P(t.ja,t.i),t.h.i.length=0,k(t.i),t.i.length=0),t.l.oa()}}function Or(t,s,a){var d=a instanceof Te?le(a):new Te(a);if(d.g!="")s&&(d.g=s+"."+d.g),ut(d,d.u);else{var T=l.location;d=T.protocol,s=s?s+"."+T.hostname:T.hostname,T=+T.port;const w=new Te(null);d&&dt(w,d),s&&(w.g=s),T&&ut(w,T),a&&(w.h=a),d=w}return a=t.G,s=t.wa,a&&s&&H(d,a,s),H(d,"VER",t.ka),yt(t,d),d}function Dr(t,s,a){if(s&&!t.L)throw Error("Can't create secondary domain capable XhrIo object.");return s=t.Aa&&!t.ma?new G(new ji({ab:a})):new G(t.ma),s.Fa(t.L),s}i.isActive=function(){return!!this.l&&this.l.isActive(this)};function Pr(){}i=Pr.prototype,i.ra=function(){},i.qa=function(){},i.pa=function(){},i.oa=function(){},i.isActive=function(){return!0},i.Ka=function(){};function re(t,s){Y.call(this),this.g=new _r(s),this.l=t,this.h=s&&s.messageUrlParams||null,t=s&&s.messageHeaders||null,s&&s.clientProtocolHeaderRequired&&(t?t["X-Client-Protocol"]="webchannel":t={"X-Client-Protocol":"webchannel"}),this.g.o=t,t=s&&s.initMessageHeaders||null,s&&s.messageContentType&&(t?t["X-WebChannel-Content-Type"]=s.messageContentType:t={"X-WebChannel-Content-Type":s.messageContentType}),s&&s.sa&&(t?t["X-WebChannel-Client-Profile"]=s.sa:t={"X-WebChannel-Client-Profile":s.sa}),this.g.U=t,(t=s&&s.Qb)&&!f(t)&&(this.g.u=t),this.A=s&&s.supportsCrossDomainXhr||!1,this.v=s&&s.sendRawJson||!1,(s=s&&s.httpSessionIdParam)&&!f(s)&&(this.g.G=s,t=this.h,t!==null&&s in t&&(t=this.h,s in t&&delete t[s])),this.j=new Xe(this)}S(re,Y),re.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},re.prototype.close=function(){Hi(this.g)},re.prototype.o=function(t){var s=this.g;if(typeof t=="string"){var a={};a.__data__=t,t=a}else this.v&&(a={},a.__data__=Pi(t),t=a);s.i.push(new xo(s.Ya++,t)),s.I==3&&Kt(s)},re.prototype.N=function(){this.g.l=null,delete this.j,Hi(this.g),delete this.g,re.Z.N.call(this)};function Cr(t){Ci.call(this),t.__headers__&&(this.headers=t.__headers__,this.statusCode=t.__status__,delete t.__headers__,delete t.__status__);var s=t.__sm__;if(s){e:{for(const a in s){t=a;break e}t=void 0}(this.i=t)&&(t=this.i,s=s!==null&&t in s?s[t]:void 0),this.data=s}else this.data=t}S(Cr,Ci);function Lr(){Li.call(this),this.status=1}S(Lr,Li);function Xe(t){this.g=t}S(Xe,Pr),Xe.prototype.ra=function(){Z(this.g,"a")},Xe.prototype.qa=function(t){Z(this.g,new Cr(t))},Xe.prototype.pa=function(t){Z(this.g,new Lr)},Xe.prototype.oa=function(){Z(this.g,"b")},re.prototype.send=re.prototype.o,re.prototype.open=re.prototype.m,re.prototype.close=re.prototype.close,Ni.NO_ERROR=0,Ni.TIMEOUT=8,Ni.HTTP_ERROR=6,Do.COMPLETE="complete",So.EventType=rt,rt.OPEN="a",rt.CLOSE="b",rt.ERROR="c",rt.MESSAGE="d",Y.prototype.listen=Y.prototype.J,G.prototype.listenOnce=G.prototype.K,G.prototype.getLastError=G.prototype.Ha,G.prototype.getLastErrorCode=G.prototype.ya,G.prototype.getStatus=G.prototype.ca,G.prototype.getResponseJson=G.prototype.La,G.prototype.getResponseText=G.prototype.la,G.prototype.send=G.prototype.ea,G.prototype.setWithCredentials=G.prototype.Fa}).apply(typeof Yt<"u"?Yt:typeof self<"u"?self:typeof window<"u"?window:{});/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dc(i){const e=typeof self<"u"&&(self.crypto||self.msCrypto),n=new Uint8Array(i);if(e&&typeof e.getRandomValues=="function")e.getRandomValues(n);else for(let r=0;r<i;r++)n[r]=Math.floor(256*Math.random());return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zr=-62135596800,Gr=1e6;class he{static now(){return he.fromMillis(Date.now())}static fromDate(e){return he.fromMillis(e.getTime())}static fromMillis(e){const n=Math.floor(e/1e3),r=Math.floor((e-1e3*n)*Gr);return new he(n,r)}constructor(e,n){if(this.seconds=e,this.nanoseconds=n,n<0)throw new F(U.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+n);if(n>=1e9)throw new F(U.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+n);if(e<zr)throw new F(U.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e);if(e>=253402300800)throw new F(U.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e)}toDate(){return new Date(this.toMillis())}toMillis(){return 1e3*this.seconds+this.nanoseconds/Gr}_compareTo(e){return this.seconds===e.seconds?Pe(this.nanoseconds,e.nanoseconds):Pe(this.seconds,e.seconds)}isEqual(e){return e.seconds===this.seconds&&e.nanoseconds===this.nanoseconds}toString(){return"Timestamp(seconds="+this.seconds+", nanoseconds="+this.nanoseconds+")"}toJSON(){return{type:he._jsonSchemaVersion,seconds:this.seconds,nanoseconds:this.nanoseconds}}static fromJSON(e){if(Mt(e,he._jsonSchema))return new he(e.seconds,e.nanoseconds)}valueOf(){const e=this.seconds-zr;return String(e).padStart(12,"0")+"."+String(this.nanoseconds).padStart(9,"0")}}he._jsonSchemaVersion="firestore/timestamp/1.0",he._jsonSchema={type:K("string",he._jsonSchemaVersion),seconds:K("number"),nanoseconds:K("number")};function $c(i){return i.name==="IndexedDbTransactionError"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */wt._jsonSchemaVersion="firestore/querySnapshot/1.0",wt._jsonSchema={type:K("string",wt._jsonSchemaVersion),bundleSource:K("string","QuerySnapshot"),bundleName:K("string"),bundle:K("string")};(function(e,n=!0){wc(vi),tt(new et("firestore",(r,{instanceIdentifier:o,options:c})=>{const l=r.getProvider("app").getImmediate(),u=new Jc(new Ec(r.getProvider("auth-internal")),new Oc(l,r.getProvider("app-check-internal")),Wc(l,o),l);return c={useFetchStreams:n,...c},u._setSettings(c),u},"PUBLIC").setMultipleInstances(!0)),De(rs,ss,e),De(rs,ss,"esm2020")})();function Fs(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const el=Fs,Vs=new Nt("auth","Firebase",Fs());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const al=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],cl=new $t(3e4,6e4);function zs(i,e){return i.tenantId&&!e.tenantId?{...e,tenantId:i.tenantId}:e}async function _i(i,e,n,r,o={}){return Gs(i,o,async()=>{let c={},l={};r&&(e==="GET"?l=r:c={body:JSON.stringify(r)});const u=Ds({key:i.config.apiKey,...l}).slice(1),p=await i._getAdditionalHeaders();p["Content-Type"]="application/json",i.languageCode&&(p["X-Firebase-Locale"]=i.languageCode);const _={method:e,headers:p,...c};return sa()||(_.referrerPolicy="no-referrer"),i.emulatorConfig&&Ps(i.emulatorConfig.host)&&(_.credentials="include"),Hs.fetch()(await Ks(i,i.config.apiHost,n,u),_)})}async function Gs(i,e,n){i._canInitEmulator=!1;const r={...ol,...e};try{const o=new ll(i),c=await Promise.race([n(),o.promise]);o.clearNetworkTimeout();const l=await c.json();if("needConfirmation"in l)throw Zt(i,"account-exists-with-different-credential",l);if(c.ok&&!("errorMessage"in l))return l;{const u=c.ok?l.errorMessage:l.error.message,[p,_]=u.split(" : ");if(p==="FEDERATED_USER_ID_ALREADY_LINKED")throw Zt(i,"credential-already-in-use",l);if(p==="EMAIL_EXISTS")throw Zt(i,"email-already-in-use",l);if(p==="USER_DISABLED")throw Zt(i,"user-disabled",l);const E=r[p]||p.toLowerCase().replace(/[_\s]+/g,"-");if(_)throw qs(i,E,_);os(i,E)}}catch(o){if(o instanceof Le)throw o;os(i,"network-request-failed",{message:String(o)})}}async function Ks(i,e,n,r){const o=`${e}${n}?${r}`,c=i,l=c.config.emulator?sl(i.config,o):`${i.config.apiScheme}://${o}`;return al.includes(n)&&(await c._persistenceManagerAvailable,c._getPersistenceType()==="COOKIE")?c._getPersistence()._getFinalTarget(l).toString():l}class ll{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,r)=>{this.timer=setTimeout(()=>r(js(this.auth,"network-request-failed")),cl.get())})}}function Zt(i,e,n){const r={appName:i.name};n.email&&(r.email=n.email),n.phoneNumber&&(r.phoneNumber=n.phoneNumber);const o=js(i,e,r);return o.customData._tokenResponse=n,o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function un(i,e,n=!1){if(n)return e;try{return await e}catch(r){throw r instanceof Le&&hl(r)&&i.auth.currentUser===i&&await i.auth.signOut(),r}}function hl({code:i}){return i==="auth/user-disabled"||i==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qs(i,e=[]){let n;switch(i){case"Browser":n=us(pe());break;case"Worker":n=`${us(pe())}-${i}`;break;default:n=i}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${vi}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xl(i){switch(i){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Nl(i){tt(new et("auth",(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),o=e.getProvider("heartbeat"),c=e.getProvider("app-check-internal"),{apiKey:l,authDomain:u}=r.options;W(l&&!l.includes(":"),"invalid-api-key",{appName:r.name});const p={apiKey:l,authDomain:u,clientPlatform:i,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Qs(i)},_=new Dl(r,o,c,p);return Cl(_,n),_},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,r)=>{e.getProvider("auth-internal").initialize()})),tt(new et("auth-internal",e=>{const n=Pl(e.getProvider("auth").getImmediate());return(r=>new Ll(r))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),De(fs,ms,xl(i)),De(fs,ms,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const Rl=5*60;na("authIdTokenMaxAge");Nl("Browser");console.warn("⚠️ Firebase未設定。.envファイルにAPIキーを設定してください。");function Zs(i){const e=new Date(i),n=e.getFullYear(),r=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${n}-${r}-${o}`}function At(i){const e=new Date(i),n=["日","月","火","水","木","金","土"];return`${e.getMonth()+1}月${e.getDate()}日（${n[e.getDay()]}）`}function Bt(){return Zs(new Date)}function Ml(i){const e=Math.floor(i/60),n=i%60;return`${String(e).padStart(2,"0")}:${String(n).padStart(2,"0")}`}function te(i){if(!i)return 0;const[e,n]=i.split(":").map(Number);return e*60+n}function eo(){return Date.now().toString(36)+Math.random().toString(36).slice(2,9)}function to(i,e,n,r){const c=ei(n-i),l=ei(r-e),u=Math.sin(c/2)**2+Math.cos(ei(i))*Math.cos(ei(n))*Math.sin(l/2)**2;return 6371*2*Math.atan2(Math.sqrt(u),Math.sqrt(1-u))}function ei(i){return i*(Math.PI/180)}function se(i){const e=document.createElement("div");return e.textContent=i,e.innerHTML}function N(i,e="info",n=3e3){const r=document.getElementById("toast-container"),o={success:"check_circle",error:"error",warning:"warning",info:"info"},c=document.createElement("div");c.className=`toast ${e}`,c.innerHTML=`
  ...
  `,r.appendChild(c),setTimeout(()=>{c.style.opacity="0",c.style.transform="translateX(40px)",c.style.transition="all .3s ease",setTimeout(()=>c.remove(),300)},n)}function Ii(i,e,n=""){const r=document.getElementById("modal-overlay");document.getElementById("modal-title").textContent=i,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=n,r.style.display="flex"}function Ce(){document.getElementById("modal-overlay").style.display="none"}function Ti(i,e){return new Promise(n=>{const r=`<p>${se(e)}</p>`;Ii(i,r,`
    ...
    `),document.getElementById("confirm-ok").onclick=()=>{Ce(),n(!0)},document.getElementById("confirm-cancel").onclick=()=>{Ce(),n(!1)}})}function Ot(i,e){const r={身体介護:{20:1670,30:2500,60:3960,90:5790,120:7630},生活援助:{20:1830,45:2250,60:2870},通院等乗降介助:{per_trip:990},医療的ケア:{30:3e3,60:5e3}}[i];if(!r)return 3e3;if(r.per_trip)return r.per_trip;const o=Object.keys(r).map(Number).sort((l,u)=>l-u);let c=o[0];for(const l of o)e>=l&&(c=l);return r[c]||3e3}function $l(i){{console.warn("Firebase未設定のためログイン画面を表示します"),setTimeout(()=>i(null,null),100);return}}async function Bl(){throw new Error("Firebase未設定です。.envにAPIキーを設定してください。")}async function Wl(){}function Ul(){const i=document.getElementById("btn-google-login");i&&i.addEventListener("click",async()=>{i.disabled=!0,i.textContent="ログイン中...";try{await Bl()}catch(e){console.error("ログインエラー:",e),e.code==="auth/popup-closed-by-user"?N("ログインがキャンセルされました","warning"):N("ログインに失敗しました","error"),i.disabled=!1,i.innerHTML=`
        ...
        Googleアカウントでログイン
      `}})}const Ae={};function it(i){if(!Ae[i]){const e=localStorage.getItem(`careroute_${i}`);Ae[i]=e?JSON.parse(e):[]}return Ae[i]}function wi(i){localStorage.setItem(`careroute_${i}`,JSON.stringify(Ae[i]||[]))}async function ps(){localStorage.removeItem("careroute_staff"),localStorage.removeItem("careroute_clients"),localStorage.removeItem("careroute_visits"),localStorage.removeItem("careroute_routes"),Ae.staff=[],Ae.clients=[],Ae.visits=[],Ae.routes=[]}async function kn(i,e){{const n=eo();return it(i).push({id:n,...e,createdAt:new Date().toISOString()}),wi(i),n}}async function An(i){return it(i)}async function On(i,e,n){{const r=it(i),o=r.findIndex(c=>c.id===e);o!==-1&&(r[o]={...r[o],...n,updatedAt:new Date().toISOString()},wi(i));return}}async function Dn(i,e){{const n=it(i),r=n.findIndex(o=>o.id===e);r!==-1&&(n.splice(r,1),wi(i));return}}async function io(i,e,n,r){return it(i).filter(c=>c[e]===r)}async function ge(){return An("staff")}async function no(i){return kn("staff",i)}async function Fl(i,e){return On("staff",i,e)}async function Vl(i){return Dn("staff",i)}async function _e(){return An("clients")}async function ro(i){return kn("clients",i)}async function jl(i,e){return On("clients",i,e)}async function ql(i){return Dn("clients",i)}async function so(){return An("visits")}async function ze(i){return io("visits","date","==",i)}async function Pn(i){return kn("visits",i)}async function gs(i,e){return On("visits",i,e)}async function Hl(i){return Dn("visits",i)}async function Cn(i){return io("routes","date","==",i)}async function zl(i){{const e=it("routes");for(const n of i){const r=e.findIndex(o=>o.staffId===n.staffId&&o.date===n.date);r>=0?e[r]={...n,updatedAt:new Date().toISOString()}:e.push({id:eo(),...n,createdAt:new Date().toISOString()})}wi("routes");return}}async function Gl(){const i=document.getElementById("page-container"),[e,n]=await Promise.all([ge().catch(()=>[]),_e().catch(()=>[])]),r=Bt(),o=await ze(r).catch(()=>[]),c=e.filter(p=>p.isActive),l=n.filter(p=>p.isActive),u=o.filter(p=>p.status!=="cancelled");i.innerHTML=`
  ...
  `}let ne=null,Dt=[],fn=[],Pt=null,mn=null,pn=[];function Ct(){return new Promise((i,e)=>{if(window.google&&window.google.maps){i();return}const n="AIzaSyCXFNBQjeiYpRYFdbs6VhISqlFZhrybM74",r=document.createElement("script");r.src=`https://maps.googleapis.com/maps/api/js?key=${n}&libraries=geometry,places&language=ja`,r.async=!0,r.defer=!0,r.onload=i,r.onerror=()=>e(new Error("Google Maps APIの読み込みに失敗しました")),document.head.appendChild(r)})}function Kl(i,e={lat:35.6938,lng:139.7034},n=14){const r=document.getElementById(i);return r?!window.google||!window.google.maps?(r.innerHTML=`
  ...
  `}}function od(i,e){const n=document.getElementById("route-legend");n&&(n.innerHTML=`
    ...
    `)}let Lt=[];async function Ln(){const i=document.getElementById("page-container");Lt=await ge().catch(()=>[]),i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
  ...
  `),document.getElementById("sf-cancel").onclick=Ce,document.getElementById("sf-save").onclick=async()=>{const c=document.getElementById("sf-name").value.trim();if(!c){N("氏名を入力してください","warning");return}const l=document.getElementById("sf-save");l.disabled=!0,l.textContent="保存中...";const u=document.getElementById("sf-address").value.trim();let p=(i==null?void 0:i.lat)||Q.lat,_=(i==null?void 0:i.lng)||Q.lng;if(u)try{await Ct();const S=await ao(u);S?(p=S.lat,_=S.lng):N("住所から座標を取得できませんでした","warning")}catch(S){console.warn("ジオコーディング失敗:",S)}const E={name:c,gender:document.getElementById("sf-gender").value,address:u,workStart:document.getElementById("sf-work-start").value,workEnd:document.getElementById("sf-work-end").value,lat:p,lng:_,skills:{},color:(i==null?void 0:i.color)||_s[Lt.length%_s.length],isActive:!0};for(const[S]of Object.entries(fi)){const b=document.querySelectorAll(`input[name="skill-${S}"]:checked`);E.skills[S]=Array.from(b).map(k=>k.value)}try{e?(await Fl(i.id,E),N("職員情報を更新しました","success")):(await no(E),N("職員を登録しました","success")),Ce(),await Ln()}catch(S){N("保存に失敗しました: "+S.message,"error")}finally{l.disabled=!1,l.textContent=e?"更新":"登録"}}}document.addEventListener("click",async i=>{const e=i.target.closest("[data-edit-staff]");if(e){const r=Lt.find(o=>o.id===e.dataset.editStaff);r&&lo(r)}const n=i.target.closest("[data-delete-staff]");if(n){const r=Lt.find(o=>o.id===n.dataset.deleteStaff);if(r&&await Ti("削除確認",`${r.name} を削除しますか？`))try{await Vl(r.id),N(`${r.name} を削除しました`,"success"),await Ln()}catch{N("削除に失敗しました","error")}}});let pi=[],Is=[];async function xn(){const i=document.getElementById("page-container");try{const[e,n]=await Promise.all([_e().catch(()=>[]),so().catch(()=>[])]);pi=e,Is=n}catch(e){console.error("データの取得に失敗",e)}i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
  ...
  `),document.getElementById("cf-cancel").onclick=Ce,document.getElementById("cf-save").onclick=async()=>{const u=document.getElementById("cf-name").value.trim();if(!u){N("氏名を入力してください","warning");return}const p=document.getElementById("cf-save");p.disabled=!0,p.textContent="保存中...";const _=document.getElementById("cf-address").value.trim();let E=(i==null?void 0:i.lat)||Q.lat,S=(i==null?void 0:i.lng)||Q.lng;if(_)try{await Ct();const k=await ao(_);k?(E=k.lat,S=k.lng,N(`座標を取得しました: ${k.lat.toFixed(4)}, ${k.lng.toFixed(4)}`,"success")):N("住所から座標を取得できませんでした。事業所付近の座標を使用します。","warning")}catch(k){console.warn("ジオコーディング失敗:",k),N("座標取得に失敗。事業所付近の座標を使用します。","warning")}const b={name:u,careLevel:document.getElementById("cf-care-level").value,address:_,requiredServices:Array.from(document.querySelectorAll('input[name="cf-service"]:checked')).map(k=>k.value),requiredSkills:Array.from(document.querySelectorAll('input[name="cf-skill"]:checked')).map(k=>k.value),genderPreference:document.getElementById("cf-gender-pref").value,visitDuration:parseInt(document.getElementById("cf-duration").value)||60,timeWindow:{start:document.getElementById("cf-time-start").value,end:document.getElementById("cf-time-end").value},notes:document.getElementById("cf-notes").value.trim(),lat:E,lng:S,isActive:!0};try{e?(await jl(i.id,b),N("利用者情報を更新しました","success")):(await ro(b),N("利用者を登録しました","success")),Ce(),await xn()}catch(k){N("保存に失敗しました: "+k.message,"error")}finally{p.disabled=!1,p.textContent=e?"更新":"登録"}}}document.addEventListener("click",async i=>{const e=i.target.closest("[data-edit-client]");if(e){const r=pi.find(o=>o.id===e.dataset.editClient);r&&uo(r)}const n=i.target.closest("[data-delete-client]");if(n){const r=pi.find(o=>o.id===n.dataset.deleteClient);if(r&&await Ti("削除確認",`${r.name} を削除しますか？`))try{await ql(r.id),N(`${r.name} を削除しました`,"success"),await xn()}catch{N("削除に失敗しました","error")}}});let Fe=Bt();async function ld(){const i=document.getElementById("page-container");i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
  ...
  `,document.getElementById("schedule-date").addEventListener("change",e=>{Fe=e.target.value,xt()}),document.getElementById("btn-add-visit").addEventListener("click",dd),document.getElementById("btn-generate-week").addEventListener("click",ud),await xt()}async function xt(){const i=document.getElementById("schedule-content"),[e,n,r,o]=await Promise.all([ge().catch(()=>[]),_e().catch(()=>[]),ze(Fe).catch(()=>[]),Cn(Fe).catch(()=>[])]);if(r.length===0){i.innerHTML=`
    ...
    `;return}const c={},l=[];let u=0,p=0,_=0;for(const b of r)b.staffId?(c[b.staffId]||(c[b.staffId]=[]),c[b.staffId].push(b)):l.push(b);let E="";l.length>0&&(E=`
      <div class="card" style="border-left: 4px solid var(--danger); margin-bottom: 24px; background: rgba(239, 68, 68, 0.05);">
        ...
        <div class="grid grid-3" style="gap: 12px;">
          ${l.map(b=>{const k=n.find(P=>P.id===b.clientId);return`
    ...
    `);for(const[b,k]of Object.entries(c)){const P=e.find(O=>O.id===b);if(!P)continue;const D=o.find(O=>O.staffId===b),C=parseInt(P.wage)||2e3;if(D&&(_+=(D.totalDistance||0)*si),k.sort((O,L)=>(O.startTime||O.scheduledTime||"").localeCompare(L.startTime||L.scheduledTime||"")),D&&D.schedule&&D.schedule.length>=2){const O=D.schedule[0].arrivalMinutes,M=(D.schedule[D.schedule.length-1].arrivalMinutes-O)/60;p+=M*C}else if(k.length>0){const O=k[0],L=k[k.length-1],M=O.startTime||O.scheduledTime||"09:00",x=L.startTime||L.scheduledTime||"17:00",B=te(M),g=(te(x)+(L.duration||60)-B)/60;p+=g*C}k.forEach((O,L)=>{O.income?u+=parseInt(O.income):u+=Ot(O.service||"身体介護",O.duration||60);let M=10,x=null;if(D&&D.schedule){const B=D.schedule.find(V=>V.clientId===O.clientId);B&&(M=B.travelTimeFromPrev||10,x=B.arrivalTime)}O.calculatedTravelTime=M,O.optimizedArrivalTime=x})}let S="";if(window.isAdmin){const b=u-p-_,k=u>0?Math.round(b/u*100):0;S=`
    ...
    <div class="grid grid-2">
      ${Object.entries(c).map(([b,k])=>{const P=e.find(D=>D.id===b);return`
          <div class="card" style="border-left:4px solid ${(P==null?void 0:P.color)||"#999"}">
            ...
            <div class="schedule-timeline">
              ${k.map((D,C)=>{const O=n.find(B=>B.id===D.clientId),L=D.optimizedArrivalTime||D.startTime||D.scheduledTime||"--:--";let M="",x="";if(C>0){const B=k[C-1],V=B.optimizedArrivalTime||B.startTime||B.scheduledTime,g=D.calculatedTravelTime||10;if(V&&L!=="--:--"){const[h,m]=V.split(":").map(Number),[y,v]=L.split(":").map(Number),I=h*60+m+(B.duration||60),z=y*60+v-I;z<g&&(x=`
  ...
  `}async function dd(){const[i,e]=await Promise.all([ge().catch(()=>[]),_e().catch(()=>[])]),n=`
    <form id="visit-form">
      <div class="form-group">
  ...
  `);const r=()=>{const o=document.getElementById("vf-service").value,c=parseInt(document.getElementById("vf-duration").value)||60,l=Ot(o,c);document.getElementById("vf-income").value=l,document.getElementById("vf-income-hint").textContent=`↑ ${o} ${c}分 → ¥${l.toLocaleString()}（自動計算）`};document.getElementById("vf-service").addEventListener("change",r),document.getElementById("vf-duration").addEventListener("change",r),r(),document.getElementById("vf-cancel").onclick=Ce,document.getElementById("vf-save").onclick=async()=>{const o=document.getElementById("vf-client").value,c=document.getElementById("vf-staff").value;if(!o||!c){N("利用者と職員を選択してください","warning");return}try{const l=parseInt(document.getElementById("vf-duration").value)||60,u=document.getElementById("vf-service").value,p=document.getElementById("vf-time").value,_=te(p)+l,E=Math.floor(_/60),S=_%60,b=`${String(E).padStart(2,"0")}:${String(S).padStart(2,"0")}`;await Pn({date:Fe,clientId:o,staffId:c,startTime:p,endTime:b,scheduledTime:p,duration:l,service:u,income:parseInt(document.getElementById("vf-income").value)||Ot(u,l),status:"scheduled"}),N("訪問予定を追加しました","success"),Ce(),await xt()}catch{N("追加に失敗しました","error")}}}async function ud(){var e;if(await Ti("週間スケジュール自動生成",`利用者の曜日設定に基づいて、今週（月〜土）の訪問予定を自動生成します。
既存の予定がある日はスキップされます。

実行しますか？`))try{const[n,r]=await Promise.all([_e(),so()]),o={月:1,火:2,水:3,木:4,金:5,土:6},c=new Date,l=c.getDay(),u=r.filter(S=>S.dayOfWeek&&o[S.dayOfWeek]!==void 0);let p=0,_=0;const E=new Map;for(const S of u){const b=o[S.dayOfWeek];if(b===void 0)continue;const k=b-l,P=new Date(c);P.setDate(c.getDate()+k);const D=Zs(P),C=`${D}_${S.clientId}`;if(E.has(C)){E.get(C).timeOptions.push({startTime:S.startTime||"09:00",duration:S.duration||60});continue}if((await ze(D)).some(L=>L.clientId===S.clientId)){E.set(C,null),_++;continue}E.set(C,{...S,date:D,timeOptions:[{startTime:S.startTime||"09:00",duration:S.duration||60}]})}for(const[S,b]of E){if(!b)continue;const k=n.find(V=>V.id===b.clientId),P=b.service||((e=k==null?void 0:k.requiredServices)==null?void 0:e[0])||"身体介護",D=b.duration||(k==null?void 0:k.visitDuration)||60,C=b.startTime||"09:00",O=Ot(P,D),L=te(C)+D,M=Math.floor(L/60),x=L%60,B=`${String(M).padStart(2,"0")}:${String(x).padStart(2,"0")}`;await Pn({date:b.date,clientId:b.clientId,clientName:b.clientName||(k==null?void 0:k.name)||"利用者",staffId:b.staffId||null,staffName:b.staffName||"未設定",startTime:C,endTime:B,scheduledTime:C,duration:D,service:P,income:O,dayOfWeek:b.dayOfWeek,status:"scheduled",timeOptions:b.timeOptions}),p++}p>0?N(`今週の訪問予定 ${p}件 を自動生成しました！${_>0?`（${_}件は既存のためスキップ）`:""}`,"success"):N(`生成する予定がありませんでした。${_>0?`（${_}件は既に登録済み）`:"利用者の曜日設定を確認してください。"}`,"warning"),await xt()}catch(n){console.error("週間スケジュール生成エラー:",n),N("スケジュール生成に失敗しました: "+n.message,"error")}}document.addEventListener("click",async i=>{const e=i.target.closest("[data-delete-visit]");if(e&&await Ti("削除確認","この訪問予定を削除しますか？"))try{await Hl(e.dataset.deleteVisit),N("訪問予定を削除しました","success"),await xt()}catch{N("削除に失敗しました","error")}});function hd(i,e){var l,u,p,_,E;let n=0;const r=[];let o=!0;for(const S of e.requiredServices||[])(u=(l=i.skills)==null?void 0:l.services)!=null&&u.includes(S)?(n+=_t.requiredSkill,r.push(`✅ ${S}対応可`)):(o=!1,r.push(`❌ ${S}に対応不可`));const c=[...((p=i.skills)==null?void 0:p.qualifications)||[],...((_=i.skills)==null?void 0:_.physical)||[],...((E=i.skills)==null?void 0:E.special)||[]];for(const S of e.requiredSkills||[])c.includes(S)?(n+=_t.requiredSkill,r.push(`✅ ${S}あり`)):(o=!1,r.push(`❌ ${S}なし`));if(e.genderPreference&&e.genderPreference!=="指定なし"){const S=e.genderPreference.replace("希望","");i.gender===S?(n+=_t.genderMatch,r.push(`✅ 性別希望合致（${S}）`)):(o=!1,r.push(`❌ 性別希望不一致（希望: ${S}）`))}if(i.type==="正社員"&&(n+=_t.staffType,r.push("✅ 正社員")),i.lat&&e.lat){const S=to(i.lat,i.lng,e.lat,e.lng),b=Math.max(0,_t.proximity*(1-S/10));n+=b}return{score:Math.round(n),reasons:r,eligible:o}}function fd(i,e,n=[],r=null,o=[]){const c=[],l=new Set,u={},p={};o.forEach((b,k)=>{p[b.id]=k});const _=(b,k)=>{if(!r)return 15;const P=p[b],D=p[k];return P!==void 0&&D!==void 0&&r[P][D]&&r[P][D].duration||15},E=[...e].sort((b,k)=>{const P=b.startTime||b.scheduledTime||"00:00",D=k.startTime||k.scheduledTime||"00:00";return P.localeCompare(D)});for(const b of E){const k=i.filter(O=>O.isActive).map(O=>{const L=n.find(g=>g.id===b.clientId),{score:M,eligible:x}=hd(O,L||b),B=b.timeOptions&&b.timeOptions.length>0?b.timeOptions:[{startTime:b.startTime||b.scheduledTime||"09:00",duration:b.duration||60}];let V=null;for(const g of B){let h=!0;const m=te(g.startTime),y=m+(g.duration||60),v=c.filter(I=>I.staffId===O.id);for(const I of v){const f=te(I.startTime),z=f+(I.duration||60);if(m<z&&y>f){h=!1;break}const ce=_(I.clientId,b.clientId);if(m>=z){if(m-z<ce){h=!1;break}}else if(y<=f&&f-y<ce){h=!1;break}}if(h){V=g;break}}return{staff:O,score:M,eligible:x&&!!V,chosenTime:V}}).filter(O=>O.eligible);if(k.length===0)continue;k.sort((O,L)=>{const M=u[O.staff.id]||0,x=u[L.staff.id]||0,B=O.staff.maxVisits||(O.staff.type==="パート"?5:10),V=L.staff.maxVisits||(L.staff.type==="パート"?5:10),g=M>=B,h=x>=V;return g!==h?g?1:-1:M!==x?M-x:O.staff.type!==L.staff.type?O.staff.type==="正社員"?-1:1:L.score-O.score});const P=k[0],D=u[P.staff.id]||0,C=P.staff.maxVisits||(P.staff.type==="パート"?5:10);if(D<C){const O=P.chosenTime.startTime,L=P.chosenTime.duration||60,M=te(O)+L;c.push({staffId:P.staff.id,staffName:P.staff.name,visitId:b.id,clientId:b.clientId,clientName:b.clientName||"利用者",score:P.score,startTime:O,endTime:minutesToTime(M),scheduledTime:O,duration:L}),l.add(b.id),u[P.staff.id]=D+1}}const S=e.filter(b=>!l.has(b.id)).map(b=>({visitId:b.id,clientName:b.clientName||"利用者",reason:"適格な職員なし、または上限超過"}));return{assignments:c,unassigned:S}}async function md(i,e,n,r=Q,o=null){const c={};for(const u of i)c[u.staffId]||(c[u.staffId]=[]),c[u.staffId].push(u.clientId);const l={};for(const[u,p]of Object.entries(c)){const _=e.find(O=>O.id===u),E=p.map(O=>n.find(L=>L.id===O)).filter(Boolean);if(E.length===0)continue;const S=[{id:"office",name:"事業所",lat:r.lat,lng:r.lng,isOffice:!0},...E.map(O=>{const L=i.find(M=>M.clientId===O.id&&M.staffId===u);return{id:O.id,name:O.name,lat:O.lat,lng:O.lng,duration:O.visitDuration||60,scheduledStart:L?L.startTime:null,timeWindow:O.timeWindow}})];let b=null;typeof o=="function"&&(b=await o(S));const k=pd(S,b);let P=gd(S,k);P=vd(P,k);const D=yd(P,k),C=_d(P,k,_,b,S);l[u]={staffId:u,staffName:(_==null?void 0:_.name)||"不明",staffColor:(_==null?void 0:_.color)||"#999",route:P,totalDistance:Math.round(D*10)/10,totalDuration:Id(C),schedule:C}}return l}function pd(i,e=null){const n=i.length,r=Array.from({length:n},()=>Array(n).fill(0));for(let o=0;o<n;o++)for(let c=0;c<n;c++)o!==c&&(e&&e[o]&&e[o][c]&&e[o][c].distance!==null?r[o][c]=e[o][c].distance:r[o][c]=to(i[o].lat,i[o].lng,i[c].lat,i[c].lng));return r}function gd(i,e){const n=i.length,r=new Set([0]),o=[0],c=[],l=[];for(let _=1;_<n;_++){const E=i[_];E.timeWindow&&E.timeWindow.start?c.push({index:_,start:te(E.timeWindow.start),end:te(E.timeWindow.end)}):l.push(_)}c.sort((_,E)=>_.start-E.start);const u=[...c.map(_=>_.index),...l];let p=0;for(;r.size<n;){let _=-1,E=1/0;for(const S of u)r.has(S)||e[p][S]<E&&(E=e[p][S],_=S);if(_===-1)break;o.push(_),r.add(_),p=_}return o.push(0),o}function vd(i,e){const n=i.length;let r=!0,o=[...i];for(;r;){r=!1;for(let c=1;c<n-2;c++)for(let l=c+1;l<n-1;l++){const u=e[o[c-1]][o[c]]+e[o[l]][o[l+1]];if(e[o[c-1]][o[l]]+e[o[c]][o[l+1]]<u-.001){const _=[...o];let E=c,S=l;for(;E<S;)[_[E],_[S]]=[_[S],_[E]],E++,S--;o=_,r=!0}}}return o}function yd(i,e){let n=0;for(let r=0;r<i.length-1;r++)n+=e[i[r]][i[r+1]];return n}function _d(i,e,n,r=null,o=[]){const c=[];let u=te((n==null?void 0:n.workStart)||"08:30");for(let p=0;p<i.length;p++){let _=0;if(p>0){const S=i[p-1],b=i[p];r&&r[S]&&r[S][b]&&r[S][b].duration!==null?_=r[S][b].duration:_=e[S][b]/20*60,u+=Math.ceil(_)}const E=o[i[p]];if(E){let S=0;E.timeWindow&&E.timeWindow.start?S=te(E.timeWindow.start):E.scheduledStart&&(S=te(E.scheduledStart)),u<S&&(u=S)}if(c.push({pointIndex:i[p],clientId:E?E.id:null,arrivalTime:Ml(u),arrivalMinutes:u,travelTimeFromPrev:Math.ceil(_)}),p>0&&p<i.length-1){const S=E&&E.duration||60;u+=S}}return c}function Id(i){if(i.length<2)return 0;const e=i[0].arrivalMinutes;return i[i.length-1].arrivalMinutes-e}let vn=null,Td=null,qe=Bt();async function ho(){const i=document.getElementById("page-container"),e=await ge(),n=["日","月","火","水","木","金","土"][new Date(qe).getDay()];i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
        <span class="material-icons-round">auto_fix_high</span>
        マッチング＆ルート最適化
      ...
      ${Object.entries(c).map(([l,u])=>{var _,E,S;const p=o[l];return`
          <div class="card" style="border-left:4px solid ${((_=u.staff)==null?void 0:_.color)||"#999"}">
            ...
            <div style="display:flex;flex-direction:column;gap:6px">
              ...
              ${((p==null?void 0:p.schedule)||[]).filter(b=>b.pointIndex!==0||p.schedule.indexOf(b)===p.schedule.length-1).map((b,k,P)=>{var C,O;if(b.pointIndex===0&&k===P.length-1)return`<div style="font-size:.8rem;color:var(--text-muted);display:flex;align-items:center;gap:4px">
                      <span class="material-icons-round" style="font-size:16px;color:var(--secondary)">business</span>
                      ${b.arrivalTime} 事業所帰着
                    </div>`;const D=u.clients.find(L=>L.clientId===b.clientId);return`<div class="visit-card">
                    <div style="display:flex;justify-content:space-between;align-items:center">
                      <strong style="font-size:.85rem">${b.arrivalTime} ${((C=D==null?void 0:D.client)==null?void 0:C.name)||"利用者"}</strong>
                      <span class="tag">${((O=D==null?void 0:D.client)==null?void 0:O.visitDuration)||60}分</span>
                    </div>
                  </div>`}).join("")}
            </div>
          </div>
  ...
  `,await sn(),(e=document.getElementById("revenue-date-picker"))==null||e.addEventListener("change",r=>{Et=r.target.value,sn()}),(n=document.getElementById("btn-refresh-revenue"))==null||n.addEventListener("click",()=>{sn()})}async function sn(){const i=document.getElementById("revenue-content");if(!i)return;const[e,n,r,o]=await Promise.all([ge(),_e(),ze(Et),Cn(Et)]);if(r.length===0){i.innerHTML=`
    ...
    `;return}let c=0,l=0,u=0,p=r.length;r.filter(b=>b.status==="completed").length;const _=e.map(b=>{const k=o.filter(x=>x.staffId===b.id),P=r.filter(x=>x.staffId===b.id);let D=0,C=0,O=0,L=0,M=0;if(P.forEach(x=>{x.income?D+=parseInt(x.income):D+=Ot(x.service||"身体介護",x.duration||60)}),k.forEach(x=>{if(L+=x.totalDistance||0,O+=(x.totalDistance||0)*si,x.schedule&&x.schedule.length>=2){const B=x.schedule[0].arrivalMinutes;M=x.schedule[x.schedule.length-1].arrivalMinutes-B,C=M/60*(parseInt(b.wage)||2e3)}}),k.length===0&&P.length>0){const x=[...P].sort((m,y)=>(m.startTime||"09:00").localeCompare(y.startTime||"09:00")),B=x[0],V=x[x.length-1],g=te(B.startTime||"09:00");M=te(V.startTime||"17:00")+(V.duration||60)-g,C=M/60*(parseInt(b.wage)||2e3)}return{...b,count:P.length,revenue:D,laborCost:C,vehicleCost:O,profit:D-C-O,workMinutes:M}}).filter(b=>b.count>0||b.revenue>0).sort((b,k)=>k.profit-b.profit);_.forEach(b=>{c+=b.revenue,l+=b.laborCost,u+=b.vehicleCost});const E=c-l-u,S=c>0?E/c*100:0;i.innerHTML=`
    <!-- メインKPI -->
    <div class="grid grid-4" style="margin-bottom:24px">
      ...
      <div class="card">
        ...
        <div style="overflow-x:auto">
          <table class="data-table">
            ...
            <tbody>
              ${_.map(b=>{const k=b.revenue>0?b.profit/b.revenue*100:0;return`
                  <tr>
                    <td>
