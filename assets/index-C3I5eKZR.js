 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ve(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function ya(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(ve())}function _a(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function Ia(){const i=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof i=="object"&&i.id!==void 0}function Ta(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function ba(){try{return typeof indexedDB=="object"}catch{return!1}}function wa(){return new Promise((i,e)=>{try{let n=!0;const s="validate-browser-context-for-indexeddb-analytics-module",o=self.indexedDB.open(s);o.onsuccess=()=>{o.result.close(),n||self.indexedDB.deleteDatabase(s),i(!0)},o.onupgradeneeded=()=>{n=!1},o.onerror=()=>{var l;e(((l=o.error)==null?void 0:l.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sa="FirebaseError";class Ce extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=Sa,Object.setPrototypeOf(this,Ce.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,jt.prototype.create)}}class jt{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},o=`${this.service}/${e}`,l=this.errors[e],c=l?Ea(l,s):"Error",u=`${this.serviceName}: ${c} (${o}).`;return new Ce(o,u,s)}}function Ea(i,e){return i.replace(ka,(n,s)=>{const o=e[s];return o!=null?String(o):`<${s}?>`})}const ka=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jr(i){try{return(i.startsWith("http://")||i.startsWith("https://")?new URL(i).hostname:i).endsWith(".cloudworkstations.dev")}catch{return!1}}class at{constructor(e,n,s){this.name=e,this.instanceFactory=n,this.type=s,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var V;(function(i){i[i.DEBUG=0]="DEBUG",i[i.VERBOSE=1]="VERBOSE",i[i.INFO=2]="INFO",i[i.WARN=3]="WARN",i[i.ERROR=4]="ERROR",i[i.SILENT=5]="SILENT"})(V||(V={}));const Da={debug:V.DEBUG,verbose:V.VERBOSE,info:V.INFO,warn:V.WARN,error:V.ERROR,silent:V.SILENT},Pa=V.INFO,La={[V.DEBUG]:"log",[V.VERBOSE]:"log",[V.INFO]:"info",[V.WARN]:"warn",[V.ERROR]:"error"},Ca=(i,e,...n)=>{if(e<i.logLevel)return;const s=new Date().toISOString(),o=La[e];if(o)console[o](`[${s}]  ${i.name}:`,...n);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Mn{constructor(e){this.name=e,this._logLevel=Pa,this._logHandler=Ca,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in V))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Da[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,V.DEBUG,...e),this._logHandler(this,V.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,V.VERBOSE,...e),this._logHandler(this,V.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,V.INFO,...e),this._logHandler(this,V.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,V.WARN,...e),this._logHandler(this,V.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,V.ERROR,...e),this._logHandler(this,V.ERROR,...e)}}const Na=(i,e)=>e.some(n=>i instanceof n);let Js,Xs;function Ma(){return Js||(Js=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Ra(){return Xs||(Xs=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const qr=new WeakMap,Tn=new WeakMap,zr=new WeakMap,cn=new WeakMap,Rn=new WeakMap;function $a(i){const e=new Promise((n,s)=>{const o=()=>{i.removeEventListener("success",l),i.removeEventListener("error",c)},l=()=>{n(De(i.result)),o()},c=()=>{s(i.error),o()};i.addEventListener("success",l),i.addEventListener("error",c)});return e.then(n=>{n instanceof IDBCursor&&qr.set(n,i)}).catch(()=>{}),Rn.set(e,i),e}function Ba(i){if(Tn.has(i))return;const e=new Promise((n,s)=>{const o=()=>{i.removeEventListener("complete",l),i.removeEventListener("error",c),i.removeEventListener("abort",c)},l=()=>{n(),o()},c=()=>{s(i.error||new DOMException("AbortError","AbortError")),o()};i.addEventListener("complete",l),i.addEventListener("error",c),i.addEventListener("abort",c)});Tn.set(i,e)}let bn={get(i,e,n){if(i instanceof IDBTransaction){if(e==="done")return Tn.get(i);if(e==="objectStoreNames")return i.objectStoreNames||zr.get(i);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return De(i[e])},set(i,e,n){return i[e]=n,!0},has(i,e){return i instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in i}};function Wa(i){bn=i(bn)}function Ua(i){return i===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...n){const s=i.call(dn(this),e,...n);return zr.set(s,e.sort?e.sort():[e]),De(s)}:Ra().includes(i)?function(...e){return i.apply(dn(this),e),De(qr.get(this))}:function(...e){return De(i.apply(dn(this),e))}}function Fa(i){return typeof i=="function"?Ua(i):(i instanceof IDBTransaction&&Ba(i),Na(i,Ma())?new Proxy(i,bn):i)}function De(i){if(i instanceof IDBRequest)return $a(i);if(cn.has(i))return cn.get(i);const e=Fa(i);return e!==i&&(cn.set(i,e),Rn.set(e,i)),e}const dn=i=>Rn.get(i);function Va(i,e,{blocked:n,upgrade:s,blocking:o,terminated:l}={}){const c=indexedDB.open(i,e),u=De(c);return s&&c.addEventListener("upgradeneeded",p=>{s(De(c.result),p.oldVersion,p.newVersion,De(c.transaction),p)}),n&&c.addEventListener("blocked",p=>n(p.oldVersion,p.newVersion,p)),u.then(p=>{l&&p.addEventListener("close",()=>l()),o&&p.addEventListener("versionchange",g=>o(g.oldVersion,g.newVersion,g))}).catch(()=>{}),u}const ja=["get","getKey","getAll","getAllKeys","count"],qa=["put","add","delete","clear"],un=new Map;function Ys(i,e){if(!(i instanceof IDBDatabase&&!(e in i)&&typeof e=="string"))return;if(un.get(e))return un.get(e);const n=e.replace(/FromIndex$/,""),s=e!==n,o=qa.includes(n);if(!(n in(s?IDBIndex:IDBObjectStore).prototype)||!(o||ja.includes(n)))return;const l=async function(c,...u){const p=this.transaction(c,o?"readwrite":"readonly");let g=p.store;return s&&(g=g.index(u.shift())),(await Promise.all([g[n](...u),o&&p.done]))[0]};return un.set(e,l),l}Wa(i=>({...i,get:(e,n,s)=>Ys(e,n)||i.get(e,n,s),has:(e,n)=>!!Ys(e,n)||i.has(e,n)}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class za{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Ha(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function Ha(i){const e=i.getComponent();return(e==null?void 0:e.type)==="VERSION"}const wn="@firebase/app",Qs="0.14.11";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tl=new Map,bl=new Map,Zs=new Map;function er(i,e){try{i.container.addComponent(e)}catch(n){Ie.debug(`Component ${e.name} failed to register with FirebaseApp ${i.name}`,n)}}function lt(i){const e=i.name;if(Zs.has(e))return Ie.debug(`There were multiple attempts to register component ${e}.`),!1;Zs.set(e,i);for(const n of Tl.values())er(n,i);for(const n of bl.values())er(n,i);return!0}function We(i){return i==null?!1:i.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ki=_l;function Pe(i,e,n){let s=Il[i]??i;n&&(s+=`-${n}`);const o=s.match(/\s|\//),l=e.match(/\s|\//);if(o||l){const c=[`Unable to register library "${s}" with version "${e}":`];o&&c.push(`library name "${s}" contains illegal characters (whitespace or "/")`),o&&l&&c.push("and"),l&&c.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Ie.warn(c.join(" "));return}lt(new at(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sl="firebase-heartbeat-database",El=1,$t="firebase-heartbeat-store";let hn=null;function Hr(){return hn||(hn=Va(Sl,El,{upgrade:(i,e)=>{switch(e){case 0:try{i.createObjectStore($t)}catch(n){console.warn(n)}}}}).catch(i=>{throw $n.create("idb-open",{originalErrorMessage:i.message})})),hn}async function kl(i){try{const n=(await Hr()).transaction($t),s=await n.objectStore($t).get(Gr(i));return await n.done,s}catch(e){if(e instanceof Ce)Ie.warn(e.message);else{const n=$n.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Ie.warn(n.message)}}}async function tr(i,e){try{const s=(await Hr()).transaction($t,"readwrite");await s.objectStore($t).put(e,Gr(i)),await s.done}catch(n){if(n instanceof Ce)Ie.warn(n.message);else{const s=$n.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Ie.warn(s.message)}}}function Gr(i){return`${i.name}!${i.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cl(i){lt(new at("platform-logger",e=>new za(e),"PRIVATE")),lt(new at("heartbeat",e=>new Ol(e),"PRIVATE")),Pe(wn,Qs,i),Pe(wn,Qs,"esm2020"),Pe("fire-js","")}Cl("");var Nl="firebase",Ml="12.12.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Pe(Nl,Ml,"app");var sr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var Bn;(function(){var i;/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(y,f){function m(){}m.prototype=f.prototype,y.F=f.prototype,y.prototype=new m,y.prototype.constructor=y,y.D=function(_,v,T){for(var h=Array(arguments.length-2),z=2;z<arguments.length;z++)h[z-2]=arguments[z];return f.prototype[v].apply(_,h)}}function n(){this.blockSize=-1}function s(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(s,n),s.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function o(y,f,m){m||(m=0);const _=Array(16);if(typeof f=="string")for(var v=0;v<16;++v)_[v]=f.charCodeAt(m++)|f.charCodeAt(m++)<<8|f.charCodeAt(m++)<<16|f.charCodeAt(m++)<<24;else for(v=0;v<16;++v)_[v]=f[m++]|f[m++]<<8|f[m++]<<16|f[m++]<<24;f=y.g[0],m=y.g[1],v=y.g[2];let T=y.g[3],h;h=f+(T^m&(v^T))+_[0]+3614090360&4294967295,f=m+(h<<7&4294967295|h>>>25),h=T+(v^f&(m^v))+_[1]+3905402710&4294967295,T=f+(h<<12&4294967295|h>>>20),h=v+(m^T&(f^m))+_[2]+606105819&4294967295,v=T+(h<<17&4294967295|h>>>15),h=m+(f^v&(T^f))+_[3]+3250441966&4294967295,m=v+(h<<22&4294967295|h>>>10),h=f+(T^m&(v^T))+_[4]+4118548399&4294967295,f=m+(h<<7&4294967295|h>>>25),h=T+(v^f&(m^v))+_[5]+1200080426&4294967295,T=f+(h<<12&4294967295|h>>>20),h=v+(m^T&(f^m))+_[6]+2821735955&4294967295,v=T+(h<<17&4294967295|h>>>15),h=m+(f^v&(T^f))+_[7]+4249261313&4294967295,m=v+(h<<22&4294967295|h>>>10),h=f+(T^m&(v^T))+_[8]+1770035416&4294967295,f=m+(h<<7&4294967295|h>>>25),h=T+(v^f&(m^v))+_[9]+2336552879&4294967295,T=f+(h<<12&4294967295|h>>>20),h=v+(m^T&(f^m))+_[10]+4294925233&4294967295,v=T+(h<<17&4294967295|h>>>15),h=m+(f^v&(T^f))+_[11]+2304563134&4294967295,m=v+(h<<22&4294967295|h>>>10),h=f+(T^m&(v^T))+_[12]+1804603682&4294967295,f=m+(h<<7&4294967295|h>>>25),h=T+(v^f&(m^v))+_[13]+4254626195&4294967295,T=f+(h<<12&4294967295|h>>>20),h=v+(m^T&(f^m))+_[14]+2792965006&4294967295,v=T+(h<<17&4294967295|h>>>15),h=m+(f^v&(T^f))+_[15]+1236535329&4294967295,m=v+(h<<22&4294967295|h>>>10),h=f+(v^T&(m^v))+_[1]+4129170786&4294967295,f=m+(h<<5&4294967295|h>>>27),h=T+(m^v&(f^m))+_[6]+3225465664&4294967295,T=f+(h<<9&4294967295|h>>>23),h=v+(f^m&(T^f))+_[11]+643717713&4294967295,v=T+(h<<14&4294967295|h>>>18),h=m+(T^f&(v^T))+_[0]+3921069994&4294967295,m=v+(h<<20&4294967295|h>>>12),h=f+(v^T&(m^v))+_[5]+3593408605&4294967295,f=m+(h<<5&4294967295|h>>>27),h=T+(m^v&(f^m))+_[10]+38016083&4294967295,T=f+(h<<9&4294967295|h>>>23),h=v+(f^m&(T^f))+_[15]+3634488961&4294967295,v=T+(h<<14&4294967295|h>>>18),h=m+(T^f&(v^T))+_[4]+3889429448&4294967295,m=v+(h<<20&4294967295|h>>>12),h=f+(v^T&(m^v))+_[9]+568446438&4294967295,f=m+(h<<5&4294967295|h>>>27),h=T+(m^v&(f^m))+_[14]+3275163606&4294967295,T=f+(h<<9&4294967295|h>>>23),h=v+(f^m&(T^f))+_[3]+4107603335&4294967295,v=T+(h<<14&4294967295|h>>>18),h=m+(T^f&(v^T))+_[8]+1163531501&4294967295,m=v+(h<<20&4294967295|h>>>12),h=f+(v^T&(m^v))+_[13]+2850285829&4294967295,f=m+(h<<5&4294967295|h>>>27),h=T+(m^v&(f^m))+_[2]+4243563512&4294967295,T=f+(h<<9&4294967295|h>>>23),h=v+(f^m&(T^f))+_[7]+1735328473&4294967295,v=T+(h<<14&4294967295|h>>>18),h=m+(T^f&(v^T))+_[12]+2368359562&4294967295,m=v+(h<<20&4294967295|h>>>12),h=f+(m^v^T)+_[5]+4294588738&4294967295,f=m+(h<<4&4294967295|h>>>28),h=T+(f^m^v)+_[8]+2272392833&4294967295,T=f+(h<<11&4294967295|h>>>21),h=v+(T^f^m)+_[11]+1839030562&4294967295,v=T+(h<<16&4294967295|h>>>16),h=m+(v^T^f)+_[14]+4259657740&4294967295,m=v+(h<<23&4294967295|h>>>9),h=f+(m^v^T)+_[1]+2763975236&4294967295,f=m+(h<<4&4294967295|h>>>28),h=T+(f^m^v)+_[4]+1272893353&4294967295,T=f+(h<<11&4294967295|h>>>21),h=v+(T^f^m)+_[7]+4139469664&4294967295,v=T+(h<<16&4294967295|h>>>16),h=m+(v^T^f)+_[10]+3200236656&4294967295,m=v+(h<<23&4294967295|h>>>9),h=f+(m^v^T)+_[13]+681279174&4294967295,f=m+(h<<4&4294967295|h>>>28),h=T+(f^m^v)+_[0]+3936430074&4294967295,T=f+(h<<11&4294967295|h>>>21),h=v+(T^f^m)+_[3]+3572445317&4294967295,v=T+(h<<16&4294967295|h>>>16),h=m+(v^T^f)+_[6]+76029189&4294967295,m=v+(h<<23&4294967295|h>>>9),h=f+(m^v^T)+_[9]+3654602809&4294967295,f=m+(h<<4&4294967295|h>>>28),h=T+(f^m^v)+_[12]+3873151461&4294967295,T=f+(h<<11&4294967295|h>>>21),h=v+(T^f^m)+_[15]+530742520&4294967295,v=T+(h<<16&4294967295|h>>>16),h=m+(v^T^f)+_[2]+3299628645&4294967295,m=v+(h<<23&4294967295|h>>>9),h=f+(v^(m|~T))+_[0]+4096336452&4294967295,f=m+(h<<6&4294967295|h>>>26),h=T+(m^(f|~v))+_[7]+1126891415&4294967295,T=f+(h<<10&4294967295|h>>>22),h=v+(f^(T|~m))+_[14]+2878612391&4294967295,v=T+(h<<15&4294967295|h>>>17),h=m+(T^(v|~f))+_[5]+4237533241&4294967295,m=v+(h<<21&4294967295|h>>>11),h=f+(v^(m|~T))+_[12]+1700485571&4294967295,f=m+(h<<6&4294967295|h>>>26),h=T+(m^(f|~v))+_[3]+2399980690&4294967295,T=f+(h<<10&4294967295|h>>>22),h=v+(f^(T|~m))+_[10]+4293915773&4294967295,v=T+(h<<15&4294967295|h>>>17),h=m+(T^(v|~f))+_[1]+2240044497&4294967295,m=v+(h<<21&4294967295|h>>>11),h=f+(v^(m|~T))+_[8]+1873313359&4294967295,f=m+(h<<6&4294967295|h>>>26),h=T+(m^(f|~v))+_[15]+4264355552&4294967295,T=f+(h<<10&4294967295|h>>>22),h=v+(f^(T|~m))+_[6]+2734768916&4294967295,v=T+(h<<15&4294967295|h>>>17),h=m+(T^(v|~f))+_[13]+1309151649&4294967295,m=v+(h<<21&4294967295|h>>>11),h=f+(v^(m|~T))+_[4]+4149444226&4294967295,f=m+(h<<6&4294967295|h>>>26),h=T+(m^(f|~v))+_[11]+3174756917&4294967295,T=f+(h<<10&4294967295|h>>>22),h=v+(f^(T|~m))+_[2]+718787259&4294967295,v=T+(h<<15&4294967295|h>>>17),h=m+(T^(v|~f))+_[9]+3951481745&4294967295,y.g[0]=y.g[0]+f&4294967295,y.g[1]=y.g[1]+(v+(h<<21&4294967295|h>>>11))&4294967295,y.g[2]=y.g[2]+v&4294967295,y.g[3]=y.g[3]+T&4294967295}s.prototype.v=function(y,f){f===void 0&&(f=y.length);const m=f-this.blockSize,_=this.C;let v=this.h,T=0;for(;T<f;){if(v==0)for(;T<=m;)o(this,y,T),T+=this.blockSize;if(typeof y=="string"){for(;T<f;)if(_[v++]=y.charCodeAt(T++),v==this.blockSize){o(this,_),v=0;break}}else for(;T<f;)if(_[v++]=y[T++],v==this.blockSize){o(this,_),v=0;break}}this.h=v,this.o+=f},s.prototype.A=function(){var y=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);y[0]=128;for(var f=1;f<y.length-8;++f)y[f]=0;f=this.o*8;for(var m=y.length-8;m<y.length;++m)y[m]=f&255,f/=256;for(this.v(y),y=Array(16),f=0,m=0;m<4;++m)for(let _=0;_<32;_+=8)y[f++]=this.g[m]>>>_&255;return y};function l(y,f){var m=u;return Object.prototype.hasOwnProperty.call(m,y)?m[y]:m[y]=f(y)}function c(y,f){this.h=f;const m=[];let _=!0;for(let v=y.length-1;v>=0;v--){const T=y[v]|0;_&&T==f||(m[v]=T,_=!1)}this.g=m}var u={};function p(y){return-128<=y&&y<128?l(y,function(f){return new c([f|0],f<0?-1:0)}):new c([y|0],y<0?-1:0)}function g(y){if(isNaN(y)||!isFinite(y))return b;if(y<0)return P(g(-y));const f=[];let m=1;for(let _=0;y>=m;_++)f[_]=y/m|0,m*=4294967296;return new c(f,0)}function E(y,f){if(y.length==0)throw Error("number format error: empty string");if(f=f||10,f<2||36<f)throw Error("radix out of range: "+f);if(y.charAt(0)=="-")return P(E(y.substring(1),f));if(y.indexOf("-")>=0)throw Error('number format error: interior "-" character');const m=g(Math.pow(f,8));let _=b;for(let T=0;T<y.length;T+=8){var v=Math.min(8,y.length-T);const h=parseInt(y.substring(T,T+v),f);v<8?(v=g(Math.pow(f,v)),_=_.j(v).add(g(h))):(_=_.j(m),_=_.add(g(h)))}return _}var b=p(0),I=p(1),k=p(16777216);i=c.prototype,i.m=function(){if(x(this))return-P(this).m();let y=0,f=1;for(let m=0;m<this.g.length;m++){const _=this.i(m);y+=(_>=0?_:4294967296+_)*f,f*=4294967296}return y},i.toString=function(y){if(y=y||10,y<2||36<y)throw Error("radix out of range: "+y);if(A(this))return"0";if(x(this))return"-"+P(this).toString(y);const f=g(Math.pow(y,6));var m=this;let _="";for(;;){const v=N(m,f).g;m=O(m,v.j(f));let T=((m.g.length>0?m.g[0]:m.h)>>>0).toString(y);if(m=v,A(m))return T+_;for(;T.length<6;)T="0"+T;_=T+_}},i.i=function(y){return y<0?0:y<this.g.length?this.g[y]:this.h};function A(y){if(y.h!=0)return!1;for(let f=0;f<y.g.length;f++)if(y.g[f]!=0)return!1;return!0}function x(y){return y.h==-1}i.l=function(y){return y=O(this,y),x(y)?-1:A(y)?0:1};function P(y){const f=y.g.length,m=[];for(let _=0;_<f;_++)m[_]=~y.g[_];return new c(m,~y.h).add(I)}i.abs=function(){return x(this)?P(this):this},i.add=function(y){const f=Math.max(this.g.length,y.g.length),m=[];let _=0;for(let v=0;v<=f;v++){let T=_+(this.i(v)&65535)+(y.i(v)&65535),h=(T>>>16)+(this.i(v)>>>16)+(y.i(v)>>>16);_=h>>>16,T&=65535,h&=65535,m[v]=h<<16|T}return new c(m,m[m.length-1]&-2147483648?-1:0)};function O(y,f){return y.add(P(f))}i.j=function(y){if(A(this)||A(y))return b;if(x(this))return x(y)?P(this).j(P(y)):P(P(this).j(y));if(x(y))return P(this.j(P(y)));if(this.l(k)<0&&y.l(k)<0)return g(this.m()*y.m());const f=this.g.length+y.g.length,m=[];for(var _=0;_<2*f;_++)m[_]=0;for(_=0;_<this.g.length;_++)for(let v=0;v<y.g.length;v++){const T=this.i(_)>>>16,h=this.i(_)&65535,z=y.i(v)>>>16,re=y.i(v)&65535;m[2*_+2*v]+=h*re,L(m,2*_+2*v),m[2*_+2*v+1]+=T*re,L(m,2*_+2*v+1),m[2*_+2*v+1]+=h*z,L(m,2*_+2*v+1),m[2*_+2*v+2]+=T*z,L(m,2*_+2*v+2)}for(y=0;y<f;y++)m[y]=m[2*y+1]<<16|m[2*y];for(y=f;y<2*f;y++)m[y]=0;return new c(m,0)};function L(y,f){for(;(y[f]&65535)!=y[f];)y[f+1]+=y[f]>>>16,y[f]&=65535,f++}function M(y,f){this.g=y,this.h=f}function N(y,f){if(A(f))throw Error("division by zero");if(A(y))return new M(b,b);if(x(y))return f=N(P(y),f),new M(P(f.g),P(f.h));if(x(f))return f=N(y,P(f)),new M(P(f.g),f.h);if(y.g.length>30){if(x(y)||x(f))throw Error("slowDivide_ only works with positive integers.");for(var m=I,_=f;_.l(y)<=0;)m=B(m),_=B(_);var v=j(m,1),T=j(_,1);for(_=j(_,2),m=j(m,2);!A(_);){var h=T.add(_);h.l(y)<=0&&(v=v.add(m),T=h),_=j(_,1),m=j(m,1)}return f=O(y,v.j(f)),new M(v,f)}for(v=b;y.l(f)>=0;){for(m=Math.max(1,Math.floor(y.m()/f.m())),_=Math.ceil(Math.log(m)/Math.LN2),_=_<=48?1:Math.pow(2,_-48),T=g(m),h=T.j(f);x(h)||h.l(y)>0;)m-=_,T=g(m),h=T.j(f);A(T)&&(T=I),v=v.add(T),y=O(y,h)}return new M(v,y)}i.B=function(y){return N(this,y).h},i.and=function(y){const f=Math.max(this.g.length,y.g.length),m=[];for(let _=0;_<f;_++)m[_]=this.i(_)&y.i(_);return new c(m,this.h&y.h)},i.or=function(y){const f=Math.max(this.g.length,y.g.length),m=[];for(let _=0;_<f;_++)m[_]=this.i(_)|y.i(_);return new c(m,this.h|y.h)},i.xor=function(y){const f=Math.max(this.g.length,y.g.length),m=[];for(let _=0;_<f;_++)m[_]=this.i(_)^y.i(_);return new c(m,this.h^y.h)};function B(y){const f=y.g.length+1,m=[];for(let _=0;_<f;_++)m[_]=y.i(_)<<1|y.i(_-1)>>>31;return new c(m,y.h)}function j(y,f){const m=f>>5;f%=32;const _=y.g.length-m,v=[];for(let T=0;T<_;T++)v[T]=f>0?y.i(T+m)>>>f|y.i(T+m+1)<<32-f:y.i(T+m);return new c(v,y.h)}s.prototype.digest=s.prototype.A,s.prototype.reset=s.prototype.u,s.prototype.update=s.prototype.v,c.prototype.add=c.prototype.add,c.prototype.multiply=c.prototype.j,c.prototype.modulo=c.prototype.B,c.prototype.compare=c.prototype.l,c.prototype.toNumber=c.prototype.m,c.prototype.toString=c.prototype.toString,c.prototype.getBits=c.prototype.i,c.fromNumber=g,c.fromString=E,Bn=c}).apply(typeof sr<"u"?sr:typeof self<"u"?self:typeof window<"u"?window:{});var si=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};(function(){var i,e=Object.defineProperty;function n(t){t=[typeof globalThis=="object"&&globalThis,t,typeof window=="object"&&window,typeof self=="object"&&self,typeof si=="object"&&si];for(var r=0;r<t.length;++r){var a=t[r];if(a&&a.Math==Math)return a}throw Error("Cannot find global object")}var s=n(this);function o(t,r){if(r)e:{var a=s;t=t.split(".");for(var d=0;d<t.length-1;d++){var w=t[d];if(!(w in a))break e;a=a[w]}t=t[t.length-1],d=a[t],r=r(d),r!=d&&r!=null&&e(a,t,{configurable:!0,writable:!0,value:r})}}o("Symbol.dispose",function(t){return t||Symbol("Symbol.dispose")}),o("Array.prototype.values",function(t){return t||function(){return this[Symbol.iterator]()}}),o("Object.entries",function(t){return t||function(r){var a=[],d;for(d in r)Object.prototype.hasOwnProperty.call(r,d)&&a.push([d,r[d]]);return a}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var l=l||{},c=this||self;function u(t){var r=typeof t;return r=="object"&&t!=null||r=="function"}function p(t,r,a){return t.call.apply(t.bind,arguments)}function g(t,r,a){return g=p,g.apply(null,arguments)}function E(t,r){var a=Array.prototype.slice.call(arguments,1);return function(){var d=a.slice();return d.push.apply(d,arguments),t.apply(this,d)}}function b(t,r){function a(){}a.prototype=r.prototype,t.Z=r.prototype,t.prototype=new a,t.prototype.constructor=t,t.Ob=function(d,w,S){for(var D=Array(arguments.length-2),R=2;R<arguments.length;R++)D[R-2]=arguments[R];return r.prototype[w].apply(d,D)}}var I=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?t=>t&&AsyncContext.Snapshot.wrap(t):t=>t;function k(t){const r=t.length;if(r>0){const a=Array(r);for(let d=0;d<r;d++)a[d]=t[d];return a}return[]}function A(t,r){for(let d=1;d<arguments.length;d++){const w=arguments[d];var a=typeof w;if(a=a!="object"?a:w?Array.isArray(w)?"array":a:"null",a=="array"||a=="object"&&typeof w.length=="number"){a=t.length||0;const S=w.length||0;t.length=a+S;for(let D=0;D<S;D++)t[a+D]=w[D]}else t.push(w)}}class x{constructor(r,a){this.i=r,this.j=a,this.h=0,this.g=null}get(){let r;return this.h>0?(this.h--,r=this.g,this.g=r.next,r.next=null):r=this.i(),r}}function P(t){c.setTimeout(()=>{throw t},0)}function O(){var t=y;let r=null;return t.g&&(r=t.g,t.g=t.g.next,t.g||(t.h=null),r.next=null),r}class L{constructor(){this.h=this.g=null}add(r,a){const d=M.get();d.set(r,a),this.h?this.h.next=d:this.g=d,this.h=d}}var M=new x(()=>new N,t=>t.reset());class N{constructor(){this.next=this.g=this.h=null}set(r,a){this.h=r,this.g=a,this.next=null}reset(){this.next=this.g=this.h=null}}let B,j=!1,y=new L,f=()=>{const t=Promise.resolve(void 0);B=()=>{t.then(m)}};function m(){for(var t;t=O();){try{t.h.call(t.g)}catch(a){P(a)}var r=M;r.j(t),r.h<100&&(r.h++,t.next=r.g,r.g=t)}j=!1}function _(){this.u=this.u,this.C=this.C}_.prototype.u=!1,_.prototype.dispose=function(){this.u||(this.u=!0,this.N())},_.prototype[Symbol.dispose]=function(){this.dispose()},_.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function v(t,r){this.type=t,this.g=this.target=r,this.defaultPrevented=!1}v.prototype.h=function(){this.defaultPrevented=!0};var T=function(){if(!c.addEventListener||!Object.defineProperty)return!1;var t=!1,r=Object.defineProperty({},"passive",{get:function(){t=!0}});try{const a=()=>{};c.addEventListener("test",a,r),c.removeEventListener("test",a,r)}catch{}return t}();function h(t){return/^[\s\xa0]*$/.test(t)}function z(t,r){v.call(this,t?t.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,t&&this.init(t,r)}b(z,v),z.prototype.init=function(t,r){const a=this.type=t.type,d=t.changedTouches&&t.changedTouches.length?t.changedTouches[0]:null;this.target=t.target||t.srcElement,this.g=r,r=t.relatedTarget,r||(a=="mouseover"?r=t.fromElement:a=="mouseout"&&(r=t.toElement)),this.relatedTarget=r,d?(this.clientX=d.clientX!==void 0?d.clientX:d.pageX,this.clientY=d.clientY!==void 0?d.clientY:d.pageY,this.screenX=d.screenX||0,this.screenY=d.screenY||0):(this.clientX=t.clientX!==void 0?t.clientX:t.pageX,this.clientY=t.clientY!==void 0?t.clientY:t.pageY,this.screenX=t.screenX||0,this.screenY=t.screenY||0),this.button=t.button,this.key=t.key||"",this.ctrlKey=t.ctrlKey,this.altKey=t.altKey,this.shiftKey=t.shiftKey,this.metaKey=t.metaKey,this.pointerId=t.pointerId||0,this.pointerType=t.pointerType,this.state=t.state,this.i=t,t.defaultPrevented&&z.Z.h.call(this)},z.prototype.h=function(){z.Z.h.call(this);const t=this.i;t.preventDefault?t.preventDefault():t.returnValue=!1};var re="closure_listenable_"+(Math.random()*1e6|0),Ci=0;function Ni(t,r,a,d,w){this.listener=t,this.proxy=null,this.src=r,this.type=a,this.capture=!!d,this.ha=w,this.key=++Ci,this.da=this.fa=!1}function Xe(t){t.da=!0,t.listener=null,t.proxy=null,t.src=null,t.ha=null}function de(t,r,a){for(const d in t)r.call(a,t[d],d,t)}function Ye(t,r){for(const a in t)r.call(void 0,t[a],a,t)}function Qe(t){const r={};for(const a in t)r[a]=t[a];return r}const ht="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Yn(t,r){let a,d;for(let w=1;w<arguments.length;w++){d=arguments[w];for(a in d)t[a]=d[a];for(let S=0;S<ht.length;S++)a=ht[S],Object.prototype.hasOwnProperty.call(d,a)&&(t[a]=d[a])}}function Kt(t){this.src=t,this.g={},this.h=0}Kt.prototype.add=function(t,r,a,d,w){const S=t.toString();t=this.g[S],t||(t=this.g[S]=[],this.h++);const D=Ri(t,r,d,w);return D>-1?(r=t[D],a||(r.fa=!1)):(r=new Ni(r,this.src,S,!!d,w),r.fa=a,t.push(r)),r};function Mi(t,r){const a=r.type;if(a in t.g){var d=t.g[a],w=Array.prototype.indexOf.call(d,r,void 0),S;(S=w>=0)&&Array.prototype.splice.call(d,w,1),S&&(Xe(r),t.g[a].length==0&&(delete t.g[a],t.h--))}}function Ri(t,r,a,d){for(let w=0;w<t.length;++w){const S=t[w];if(!S.da&&S.listener==r&&S.capture==!!a&&S.ha==d)return w}return-1}var $i="closure_lm_"+(Math.random()*1e6|0),Bi={};function Qn(t,r,a,d,w){if(Array.isArray(r)){for(let S=0;S<r.length;S++)Qn(t,r[S],a,d,w);return null}return a=ts(a),t&&t[re]?t.J(r,a,u(d)?!!d.capture:!1,w):Po(t,r,a,!1,d,w)}function Po(t,r,a,d,w,S){if(!r)throw Error("Invalid event type");const D=u(w)?!!w.capture:!!w;let R=Ui(t);if(R||(t[$i]=R=new Kt(t)),a=R.add(r,a,d,D,S),a.proxy)return a;if(d=Lo(),a.proxy=d,d.src=t,d.listener=a,t.addEventListener)T||(w=D),w===void 0&&(w=!1),t.addEventListener(r.toString(),d,w);else if(t.attachEvent)t.attachEvent(es(r.toString()),d);else if(t.addListener&&t.removeListener)t.addListener(d);else throw Error("addEventListener and attachEvent are unavailable.");return a}function Lo(){function t(a){return r.call(t.src,t.listener,a)}const r=Co;return t}function Zn(t,r,a,d,w){if(Array.isArray(r))for(var S=0;S<r.length;S++)Zn(t,r[S],a,d,w);else d=u(d)?!!d.capture:!!d,a=ts(a),t&&t[re]?(t=t.i,S=String(r).toString(),S in t.g&&(r=t.g[S],a=Ri(r,a,d,w),a>-1&&(Xe(r[a]),Array.prototype.splice.call(r,a,1),r.length==0&&(delete t.g[S],t.h--)))):t&&(t=Ui(t))&&(r=t.g[r.toString()],t=-1,r&&(t=Ri(r,a,d,w)),(a=t>-1?r[t]:null)&&Wi(a))}function Wi(t){if(typeof t!="number"&&t&&!t.da){var r=t.src;if(r&&r[re])Mi(r.i,t);else{var a=t.type,d=t.proxy;r.removeEventListener?r.removeEventListener(a,d,t.capture):r.detachEvent?r.detachEvent(es(a),d):r.addListener&&r.removeListener&&r.removeListener(d),(a=Ui(r))?(Mi(a,t),a.h==0&&(a.src=null,r[$i]=null)):Xe(t)}}}function es(t){return t in Bi?Bi[t]:Bi[t]="on"+t}function Co(t,r){if(t.da)t=!0;else{r=new z(r,this);const a=t.listener,d=t.ha||t.src;t.fa&&Wi(t),t=a.call(d,r)}return t}function Ui(t){return t=t[$i],t instanceof Kt?t:null}var Fi="__closure_events_fn_"+(Math.random()*1e9>>>0);function ts(t){return typeof t=="function"?t:(t[Fi]||(t[Fi]=function(r){return t.handleEvent(r)}),t[Fi])}function ee(){_.call(this),this.i=new Kt(this),this.M=this,this.G=null}b(ee,_),ee.prototype[re]=!0,ee.prototype.removeEventListener=function(t,r,a,d){Zn(this,t,r,a,d)};function te(t,r){var a,d=t.G;if(d)for(a=[];d;d=d.G)a.push(d);if(t=t.M,d=r.type||r,typeof r=="string")r=new v(r,t);else if(r instanceof v)r.target=r.target||t;else{var w=r;r=new v(d,t),Yn(r,w)}w=!0;let S,D;if(a)for(D=a.length-1;D>=0;D--)S=r.g=a[D],w=Jt(S,d,!0,r)&&w;if(S=r.g=t,w=Jt(S,d,!0,r)&&w,w=Jt(S,d,!1,r)&&w,a)for(D=0;D<a.length;D++)S=r.g=a[D],w=Jt(S,d,!1,r)&&w}ee.prototype.N=function(){if(ee.Z.N.call(this),this.i){var t=this.i;for(const r in t.g){const a=t.g[r];for(let d=0;d<a.length;d++)Xe(a[d]);delete t.g[r],t.h--}}this.G=null},ee.prototype.J=function(t,r,a,d){return this.i.add(String(t),r,!1,a,d)},ee.prototype.K=function(t,r,a,d){return this.i.add(String(t),r,!0,a,d)};function Jt(t,r,a,d){if(r=t.i.g[String(r)],!r)return!0;r=r.concat();let w=!0;for(let S=0;S<r.length;++S){const D=r[S];if(D&&!D.da&&D.capture==a){const R=D.listener,J=D.ha||D.src;D.fa&&Mi(t.i,D),w=R.call(J,d)!==!1&&w}}return w&&!d.defaultPrevented}function No(t,r){if(typeof t!="function")if(t&&typeof t.handleEvent=="function")t=g(t.handleEvent,t);else throw Error("Invalid listener argument");return Number(r)>2147483647?-1:c.setTimeout(t,r||0)}function is(t){t.g=No(()=>{t.g=null,t.i&&(t.i=!1,is(t))},t.l);const r=t.h;t.h=null,t.m.apply(null,r)}class Mo extends _{constructor(r,a){super(),this.m=r,this.l=a,this.h=null,this.i=!1,this.g=null}j(r){this.h=arguments,this.g?this.i=!0:is(this)}N(){super.N(),this.g&&(c.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function ft(t){_.call(this),this.h=t,this.g={}}b(ft,_);var ns=[];function ss(t){de(t.g,function(r,a){this.g.hasOwnProperty(a)&&Wi(r)},t),t.g={}}ft.prototype.N=function(){ft.Z.N.call(this),ss(this)},ft.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Vi=c.JSON.stringify,Ro=c.JSON.parse,$o=class{stringify(t){return c.JSON.stringify(t,void 0)}parse(t){return c.JSON.parse(t,void 0)}};function rs(){}function Bo(){}var mt={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function ji(){v.call(this,"d")}b(ji,v);function qi(){v.call(this,"c")}b(qi,v);var Ze={},os=null;function zi(){return os=os||new ee}Ze.Ia="serverreachability";function as(t){v.call(this,Ze.Ia,t)}b(as,v);function pt(t){const r=zi();te(r,new as(r))}Ze.STAT_EVENT="statevent";function ls(t,r){v.call(this,Ze.STAT_EVENT,t),this.stat=r}b(ls,v);function ie(t){const r=zi();te(r,new ls(r,t))}Ze.Ja="timingevent";function cs(t,r){v.call(this,Ze.Ja,t),this.size=r}b(cs,v);function gt(t,r){if(typeof t!="function")throw Error("Fn must not be null and must be a function");return c.setTimeout(function(){t()},r)}function vt(){this.g=!0}vt.prototype.ua=function(){this.g=!1};function Wo(t,r,a,d,w,S){t.info(function(){if(t.g)if(S){var D="",R=S.split("&");for(let q=0;q<R.length;q++){var J=R[q].split("=");if(J.length>1){const Y=J[0];J=J[1];const he=Y.split("_");D=he.length>=2&&he[1]=="type"?D+(Y+"="+J+"&"):D+(Y+"=redacted&")}}}else D=null;else D=S;return"XMLHTTP REQ ("+d+") [attempt "+w+"]: "+r+`
`+a+`
`+D})}function Uo(t,r,a,d,w,S,D){t.info(function(){return"XMLHTTP RESP ("+d+") [ attempt "+w+"]: "+r+`
`+a+`
`+S+" "+D})}function et(t,r,a,d){t.info(function(){return"XMLHTTP TEXT ("+r+"): "+Vo(t,a)+(d?" "+d:"")})}function Fo(t,r){t.info(function(){return"TIMEOUT: "+r})}vt.prototype.info=function(){};function Vo(t,r){if(!t.g)return r;if(!r)return null;try{const S=JSON.parse(r);if(S){for(t=0;t<S.length;t++)if(Array.isArray(S[t])){var a=S[t];if(!(a.length<2)){var d=a[1];if(Array.isArray(d)&&!(d.length<1)){var w=d[0];if(w!="noop"&&w!="stop"&&w!="close")for(let D=1;D<d.length;D++)d[D]=""}}}}return Vi(S)}catch{return r}}var Hi={NO_ERROR:0,TIMEOUT:8},jo={},ds;function Gi(){}b(Gi,rs),Gi.prototype.g=function(){return new XMLHttpRequest},ds=new Gi;function yt(t){return encodeURIComponent(String(t))}function qo(t){var r=1;t=t.split(":");const a=[];for(;r>0&&t.length;)a.push(t.shift()),r--;return t.length&&a.push(t.join(":")),a}function be(t,r,a,d){this.j=t,this.i=r,this.l=a,this.S=d||1,this.V=new ft(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new us}function us(){this.i=null,this.g="",this.h=!1}var hs={},Ki={};function Ji(t,r,a){t.M=1,t.A=Yt(ue(r)),t.u=a,t.R=!0,fs(t,null)}function fs(t,r){t.F=Date.now(),Xt(t),t.B=ue(t.A);var a=t.B,d=t.S;Array.isArray(d)||(d=[String(d)]),ks(a.i,"t",d),t.C=0,a=t.j.L,t.h=new us,t.g=qs(t.j,a?r:null,!t.u),t.P>0&&(t.O=new Mo(g(t.Y,t,t.g),t.P)),r=t.V,a=t.g,d=t.ba;var w="readystatechange";Array.isArray(w)||(w&&(ns[0]=w.toString()),w=ns);for(let S=0;S<w.length;S++){const D=Qn(a,w[S],d||r.handleEvent,!1,r.h||r);if(!D)break;r.g[D.key]=D}r=t.J?Qe(t.J):{},t.u?(t.v||(t.v="POST"),r["Content-Type"]="application/x-www-form-urlencoded",t.g.ea(t.B,t.v,t.u,r)):(t.v="GET",t.g.ea(t.B,t.v,null,r)),pt(),Wo(t.i,t.v,t.B,t.l,t.S,t.u)}be.prototype.ba=function(t){t=t.target;const r=this.O;r&&Ee(t)==3?r.j():this.Y(t)},be.prototype.Y=function(t){try{if(t==this.g)e:{const R=Ee(this.g),J=this.g.ya(),q=this.g.ca();if(!(R<3)&&(R!=3||this.g&&(this.h.h||this.g.la()||Cs(this.g)))){this.K||R!=4||J==7||(J==8||q<=0?pt(3):pt(2)),Xi(this);var r=this.g.ca();this.X=r;var a=zo(this);if(this.o=r==200,Uo(this.i,this.v,this.B,this.l,this.S,R,r),this.o){if(this.U&&!this.L){t:{if(this.g){var d,w=this.g;if((d=w.g?w.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!h(d)){var S=d;break t}}S=null}if(t=S)et(this.i,this.l,t,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,Yi(this,t);else{this.o=!1,this.m=3,ie(12),Me(this),_t(this);break e}}if(this.R){t=!0;let Y;for(;!this.K&&this.C<a.length;)if(Y=Ho(this,a),Y==Ki){R==4&&(this.m=4,ie(14),t=!1),et(this.i,this.l,null,"[Incomplete Response]");break}else if(Y==hs){this.m=4,ie(15),et(this.i,this.l,a,"[Invalid Chunk]"),t=!1;break}else et(this.i,this.l,Y,null),Yi(this,Y);if(ms(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),R!=4||a.length!=0||this.h.h||(this.m=1,ie(16),t=!1),this.o=this.o&&t,!t)et(this.i,this.l,a,"[Invalid Chunked Response]"),Me(this),_t(this);else if(a.length>0&&!this.W){this.W=!0;var D=this.j;D.g==this&&D.aa&&!D.P&&(D.j.info("Great, no buffering proxy detected. Bytes received: "+a.length),on(D),D.P=!0,ie(11))}}else et(this.i,this.l,a,null),Yi(this,a);R==4&&Me(this),this.o&&!this.K&&(R==4?Us(this.j,this):(this.o=!1,Xt(this)))}else oa(this.g),r==400&&a.indexOf("Unknown SID")>0?(this.m=3,ie(12)):(this.m=0,ie(13)),Me(this),_t(this)}}}catch{}finally{}};function zo(t){if(!ms(t))return t.g.la();const r=Cs(t.g);if(r==="")return"";let a="";const d=r.length,w=Ee(t.g)==4;if(!t.h.i){if(typeof TextDecoder>"u")return Me(t),_t(t),"";t.h.i=new c.TextDecoder}for(let S=0;S<d;S++)t.h.h=!0,a+=t.h.i.decode(r[S],{stream:!(w&&S==d-1)});return r.length=0,t.h.g+=a,t.C=0,t.h.g}function ms(t){return t.g?t.v=="GET"&&t.M!=2&&t.j.Aa:!1}function Ho(t,r){var a=t.C,d=r.indexOf(`
`,a);return d==-1?Ki:(a=Number(r.substring(a,d)),isNaN(a)?hs:(d+=1,d+a>r.length?Ki:(r=r.slice(d,d+a),t.C=d+a,r)))}be.prototype.cancel=function(){this.K=!0,Me(this)};function Xt(t){t.T=Date.now()+t.H,ps(t,t.H)}function ps(t,r){if(t.D!=null)throw Error("WatchDog timer not null");t.D=gt(g(t.aa,t),r)}function Xi(t){t.D&&(c.clearTimeout(t.D),t.D=null)}be.prototype.aa=function(){this.D=null;const t=Date.now();t-this.T>=0?(Fo(this.i,this.B),this.M!=2&&(pt(),ie(17)),Me(this),this.m=2,_t(this)):ps(this,this.T-t)};function _t(t){t.j.I==0||t.K||Us(t.j,t)}function Me(t){Xi(t);var r=t.O;r&&typeof r.dispose=="function"&&r.dispose(),t.O=null,ss(t.V),t.g&&(r=t.g,t.g=null,r.abort(),r.dispose())}function Yi(t,r){try{var a=t.j;if(a.I!=0&&(a.g==t||Qi(a.h,t))){if(!t.L&&Qi(a.h,t)&&a.I==3){try{var d=a.Ba.g.parse(r)}catch{d=null}if(Array.isArray(d)&&d.length==3){var w=d;if(w[0]==0){e:if(!a.v){if(a.g)if(a.g.F+3e3<t.F)ii(a),ei(a);else break e;rn(a),ie(18)}}else a.xa=w[1],0<a.xa-a.K&&w[2]<37500&&a.F&&a.A==0&&!a.C&&(a.C=gt(g(a.Va,a),6e3));ys(a.h)<=1&&a.ta&&(a.ta=void 0)}else $e(a,11)}else if((t.L||a.g==t)&&ii(a),!h(r))for(w=a.Ba.g.parse(r),r=0;r<w.length;r++){let q=w[r];const Y=q[0];if(!(Y<=a.K))if(a.K=Y,q=q[1],a.I==2)if(q[0]=="c"){a.M=q[1],a.ba=q[2];const he=q[3];he!=null&&(a.ka=he,a.j.info("VER="+a.ka));const Be=q[4];Be!=null&&(a.za=Be,a.j.info("SVER="+a.za));const ke=q[5];ke!=null&&typeof ke=="number"&&ke>0&&(d=1.5*ke,a.O=d,a.j.info("backChannelRequestTimeoutMs_="+d)),d=a;const Ae=t.g;if(Ae){const ni=Ae.g?Ae.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(ni){var S=d.h;S.g||ni.indexOf("spdy")==-1&&ni.indexOf("quic")==-1&&ni.indexOf("h2")==-1||(S.j=S.l,S.g=new Set,S.h&&(Zi(S,S.h),S.h=null))}if(d.G){const an=Ae.g?Ae.g.getResponseHeader("X-HTTP-Session-Id"):null;an&&(d.wa=an,H(d.J,d.G,an))}}a.I=3,a.l&&a.l.ra(),a.aa&&(a.T=Date.now()-t.F,a.j.info("Handshake RTT: "+a.T+"ms")),d=a;var D=t;if(d.na=js(d,d.L?d.ba:null,d.W),D.L){_s(d.h,D);var R=D,J=d.O;J&&(R.H=J),R.D&&(Xi(R),Xt(R)),d.g=D}else Bs(d);a.i.length>0&&ti(a)}else q[0]!="stop"&&q[0]!="close"||$e(a,7);else a.I==3&&(q[0]=="stop"||q[0]=="close"?q[0]=="stop"?$e(a,7):sn(a):q[0]!="noop"&&a.l&&a.l.qa(q),a.A=0)}}pt(4)}catch{}}var Go=class{constructor(t,r){this.g=t,this.map=r}};function gs(t){this.l=t||10,c.PerformanceNavigationTiming?(t=c.performance.getEntriesByType("navigation"),t=t.length>0&&(t[0].nextHopProtocol=="hq"||t[0].nextHopProtocol=="h2")):t=!!(c.chrome&&c.chrome.loadTimes&&c.chrome.loadTimes()&&c.chrome.loadTimes().wasFetchedViaSpdy),this.j=t?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function vs(t){return t.h?!0:t.g?t.g.size>=t.j:!1}function ys(t){return t.h?1:t.g?t.g.size:0}function Qi(t,r){return t.h?t.h==r:t.g?t.g.has(r):!1}function Zi(t,r){t.g?t.g.add(r):t.h=r}function _s(t,r){t.h&&t.h==r?t.h=null:t.g&&t.g.has(r)&&t.g.delete(r)}gs.prototype.cancel=function(){if(this.i=Is(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const t of this.g.values())t.cancel();this.g.clear()}};function Is(t){if(t.h!=null)return t.i.concat(t.h.G);if(t.g!=null&&t.g.size!==0){let r=t.i;for(const a of t.g.values())r=r.concat(a.G);return r}return k(t.i)}var Ts=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Ko(t,r){if(t){t=t.split("&");for(let a=0;a<t.length;a++){const d=t[a].indexOf("=");let w,S=null;d>=0?(w=t[a].substring(0,d),S=t[a].substring(d+1)):w=t[a],r(w,S?decodeURIComponent(S.replace(/\+/g," ")):"")}}}function we(t){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let r;t instanceof we?(this.l=t.l,It(this,t.j),this.o=t.o,this.g=t.g,Tt(this,t.u),this.h=t.h,en(this,As(t.i)),this.m=t.m):t&&(r=String(t).match(Ts))?(this.l=!1,It(this,r[1]||"",!0),this.o=bt(r[2]||""),this.g=bt(r[3]||"",!0),Tt(this,r[4]),this.h=bt(r[5]||"",!0),en(this,r[6]||"",!0),this.m=bt(r[7]||"")):(this.l=!1,this.i=new St(null,this.l))}we.prototype.toString=function(){const t=[];var r=this.j;r&&t.push(wt(r,bs,!0),":");var a=this.g;return(a||r=="file")&&(t.push("//"),(r=this.o)&&t.push(wt(r,bs,!0),"@"),t.push(yt(a).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a=this.u,a!=null&&t.push(":",String(a))),(a=this.h)&&(this.g&&a.charAt(0)!="/"&&t.push("/"),t.push(wt(a,a.charAt(0)=="/"?Yo:Xo,!0))),(a=this.i.toString())&&t.push("?",a),(a=this.m)&&t.push("#",wt(a,Zo)),t.join("")},we.prototype.resolve=function(t){const r=ue(this);let a=!!t.j;a?It(r,t.j):a=!!t.o,a?r.o=t.o:a=!!t.g,a?r.g=t.g:a=t.u!=null;var d=t.h;if(a)Tt(r,t.u);else if(a=!!t.h){if(d.charAt(0)!="/")if(this.g&&!this.h)d="/"+d;else{var w=r.h.lastIndexOf("/");w!=-1&&(d=r.h.slice(0,w+1)+d)}if(w=d,w==".."||w==".")d="";else if(w.indexOf("./")!=-1||w.indexOf("/.")!=-1){d=w.lastIndexOf("/",0)==0,w=w.split("/");const S=[];for(let D=0;D<w.length;){const R=w[D++];R=="."?d&&D==w.length&&S.push(""):R==".."?((S.length>1||S.length==1&&S[0]!="")&&S.pop(),d&&D==w.length&&S.push("")):(S.push(R),d=!0)}d=S.join("/")}else d=w}return a?r.h=d:a=t.i.toString()!=="",a?en(r,As(t.i)):a=!!t.m,a&&(r.m=t.m),r};function ue(t){return new we(t)}function It(t,r,a){t.j=a?bt(r,!0):r,t.j&&(t.j=t.j.replace(/:$/,""))}function Tt(t,r){if(r){if(r=Number(r),isNaN(r)||r<0)throw Error("Bad port number "+r);t.u=r}else t.u=null}function en(t,r,a){r instanceof St?(t.i=r,ea(t.i,t.l)):(a||(r=wt(r,Qo)),t.i=new St(r,t.l))}function H(t,r,a){t.i.set(r,a)}function Yt(t){return H(t,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),t}function bt(t,r){return t?r?decodeURI(t.replace(/%25/g,"%2525")):decodeURIComponent(t):""}function wt(t,r,a){return typeof t=="string"?(t=encodeURI(t).replace(r,Jo),a&&(t=t.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),t):null}function Jo(t){return t=t.charCodeAt(0),"%"+(t>>4&15).toString(16)+(t&15).toString(16)}var bs=/[#\/\?@]/g,Xo=/[#\?:]/g,Yo=/[#\?]/g,Qo=/[#\?@]/g,Zo=/#/g;function St(t,r){this.h=this.g=null,this.i=t||null,this.j=!!r}function Re(t){t.g||(t.g=new Map,t.h=0,t.i&&Ko(t.i,function(r,a){t.add(decodeURIComponent(r.replace(/\+/g," ")),a)}))}i=St.prototype,i.add=function(t,r){Re(this),this.i=null,t=tt(this,t);let a=this.g.get(t);return a||this.g.set(t,a=[]),a.push(r),this.h+=1,this};function ws(t,r){Re(t),r=tt(t,r),t.g.has(r)&&(t.i=null,t.h-=t.g.get(r).length,t.g.delete(r))}function Ss(t,r){return Re(t),r=tt(t,r),t.g.has(r)}i.forEach=function(t,r){Re(this),this.g.forEach(function(a,d){a.forEach(function(w){t.call(r,w,d,this)},this)},this)};function Es(t,r){Re(t);let a=[];if(typeof r=="string")Ss(t,r)&&(a=a.concat(t.g.get(tt(t,r))));else for(t=Array.from(t.g.values()),r=0;r<t.length;r++)a=a.concat(t[r]);return a}i.set=function(t,r){return Re(this),this.i=null,t=tt(this,t),Ss(this,t)&&(this.h-=this.g.get(t).length),this.g.set(t,[r]),this.h+=1,this},i.get=function(t,r){return t?(t=Es(this,t),t.length>0?String(t[0]):r):r};function ks(t,r,a){ws(t,r),a.length>0&&(t.i=null,t.g.set(tt(t,r),k(a)),t.h+=a.length)}i.toString=function(){if(this.i)return this.i;if(!this.g)return"";const t=[],r=Array.from(this.g.keys());for(let d=0;d<r.length;d++){var a=r[d];const w=yt(a);a=Es(this,a);for(let S=0;S<a.length;S++){let D=w;a[S]!==""&&(D+="="+yt(a[S])),t.push(D)}}return this.i=t.join("&")};function As(t){const r=new St;return r.i=t.i,t.g&&(r.g=new Map(t.g),r.h=t.h),r}function tt(t,r){return r=String(r),t.j&&(r=r.toLowerCase()),r}function ea(t,r){r&&!t.j&&(Re(t),t.i=null,t.g.forEach(function(a,d){const w=d.toLowerCase();d!=w&&(ws(this,d),ks(this,w,a))},t)),t.j=r}function ta(t,r){const a=new vt;if(c.Image){const d=new Image;d.onload=E(Se,a,"TestLoadImage: loaded",!0,r,d),d.onerror=E(Se,a,"TestLoadImage: error",!1,r,d),d.onabort=E(Se,a,"TestLoadImage: abort",!1,r,d),d.ontimeout=E(Se,a,"TestLoadImage: timeout",!1,r,d),c.setTimeout(function(){d.ontimeout&&d.ontimeout()},1e4),d.src=t}else r(!1)}function ia(t,r){const a=new vt,d=new AbortController,w=setTimeout(()=>{d.abort(),Se(a,"TestPingServer: timeout",!1,r)},1e4);fetch(t,{signal:d.signal}).then(S=>{clearTimeout(w),S.ok?Se(a,"TestPingServer: ok",!0,r):Se(a,"TestPingServer: server error",!1,r)}).catch(()=>{clearTimeout(w),Se(a,"TestPingServer: error",!1,r)})}function Se(t,r,a,d,w){try{w&&(w.onload=null,w.onerror=null,w.onabort=null,w.ontimeout=null),d(a)}catch{}}function na(){this.g=new $o}function tn(t){this.i=t.Sb||null,this.h=t.ab||!1}b(tn,rs),tn.prototype.g=function(){return new Qt(this.i,this.h)};function Qt(t,r){ee.call(this),this.H=t,this.o=r,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}b(Qt,ee),i=Qt.prototype,i.open=function(t,r){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=t,this.D=r,this.readyState=1,kt(this)},i.send=function(t){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const r={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};t&&(r.body=t),(this.H||c).fetch(new Request(this.D,r)).then(this.Pa.bind(this),this.ga.bind(this))},i.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,Et(this)),this.readyState=0},i.Pa=function(t){if(this.g&&(this.l=t,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=t.headers,this.readyState=2,kt(this)),this.g&&(this.readyState=3,kt(this),this.g)))if(this.responseType==="arraybuffer")t.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof c.ReadableStream<"u"&&"body"in t){if(this.j=t.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;xs(this)}else t.text().then(this.Oa.bind(this),this.ga.bind(this))};function xs(t){t.j.read().then(t.Ma.bind(t)).catch(t.ga.bind(t))}i.Ma=function(t){if(this.g){if(this.o&&t.value)this.response.push(t.value);else if(!this.o){var r=t.value?t.value:new Uint8Array(0);(r=this.B.decode(r,{stream:!t.done}))&&(this.response=this.responseText+=r)}t.done?Et(this):kt(this),this.readyState==3&&xs(this)}},i.Oa=function(t){this.g&&(this.response=this.responseText=t,Et(this))},i.Na=function(t){this.g&&(this.response=t,Et(this))},i.ga=function(){this.g&&Et(this)};function Et(t){t.readyState=4,t.l=null,t.j=null,t.B=null,kt(t)}i.setRequestHeader=function(t,r){this.A.append(t,r)},i.getResponseHeader=function(t){return this.h&&this.h.get(t.toLowerCase())||""},i.getAllResponseHeaders=function(){if(!this.h)return"";const t=[],r=this.h.entries();for(var a=r.next();!a.done;)a=a.value,t.push(a[0]+": "+a[1]),a=r.next();return t.join(`\r
`)};function kt(t){t.onreadystatechange&&t.onreadystatechange.call(t)}Object.defineProperty(Qt.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(t){this.m=t?"include":"same-origin"}});function Os(t){let r="";return de(t,function(a,d){r+=d,r+=":",r+=a,r+=`\r
`}),r}function nn(t,r,a){e:{for(d in a){var d=!1;break e}d=!0}d||(a=Os(a),typeof t=="string"?a!=null&&yt(a):H(t,r,a))}function G(t){ee.call(this),this.headers=new Map,this.L=t||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}b(G,ee);var sa=/^https?$/i,ra=["POST","PUT"];i=G.prototype,i.Fa=function(t){this.H=t},i.ea=function(t,r,a,d){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+t);r=r?r.toUpperCase():"GET",this.D=t,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():ds.g(),this.g.onreadystatechange=I(g(this.Ca,this));try{this.B=!0,this.g.open(r,String(t),!0),this.B=!1}catch(S){Ds(this,S);return}if(t=a||"",a=new Map(this.headers),d)if(Object.getPrototypeOf(d)===Object.prototype)for(var w in d)a.set(w,d[w]);else if(typeof d.keys=="function"&&typeof d.get=="function")for(const S of d.keys())a.set(S,d.get(S));else throw Error("Unknown input type for opt_headers: "+String(d));d=Array.from(a.keys()).find(S=>S.toLowerCase()=="content-type"),w=c.FormData&&t instanceof c.FormData,!(Array.prototype.indexOf.call(ra,r,void 0)>=0)||d||w||a.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[S,D]of a)this.g.setRequestHeader(S,D);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(t),this.v=!1}catch(S){Ds(this,S)}};function Ds(t,r){t.h=!1,t.g&&(t.j=!0,t.g.abort(),t.j=!1),t.l=r,t.o=5,Ps(t),Zt(t)}function Ps(t){t.A||(t.A=!0,te(t,"complete"),te(t,"error"))}i.abort=function(t){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=t||7,te(this,"complete"),te(this,"abort"),Zt(this))},i.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Zt(this,!0)),G.Z.N.call(this)},i.Ca=function(){this.u||(this.B||this.v||this.j?Ls(this):this.Xa())},i.Xa=function(){Ls(this)};function Ls(t){if(t.h&&typeof l<"u"){if(t.v&&Ee(t)==4)setTimeout(t.Ca.bind(t),0);else if(te(t,"readystatechange"),Ee(t)==4){t.h=!1;try{const S=t.ca();e:switch(S){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var r=!0;break e;default:r=!1}var a;if(!(a=r)){var d;if(d=S===0){let D=String(t.D).match(Ts)[1]||null;!D&&c.self&&c.self.location&&(D=c.self.location.protocol.slice(0,-1)),d=!sa.test(D?D.toLowerCase():"")}a=d}if(a)te(t,"complete"),te(t,"success");else{t.o=6;try{var w=Ee(t)>2?t.g.statusText:""}catch{w=""}t.l=w+" ["+t.ca()+"]",Ps(t)}}finally{Zt(t)}}}}function Zt(t,r){if(t.g){t.m&&(clearTimeout(t.m),t.m=null);const a=t.g;t.g=null,r||te(t,"ready");try{a.onreadystatechange=null}catch{}}}i.isActive=function(){return!!this.g};function Ee(t){return t.g?t.g.readyState:0}i.ca=function(){try{return Ee(this)>2?this.g.status:-1}catch{return-1}},i.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},i.La=function(t){if(this.g){var r=this.g.responseText;return t&&r.indexOf(t)==0&&(r=r.substring(t.length)),Ro(r)}};function Cs(t){try{if(!t.g)return null;if("response"in t.g)return t.g.response;switch(t.F){case"":case"text":return t.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in t.g)return t.g.mozResponseArrayBuffer}return null}catch{return null}}function oa(t){const r={};t=(t.g&&Ee(t)>=2&&t.g.getAllResponseHeaders()||"").split(`\r
`);for(let d=0;d<t.length;d++){if(h(t[d]))continue;var a=qo(t[d]);const w=a[0];if(a=a[1],typeof a!="string")continue;a=a.trim();const S=r[w]||[];r[w]=S,S.push(a)}Ye(r,function(d){return d.join(", ")})}i.ya=function(){return this.o},i.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function At(t,r,a){return a&&a.internalChannelParams&&a.internalChannelParams[t]||r}function Ns(t){this.za=0,this.i=[],this.j=new vt,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=At("failFast",!1,t),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=At("baseRetryDelayMs",5e3,t),this.Za=At("retryDelaySeedMs",1e4,t),this.Ta=At("forwardChannelMaxRetries",2,t),this.va=At("forwardChannelRequestTimeoutMs",2e4,t),this.ma=t&&t.xmlHttpFactory||void 0,this.Ua=t&&t.Rb||void 0,this.Aa=t&&t.useFetchStreams||!1,this.O=void 0,this.L=t&&t.supportsCrossDomainXhr||!1,this.M="",this.h=new gs(t&&t.concurrentRequestLimit),this.Ba=new na,this.S=t&&t.fastHandshake||!1,this.R=t&&t.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=t&&t.Pb||!1,t&&t.ua&&this.j.ua(),t&&t.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&t&&t.detectBufferingProxy||!1,this.ia=void 0,t&&t.longPollingTimeout&&t.longPollingTimeout>0&&(this.ia=t.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}i=Ns.prototype,i.ka=8,i.I=1,i.connect=function(t,r,a,d){ie(0),this.W=t,this.H=r||{},a&&d!==void 0&&(this.H.OSID=a,this.H.OAID=d),this.F=this.X,this.J=js(this,null,this.W),ti(this)};function sn(t){if(Ms(t),t.I==3){var r=t.V++,a=ue(t.J);if(H(a,"SID",t.M),H(a,"RID",r),H(a,"TYPE","terminate"),xt(t,a),r=new be(t,t.j,r),r.M=2,r.A=Yt(ue(a)),a=!1,c.navigator&&c.navigator.sendBeacon)try{a=c.navigator.sendBeacon(r.A.toString(),"")}catch{}!a&&c.Image&&(new Image().src=r.A,a=!0),a||(r.g=qs(r.j,null),r.g.ea(r.A)),r.F=Date.now(),Xt(r)}Vs(t)}function ei(t){t.g&&(on(t),t.g.cancel(),t.g=null)}function Ms(t){ei(t),t.v&&(c.clearTimeout(t.v),t.v=null),ii(t),t.h.cancel(),t.m&&(typeof t.m=="number"&&c.clearTimeout(t.m),t.m=null)}function ti(t){if(!vs(t.h)&&!t.m){t.m=!0;var r=t.Ea;B||f(),j||(B(),j=!0),y.add(r,t),t.D=0}}function aa(t,r){return ys(t.h)>=t.h.j-(t.m?1:0)?!1:t.m?(t.i=r.G.concat(t.i),!0):t.I==1||t.I==2||t.D>=(t.Sa?0:t.Ta)?!1:(t.m=gt(g(t.Ea,t,r),Fs(t,t.D)),t.D++,!0)}i.Ea=function(t){if(this.m)if(this.m=null,this.I==1){if(!t){this.V=Math.floor(Math.random()*1e5),t=this.V++;const w=new be(this,this.j,t);let S=this.o;if(this.U&&(S?(S=Qe(S),Yn(S,this.U)):S=this.U),this.u!==null||this.R||(w.J=S,S=null),this.S)e:{for(var r=0,a=0;a<this.i.length;a++){t:{var d=this.i[a];if("__data__"in d.map&&(d=d.map.__data__,typeof d=="string")){d=d.length;break t}d=void 0}if(d===void 0)break;if(r+=d,r>4096){r=a;break e}if(r===4096||a===this.i.length-1){r=a+1;break e}}r=1e3}else r=1e3;r=$s(this,w,r),a=ue(this.J),H(a,"RID",t),H(a,"CVER",22),this.G&&H(a,"X-HTTP-Session-Id",this.G),xt(this,a),S&&(this.R?r="headers="+yt(Os(S))+"&"+r:this.u&&nn(a,this.u,S)),Zi(this.h,w),this.Ra&&H(a,"TYPE","init"),this.S?(H(a,"$req",r),H(a,"SID","null"),w.U=!0,Ji(w,a,null)):Ji(w,a,r),this.I=2}}else this.I==3&&(t?Rs(this,t):this.i.length==0||vs(this.h)||Rs(this))};function Rs(t,r){var a;r?a=r.l:a=t.V++;const d=ue(t.J);H(d,"SID",t.M),H(d,"RID",a),H(d,"AID",t.K),xt(t,d),t.u&&t.o&&nn(d,t.u,t.o),a=new be(t,t.j,a,t.D+1),t.u===null&&(a.J=t.o),r&&(t.i=r.G.concat(t.i)),r=$s(t,a,1e3),a.H=Math.round(t.va*.5)+Math.round(t.va*.5*Math.random()),Zi(t.h,a),Ji(a,d,r)}function xt(t,r){t.H&&de(t.H,function(a,d){H(r,d,a)}),t.l&&de({},function(a,d){H(r,d,a)})}function $s(t,r,a){a=Math.min(t.i.length,a);const d=t.l?g(t.l.Ka,t.l,t):null;e:{var w=t.i;let R=-1;for(;;){const J=["count="+a];R==-1?a>0?(R=w[0].g,J.push("ofs="+R)):R=0:J.push("ofs="+R);let q=!0;for(let Y=0;Y<a;Y++){var S=w[Y].g;const he=w[Y].map;if(S-=R,S<0)R=Math.max(0,w[Y].g-100),q=!1;else try{S="req"+S+"_"||"";try{var D=he instanceof Map?he:Object.entries(he);for(const[Be,ke]of D){let Ae=ke;u(ke)&&(Ae=Vi(ke)),J.push(S+Be+"="+encodeURIComponent(Ae))}}catch(Be){throw J.push(S+"type="+encodeURIComponent("_badmap")),Be}}catch{d&&d(he)}}if(q){D=J.join("&");break e}}D=void 0}return t=t.i.splice(0,a),r.G=t,D}function Bs(t){if(!t.g&&!t.v){t.Y=1;var r=t.Da;B||f(),j||(B(),j=!0),y.add(r,t),t.A=0}}function rn(t){return t.g||t.v||t.A>=3?!1:(t.Y++,t.v=gt(g(t.Da,t),Fs(t,t.A)),t.A++,!0)}i.Da=function(){if(this.v=null,Ws(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var t=4*this.T;this.j.info("BP detection timer enabled: "+t),this.B=gt(g(this.Wa,this),t)}},i.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,ie(10),ei(this),Ws(this))};function on(t){t.B!=null&&(c.clearTimeout(t.B),t.B=null)}function Ws(t){t.g=new be(t,t.j,"rpc",t.Y),t.u===null&&(t.g.J=t.o),t.g.P=0;var r=ue(t.na);H(r,"RID","rpc"),H(r,"SID",t.M),H(r,"AID",t.K),H(r,"CI",t.F?"0":"1"),!t.F&&t.ia&&H(r,"TO",t.ia),H(r,"TYPE","xmlhttp"),xt(t,r),t.u&&t.o&&nn(r,t.u,t.o),t.O&&(t.g.H=t.O);var a=t.g;t=t.ba,a.M=1,a.A=Yt(ue(r)),a.u=null,a.R=!0,fs(a,t)}i.Va=function(){this.C!=null&&(this.C=null,ei(this),rn(this),ie(19))};function ii(t){t.C!=null&&(c.clearTimeout(t.C),t.C=null)}function Us(t,r){var a=null;if(t.g==r){ii(t),on(t),t.g=null;var d=2}else if(Qi(t.h,r))a=r.G,_s(t.h,r),d=1;else return;if(t.I!=0){if(r.o)if(d==1){a=r.u?r.u.length:0,r=Date.now()-r.F;var w=t.D;d=zi(),te(d,new cs(d,a)),ti(t)}else Bs(t);else if(w=r.m,w==3||w==0&&r.X>0||!(d==1&&aa(t,r)||d==2&&rn(t)))switch(a&&a.length>0&&(r=t.h,r.i=r.i.concat(a)),w){case 1:$e(t,5);break;case 4:$e(t,10);break;case 3:$e(t,6);break;default:$e(t,2)}}}function Fs(t,r){let a=t.Qa+Math.floor(Math.random()*t.Za);return t.isActive()||(a*=2),a*r}function $e(t,r){if(t.j.info("Error code "+r),r==2){var a=g(t.bb,t),d=t.Ua;const w=!d;d=new we(d||"//www.google.com/images/cleardot.gif"),c.location&&c.location.protocol=="http"||It(d,"https"),Yt(d),w?ta(d.toString(),a):ia(d.toString(),a)}else ie(2);t.I=0,t.l&&t.l.pa(r),Vs(t),Ms(t)}i.bb=function(t){t?(this.j.info("Successfully pinged google.com"),ie(2)):(this.j.info("Failed to ping google.com"),ie(1))};function Vs(t){if(t.I=0,t.ja=[],t.l){const r=Is(t.h);(r.length!=0||t.i.length!=0)&&(A(t.ja,r),A(t.ja,t.i),t.h.i.length=0,k(t.i),t.i.length=0),t.l.oa()}}function js(t,r,a){var d=a instanceof we?ue(a):new we(a);if(d.g!="")r&&(d.g=r+"."+d.g),Tt(d,d.u);else{var w=c.location;d=w.protocol,r=r?r+"."+w.hostname:w.hostname,w=+w.port;const S=new we(null);d&&It(S,d),r&&(S.g=r),w&&Tt(S,w),a&&(S.h=a),d=S}return a=t.G,r=t.wa,a&&r&&H(d,a,r),H(d,"VER",t.ka),xt(t,d),d}function qs(t,r,a){if(r&&!t.L)throw Error("Can't create secondary domain capable XhrIo object.");return r=t.Aa&&!t.ma?new G(new tn({ab:a})):new G(t.ma),r.Fa(t.L),r}i.isActive=function(){return!!this.l&&this.l.isActive(this)};function zs(){}i=zs.prototype,i.ra=function(){},i.qa=function(){},i.pa=function(){},i.oa=function(){},i.isActive=function(){return!0},i.Ka=function(){};function oe(t,r){ee.call(this),this.g=new Ns(r),this.l=t,this.h=r&&r.messageUrlParams||null,t=r&&r.messageHeaders||null,r&&r.clientProtocolHeaderRequired&&(t?t["X-Client-Protocol"]="webchannel":t={"X-Client-Protocol":"webchannel"}),this.g.o=t,t=r&&r.initMessageHeaders||null,r&&r.messageContentType&&(t?t["X-WebChannel-Content-Type"]=r.messageContentType:t={"X-WebChannel-Content-Type":r.messageContentType}),r&&r.sa&&(t?t["X-WebChannel-Client-Profile"]=r.sa:t={"X-WebChannel-Client-Profile":r.sa}),this.g.U=t,(t=r&&r.Qb)&&!h(t)&&(this.g.u=t),this.A=r&&r.supportsCrossDomainXhr||!1,this.v=r&&r.sendRawJson||!1,(r=r&&r.httpSessionIdParam)&&!h(r)&&(this.g.G=r,t=this.h,t!==null&&r in t&&(t=this.h,r in t&&delete t[r])),this.j=new it(this)}b(oe,ee),oe.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},oe.prototype.close=function(){sn(this.g)},oe.prototype.o=function(t){var r=this.g;if(typeof t=="string"){var a={};a.__data__=t,t=a}else this.v&&(a={},a.__data__=Vi(t),t=a);r.i.push(new Go(r.Ya++,t)),r.I==3&&ti(r)},oe.prototype.N=function(){this.g.l=null,delete this.j,sn(this.g),delete this.g,oe.Z.N.call(this)};function Hs(t){ji.call(this),t.__headers__&&(this.headers=t.__headers__,this.statusCode=t.__status__,delete t.__headers__,delete t.__status__);var r=t.__sm__;if(r){e:{for(const a in r){t=a;break e}t=void 0}(this.i=t)&&(t=this.i,r=r!==null&&t in r?r[t]:void 0),this.data=r}else this.data=t}b(Hs,ji);function Gs(){qi.call(this),this.status=1}b(Gs,qi);function it(t){this.g=t}b(it,zs),it.prototype.ra=function(){te(this.g,"a")},it.prototype.qa=function(t){te(this.g,new Hs(t))},it.prototype.pa=function(t){te(this.g,new Gs)},it.prototype.oa=function(){te(this.g,"b")},oe.prototype.send=oe.prototype.o,oe.prototype.open=oe.prototype.m,oe.prototype.close=oe.prototype.close,Hi.NO_ERROR=0,Hi.TIMEOUT=8,Hi.HTTP_ERROR=6,jo.COMPLETE="complete",Bo.EventType=mt,mt.OPEN="a",mt.CLOSE="b",mt.ERROR="c",mt.MESSAGE="d",ee.prototype.listen=ee.prototype.J,G.prototype.listenOnce=G.prototype.K,G.prototype.getLastError=G.prototype.Ha,G.prototype.getLastErrorCode=G.prototype.ya,G.prototype.getStatus=G.prototype.ca,G.prototype.getResponseJson=G.prototype.La,G.prototype.getResponseText=G.prototype.la,G.prototype.send=G.prototype.ea,G.prototype.setWithCredentials=G.prototype.Fa}).apply(typeof si<"u"?si:typeof self<"u"?self:typeof window<"u"?window:{});/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ai="12.12.0";function Rl(i){Ai=i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fi=new Mn("@firebase/firestore");function le(i,...e){if(fi.logLevel<=V.DEBUG){const n=e.map(Jr);fi.debug(`Firestore (${Ai}): ${i}`,...n)}}function Kr(i,...e){if(fi.logLevel<=V.ERROR){const n=e.map(Jr);fi.error(`Firestore (${Ai}): ${i}`,...n)}}function Jr(i){if(typeof i=="string")return i;try{return function(n){return JSON.stringify(n)}(i)}catch{return i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mi(i,e,n){let s="Unexpected state";typeof e=="string"?s=e:n=e,Xr(i,s,n)}function Xr(i,e,n){let s=`FIRESTORE (${Ai}) INTERNAL ASSERTION FAILED: ${e} (ID: ${i.toString(16)})`;if(n!==void 0)try{s+=" CONTEXT: "+JSON.stringify(n)}catch{s+=" CONTEXT: "+n}throw Kr(s),new Error(s)}function Dt(i,e,n,s){let o="Unexpected state";typeof n=="string"?o=n:s=n,i||Xr(e,o,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $l{constructor(e,n){this.user=n,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class Bl{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,n){e.enqueueRetryable(()=>n(ne.UNAUTHENTICATED))}shutdown(){}}class Wl{constructor(e){this.t=e,this.currentUser=ne.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,n){Dt(this.o===void 0,42304);let s=this.i;const o=p=>this.i!==s?(s=this.i,n(p)):Promise.resolve();let l=new Pt;this.o=()=>{this.i++,this.currentUser=this.u(),l.resolve(),l=new Pt,e.enqueueRetryable(()=>o(this.currentUser))};const c=()=>{const p=l;e.enqueueRetryable(async()=>{await p.promise,await o(this.currentUser)})},u=p=>{le("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=p,this.o&&(this.auth.addAuthTokenListener(this.o),c())};this.t.onInit(p=>u(p)),setTimeout(()=>{if(!this.auth){const p=this.t.getImmediate({optional:!0});p?u(p):(le("FirebaseAuthCredentialsProvider","Auth not yet detected"),l.resolve(),l=new Pt)}},0),c()}getToken(){const e=this.i,n=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(n).then(s=>this.i!==e?(le("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):s?(Dt(typeof s.accessToken=="string",31837,{l:s}),new $l(s.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return Dt(e===null||typeof e=="string",2055,{h:e}),new ne(e)}}class Ul{constructor(e,n,s){this.P=e,this.T=n,this.I=s,this.type="FirstParty",this.user=ne.FIRST_PARTY,this.R=new Map}A(){return this.I?this.I():null}get headers(){this.R.set("X-Goog-AuthUser",this.P);const e=this.A();return e&&this.R.set("Authorization",e),this.T&&this.R.set("X-Goog-Iam-Authorization-Token",this.T),this.R}}class Fl{constructor(e,n,s){this.P=e,this.T=n,this.I=s}getToken(){return Promise.resolve(new Ul(this.P,this.T,this.I))}start(e,n){e.enqueueRetryable(()=>n(ne.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class rr{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class Vl{constructor(e,n){this.V=n,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,We(e)&&e.settings.appCheckToken&&(this.p=e.settings.appCheckToken)}start(e,n){Dt(this.o===void 0,3512);const s=l=>{l.error!=null&&le("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${l.error.message}`);const c=l.token!==this.m;return this.m=l.token,le("FirebaseAppCheckTokenProvider",`Received ${c?"new":"existing"} token.`),c?n(l.token):Promise.resolve()};this.o=l=>{e.enqueueRetryable(()=>s(l))};const o=l=>{le("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=l,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit(l=>o(l)),setTimeout(()=>{if(!this.appCheck){const l=this.V.getImmediate({optional:!0});l?o(l):le("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){if(this.p)return Promise.resolve(new rr(this.p));const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(n=>n?(Dt(typeof n.token=="string",44558,{tokenResult:n}),this.m=n.token,new rr(n.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const or="__name__";class fe{constructor(e,n,s){n===void 0?n=0:n>e.length&&mi(637,{offset:n,range:e.length}),s===void 0?s=e.length-n:s>e.length-n&&mi(1746,{length:s,range:e.length-n}),this.segments=e,this.offset=n,this.len=s}get length(){return this.len}isEqual(e){return fe.comparator(this,e)===0}child(e){const n=this.segments.slice(this.offset,this.limit());return e instanceof fe?e.forEach(s=>{n.push(s)}):n.push(e),this.construct(n)}limit(){return this.offset+this.length}popFirst(e){return e=e===void 0?1:e,this.construct(this.segments,this.offset+e,this.length-e)}popLast(){return this.construct(this.segments,this.offset,this.length-1)}firstSegment(){return this.segments[this.offset]}lastSegment(){return this.get(this.length-1)}get(e){return this.segments[this.offset+e]}isEmpty(){return this.length===0}isPrefixOf(e){if(e.length<this.length)return!1;for(let n=0;n<this.length;n++)if(this.get(n)!==e.get(n))return!1;return!0}isImmediateParentOf(e){if(this.length+1!==e.length)return!1;for(let n=0;n<this.length;n++)if(this.get(n)!==e.get(n))return!1;return!0}forEach(e){for(let n=this.offset,s=this.limit();n<s;n++)e(this.segments[n])}toArray(){return this.segments.slice(this.offset,this.limit())}static comparator(e,n){const s=Math.min(e.length,n.length);for(let o=0;o<s;o++){const l=fe.compareSegments(e.get(o),n.get(o));if(l!==0)return l}return Le(e.length,n.length)}static compareSegments(e,n){const s=fe.isNumericId(e),o=fe.isNumericId(n);return s&&!o?-1:!s&&o?1:s&&o?fe.extractNumericId(e).compare(fe.extractNumericId(n)):zl(e,n)}static isNumericId(e){return e.startsWith("__id")&&e.endsWith("__")}static extractNumericId(e){return Bn.fromString(e.substring(4,e.length-2))}}class ae extends fe{construct(e,n,s){return new ae(e,n,s)}canonicalString(){return this.toArray().join("/")}toString(){return this.canonicalString()}toUriEncodedString(){return this.toArray().map(encodeURIComponent).join("/")}static fromString(...e){const n=[];for(const s of e){if(s.indexOf("//")>=0)throw new F(U.INVALID_ARGUMENT,`Invalid segment (${s}). Paths must not contain // in them.`);n.push(...s.split("/").filter(o=>o.length>0))}return new ae(n)}static emptyPath(){return new ae([])}}const Kl=/^[_a-zA-Z][_a-zA-Z0-9]*$/;class Ue extends fe{construct(e,n,s){return new Ue(e,n,s)}static isValidIdentifier(e){return Kl.test(e)}canonicalString(){return this.toArray().map(e=>(e=e.replace(/\\/g,"\\\\").replace(/`/g,"\\`"),Ue.isValidIdentifier(e)||(e="`"+e+"`"),e)).join(".")}toString(){return this.canonicalString()}isKeyField(){return this.length===1&&this.get(0)===or}static keyField(){return new Ue([or])}static fromServerFormat(e){const n=[];let s="",o=0;const l=()=>{if(s.length===0)throw new F(U.INVALID_ARGUMENT,`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);n.push(s),s=""};let c=!1;for(;o<e.length;){const u=e[o];if(u==="\\"){if(o+1===e.length)throw new F(U.INVALID_ARGUMENT,"Path has trailing escape character: "+e);const p=e[o+1];if(p!=="\\"&&p!=="."&&p!=="`")throw new F(U.INVALID_ARGUMENT,"Path has invalid escape sequence: "+e);s+=p,o+=2}else u==="`"?(c=!c,o++):u!=="."||c?(s+=u,o++):(l(),o++)}if(l(),c)throw new F(U.INVALID_ARGUMENT,"Unterminated ` in path: "+e);return new Ue(n)}static emptyPath(){return new Ue([])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function K(i,e){const n={typeString:i};return e&&(n.value=e),n}function zt(i,e){if(!Xl(i))throw new F(U.INVALID_ARGUMENT,"JSON must be an object");let n;for(const s in e)if(e[s]){const o=e[s].typeString,l="value"in e[s]?{value:e[s].value}:void 0;if(!(s in i)){n=`JSON missing required field: '${s}'`;break}const c=i[s];if(o&&typeof c!==o){n=`JSON field '${s}' must be a ${o}.`;break}if(l!==void 0&&c!==l.value){n=`Expected '${s}' field to equal '${l.value}'`;break}}if(n)throw new F(U.INVALID_ARGUMENT,n);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ar=-62135596800,lr=1e6;class me{static now(){return me.fromMillis(Date.now())}static fromDate(e){return me.fromMillis(e.getTime())}static fromMillis(e){const n=Math.floor(e/1e3),s=Math.floor((e-1e3*n)*lr);return new me(n,s)}constructor(e,n){if(this.seconds=e,this.nanoseconds=n,n<0)throw new F(U.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+n);if(n>=1e9)throw new F(U.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+n);if(e<ar)throw new F(U.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e);if(e>=253402300800)throw new F(U.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e)}toDate(){return new Date(this.toMillis())}toMillis(){return 1e3*this.seconds+this.nanoseconds/lr}_compareTo(e){return this.seconds===e.seconds?Le(this.nanoseconds,e.nanoseconds):Le(this.seconds,e.seconds)}isEqual(e){return e.seconds===this.seconds&&e.nanoseconds===this.nanoseconds}toString(){return"Timestamp(seconds="+this.seconds+", nanoseconds="+this.nanoseconds+")"}toJSON(){return{type:me._jsonSchemaVersion,seconds:this.seconds,nanoseconds:this.nanoseconds}}static fromJSON(e){if(zt(e,me._jsonSchema))return new me(e.seconds,e.nanoseconds)}valueOf(){const e=this.seconds-ar;return String(e).padStart(12,"0")+"."+String(this.nanoseconds).padStart(9,"0")}}me._jsonSchemaVersion="firestore/timestamp/1.0",me._jsonSchema={type:K("string",me._jsonSchemaVersion),seconds:K("number"),nanoseconds:K("number")};function Yl(i){return i.name==="IndexedDbTransactionError"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ke{constructor(e){this.binaryString=e}static fromBase64String(e){const n=function(o){try{return atob(o)}catch(l){throw typeof DOMException<"u"&&l instanceof DOMException?new Ql("Invalid base64 string: "+l):l}}(e);return new Ke(n)}static fromUint8Array(e){const n=function(o){let l="";for(let c=0;c<o.length;++c)l+=String.fromCharCode(o[c]);return l}(e);return new Ke(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(n){return btoa(n)}(this.binaryString)}toUint8Array(){return function(n){const s=new Uint8Array(n.length);for(let o=0;o<n.length;o++)s[o]=n.charCodeAt(o);return s}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return Le(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}Ke.EMPTY_BYTE_STRING=new Ke("");const cr="(default)";class pi{constructor(e,n){this.projectId=e,this.database=n||cr}static empty(){return new pi("","")}get isDefaultDatabase(){return this.database===cr}isEqual(e){return e instanceof pi&&e.projectId===this.projectId&&e.database===this.database}}function Zl(i,e){if(!Object.prototype.hasOwnProperty.apply(i.options,["projectId"]))throw new F(U.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new pi(i.options.projectId,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var dr,$;($=dr||(dr={}))[$.OK=0]="OK",$[$.CANCELLED=1]="CANCELLED",$[$.UNKNOWN=2]="UNKNOWN",$[$.INVALID_ARGUMENT=3]="INVALID_ARGUMENT",$[$.DEADLINE_EXCEEDED=4]="DEADLINE_EXCEEDED",$[$.NOT_FOUND=5]="NOT_FOUND",$[$.ALREADY_EXISTS=6]="ALREADY_EXISTS",$[$.PERMISSION_DENIED=7]="PERMISSION_DENIED",$[$.UNAUTHENTICATED=16]="UNAUTHENTICATED",$[$.RESOURCE_EXHAUSTED=8]="RESOURCE_EXHAUSTED",$[$.FAILED_PRECONDITION=9]="FAILED_PRECONDITION",$[$.ABORTED=10]="ABORTED",$[$.OUT_OF_RANGE=11]="OUT_OF_RANGE",$[$.UNIMPLEMENTED=12]="UNIMPLEMENTED",$[$.INTERNAL=13]="INTERNAL",$[$.UNAVAILABLE=14]="UNAVAILABLE",$[$.DATA_LOSS=15]="DATA_LOSS";/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */new Bn([4294967295,4294967295],0);/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Un{constructor(e,n,s){this.converter=n,this._query=s,this.type="query",this.firestore=e}withConverter(e){return new Un(this.firestore,e,this._query)}}class pe{constructor(e,n,s){this.converter=n,this._key=s,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Fn(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new pe(this.firestore,e,this._key)}toJSON(){return{type:pe._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(e,n,s){if(zt(n,pe._jsonSchema))return new pe(e,s||null,new Fe(ae.fromString(n.referencePath)))}}pe._jsonSchemaVersion="firestore/documentReference/1.0",pe._jsonSchema={type:K("string",pe._jsonSchemaVersion),referencePath:K("string")};class Fn extends Un{constructor(e,n,s){super(e,n,tc(s)),this._path=s,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new pe(this.firestore,null,new Fe(e))}withConverter(e){return new Fn(this.firestore,e,this._path)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gr="AsyncQueue";class vr{constructor(e=Promise.resolve()){this.Yu=[],this.ec=!1,this.tc=[],this.nc=null,this.rc=!1,this.sc=!1,this.oc=[],this.M_=new sc(this,"async_queue_retry"),this._c=()=>{const s=mn();s&&le(gr,"Visibility state changed to "+s.visibilityState),this.M_.w_()},this.ac=e;const n=mn();n&&typeof n.addEventListener=="function"&&n.addEventListener("visibilitychange",this._c)}get isShuttingDown(){return this.ec}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.uc(),this.cc(e)}enterRestrictedMode(e){if(!this.ec){this.ec=!0,this.sc=e||!1;const n=mn();n&&typeof n.removeEventListener=="function"&&n.removeEventListener("visibilitychange",this._c)}}enqueue(e){if(this.uc(),this.ec)return new Promise(()=>{});const n=new Pt;return this.cc(()=>this.ec&&this.sc?Promise.resolve():(e().then(n.resolve,n.reject),n.promise)).then(()=>n.promise)}enqueueRetryable(e){this.enqueueAndForget(()=>(this.Yu.push(e),this.lc()))}async lc(){if(this.Yu.length!==0){try{await this.Yu[0](),this.Yu.shift(),this.M_.reset()}catch(e){if(!Yl(e))throw e;le(gr,"Operation failed with retryable error: "+e)}this.Yu.length>0&&this.M_.p_(()=>this.lc())}}cc(e){const n=this.ac.then(()=>(this.rc=!0,e().catch(s=>{throw this.nc=s,this.rc=!1,Kr("INTERNAL UNHANDLED ERROR: ",yr(s)),s}).then(s=>(this.rc=!1,s))));return this.ac=n,n}enqueueAfterDelay(e,n,s){this.uc(),this.oc.indexOf(e)>-1&&(n=0);const o=Wn.createAndSchedule(this,e,n,s,l=>this.hc(l));return this.tc.push(o),o}uc(){this.nc&&mi(47125,{Pc:yr(this.nc)})}verifyOperationInProgress(){}async Tc(){let e;do e=this.ac,await e;while(e!==this.ac)}Ec(e){for(const n of this.tc)if(n.timerId===e)return!0;return!1}Ic(e){return this.Tc().then(()=>{this.tc.sort((n,s)=>n.targetTimeMs-s.targetTimeMs);for(const n of this.tc)if(n.skipDelay(),e!=="all"&&n.timerId===e)break;return this.Tc()})}Rc(e){this.oc.push(e)}hc(e){const n=this.tc.indexOf(e);this.tc.splice(n,1)}}function yr(i){let e=i.message||"";return i.stack&&(e=i.stack.includes(i.message)?i.stack:i.message+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _e{constructor(e){this._byteString=e}static fromBase64String(e){try{return new _e(Ke.fromBase64String(e))}catch(n){throw new F(U.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+n)}}static fromUint8Array(e){return new _e(Ke.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}toJSON(){return{type:_e._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(e){if(zt(e,_e._jsonSchema))return _e.fromBase64String(e.bytes)}}_e._jsonSchemaVersion="firestore/bytes/1.0",_e._jsonSchema={type:K("string",_e._jsonSchemaVersion),bytes:K("string")};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yr{constructor(...e){for(let n=0;n<e.length;++n)if(e[n].length===0)throw new F(U.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Ue(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qe{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new F(U.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new F(U.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return Le(this._lat,e._lat)||Le(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:qe._jsonSchemaVersion}}static fromJSON(e){if(zt(e,qe._jsonSchema))return new qe(e.latitude,e.longitude)}}qe._jsonSchemaVersion="firestore/geoPoint/1.0",qe._jsonSchema={type:K("string",qe._jsonSchemaVersion),latitude:K("number"),longitude:K("number")};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ze{constructor(e){this._values=(e||[]).map(n=>n)}toArray(){return this._values.map(e=>e)}isEqual(e){return function(s,o){if(s.length!==o.length)return!1;for(let l=0;l<s.length;++l)if(s[l]!==o[l])return!1;return!0}(this._values,e._values)}toJSON(){return{type:ze._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(zt(e,ze._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every(n=>typeof n=="number"))return new ze(e.vectorValues);throw new F(U.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}ze._jsonSchemaVersion="firestore/vectorValue/1.0",ze._jsonSchema={type:K("string",ze._jsonSchemaVersion),vectorValues:K("object")};function Qr(i,e,n){if((e=qt(e))instanceof Yr)return e._internalPath;if(typeof e=="string")return uc(i,e);throw Sn("Field path arguments must be of type string or ",i)}const dc=new RegExp("[~\\*/\\[\\]]");function uc(i,e,n){if(e.search(dc)>=0)throw Sn(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,i);try{return new Yr(...e.split("."))._internalPath}catch{throw Sn(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,i)}}function Sn(i,e,n,s,o){let l=`Function ${e}() called with invalid data`;l+=". ";let c="";return new F(U.INVALID_ARGUMENT,l+i+c)}const _r="@firebase/firestore",Ir="4.14.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zr{constructor(e,n,s,o,l){this._firestore=e,this._userDataWriter=n,this._key=s,this._document=o,this._converter=l}get id(){return this._key.path.lastSegment()}get ref(){return new pe(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const e=new hc(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}_fieldsProto(){var e;return((e=this._document)==null?void 0:e.data.clone().value.mapValue.fields)??void 0}get(e){if(this._document){const n=this._document.data.field(Qr("DocumentSnapshot.get",e));if(n!==null)return this._userDataWriter.convertValue(n)}}}class hc extends Zr{data(){return super.data()}}class ri{constructor(e,n){this.hasPendingWrites=e,this.fromCache=n}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class st extends Zr{constructor(e,n,s,o,l,c){super(e,n,s,o,c),this._firestore=e,this._firestoreImpl=e,this.metadata=l}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const n=new ci(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(n,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,n={}){if(this._document){const s=this._document.data.field(Qr("DocumentSnapshot.get",e));if(s!==null)return this._userDataWriter.convertValue(s,n.serverTimestamps)}}toJSON(){if(this.metadata.hasPendingWrites)throw new F(U.FAILED_PRECONDITION,"DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const e=this._document,n={};return n.type=st._jsonSchemaVersion,n.bundle="",n.bundleSource="DocumentSnapshot",n.bundleName=this._key.toString(),!e||!e.isValidDocument()||!e.isFoundDocument()?n:(this._userDataWriter.convertObjectMap(e.data.value.mapValue.fields,"previous"),n.bundle=(this._firestore,this.ref.path,"NOT SUPPORTED"),n)}}st._jsonSchemaVersion="firestore/documentSnapshot/1.0",st._jsonSchema={type:K("string",st._jsonSchemaVersion),bundleSource:K("string","DocumentSnapshot"),bundleName:K("string"),bundle:K("string")};class ci extends st{data(e={}){return super.data(e)}}class Lt{constructor(e,n,s,o){this._firestore=e,this._userDataWriter=n,this._snapshot=o,this.metadata=new ri(o.hasPendingWrites,o.fromCache),this.query=s}get docs(){const e=[];return this.forEach(n=>e.push(n)),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,n){this._snapshot.docs.forEach(s=>{e.call(n,new ci(this._firestore,this._userDataWriter,s.key,s,new ri(this._snapshot.mutatedKeys.has(s.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){const n=!!e.includeMetadataChanges;if(n&&this._snapshot.excludesMetadataChanges)throw new F(U.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===n||(this._cachedChanges=function(o,l){if(o._snapshot.oldDocs.isEmpty()){let c=0;return o._snapshot.docChanges.map(u=>{const p=new ci(o._firestore,o._userDataWriter,u.doc.key,u.doc,new ri(o._snapshot.mutatedKeys.has(u.doc.key),o._snapshot.fromCache),o.query.converter);return u.doc,{type:"added",doc:p,oldIndex:-1,newIndex:c++}})}{let c=o._snapshot.oldDocs;return o._snapshot.docChanges.filter(u=>l||u.type!==3).map(u=>{const p=new ci(o._firestore,o._userDataWriter,u.doc.key,u.doc,new ri(o._snapshot.mutatedKeys.has(u.doc.key),o._snapshot.fromCache),o.query.converter);let g=-1,E=-1;return u.type!==0&&(g=c.indexOf(u.doc.key),c=c.delete(u.doc.key)),u.type!==1&&(c=c.add(u.doc),E=c.indexOf(u.doc.key)),{type:fc(u.type),doc:p,oldIndex:g,newIndex:E}})}}(this,n),this._cachedChangesIncludeMetadataChanges=n),this._cachedChanges}toJSON(){if(this.metadata.hasPendingWrites)throw new F(U.FAILED_PRECONDITION,"QuerySnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const e={};e.type=Lt._jsonSchemaVersion,e.bundleSource="QuerySnapshot",e.bundleName=ql.newId(),this._firestore._databaseId.database,this._firestore._databaseId.projectId;const n=[],s=[],o=[];return this.docs.forEach(l=>{l._document!==null&&(n.push(l._document),s.push(this._userDataWriter.convertObjectMap(l._document.data.value.mapValue.fields,"previous")),o.push(l.ref.path))}),e.bundle=(this._firestore,this.query._query,e.bundleName,"NOT SUPPORTED"),e}}function fc(i){switch(i){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return mi(61501,{type:i})}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Lt._jsonSchemaVersion="firestore/querySnapshot/1.0",Lt._jsonSchema={type:K("string",Lt._jsonSchemaVersion),bundleSource:K("string","QuerySnapshot"),bundleName:K("string"),bundle:K("string")};(function(e,n=!0){Rl(ki),lt(new at("firestore",(s,{instanceIdentifier:o,options:l})=>{const c=s.getProvider("app").getImmediate(),u=new cc(new Wl(s.getProvider("auth-internal")),new Vl(c,s.getProvider("app-check-internal")),Zl(c,o),c);return l={useFetchStreams:n,...l},u._setSettings(l),u},"PUBLIC").setMultipleInstances(!0)),Pe(_r,Ir,e),Pe(_r,Ir,"esm2020")})();function eo(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const mc=eo,to=new jt("auth","Firebase",eo());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gi=new Mn("@firebase/auth");function pc(i,...e){gi.logLevel<=V.WARN&&gi.warn(`Auth (${ki}): ${i}`,...e)}function di(i,...e){gi.logLevel<=V.ERROR&&gi.error(`Auth (${ki}): ${i}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tr(i,...e){throw Vn(i,...e)}function io(i,...e){return Vn(i,...e)}function no(i,e,n){const s={...mc(),[e]:n};return new jt("auth","Firebase",s).create(e,{appName:i.name})}function ui(i){return no(i,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function Vn(i,...e){if(typeof i!="string"){const n=e[0],s=[...e.slice(1)];return s[0]&&(s[0].appName=i.name),i._errorFactory.create(n,...s)}return to.create(i,...e)}function W(i,e,...n){if(!i)throw Vn(e,...n)}function Ct(i){const e="INTERNAL ASSERTION FAILED: "+i;throw di(e),new Error(e)}function vi(i,e){i||Ct(e)}function gc(){return br()==="http:"||br()==="https:"}function br(){var i;return typeof self<"u"&&((i=self.location)==null?void 0:i.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ht{constructor(e,n){this.shortDelay=e,this.longDelay=n,vi(n>e,"Short delay should be less than long delay!"),this.isMobile=ya()||Ta()}get(){return vc()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _c(i,e){vi(i.emulator,"Emulator should always be set here");const{url:n}=i.emulator;return e?`${n}${e.startsWith("/")?e.slice(1):e}`:n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tc=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],bc=new Ht(3e4,6e4);function ro(i,e){return i.tenantId&&!e.tenantId?{...e,tenantId:i.tenantId}:e}async function xi(i,e,n,s,o={}){return oo(i,o,async()=>{let l={},c={};s&&(e==="GET"?c=s:l={body:JSON.stringify(s)});const u=Vr({key:i.config.apiKey,...c}).slice(1),p=await i._getAdditionalHeaders();p["Content-Type"]="application/json",i.languageCode&&(p["X-Firebase-Locale"]=i.languageCode);const g={method:e,headers:p,...l};return _a()||(g.referrerPolicy="no-referrer"),i.emulatorConfig&&jr(i.emulatorConfig.host)&&(g.credentials="include"),so.fetch()(await ao(i,i.config.apiHost,n,u),g)})}async function oo(i,e,n){i._canInitEmulator=!1;const s={...Ic,...e};try{const o=new wc(i),l=await Promise.race([n(),o.promise]);o.clearNetworkTimeout();const c=await l.json();if("needConfirmation"in c)throw oi(i,"account-exists-with-different-credential",c);if(l.ok&&!("errorMessage"in c))return c;{const u=l.ok?c.errorMessage:c.error.message,[p,g]=u.split(" : ");if(p==="FEDERATED_USER_ID_ALREADY_LINKED")throw oi(i,"credential-already-in-use",c);if(p==="EMAIL_EXISTS")throw oi(i,"email-already-in-use",c);if(p==="USER_DISABLED")throw oi(i,"user-disabled",c);const E=s[p]||p.toLowerCase().replace(/[_\s]+/g,"-");if(g)throw no(i,E,g);Tr(i,E)}}catch(o){if(o instanceof Ce)throw o;Tr(i,"network-request-failed",{message:String(o)})}}async function ao(i,e,n,s){const o=`${e}${n}?${s}`,l=i,c=l.config.emulator?_c(i.config,o):`${i.config.apiScheme}://${o}`;return Tc.includes(n)&&(await l._persistenceManagerAvailable,l._getPersistenceType()==="COOKIE")?l._getPersistence()._getFinalTarget(c).toString():c}class wc{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,s)=>{this.timer=setTimeout(()=>s(io(this.auth,"network-request-failed")),bc.get())})}}function oi(i,e,n){const s={appName:i.name};n.email&&(s.email=n.email),n.phoneNumber&&(s.phoneNumber=n.phoneNumber);const o=io(i,e,s);return o.customData._tokenResponse=n,o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Sc(i,e){return xi(i,"POST","/v1/accounts:delete",e)}async function yi(i,e){return xi(i,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nt(i){if(i)try{const e=new Date(Number(i));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Ec(i,e=!1){const n=qt(i),s=await n.getIdToken(e),o=lo(s);W(o&&o.exp&&o.auth_time&&o.iat,n.auth,"internal-error");const l=typeof o.firebase=="object"?o.firebase:void 0,c=l==null?void 0:l.sign_in_provider;return{claims:o,token:s,authTime:Nt(pn(o.auth_time)),issuedAtTime:Nt(pn(o.iat)),expirationTime:Nt(pn(o.exp)),signInProvider:c||null,signInSecondFactor:(l==null?void 0:l.sign_in_second_factor)||null}}function pn(i){return Number(i)*1e3}function lo(i){const[e,n,s]=i.split(".");if(e===void 0||n===void 0||s===void 0)return di("JWT malformed, contained fewer than 3 sections"),null;try{const o=Fr(n);return o?JSON.parse(o):(di("Failed to decode base64 JWT payload"),null)}catch(o){return di("Caught error parsing JWT payload as JSON",o==null?void 0:o.toString()),null}}function wr(i){const e=lo(i);return W(e,"internal-error"),W(typeof e.exp<"u","internal-error"),W(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function En(i,e,n=!1){if(n)return e;try{return await e}catch(s){throw s instanceof Ce&&kc(s)&&i.auth.currentUser===i&&await i.auth.signOut(),s}}function kc({code:i}){return i==="auth/user-disabled"||i==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _i(i){var b;const e=i.auth,n=await i.getIdToken(),s=await En(i,yi(e,{idToken:n}));W(s==null?void 0:s.users.length,e,"internal-error");const o=s.users[0];i._notifyReloadListener(o);const l=(b=o.providerUserInfo)!=null&&b.length?co(o.providerUserInfo):[],c=Oc(i.providerData,l),u=i.isAnonymous,p=!(i.email&&o.passwordHash)&&!(c!=null&&c.length),g=u?p:!1,E={uid:o.localId,displayName:o.displayName||null,photoURL:o.photoUrl||null,email:o.email||null,emailVerified:o.emailVerified||!1,phoneNumber:o.phoneNumber||null,tenantId:o.tenantId||null,providerData:c,metadata:new kn(o.createdAt,o.lastLoginAt),isAnonymous:g};Object.assign(i,E)}async function xc(i){const e=qt(i);await _i(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Oc(i,e){return[...i.filter(s=>!e.some(o=>o.providerId===s.providerId)),...e]}function co(i){return i.map(({providerId:e,...n})=>({providerId:e,uid:n.rawId||"",displayName:n.displayName||null,email:n.email||null,phoneNumber:n.phoneNumber||null,photoURL:n.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rt{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){W(e.idToken,"internal-error"),W(typeof e.idToken<"u","internal-error"),W(typeof e.refreshToken<"u","internal-error");const n="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):wr(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,n)}updateFromIdToken(e){W(e.length!==0,"internal-error");const n=wr(e);this.updateTokensAndExpiration(e,null,n)}async getToken(e,n=!1){return!n&&this.accessToken&&!this.isExpired?this.accessToken:(W(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,n){const{accessToken:s,refreshToken:o,expiresIn:l}=await Dc(e,n);this.updateTokensAndExpiration(s,o,Number(l))}updateTokensAndExpiration(e,n,s){this.refreshToken=n||null,this.accessToken=e||null,this.expirationTime=Date.now()+s*1e3}static fromJSON(e,n){const{refreshToken:s,accessToken:o,expirationTime:l}=n,c=new rt;return s&&(W(typeof s=="string","internal-error",{appName:e}),c.refreshToken=s),o&&(W(typeof o=="string","internal-error",{appName:e}),c.accessToken=o),l&&(W(typeof l=="number","internal-error",{appName:e}),c.expirationTime=l),c}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new rt,this.toJSON())}_performRefresh(){return Ct("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xe(i,e){W(typeof i=="string"||typeof i>"u","internal-error",{appName:e})}class ge{constructor({uid:e,auth:n,stsTokenManager:s,...o}){this.providerId="firebase",this.proactiveRefresh=new Ac(this),this.reloadUserInfo=null,this.reloadListener=null,this.uid=e,this.auth=n,this.stsTokenManager=s,this.accessToken=s.accessToken,this.displayName=o.displayName||null,this.email=o.email||null,this.emailVerified=o.emailVerified||!1,this.phoneNumber=o.phoneNumber||null,this.photoURL=o.photoURL||null,this.isAnonymous=o.isAnonymous||!1,this.tenantId=o.tenantId||null,this.providerData=o.providerData?[...o.providerData]:[],this.metadata=new kn(o.createdAt||void 0,o.lastLoginAt||void 0)}async getIdToken(e){const n=await En(this,this.stsTokenManager.getToken(this.auth,e));return W(n,this.auth,"internal-error"),this.accessToken!==n&&(this.accessToken=n,await this.auth._persistUserIfCurrent(this),this.auth._notifyListenersIfCurrent(this)),n}getIdTokenResult(e){return Ec(this,e)}reload(){return xc(this)}_assign(e){this!==e&&(W(this.uid===e.uid,this.auth,"internal-error"),this.displayName=e.displayName,this.photoURL=e.photoURL,this.email=e.email,this.emailVerified=e.emailVerified,this.phoneNumber=e.phoneNumber,this.isAnonymous=e.isAnonymous,this.tenantId=e.tenantId,this.providerData=e.providerData.map(n=>({...n})),this.metadata._copy(e.metadata),this.stsTokenManager._assign(e.stsTokenManager))}_clone(e){const n=new ge({...this,auth:e,stsTokenManager:this.stsTokenManager._clone()});return n.metadata._copy(this.metadata),n}_onReload(e){W(!this.reloadListener,this.auth,"internal-error"),this.reloadListener=e,this.reloadUserInfo&&(this._notifyReloadListener(this.reloadUserInfo),this.reloadUserInfo=null)}_notifyReloadListener(e){this.reloadListener?this.reloadListener(e):this.reloadUserInfo=e}_startProactiveRefresh(){this.proactiveRefresh._start()}_stopProactiveRefresh(){this.proactiveRefresh._stop()}async _updateTokensIfNecessary(e,n=!1){let s=!1;e.idToken&&e.idToken!==this.stsTokenManager.accessToken&&(this.stsTokenManager.updateFromServerResponse(e),s=!0),n&&await _i(this),await this.auth._persistUserIfCurrent(this),s&&this.auth._notifyListenersIfCurrent(this)}async delete(){if(We(this.auth.app))return Promise.reject(ui(this.auth));const e=await this.getIdToken();return await En(this,Sc(this.auth,{idToken:e})),this.stsTokenManager.clearRefreshToken(),this.auth.signOut()}toJSON(){return{uid:this.uid,email:this.email||void 0,emailVerified:this.emailVerified,displayName:this.displayName||void 0,isAnonymous:this.isAnonymous,photoURL:this.photoURL||void 0,phoneNumber:this.phoneNumber||void 0,tenantId:this.tenantId||void 0,providerData:this.providerData.map(e=>({...e})),stsTokenManager:this.stsTokenManager.toJSON(),_redirectEventId:this._redirectEventId,...this.metadata.toJSON(),apiKey:this.auth.config.apiKey,appName:this.auth.name}}get refreshToken(){return this.stsTokenManager.refreshToken||""}static _fromJSON(e,n){const s=n.displayName??void 0,o=n.email??void 0,l=n.phoneNumber??void 0,c=n.photoURL??void 0,u=n.tenantId??void 0,p=n._redirectEventId??void 0,g=n.createdAt??void 0,E=n.lastLoginAt??void 0,{uid:b,emailVerified:I,isAnonymous:k,providerData:A,stsTokenManager:x}=n;W(b&&x,e,"internal-error");const P=rt.fromJSON(this.name,x);W(typeof b=="string",e,"internal-error"),xe(s,e.name),xe(o,e.name),W(typeof I=="boolean",e,"internal-error"),W(typeof k=="boolean",e,"internal-error"),xe(l,e.name),xe(c,e.name),xe(u,e.name),xe(p,e.name),xe(g,e.name),xe(E,e.name);const O=new ge({uid:b,auth:e,email:o,emailVerified:I,displayName:s,isAnonymous:k,photoURL:c,phoneNumber:l,tenantId:u,stsTokenManager:P,createdAt:g,lastLoginAt:E});return A&&Array.isArray(A)&&(O.providerData=A.map(L=>({...L}))),p&&(O._redirectEventId=p),O}static async _fromIdTokenResponse(e,n,s=!1){const o=new rt;o.updateFromServerResponse(n);const l=new ge({uid:n.localId,auth:e,stsTokenManager:o,isAnonymous:s});return await _i(l),l}static async _fromGetAccountInfoResponse(e,n,s){const o=n.users[0];W(o.localId!==void 0,"internal-error");const l=o.providerUserInfo!==void 0?co(o.providerUserInfo):[],c=!(o.email&&o.passwordHash)&&!(l!=null&&l.length),u=new rt;u.updateFromIdToken(s);const p=new ge({uid:o.localId,auth:e,stsTokenManager:u,isAnonymous:c}),g={uid:o.localId,displayName:o.displayName||null,photoURL:o.photoUrl||null,email:o.email||null,emailVerified:o.emailVerified||!1,phoneNumber:o.phoneNumber||null,tenantId:o.tenantId||null,providerData:l,metadata:new kn(o.createdAt,o.lastLoginAt),isAnonymous:!(o.email&&o.passwordHash)&&!(l!=null&&l.length)};return Object.assign(p,g),p}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sr=new Map;function Ve(i){vi(i instanceof Function,"Expected a class definition");let e=Sr.get(i);return e?(vi(e instanceof i,"Instance stored in cache mismatched with class"),e):(e=new i,Sr.set(i,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gn(i,e,n){return`firebase:${i}:${e}:${n}`}class ot{constructor(e,n,s){this.persistence=e,this.auth=n,this.userKey=s;const{config:o,name:l}=this.auth;this.fullUserKey=gn(this.userKey,o.apiKey,l),this.fullPersistenceKey=gn("persistence",o.apiKey,l),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const n=await yi(this.auth,{idToken:e}).catch(()=>{});return n?ge._fromGetAccountInfoResponse(this.auth,n,e):null}return ge._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,s="authUser"){if(!n.length)return new ot(Ve(Er),e,s);const o=(await Promise.all(n.map(async g=>{if(await g._isAvailable())return g}))).filter(g=>g);let l=o[0]||Ve(Er);const c=gn(s,e.config.apiKey,e.name);let u=null;for(const g of n)try{const E=await g._get(c);if(E){let b;if(typeof E=="string"){const I=await yi(e,{idToken:E}).catch(()=>{});if(!I)break;b=await ge._fromGetAccountInfoResponse(e,I,E)}else b=ge._fromJSON(e,E);g!==l&&(u=b),l=g;break}}catch{}const p=o.filter(g=>g._shouldAllowMigration);return!l._shouldAllowMigration||!p.length?new ot(l,e,s):(l=p[0],u&&await l._set(c,u.toJSON()),await Promise.all(n.map(async g=>{if(g!==l)try{await g._remove(c)}catch{}})),new ot(l,e,s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ho(i,e=[]){let n;switch(i){case"Browser":n=kr(ve());break;case"Worker":n=`${kr(ve())}-${i}`;break;default:n=i}const s=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${ki}/${s}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Uc(i,e={}){return xi(i,"GET","/v2/passwordPolicy",ro(i,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jc{constructor(e,n,s,o){this.app=e,this.heartbeatServiceProvider=n,this.appCheckServiceProvider=s,this.config=o,this.currentUser=null,this.emulatorConfig=null,this.operations=Promise.resolve(),this.authStateSubscription=new Ar(this),this.idTokenSubscription=new Ar(this),this.beforeStateQueue=new Wc(this),this.redirectUser=null,this.isProactiveRefreshEnabled=!1,this.EXPECTED_PASSWORD_POLICY_SCHEMA_VERSION=1,this._canInitEmulator=!0,this._isInitialized=!1,this._deleted=!1,this._initializationPromise=null,this._popupRedirectResolver=null,this._errorFactory=to,this._agentRecaptchaConfig=null,this._tenantRecaptchaConfigs={},this._projectPasswordPolicy=null,this._tenantPasswordPolicies={},this._resolvePersistenceManagerAvailable=void 0,this.lastNotifiedUid=void 0,this.languageCode=null,this.tenantId=null,this.settings={appVerificationDisabledForTesting:!1},this.frameworks=[],this.name=e.name,this.clientVersion=o.sdkClientVersion,this._persistenceManagerAvailable=new Promise(l=>this._resolvePersistenceManagerAvailable=l)}_initializeWithPersistence(e,n){return n&&(this._popupRedirectResolver=Ve(n)),this._initializationPromise=this.queue(async()=>{var s,o,l;if(!this._deleted&&(this.persistenceManager=await ot.create(this,e),(s=this._resolvePersistenceManagerAvailable)==null||s.call(this),!this._deleted)){if((o=this._popupRedirectResolver)!=null&&o._shouldInitProactively)try{await this._popupRedirectResolver._initialize(this)}catch{}await this.initializeCurrentUser(n),this.lastNotifiedUid=((l=this.currentUser)==null?void 0:l.uid)||null,!this._deleted&&(this._isInitialized=!0)}}),this._initializationPromise}async _onStorageEvent(){if(this._deleted)return;const e=await this.assertedPersistence.getCurrentUser();if(!(!this.currentUser&&!e)){if(this.currentUser&&e&&this.currentUser.uid===e.uid){this._currentUser._assign(e),await this.currentUser.getIdToken();return}await this._updateCurrentUser(e,!0)}}async initializeCurrentUserFromIdToken(e){try{const n=await yi(this,{idToken:e}),s=await ge._fromGetAccountInfoResponse(this,n,e);await this.directlySetCurrentUser(s)}catch(n){console.warn("FirebaseServerApp could not login user with provided authIdToken: ",n),await this.directlySetCurrentUser(null)}}async initializeCurrentUser(e){var l;if(We(this.app)){const c=this.app.settings.authIdToken;return c?new Promise(u=>{setTimeout(()=>this.initializeCurrentUserFromIdToken(c).then(u,u))}):this.directlySetCurrentUser(null)}const n=await this.assertedPersistence.getCurrentUser();let s=n,o=!1;if(e&&this.config.authDomain){await this.getOrInitRedirectPersistenceManager();const c=(l=this.redirectUser)==null?void 0:l._redirectEventId,u=s==null?void 0:s._redirectEventId,p=await this.tryRedirectSignIn(e);(!c||c===u)&&(p!=null&&p.user)&&(s=p.user,o=!0)}if(!s)return this.directlySetCurrentUser(null);if(!s._redirectEventId){if(o)try{await this.beforeStateQueue.runMiddleware(s)}catch(c){s=n,this._popupRedirectResolver._overrideRedirectResult(this,()=>Promise.reject(c))}return s?this.reloadAndSetCurrentUserOrClear(s):this.directlySetCurrentUser(null)}return W(this._popupRedirectResolver,this,"argument-error"),await this.getOrInitRedirectPersistenceManager(),this.redirectUser&&this.redirectUser._redirectEventId===s._redirectEventId?this.directlySetCurrentUser(s):this.reloadAndSetCurrentUserOrClear(s)}async tryRedirectSignIn(e){let n=null;try{n=await this._popupRedirectResolver._completeRedirectFn(this,e,!0)}catch{await this._setRedirectUser(null)}return n}async reloadAndSetCurrentUserOrClear(e){try{await _i(e)}catch(n){if((n==null?void 0:n.code)!=="auth/network-request-failed")return this.directlySetCurrentUser(null)}return this.directlySetCurrentUser(e)}useDeviceLanguage(){this.languageCode=yc()}async _delete(){this._deleted=!0}async updateCurrentUser(e){if(We(this.app))return Promise.reject(ui(this));const n=e?qt(e):null;return n&&W(n.auth.config.apiKey===this.config.apiKey,this,"invalid-user-token"),this._updateCurrentUser(n&&n._clone(this))}async _updateCurrentUser(e,n=!1){if(!this._deleted)return e&&W(this.tenantId===e.tenantId,this,"tenant-id-mismatch"),n||await this.beforeStateQueue.runMiddleware(e),this.queue(async()=>{await this.directlySetCurrentUser(e),this.notifyAuthListeners()})}async signOut(){return We(this.app)?Promise.reject(ui(this)):(await this.beforeStateQueue.runMiddleware(null),(this.redirectPersistenceManager||this._popupRedirectResolver)&&await this._setRedirectUser(null),this._updateCurrentUser(null,!0))}setPersistence(e){return We(this.app)?Promise.reject(ui(this)):this.queue(async()=>{await this.assertedPersistence.setPersistence(Ve(e))})}_getRecaptchaConfig(){return this.tenantId==null?this._agentRecaptchaConfig:this._tenantRecaptchaConfigs[this.tenantId]}async validatePassword(e){this._getPasswordPolicyInternal()||await this._updatePasswordPolicy();const n=this._getPasswordPolicyInternal();return n.schemaVersion!==this.EXPECTED_PASSWORD_POLICY_SCHEMA_VERSION?Promise.reject(this._errorFactory.create("unsupported-password-policy-schema-version",{})):n.validatePassword(e)}_getPasswordPolicyInternal(){return this.tenantId===null?this._projectPasswordPolicy:this._tenantPasswordPolicies[this.tenantId]}async _updatePasswordPolicy(){const e=await Uc(this),n=new Vc(e);this.tenantId===null?this._projectPasswordPolicy=n:this._tenantPasswordPolicies[this.tenantId]=n}_getPersistenceType(){return this.assertedPersistence.persistence.type}_getPersistence(){return this.assertedPersistence.persistence}_updateErrorMap(e){this._errorFactory=new jt("auth","Firebase",e())}onAuthStateChanged(e,n,s){return this.registerStateListener(this.authStateSubscription,e,n,s)}beforeAuthStateChanged(e,n){return this.beforeStateQueue.pushCallback(e,n)}onIdTokenChanged(e,n,s){return this.registerStateListener(this.idTokenSubscription,e,n,s)}authStateReady(){return new Promise((e,n)=>{if(this.currentUser)e();else{const s=this.onAuthStateChanged(()=>{s(),e()},n)}})}async revokeAccessToken(e){if(this.currentUser){const n=await this.currentUser.getIdToken(),s={providerId:"apple.com",tokenType:"ACCESS_TOKEN",token:e,idToken:n};this.tenantId!=null&&(s.tenantId=this.tenantId),await Pc(this,s)}}toJSON(){var e;return{apiKey:this.config.apiKey,authDomain:this.config.authDomain,appName:this.name,currentUser:(e=this._currentUser)==null?void 0:e.toJSON()}}async _setRedirectUser(e,n){const s=await this.getOrInitRedirectPersistenceManager(n);return e===null?s.removeCurrentUser():s.setCurrentUser(e)}async getOrInitRedirectPersistenceManager(e){if(!this.redirectPersistenceManager){const n=e&&Ve(e)||this._popupRedirectResolver;W(n,this,"argument-error"),this.redirectPersistenceManager=await ot.create(this,[Ve(n._redirectPersistence)],"redirectUser"),this.redirectUser=await this.redirectPersistenceManager.getCurrentUser()}return this.redirectPersistenceManager}async _redirectUserForId(e){var n,s;return this._isInitialized&&await this.queue(async()=>{}),((n=this._currentUser)==null?void 0:n._redirectEventId)===e?this._currentUser:((s=this.redirectUser)==null?void 0:s._redirectEventId)===e?this.redirectUser:null}async _persistUserIfCurrent(e){if(e===this.currentUser)return this.queue(async()=>this.directlySetCurrentUser(e))}_notifyListenersIfCurrent(e){e===this.currentUser&&this.notifyAuthListeners()}_key(){return`${this.config.authDomain}:${this.config.apiKey}:${this.name}`}_startProactiveRefresh(){this.isProactiveRefreshEnabled=!0,this.currentUser&&this._currentUser._startProactiveRefresh()}_stopProactiveRefresh(){this.isProactiveRefreshEnabled=!1,this.currentUser&&this._currentUser._stopProactiveRefresh()}get _currentUser(){return this.currentUser}notifyAuthListeners(){var n;if(!this._isInitialized)return;this.idTokenSubscription.next(this.currentUser);const e=((n=this.currentUser)==null?void 0:n.uid)??null;this.lastNotifiedUid!==e&&(this.lastNotifiedUid=e,this.authStateSubscription.next(this.currentUser))}registerStateListener(e,n,s,o){if(this._deleted)return()=>{};const l=typeof n=="function"?n:n.next.bind(n);let c=!1;const u=this._isInitialized?Promise.resolve():this._initializationPromise;if(W(u,this,"internal-error"),u.then(()=>{c||l(this.currentUser)}),typeof n=="function"){const p=e.addObserver(n,s,o);return()=>{c=!0,p()}}else{const p=e.addObserver(n);return()=>{c=!0,p()}}}async directlySetCurrentUser(e){this.currentUser&&this.currentUser!==e&&this._currentUser._stopProactiveRefresh(),e&&this.isProactiveRefreshEnabled&&e._startProactiveRefresh(),this.currentUser=e,e?await this.assertedPersistence.setCurrentUser(e):await this.assertedPersistence.removeCurrentUser()}queue(e){return this.operations=this.operations.then(e,e),this.operations}get assertedPersistence(){return W(this.persistenceManager,this,"internal-error"),this.persistenceManager}_logFramework(e){!e||this.frameworks.includes(e)||(this.frameworks.push(e),this.frameworks.sort(),this.clientVersion=ho(this.config.clientPlatform,this._getFrameworks()))}_getFrameworks(){return this.frameworks}async _getAdditionalHeaders(){var o;const e={"X-Client-Version":this.clientVersion};this.app.options.appId&&(e["X-Firebase-gmpid"]=this.app.options.appId);const n=await((o=this.heartbeatServiceProvider.getImmediate({optional:!0}))==null?void 0:o.getHeartbeatsHeader());n&&(e["X-Firebase-Client"]=n);const s=await this._getAppCheckToken();return s&&(e["X-Firebase-AppCheck"]=s),e}async _getAppCheckToken(){var n;if(We(this.app)&&this.app.settings.appCheckToken)return this.app.settings.appCheckToken;const e=await((n=this.appCheckServiceProvider.getImmediate({optional:!0}))==null?void 0:n.getToken());return e!=null&&e.error&&pc(`Error while retrieving App Check token: ${e.error}`),e==null?void 0:e.token}}function qc(i){return qt(i)}class Ar{constructor(e){this.auth=e,this.observer=null,this.addObserver=Aa(n=>this.observer=n)}get next(){return W(this.observer,this.auth,"internal-error"),this.observer.next.bind(this.observer)}}function zc(i,e){const n=(e==null?void 0:e.persistence)||[],s=(Array.isArray(n)?n:[n]).map(Ve);e!=null&&e.errorMap&&i._updateErrorMap(e.errorMap),i._initializeWithPersistence(s,e==null?void 0:e.popupRedirectResolver)}new Ht(3e4,6e4);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */new Ht(5e3,15e3);var xr="@firebase/auth",Or="1.13.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gc(i){switch(i){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Kc(i){lt(new at("auth",(e,{options:n})=>{const s=e.getProvider("app").getImmediate(),o=e.getProvider("heartbeat"),l=e.getProvider("app-check-internal"),{apiKey:c,authDomain:u}=s.options;W(c&&!c.includes(":"),"invalid-api-key",{appName:s.name});const p={apiKey:c,authDomain:u,clientPlatform:i,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:ho(i)},g=new jc(s,o,l,p);return zc(g,n),g},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,s)=>{e.getProvider("auth-internal").initialize()})),lt(new at("auth-internal",e=>{const n=qc(e.getProvider("auth").getImmediate());return(s=>new Hc(s))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),Pe(xr,Or,Gc(i)),Pe(xr,Or,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jc=5*60;va("authIdTokenMaxAge");Kc("Browser");console.warn("⚠️ Firebase未設定。.envファイルにAPIキーを設定してください。");function fo(i){const e=new Date(i),n=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${n}-${s}-${o}`}function ct(i){const e=new Date(i),n=["日","月","火","水","木","金","土"];return`${e.getMonth()+1}月${e.getDate()}日（${n[e.getDay()]}）`}function Je(){return fo(new Date)}function Bt(i){const e=Math.floor(i/60),n=i%60;return`${String(e).padStart(2,"0")}:${String(n).padStart(2,"0")}`}function X(i){if(!i)return 0;const[e,n]=i.split(":").map(Number);return e*60+n}function mo(){return Date.now().toString(36)+Math.random().toString(36).slice(2,9)}function po(i,e,n,s){const l=ai(n-i),c=ai(s-e),u=Math.sin(l/2)**2+Math.cos(ai(i))*Math.cos(ai(n))*Math.sin(c/2)**2;return 6371*2*Math.atan2(Math.sqrt(u),Math.sqrt(1-u))}function ai(i){return i*(Math.PI/180)}function Z(i){const e=document.createElement("div");return e.textContent=i,e.innerHTML}function C(i,e="info",n=3e3){const s=document.getElementById("toast-container"),o={success:"check_circle",error:"error",warning:"warning",info:"info"},l=document.createElement("div");l.className=`toast ${e}`,l.innerHTML=`
    <span class="material-icons-round toast-icon">${o[e]||"info"}</span>
    <span>${Z(i)}</span>
  `,s.appendChild(l),setTimeout(()=>{l.style.opacity="0",l.style.transform="translateX(40px)",l.style.transition="all .3s ease",setTimeout(()=>l.remove(),300)},n)}function Gt(i,e,n=""){const s=document.getElementById("modal-overlay");document.getElementById("modal-title").textContent=i,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=n,s.style.display="flex"}function ye(){document.getElementById("modal-overlay").style.display="none"}function Oi(i,e){return new Promise(n=>{const s=`<p>${Z(e)}</p>`;Gt(i,s,`
      <button class="btn btn-secondary" id="confirm-cancel">キャンセル</button>
      <button class="btn btn-danger" id="confirm-ok">OK</button>
    `),document.getElementById("confirm-ok").onclick=()=>{ye(),n(!0)},document.getElementById("confirm-cancel").onclick=()=>{ye(),n(!1)}})}function go(i,e){if(!i)return 0;let n=1500;return i.type==="正社員"?i.name.includes("前川")?n=2500:n=1500:i.type==="パート"&&(n=parseInt(i.wage)||1500),Math.round(n*(e/60))}function An(i,e){const s={身体介護:{20:1670,30:2500,60:3960,90:5790,120:7630},生活援助:{20:1830,45:2250,60:2870},通院等乗降介助:{per_trip:990},医療的ケア:{30:3e3,60:5e3}}[i];if(!s)return 3e3;if(s.per_trip)return s.per_trip;const o=Object.keys(s).map(Number).sort((c,u)=>c-u);let l=o[0];for(const c of o)e>=c&&(l=c);return s[l]||3e3}function Xc(i){{console.warn("Firebase未設定のためログイン画面を表示します"),setTimeout(()=>i(null,null),100);return}}async function Yc(){throw new Error("Firebase未設定です。.envにAPIキーを設定してください。")}async function Qc(){}function Zc(){const i=document.getElementById("btn-google-login");i&&i.addEventListener("click",async()=>{i.disabled=!0,i.textContent="ログイン中...";try{await Yc()}catch(e){console.error("ログインエラー:",e),e.code==="auth/popup-closed-by-user"?C("ログインがキャンセルされました","warning"):C("ログインに失敗しました","error"),i.disabled=!1,i.innerHTML=`
        ...
        Googleアカウントでログイン
      `}})}const Oe={};function ut(i){if(!Oe[i]){const e=localStorage.getItem(`careroute_${i}`);Oe[i]=e?JSON.parse(e):[]}return Oe[i]}function Di(i){localStorage.setItem(`careroute_${i}`,JSON.stringify(Oe[i]||[]))}async function Dr(){localStorage.removeItem("careroute_staff"),localStorage.removeItem("careroute_clients"),localStorage.removeItem("careroute_visits"),localStorage.removeItem("careroute_routes"),Oe.staff=[],Oe.clients=[],Oe.visits=[],Oe.routes=[]}async function jn(i,e){{const n=mo();return ut(i).push({id:n,...e,createdAt:new Date().toISOString()}),Di(i),n}}async function qn(i){return ut(i)}async function zn(i,e,n){{const s=ut(i),o=s.findIndex(l=>l.id===e);o!==-1&&(s[o]={...s[o],...n,updatedAt:new Date().toISOString()},Di(i));return}}async function Hn(i,e){{const n=ut(i),s=n.findIndex(o=>o.id===e);s!==-1&&(n.splice(s,1),Di(i));return}}async function vo(i,e,n,s){return ut(i).filter(l=>l[e]===s)}async function ce(){return qn("staff")}async function yo(i){return jn("staff",i)}async function ed(i,e){return zn("staff",i,e)}async function td(i){return Hn("staff",i)}async function Te(){return qn("clients")}async function _o(i){return jn("clients",i)}async function id(i,e){return zn("clients",i,e)}async function nd(i){return Hn("clients",i)}async function Io(){return qn("visits")}async function Ne(i){return vo("visits","date","==",i)}async function Pi(i){return jn("visits",i)}async function Ii(i,e){return zn("visits",i,e)}async function To(i){return Hn("visits",i)}async function Gn(i){return vo("routes","date","==",i)}async function sd(i){{const e=ut("routes");for(const n of i){const s=e.findIndex(o=>o.staffId===n.staffId&&o.date===n.date);s>=0?e[s]={...n,updatedAt:new Date().toISOString()}:e.push({id:mo(),...n,createdAt:new Date().toISOString()})}Di("routes");return}}async function rd(){const i=document.getElementById("page-container"),[e,n]=await Promise.all([ce().catch(()=>[]),Te().catch(()=>[])]),s=Je(),o=await Ne(s).catch(()=>[]),l=e.filter(b=>b.isActive);n.filter(b=>b.isActive);const c=o.filter(b=>b.type!=="sales");c.filter(b=>b.status==="scheduled"||!b.status);const u=c.filter(b=>b.status==="completed"),p=c.filter(b=>b.status==="cancelled"),g=o.filter(b=>b.type==="sales"),E={};p.forEach(b=>{const I=b.cancelReason||"理由なし";E[I]=(E[I]||0)+1}),i.innerHTML=`
    ...
    <div class="grid grid-2">
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        <div>
          ${l.length===0?'<p style="color:var(--text-muted);text-align:center;padding:20px">職員が登録されていません</p>':l.map(b=>{const I=c.filter(P=>P.staffId===b.id),k=I.filter(P=>P.status==="completed").length,A=I.filter(P=>P.status==="cancelled").length,x=g.filter(P=>P.staffId===b.id).length;return`
                  <div style="display:flex;align-items:center;gap:12px;padding:12px 0;border-bottom:1px solid var(--border)">
                    ...
                    <div style="display:flex; gap:16px;">
                      ...
                      <div style="text-align:center;">
                        ...
                        <div style="font-weight:bold; color:${A>0?"var(--danger)":"var(--text-muted)"};">${A}</div>
                      </div>
                      <div style="text-align:center;">
  ...
  `}let se=null,Wt=[],xn=[],Ut=null,On=null,Dn=[];function dt(){return new Promise((i,e)=>{if(window.google&&window.google.maps){i();return}const n="AIzaSyCXFNBQjeiYpRYFdbs6VhISqlFZhrybM74",s=document.createElement("script");s.src=`https://maps.googleapis.com/maps/api/js?key=${n}&libraries=geometry,places&language=ja`,s.async=!0,s.defer=!0,s.onload=i,s.onerror=()=>e(new Error("Google Maps APIの読み込みに失敗しました")),document.head.appendChild(s)})}function od(i,e={lat:35.6938,lng:139.7034},n=14){const s=document.getElementById(i);return s?!window.google||!window.google.maps?(s.innerHTML=`
    ...
    `,null):(se=new google.maps.Map(s,{center:e,zoom:n,mapTypeControl:!0,streetViewControl:!1,fullscreenControl:!0,styles:hd()}),Ut=new google.maps.InfoWindow,On=new google.maps.DirectionsService,se):null}function bo(i,e={}){if(!se)return null;const n=new google.maps.Marker({map:se,position:i,title:e.title||"",icon:e.icon||void 0,label:e.label||void 0});return e.infoContent&&n.addListener("click",()=>{Ut.setContent(e.infoContent),Ut.open(se,n)}),Wt.push(n),n}function Pr(i,e,n,s){if(!se)return null;const o={path:"M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z",fillColor:e,fillOpacity:1,strokeColor:"#fff",strokeWeight:2,scale:1.8,anchor:new google.maps.Point(12,22),labelOrigin:new google.maps.Point(12,9)};return bo(i,{icon:o,label:void 0,infoContent:s})}function ad(i,e){return se?bo(i,{title:e,icon:{path:"M12 2L2 7v10l10 5 10-5V7L12 2z",fillColor:"#F59E0B",fillOpacity:1,strokeColor:"#fff",strokeWeight:2,scale:2,anchor:new google.maps.Point(12,12)},infoContent:`<div style="color:#333;padding:4px"><strong>🏢 ${e}</strong><br>（出発地点）</div>`}):null}function ld(i,e,n){if(!se)return null;const s=i.map(l=>({lat:l.lat,lng:l.lng})),o=new google.maps.Polyline({path:s,geodesic:!0,strokeColor:e,strokeOpacity:.8,strokeWeight:4,map:se});return xn.push(o),o}async function cd(i,e){if(!se||!On||i.length<2)return;const n=i[0],s=i[i.length-1],o=i.slice(1,-1).map(l=>({location:new google.maps.LatLng(l.lat,l.lng),stopover:!0}));try{const l=await new Promise((u,p)=>{On.route({origin:new google.maps.LatLng(n.lat,n.lng),destination:new google.maps.LatLng(s.lat,s.lng),waypoints:o,travelMode:google.maps.TravelMode.DRIVING,optimizeWaypoints:!1},(g,E)=>{E==="OK"?u(g):p(new Error(`Directions API: ${E}`))})}),c=new google.maps.DirectionsRenderer({map:se,directions:l,suppressMarkers:!0,polylineOptions:{strokeColor:e,strokeWeight:4,strokeOpacity:.8}});return Dn.push(c),c}catch(l){return console.warn("Directions API呼び出し失敗。直線ポリラインで代替:",l),ld(i,e)}}async function Pn(i){if(!window.google||!window.google.maps)return null;const e=new google.maps.DistanceMatrixService,n=i.map(s=>new google.maps.LatLng(s.lat,s.lng));try{return(await new Promise((l,c)=>{e.getDistanceMatrix({origins:n,destinations:n,travelMode:google.maps.TravelMode.DRIVING,unitSystem:google.maps.UnitSystem.METRIC},(u,p)=>{p==="OK"?l(u):c(new Error(`Distance Matrix API: ${p}`))})})).rows.map(l=>l.elements.map(c=>({distance:c.status==="OK"?c.distance.value/1e3:null,duration:c.status==="OK"?Math.ceil(c.duration.value/60):null})))}catch(s){return console.error("Distance Matrix取得失敗:",s),null}}function dd(){Wt.forEach(i=>i.setMap(null)),Wt=[],xn.forEach(i=>i.setMap(null)),xn=[],Dn.forEach(i=>i.setMap(null)),Dn=[],Ut&&Ut.close()}function ud(){if(!se||Wt.length===0)return;const i=new google.maps.LatLngBounds;Wt.forEach(e=>i.extend(e.getPosition())),se.fitBounds(i,50)}async function wo(i){if(!i||i.trim()==="")return null;if(!window.google||!window.google.maps)return console.warn("ジオコーディング: Google Maps APIが未読み込みです"),null;const e=new google.maps.Geocoder;try{return await new Promise((s,o)=>{e.geocode({address:i,region:"jp"},(l,c)=>{if(c==="OK"&&l[0]){const u=l[0].geometry.location;s({lat:u.lat(),lng:u.lng()})}else o(new Error(`ジオコーディング失敗: ${c}`))})})}catch(n){return console.warn("住所の座標変換に失敗:",n.message),null}}function hd(){return[{elementType:"geometry",stylers:[{color:"#1d2c4d"}]},{elementType:"labels.text.fill",stylers:[{color:"#8ec3b9"}]},{elementType:"labels.text.stroke",stylers:[{color:"#1a3646"}]},{featureType:"road",elementType:"geometry",stylers:[{color:"#304a7d"}]},{featureType:"road",elementType:"geometry.stroke",stylers:[{color:"#255763"}]},{featureType:"road.highway",elementType:"geometry",stylers:[{color:"#2c6675"}]},{featureType:"water",elementType:"geometry",stylers:[{color:"#17263c"}]},{featureType:"poi",elementType:"labels",stylers:[{visibility:"off"}]}]}const Ti={qualifications:{label:"資格",options:["介護福祉士","実務者研修修了","初任者研修修了","看護師","ヘルパー2級"]},services:{label:"対応可能サービス",options:["身体介護","生活援助","通院等乗降介助","医療的ケア"]},physical:{label:"身体的対応力",options:["重介護対応可","移乗介助可","入浴介助可","二人介助対応可"]},special:{label:"特別スキル",options:["認知症ケア","ターミナルケア","精神障害対応","障害児支援"]}},fd=["要支援1","要支援2","要介護1","要介護2","要介護3","要介護4","要介護5"],So=["身体介護","生活援助","通院等乗降介助","医療的ケア"],md=["男性","女性"],pd=["指定なし","男性希望","女性希望"],gd=["利用者の体調不良","利用者の入院","家族の都合","不在・応答なし","その他"],vd=["居宅介護支援事業所（ケアマネ）","地域包括支援センター","医療機関（退院調整室）","その他"],yd=["08:00","08:30","09:00","09:30","10:00","10:30","11:00","11:30","12:00","12:30","13:00","13:30","14:00","14:30","15:00","15:30","16:00","16:30","17:00"],Lr=["#4A90D9","#E74C3C","#2ECC71","#F39C12","#9B59B6","#1ABC9C","#E67E22","#3498DB","#E91E63","#00BCD4","#8BC34A","#FF5722"],Ot={requiredSkill:1e3,genderMatch:2e3,staffType:500,proximity:500},hi=25,Q={name:"事業所（拠点）",address:"〒501-3304 岐阜県加茂郡富加町高畑２９１",lat:35.497,lng:136.993};let Ln="all",bi=Je();async function _d(){var n,s,o;const i=document.getElementById("page-container");i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
        <span class="material-icons-round">map</span>
        マップビュー
      ...
      <div class="btn-group">
        <input type="date" id="map-date-picker" class="form-input" value="${bi}" style="width:160px">
  ...
  `;try{await dt()}catch(l){console.warn("Maps APIの読み込みスキップ:",l)}const e=od("map-canvas",{lat:Q.lat,lng:Q.lng});await li(e),(n=document.getElementById("map-date-picker"))==null||n.addEventListener("change",l=>{bi=l.target.value,li(e)}),(s=document.getElementById("staff-filter"))==null||s.addEventListener("change",l=>{Ln=l.target.value,li(e)}),(o=document.getElementById("btn-refresh-map"))==null||o.addEventListener("click",()=>{li(e)})}async function li(i){const[e,n,s]=await Promise.all([ce().catch(()=>[]),Te().catch(()=>[]),Ne(bi).catch(()=>[])]),o=document.getElementById("staff-filter");if(o&&o.options.length<=1&&e.forEach(c=>{const u=document.createElement("option");u.value=c.id,u.textContent=c.name,o.appendChild(u)}),!i){Td(e,n);return}dd(),ad({lat:Q.lat,lng:Q.lng},Q.name);const l=await Gn(bi).catch(()=>[]);if(l.length>0)for(const c of l){if(Ln!=="all"&&c.staffId!==Ln)continue;const u=e.find(E=>E.id===c.staffId),p=(u==null?void 0:u.color)||"#999",g=[{lat:Q.lat,lng:Q.lng}];for(const E of c.clientIds||[]){const b=n.find(I=>I.id===E);b&&(g.push({lat:b.lat,lng:b.lng}),Pr({lat:b.lat,lng:b.lng},p,"",`<div style="color:#333;padding:4px">
  ...
  `}}function Td(i,e){const n=document.getElementById("route-legend");n&&(n.innerHTML=`
    ...
    `)}let Ft=[];async function Kn(){const i=document.getElementById("page-container");Ft=await ce().catch(()=>[]),i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
  ...
  `),document.getElementById("sf-cancel").onclick=ye,document.getElementById("sf-save").onclick=async()=>{const l=document.getElementById("sf-name").value.trim();if(!l){C("氏名を入力してください","warning");return}const c=document.getElementById("sf-save");c.disabled=!0,c.textContent="保存中...";const u=document.getElementById("sf-address").value.trim();let p=(i==null?void 0:i.lat)||Q.lat,g=(i==null?void 0:i.lng)||Q.lng;if(u)try{await dt();const b=await wo(u);b?(p=b.lat,g=b.lng):C("住所から座標を取得できませんでした","warning")}catch(b){console.warn("ジオコーディング失敗:",b)}const E={name:l,gender:document.getElementById("sf-gender").value,address:u,workStart:document.getElementById("sf-work-start").value,workEnd:document.getElementById("sf-work-end").value,lat:p,lng:g,skills:{},color:(i==null?void 0:i.color)||Lr[Ft.length%Lr.length],isActive:!0};for(const[b]of Object.entries(Ti)){const I=document.querySelectorAll(`input[name="skill-${b}"]:checked`);E.skills[b]=Array.from(I).map(k=>k.value)}try{e?(await ed(i.id,E),C("職員情報を更新しました","success")):(await yo(E),C("職員を登録しました","success")),ye(),await Kn()}catch(b){C("保存に失敗しました: "+b.message,"error")}finally{c.disabled=!1,c.textContent=e?"更新":"登録"}}}document.addEventListener("click",async i=>{const e=i.target.closest("[data-edit-staff]");if(e){const s=Ft.find(o=>o.id===e.dataset.editStaff);s&&Eo(s)}const n=i.target.closest("[data-delete-staff]");if(n){const s=Ft.find(o=>o.id===n.dataset.deleteStaff);if(s&&await Oi("削除確認",`${s.name} を削除しますか？`))try{await td(s.id),C(`${s.name} を削除しました`,"success"),await Kn()}catch{C("削除に失敗しました","error")}}});let wi=[],Cr=[];async function Jn(){const i=document.getElementById("page-container");try{const[e,n]=await Promise.all([Te().catch(()=>[]),Io().catch(()=>[])]);wi=e,Cr=n}catch(e){console.error("データの取得に失敗",e)}i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
  ...
  `}function ko(i=null){var l,c;const e=!!i,n=[...Ti.physical.options,...Ti.special.options],s=`
    <form id="client-form">
      <div class="form-row">
        <div class="form-group">
          <label class="form-label">氏名 *</label>
  ...
  `;Gt(e?"利用者情報の編集":"新規利用者登録",s,`
    <button class="btn btn-secondary" id="cf-cancel">キャンセル</button>
    <button class="btn btn-primary" id="cf-save">${e?"更新":"登録"}</button>
  `),document.getElementById("cf-cancel").onclick=ye,document.getElementById("cf-save").onclick=async()=>{const u=document.getElementById("cf-name").value.trim();if(!u){C("氏名を入力してください","warning");return}const p=document.getElementById("cf-save");p.disabled=!0,p.textContent="保存中...";const g=document.getElementById("cf-address").value.trim();let E=(i==null?void 0:i.lat)||Q.lat,b=(i==null?void 0:i.lng)||Q.lng;if(g)try{await dt();const k=await wo(g);k?(E=k.lat,b=k.lng,C(`座標を取得しました: ${k.lat.toFixed(4)}, ${k.lng.toFixed(4)}`,"success")):C("住所から座標を取得できませんでした。事業所付近の座標を使用します。","warning")}catch(k){console.warn("ジオコーディング失敗:",k),C("座標取得に失敗。事業所付近の座標を使用します。","warning")}const I={name:u,careLevel:document.getElementById("cf-care-level").value,address:g,requiredServices:Array.from(document.querySelectorAll('input[name="cf-service"]:checked')).map(k=>k.value),requiredSkills:Array.from(document.querySelectorAll('input[name="cf-skill"]:checked')).map(k=>k.value),genderPreference:document.getElementById("cf-gender-pref").value,visitDuration:parseInt(document.getElementById("cf-duration").value)||60,timeWindow:{start:document.getElementById("cf-time-start").value,end:document.getElementById("cf-time-end").value},notes:document.getElementById("cf-notes").value.trim(),lat:E,lng:b,isActive:!0};try{e?(await id(i.id,I),C("利用者情報を更新しました","success")):(await _o(I),C("利用者を登録しました","success")),ye(),await Jn()}catch(k){C("保存に失敗しました: "+k.message,"error")}finally{p.disabled=!1,p.textContent=e?"更新":"登録"}}}document.addEventListener("click",async i=>{const e=i.target.closest("[data-edit-client]");if(e){const s=wi.find(o=>o.id===e.dataset.editClient);s&&ko(s)}const n=i.target.closest("[data-delete-client]");if(n){const s=wi.find(o=>o.id===n.dataset.deleteClient);if(s&&await Oi("削除確認",`${s.name} を削除しますか？`))try{await nd(s.id),C(`${s.name} を削除しました`,"success"),await Jn()}catch{C("削除に失敗しました","error")}}});let je=Je();async function Sd(){const i=document.getElementById("page-container");i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
      ...
      <div class="btn-group">
        <input type="date" id="schedule-date" class="form-input" value="${je}" style="width:180px" />
  ...
  `,document.getElementById("schedule-date").addEventListener("change",e=>{je=e.target.value,Vt()}),document.getElementById("btn-add-visit").addEventListener("click",Ed),document.getElementById("btn-generate-week").addEventListener("click",kd),await Vt()}async function Vt(){const i=document.getElementById("schedule-content"),[e,n,s,o]=await Promise.all([ce().catch(()=>[]),Te().catch(()=>[]),Ne(je).catch(()=>[]),Gn(je).catch(()=>[])]);if(s.length===0){i.innerHTML=`
      <div class="empty-state">
        <span class="material-icons-round">event_busy</span>
        <h3>${ct(je)} の訪問予定はありません</h3>
        <p>「訪問追加」ボタンから予定を登録するか、マッチング＆最適化を実行してください</p>
      </div>
    `;return}const l={},c=[];let u=0,p=0,g=0;for(const I of s)I.staffId?(l[I.staffId]||(l[I.staffId]=[]),l[I.staffId].push(I)):c.push(I);c.sort((I,k)=>{const A=I.startTime||I.scheduledTime||"00:00",x=k.startTime||k.scheduledTime||"00:00";return A.localeCompare(x)});let E="";c.length>0&&(E=`
      <div class="card" style="border-left: 4px solid var(--danger); margin-bottom: 24px; background: rgba(239, 68, 68, 0.05);">
        ...
        <div class="grid grid-3" style="gap: 12px;">
          ${c.map(I=>{const k=n.find(A=>A.id===I.clientId);return`
    ...
    `);for(const[I,k]of Object.entries(l)){const A=e.find(O=>O.id===I);if(!A)continue;const x=o.find(O=>O.staffId===I),P=parseInt(A.wage)||2e3;if(x&&(g+=(x.totalDistance||0)*hi),k.sort((O,L)=>{const M=O.optimizedArrivalTime||O.startTime||O.scheduledTime||"00:00",N=L.optimizedArrivalTime||L.startTime||L.scheduledTime||"00:00";return M.localeCompare(N)}),x&&x.schedule&&x.schedule.length>=2){const O=x.schedule[0].arrivalMinutes,M=(x.schedule[x.schedule.length-1].arrivalMinutes-O)/60;p+=M*P}else if(k.length>0){const O=k[0],L=k[k.length-1],M=O.startTime||O.scheduledTime||"09:00",N=L.startTime||L.scheduledTime||"17:00",B=X(M),y=(X(N)+(L.duration||60)-B)/60;p+=y*P}k.forEach((O,L)=>{u+=go(A,O.duration||60);let M=10,N=null;if(x&&x.schedule){const B=x.schedule.find(j=>j.clientId===O.clientId);B&&(M=B.travelTimeFromPrev||10,N=B.arrivalTime)}O.calculatedTravelTime=M,O.optimizedArrivalTime=N}),k.sort((O,L)=>{const M=O.optimizedArrivalTime||O.startTime||O.scheduledTime||"00:00",N=L.optimizedArrivalTime||L.startTime||L.scheduledTime||"00:00";return M.localeCompare(N)})}let b="";if(window.isAdmin){const I=u-p-g,k=u>0?Math.round(I/u*100):0;b=`
    ...
    <div class="grid grid-2">
      ${Object.entries(l).map(([I,k])=>{const A=e.find(x=>x.id===I);return`
          <div class="card" style="border-left:4px solid ${(A==null?void 0:A.color)||"#999"}">
            <h3 class="card-title" style="margin-bottom:12px">
              <div style="width:24px;height:24px;border-radius:50%;background:${(A==null?void 0:A.color)||"#999"};
                display:flex;align-items:center;justify-content:center;color:#fff;font-size:.7rem;font-weight:700">
                ${k.length}
              </div>
              ${Z((A==null?void 0:A.name)||"未割当")}
            </h3>
            <div class="schedule-timeline">
              ${k.map((x,P)=>{const O=n.find(B=>B.id===x.clientId),L=x.optimizedArrivalTime||x.startTime||x.scheduledTime||"--:--";let M="",N="";if(P>0){const B=k[P-1],j=B.optimizedArrivalTime||B.startTime||B.scheduledTime,y=x.calculatedTravelTime||10;if(j&&L!=="--:--"){const[f,m]=j.split(":").map(Number),[_,v]=L.split(":").map(Number),T=f*60+m+(B.duration||60),z=_*60+v-T;z<y&&(N=`
                  ...
                  <div class="time-slot">
                    ...
                    <div class="time-content">
                      <div class="visit-card">
                        <div style="display:flex;justify-content:space-between;align-items:start">
                          <div>
                            <strong>${Z(x.clientName||(O==null?void 0:O.name)||"不明")} ${x.type==="sales"?'<span class="tag" style="background:var(--warning);color:white;margin-left:4px">営業</span>':""}</strong>
                            ...
                            <div style="font-size:.75rem;color:var(--text-muted); margin-top:2px;">
                              ...
                              ${Z(x.type==="sales"?x.salesTarget||"営業先":(O==null?void 0:O.area)||"未設定")}
                            </div>
                          </div>
  ...
  `}async function Ed(){const[i,e]=await Promise.all([ce().catch(()=>[]),Te().catch(()=>[])]),n=`
    <form id="visit-form">
      <div class="form-group">
  ...
  `);const s=()=>{const o=document.getElementById("vf-service").value,l=parseInt(document.getElementById("vf-duration").value)||60,c=An(o,l);document.getElementById("vf-income").value=c,document.getElementById("vf-income-hint").textContent=`↑ ${o} ${l}分 → ¥${c.toLocaleString()}（自動計算）`};document.getElementById("vf-service").addEventListener("change",s),document.getElementById("vf-duration").addEventListener("change",s),s(),document.getElementById("vf-cancel").onclick=ye,document.getElementById("vf-save").onclick=async()=>{const o=document.getElementById("vf-client").value,l=document.getElementById("vf-staff").value;if(!o||!l){C("利用者と職員を選択してください","warning");return}try{const c=parseInt(document.getElementById("vf-duration").value)||60,u=document.getElementById("vf-service").value,p=document.getElementById("vf-time").value,g=X(p)+c,E=Math.floor(g/60),b=g%60,I=`${String(E).padStart(2,"0")}:${String(b).padStart(2,"0")}`;await Pi({date:je,clientId:o,staffId:l,startTime:p,endTime:I,scheduledTime:p,duration:c,service:u,income:parseInt(document.getElementById("vf-income").value)||An(u,c),status:"scheduled"}),C("訪問予定を追加しました","success"),ye(),await Vt()}catch{C("追加に失敗しました","error")}}}async function kd(){var e;if(await Oi("週間スケジュール自動生成",`利用者の曜日設定に基づいて、今週（月〜土）の訪問予定を自動生成します。
既存の予定がある日はスキップされます。

実行しますか？`))try{const[n,s]=await Promise.all([Te(),Io()]),o={月:1,火:2,水:3,木:4,金:5,土:6},l=new Date,c=l.getDay(),u=s.filter(b=>b.dayOfWeek&&o[b.dayOfWeek]!==void 0);let p=0,g=0;const E=new Map;for(const b of u){const I=o[b.dayOfWeek];if(I===void 0)continue;const k=I-c,A=new Date(l);A.setDate(l.getDate()+k);const x=fo(A),P=`${x}_${b.clientId}`;if(E.has(P)){E.get(P).timeOptions.push({startTime:b.startTime||"09:00",duration:b.duration||60});continue}if((await Ne(x)).some(L=>L.clientId===b.clientId)){E.set(P,null),g++;continue}E.set(P,{...b,date:x,timeOptions:[{startTime:b.startTime||"09:00",duration:b.duration||60}]})}for(const[b,I]of E){if(!I)continue;const k=n.find(j=>j.id===I.clientId),A=I.service||((e=k==null?void 0:k.requiredServices)==null?void 0:e[0])||"身体介護",x=I.duration||(k==null?void 0:k.visitDuration)||60,P=I.startTime||"09:00",O=An(A,x),L=X(P)+x,M=Math.floor(L/60),N=L%60,B=`${String(M).padStart(2,"0")}:${String(N).padStart(2,"0")}`;await Pi({date:I.date,clientId:I.clientId,clientName:I.clientName||(k==null?void 0:k.name)||"利用者",staffId:I.staffId||null,staffName:I.staffName||"未設定",startTime:P,endTime:B,scheduledTime:P,duration:x,service:A,income:O,dayOfWeek:I.dayOfWeek,status:"scheduled",timeOptions:I.timeOptions}),p++}p>0?C(`今週の訪問予定 ${p}件 を自動生成しました！${g>0?`（${g}件は既存のためスキップ）`:""}`,"success"):C(`生成する予定がありませんでした。${g>0?`（${g}件は既に登録済み）`:"利用者の曜日設定を確認してください。"}`,"warning"),await Vt()}catch(n){console.error("週間スケジュール生成エラー:",n),C("スケジュール生成に失敗しました: "+n.message,"error")}}document.addEventListener("click",async i=>{const e=i.target.closest("[data-delete-visit]");if(e&&await Oi("削除確認","この訪問予定を削除しますか？"))try{await To(e.dataset.deleteVisit),C("訪問予定を削除しました","success"),await Vt()}catch{C("削除に失敗しました","error")}});function Ad(i,e){const n=X(i),s=[{startTime:i,duration:e}],o=n+15;o+e<=18*60&&s.push({startTime:Bt(o),duration:e});const l=n-15;return l>=7*60&&s.push({startTime:Bt(l),duration:e}),s}function Nr(i){return i?X(i)<12*60+30?"AM":"PM":"AM"}function xd(i,e,n=null){var g,E,b,I,k;let s=0;const o=[];let l=!0;for(const A of e.requiredServices||[])(E=(g=i.skills)==null?void 0:g.services)!=null&&E.includes(A)?(s+=Ot.requiredSkill,o.push(`✅ ${A}対応可`)):(l=!1,o.push(`❌ ${A}に対応不可`));const c=[...((b=i.skills)==null?void 0:b.qualifications)||[],...((I=i.skills)==null?void 0:I.physical)||[],...((k=i.skills)==null?void 0:k.special)||[]];for(const A of e.requiredSkills||[])c.includes(A)?(s+=Ot.requiredSkill,o.push(`✅ ${A}あり`)):(l=!1,o.push(`❌ ${A}なし`));if(e.genderPreference&&e.genderPreference!=="指定なし"){const A=e.genderPreference.replace("希望","");i.gender===A?(s+=Ot.genderMatch,o.push(`✅ 性別希望合致（${A}）`)):(l=!1,o.push(`❌ 性別希望不一致（希望: ${A}）`))}i.type==="正社員"&&(s+=Ot.staffType,o.push("✅ 正社員"));const u=(n==null?void 0:n.lat)||i.lat,p=(n==null?void 0:n.lng)||i.lng;if(u&&e.lat){const A=po(u,p,e.lat,e.lng);let x=Ot.proximity;n!=null&&n.isTransition&&(x=x*.2,o.push("ℹ️ ブロック移動（エリア移動許容）"));const P=Math.max(0,x*(1-A/10));s+=P,P>x*.8&&o.push(`✅ 近距離ボーナス (+${Math.round(P)})`)}return{score:Math.round(s),reasons:o,eligible:l}}function vn(i){var e;return(e=i.name)!=null&&e.includes("前川")?3:i.maxVisits||(i.type==="パート"?5:10)}function Od(i,e,n=[],s=null,o=[]){const l=[],c=new Set,u={},p={};o.forEach((I,k)=>{p[I.id]=k});const g=(I,k)=>{if(!s)return 15;const A=p[I],x=p[k];return A!==void 0&&x!==void 0&&s[A][x]&&s[A][x].duration||15},E=[...e].sort((I,k)=>{const A=I.startTime||I.scheduledTime||"00:00",x=k.startTime||k.scheduledTime||"00:00";return A.localeCompare(x)});for(const I of E){if(l.some(O=>O.clientId===I.clientId)){c.add(I.id);continue}const k=i.filter(O=>O.isActive).map(O=>{const L=n.find(T=>T.id===I.clientId),M=l.filter(T=>T.staffId===O.id),N=M.length>0?M[M.length-1]:null;let B=null;if(N){const T=n.find(h=>h.id===N.clientId);if(T){const h=I.startTime||I.scheduledTime||"09:00",z=Nr(N.startTime)!==Nr(h);B={lat:T.lat,lng:T.lng,isTransition:z}}}const{score:j,eligible:y}=xd(O,L||I,B),f=I.startTime||I.scheduledTime||"09:00",m=I.duration||60,_=I.timeOptions&&I.timeOptions.length>0?I.timeOptions:Ad(f,m);let v=null;for(const T of _){let h=!0;const z=X(T.startTime),re=z+(T.duration||60),Ci=X(O.workStart||"07:00"),Ni=X(O.workEnd||"18:00");if(z<Ci||re>Ni){h=!1;continue}const Xe=l.filter(de=>de.staffId===O.id);for(const de of Xe){const Ye=X(de.startTime),Qe=Ye+(de.duration||60);if(z<Qe&&re>Ye){h=!1;break}const ht=g(de.clientId,I.clientId);if(z>=Qe){if(z-Qe<ht){h=!1;break}}else if(re<=Ye&&Ye-re<ht){h=!1;break}}if(h){v=T;break}}return{staff:O,score:j,eligible:y&&!!v,chosenTime:v}}).filter(O=>O.eligible);if(k.length===0)continue;k.sort((O,L)=>{var T,h;const M=u[O.staff.id]||0,N=u[L.staff.id]||0,B=vn(O.staff),j=vn(L.staff),y=M>=B,f=N>=j;if(y!==f)return y?1:-1;const m=7,_=O.staff.type==="正社員"&&!((T=O.staff.name)!=null&&T.includes("前川"))&&M<m,v=L.staff.type==="正社員"&&!((h=L.staff.name)!=null&&h.includes("前川"))&&N<m;return _!==v?_?-1:1:M!==N?M-N:O.staff.type!==L.staff.type?O.staff.type==="正社員"?-1:1:L.score-O.score});const A=k[0],x=u[A.staff.id]||0,P=vn(A.staff);if(x<P){const O=A.chosenTime.startTime,L=A.chosenTime.duration||60,M=X(O)+L;l.push({staffId:A.staff.id,staffName:A.staff.name,visitId:I.id,clientId:I.clientId,clientName:I.clientName||"利用者",score:A.score,startTime:O,endTime:Bt(M),scheduledTime:O,duration:L}),c.add(I.id),u[A.staff.id]=x+1}}const b=e.filter(I=>!c.has(I.id)).map(I=>({visitId:I.id,clientName:I.clientName||"利用者",reason:"適格な職員なし、または上限超過",visit:I}));return{assignments:l,unassigned:b}}async function Ao(i,e,n,s=Q,o=null){const l={};for(const u of i)l[u.staffId]||(l[u.staffId]=[]),l[u.staffId].push(u.clientId);const c={};for(const[u,p]of Object.entries(l)){const g=e.find(O=>O.id===u),E=p.map(O=>n.find(L=>L.id===O)).filter(Boolean);if(E.length===0)continue;const b=[{id:"office",name:"事業所",lat:s.lat,lng:s.lng,isOffice:!0},...E.map(O=>{const L=i.find(M=>M.clientId===O.id&&M.staffId===u);return{id:O.id,name:O.name,lat:O.lat,lng:O.lng,duration:O.visitDuration||60,scheduledStart:L?L.startTime:null,timeWindow:O.timeWindow}})];let I=null;typeof o=="function"&&(I=await o(b));const k=Dd(b,I);let A=Pd(b,k);A=Ld(A,k);const x=Cd(A,k),P=Nd(A,k,g,I,b);c[u]={staffId:u,staffName:(g==null?void 0:g.name)||"不明",staffColor:(g==null?void 0:g.color)||"#999",route:A,totalDistance:Math.round(x*10)/10,totalDuration:Md(P),schedule:P}}return c}function Dd(i,e=null){const n=i.length,s=Array.from({length:n},()=>Array(n).fill(0));for(let o=0;o<n;o++)for(let l=0;l<n;l++)o!==l&&(e&&e[o]&&e[o][l]&&e[o][l].distance!==null?s[o][l]=e[o][l].distance:s[o][l]=po(i[o].lat,i[o].lng,i[l].lat,i[l].lng));return s}function Pd(i,e){const n=i.length,s=new Set([0]),o=[0],l=[],c=[];for(let g=1;g<n;g++){const E=i[g];E.timeWindow&&E.timeWindow.start?l.push({index:g,start:X(E.timeWindow.start),end:X(E.timeWindow.end)}):c.push(g)}l.sort((g,E)=>g.start-E.start);const u=[...l.map(g=>g.index),...c];let p=0;for(;s.size<n;){let g=-1,E=1/0;for(const b of u)s.has(b)||e[p][b]<E&&(E=e[p][b],g=b);if(g===-1)break;o.push(g),s.add(g),p=g}return o.push(0),o}function Ld(i,e){const n=i.length;let s=!0,o=[...i];for(;s;){s=!1;for(let l=1;l<n-2;l++)for(let c=l+1;c<n-1;c++){const u=e[o[l-1]][o[l]]+e[o[c]][o[c+1]];if(e[o[l-1]][o[c]]+e[o[l]][o[c+1]]<u-.001){const g=[...o];let E=l,b=c;for(;E<b;)[g[E],g[b]]=[g[b],g[E]],E++,b--;o=g,s=!0}}}return o}function Cd(i,e){let n=0;for(let s=0;s<i.length-1;s++)n+=e[i[s]][i[s+1]];return n}function Nd(i,e,n,s=null,o=[]){const l=[];let u=X((n==null?void 0:n.workStart)||"08:30");for(let p=0;p<i.length;p++){let g=0;if(p>0){const b=i[p-1],I=i[p];s&&s[b]&&s[b][I]&&s[b][I].duration!==null?g=s[b][I].duration:g=e[b][I]/20*60,u+=Math.ceil(g)}const E=o[i[p]];if(E){let b=0;E.timeWindow&&E.timeWindow.start?b=X(E.timeWindow.start):E.scheduledStart&&(b=X(E.scheduledStart)),u<b&&(u=b)}if(l.push({pointIndex:i[p],clientId:E?E.id:null,arrivalTime:Bt(u),arrivalMinutes:u,travelTimeFromPrev:Math.ceil(g)}),p>0&&p<i.length-1){const b=E&&E.duration||60;u+=b}}return l}function Md(i){if(i.length<2)return 0;const e=i[0].arrivalMinutes;return i[i.length-1].arrivalMinutes-e}let He=null,Si=null,Ge=Je(),Ei=null,Xn=null,Cn=null,nt=null;async function xo(){const i=document.getElementById("page-container"),e=await ce(),n=["日","月","火","水","木","金","土"][new Date(Ge).getDay()];i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
        <span class="material-icons-round">auto_fix_high</span>
        マッチング＆ルート最適化
      ...
      <div style="display:flex;align-items:center;gap:12px">
        <input type="date" id="match-date-picker" class="form-input" value="${Ge}" style="width:160px">
      ...
      ${Object.entries(l).map(([c,u])=>{var g,E,b;const p=o[c];return`
          <div class="card" style="border-left:4px solid ${((g=u.staff)==null?void 0:g.color)||"#999"}">
            ...
            <div style="display:flex;flex-direction:column;gap:6px">
              ...
              ${((p==null?void 0:p.schedule)||[]).filter(I=>I.pointIndex!==0||p.schedule.indexOf(I)===p.schedule.length-1).map((I,k,A)=>{var P,O;if(I.pointIndex===0&&k===A.length-1)return`<div style="font-size:.8rem;color:var(--text-muted);display:flex;align-items:center;gap:4px">
                      <span class="material-icons-round" style="font-size:16px;color:var(--secondary)">business</span>
                      ${I.arrivalTime} 事業所帰着
                    </div>`;const x=u.clients.find(L=>L.clientId===I.clientId);return`<div class="visit-card">
                    <div style="display:flex;justify-content:space-between;align-items:center">
                      <strong style="font-size:.85rem">${I.arrivalTime} ${((P=x==null?void 0:x.client)==null?void 0:P.name)||"利用者"}</strong>
                      <span class="tag">${((O=x==null?void 0:x.client)==null?void 0:O.visitDuration)||60}分</span>
                    </div>
                  </div>`}).join("")}
            </div>
          </div>
  ...
  `}async function $d(i,e){try{const n=Object.entries(e).map(([l,c])=>{const u=He.filter(p=>p.staffId===l).map(p=>p.clientId);return{staffId:l,date:Ge,clientIds:u,totalDistance:c.totalDistance,totalDuration:c.totalDuration,schedule:c.schedule}}),s=await Ne(Ge),o=new Set;for(const l of s){const c=He.find(u=>u.visitId===l.id);c&&(await Ii(l.id,{staffId:c.staffId,staffName:c.staffName,startTime:c.startTime,endTime:c.endTime,scheduledTime:c.scheduledTime}),o.add(l.clientId))}for(const l of s)He.find(u=>u.visitId===l.id)||(o.has(l.clientId)?await To(l.id):await Ii(l.id,{staffId:null,staffName:"未設定"}));await sd(n),C("スケジュールとルートを保存しました！","success")}catch(n){C("保存に失敗しました: "+n.message,"error")}}function Do(){var i;(i=document.getElementById("btn-save-routes"))==null||i.addEventListener("click",async()=>{await $d(Xn,Si)}),document.querySelectorAll(".btn-manual-assign").forEach(e=>{e.addEventListener("click",n=>{const s=n.target.closest(".btn-manual-assign").dataset.visitId;Bd(s)})})}function Bd(i){const e=nt.find(c=>c.visitId===i);if(!e)return;const n=e.visit,s=Ei.map(c=>`<option value="${c.id}">${Z(c.name)}</option>`).join(""),o=`
  ...
  `),document.getElementById("manual-cancel").onclick=()=>{ye()},document.getElementById("manual-ok").onclick=async()=>{const c=document.getElementById("manual-staff-select").value,u=document.getElementById("manual-time-input").value;ye(),await Wd(i,c,u)}}async function Wd(i,e,n){const s=nt.findIndex(E=>E.visitId===i);if(s===-1)return;const l=nt[s].visit,c=Ei.find(E=>E.id===e),u=l.duration||60,p=X(n)+u;He.push({staffId:c.id,staffName:c.name,visitId:l.id,clientId:l.clientId,clientName:l.clientName||"利用者",score:9999,startTime:n,endTime:Bt(p),scheduledTime:n,duration:u}),nt.splice(s,1);const g=document.getElementById("optimization-results");g.innerHTML='<div style="text-align:center;padding:32px;"><span class="material-icons-round" style="animation:spin 1s linear infinite">sync</span> ルート再計算中...</div>';try{Si=await Ao(He,Ei,Cn,Q,async b=>{try{return await dt(),await Pn(b)}catch{return null}}),g.innerHTML=Oo(Xn,Cn,He,nt,Si),Do(),C(`${c.name}さんに手動割り当てし、ルートを再計算しました`,"success")}catch(E){C("ルート再計算に失敗しました","error"),console.error(E)}}let Mt=Je();async function Ud(){var e,n;const i=document.getElementById("page-container");if(!window.isAdmin){i.innerHTML=`
      <div class="empty-state">
    ...
    <div class="page-header">
      ...
      <div class="btn-group">
        <input type="date" id="revenue-date-picker" class="form-input" value="${Mt}" style="width:160px">
  ...
  `,await yn(),(e=document.getElementById("revenue-date-picker"))==null||e.addEventListener("change",s=>{Mt=s.target.value,yn()}),(n=document.getElementById("btn-refresh-revenue"))==null||n.addEventListener("click",()=>{yn()})}async function yn(){const i=document.getElementById("revenue-content");if(!i)return;const[e,n,s,o]=await Promise.all([ce(),Te(),Ne(Mt),Gn(Mt)]);if(s.length===0){i.innerHTML=`
      <div class="empty-state">
        <span class="material-icons-round" style="font-size:48px;opacity:.2">event_busy</span>
        <p>${ct(Mt)} の訪問予定データがありません。</p>
      </div>
    `;return}let l=0,c=0,u=0,p=s.length;s.filter(I=>I.status==="completed").length;const g=e.map(I=>{const k=o.filter(N=>N.staffId===I.id),A=s.filter(N=>N.staffId===I.id);let x=0,P=0,O=0,L=0,M=0;if(A.forEach(N=>{x+=go(I,N.duration||60)}),k.forEach(N=>{if(L+=N.totalDistance||0,O+=(N.totalDistance||0)*hi,N.schedule&&N.schedule.length>=2){const B=N.schedule[0].arrivalMinutes;M=N.schedule[N.schedule.length-1].arrivalMinutes-B,P=M/60*(parseInt(I.wage)||2e3)}}),k.length===0&&A.length>0){const N=[...A].sort((m,_)=>(m.startTime||"09:00").localeCompare(_.startTime||"09:00")),B=N[0],j=N[N.length-1],y=X(B.startTime||"09:00");M=X(j.startTime||"17:00")+(j.duration||60)-y,P=M/60*(parseInt(I.wage)||2e3)}return{...I,count:A.length,revenue:x,laborCost:P,vehicleCost:O,profit:x-P-O,workMinutes:M}}).filter(I=>I.count>0||I.revenue>0).sort((I,k)=>k.profit-I.profit);g.forEach(I=>{l+=I.revenue,c+=I.laborCost,u+=I.vehicleCost});const E=l-c-u,b=l>0?E/l*100:0;i.innerHTML=`
    <!-- メインKPI -->
    <div class="grid grid-4" style="margin-bottom:24px">
      ...
      <div class="card stat-card" style="border-top: 4px solid var(--secondary)">
        ...
        <div style="font-size:.8rem;color:var(--text-muted);margin-top:4px">@${hi}円/km</div>
      </div>
        ...
        <div style="padding:20px;display:flex;flex-direction:column;gap:24px">
          ...
          <div class="card" style="background:rgba(255,255,255,0.03);border:none;padding:16px">
            ...
            <ul style="font-size:.85rem;line-height:1.6;padding-left:16px;color:var(--text-muted)">
              ...
              <li>現在の移動コスト単価は1kmあたり${hi}円で計算されています。</li>
            </ul>
          </div>
        </div>
      </div>
    </div>
  `}async function Fd(){const i=document.getElementById("page-container"),e=Je();i.innerHTML=`
  ...
  `,document.getElementById("btn-add-sales").addEventListener("click",jd),await Li(e)}async function Li(i){try{const e=await Ne(i),n="staff_1",s=e.filter(g=>g.staffId===n);s.sort((g,E)=>(g.scheduledTime||g.startTime||"").localeCompare(E.scheduledTime||E.startTime||""));const o=document.getElementById("my-schedule-list"),l=s.length,c=s.filter(g=>g.status==="completed").length,u=s.filter(g=>g.status==="cancelled").length;if(document.getElementById("my-schedule-summary").innerHTML=`
    ...
    `,s.forEach((g,E)=>{const b=g.type==="sales",I=g.duration||60,k=g.status||"scheduled";let A="var(--primary)",x="",P="",O="";k==="completed"?(A="var(--success)",x='<span class="material-icons-round" style="color:var(--success)">check_circle</span>',O='<span class="tag" style="background:var(--success); color:white;">完了</span>'):k==="cancelled"?(A="var(--danger)",x='<span class="material-icons-round" style="color:var(--danger)">cancel</span>',O=`<span class="tag" style="background:var(--danger); color:white;">キャンセル: ${Z(g.cancelReason||"理由なし")}</span>`):P=`
        ...
        <div style="display:flex; align-items:flex-start; gap: 12px;">
          ...
          <div class="card" style="flex: 1; padding: 16px; border-radius: 12px; border-left: 4px solid ${L}; position: relative; opacity: ${k!=="scheduled"?"0.7":"1"};">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 8px;">
              ...
              ${O||`<span class="tag" style="background: var(--bg-color);">${I}分</span>`}
            </div>
    ...
    `,o.innerHTML=p,document.querySelectorAll(".btn-complete-visit").forEach(g=>{g.addEventListener("click",async E=>{const b=E.currentTarget.dataset.id;if(confirm("この訪問を「完了」にしてよろしいですか？"))try{await Ii(b,{status:"completed"}),C("訪問を完了しました","success"),Li(i)}catch{C("更新に失敗しました","error")}})}),document.querySelectorAll(".btn-cancel-visit").forEach(g=>{g.addEventListener("click",E=>{const b=E.currentTarget.dataset.id;Vd(b,i)})})}catch(e){console.error("マイスケジュール取得エラー:",e),document.getElementById("my-schedule-list").innerHTML=`
  ...
  `,n.style.display="flex",document.getElementById("btn-submit-cancel").addEventListener("click",async()=>{const c=document.getElementById("cancel-reason-select").value;if(!c){C("キャンセル理由を選択してください","warning");return}const u=document.getElementById("cancel-notes").value;try{await Ii(i,{status:"cancelled",cancelReason:c,cancelNotes:u}),C("キャンセルを登録しました","success"),n.style.display="none",Li(e)}catch{C("更新に失敗しました","error")}})}function jd(){const i=Je(),e=document.getElementById("modal-overlay"),n=document.getElementById("modal-title"),s=document.getElementById("modal-body"),o=document.getElementById("modal-footer");n.innerHTML='<span class="material-icons-round" style="color:var(--warning)">storefront</span> 営業予定の追加',s.innerHTML=`
  ...
  `,e.style.display="flex",document.getElementById("btn-submit-sales").addEventListener("click",async()=>{const l=document.getElementById("sales-client-name").value.trim();if(!l){C("訪問先名を入力してください","warning");return}const c=document.getElementById("sales-target-select").value,u=document.getElementById("sales-start-time").value,p=parseInt(document.getElementById("sales-duration").value,10);try{await Pi({staffId:"staff_1",staffName:"佐藤 看護師",clientId:"sales_"+Date.now(),clientName:l,date:i,startTime:u,scheduledTime:u,duration:p,type:"sales",salesTarget:c,status:"scheduled"}),C("営業予定を追加しました","success"),e.style.display="none",Li(i)}catch(g){console.error(g),C("追加に失敗しました","error")}})}const qd={dashboard:{render:rd,title:"ダッシュボード"},map:{render:_d,title:"マップビュー"},staff:{render:Kn,title:"職員管理"},client:{render:Jn,title:"利用者管理"},schedule:{render:Sd,title:"スケジュール"},matching:{render:xo,title:"マッチング＆最適化"},revenue:{render:Ud,title:"収支シミュレーション"},"my-schedule":{render:Fd,title:"マイスケジュール"}};function zd(){var o,l,c,u;document.querySelectorAll(".nav-item").forEach(p=>{p.addEventListener("click",()=>{const g=p.dataset.page;g&&Rt(g)})}),(o=document.getElementById("btn-sidebar-toggle"))==null||o.addEventListener("click",()=>{document.getElementById("sidebar").classList.toggle("collapsed")});const e=document.getElementById("sidebar"),n=document.getElementById("sidebar-overlay"),s=()=>{e.classList.toggle("open"),n.classList.toggle("open")};(l=document.getElementById("btn-mobile-menu"))==null||l.addEventListener("click",s),n==null||n.addEventListener("click",s),(c=document.getElementById("btn-modal-close"))==null||c.addEventListener("click",()=>{document.getElementById("modal-overlay").style.display="none"}),(u=document.getElementById("modal-overlay"))==null||u.addEventListener("click",p=>{p.target===p.currentTarget&&(p.currentTarget.style.display="none")})}async function Rt(i){var s,o;const e=qd[i];if(!e)return;if(window.isAdmin===!1&&i!=="my-schedule"){console.warn("アクセス権限がありません:",i);return}document.querySelectorAll(".nav-item").forEach(l=>{l.classList.toggle("active",l.dataset.page===i)}),(s=document.getElementById("sidebar"))==null||s.classList.remove("open"),(o=document.getElementById("sidebar-overlay"))==null||o.classList.remove("open"),document.title=`${e.title} - CareRoute`;const n=document.getElementById("page-container");n.innerHTML='<div class="loading"><div class="spinner"></div></div>';try{await e.render()}catch(l){console.error(`ページ「${e.title}」の表示エラー:`,l),n.innerHTML=`
      <div class="empty-state">
