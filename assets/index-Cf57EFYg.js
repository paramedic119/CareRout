 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pe=new pn("@firebase/app"),Aa="@firebase/app-compat",Oa="@firebase/analytics-compat",Pa="@firebase/analytics",Da="@firebase/app-check-compat",Ca="@firebase/app-check",La="@firebase/auth",xa="@firebase/auth-compat",Ra="@firebase/database",Na="@firebase/data-connect",Ma="@firebase/database-compat",$a="@firebase/functions",Ua="@firebase/functions-compat",Wa="@firebase/installations",Ba="@firebase/installations-compat",Fa="@firebase/messaging",Va="@firebase/messaging-compat",ja="@firebase/performance",qa="@firebase/performance-compat",Ha="@firebase/remote-config",za="@firebase/remote-config-compat",Ga="@firebase/storage",Ka="@firebase/storage-compat",Ja="@firebase/firestore",Xa="@firebase/ai",Ya="@firebase/firestore-compat",Qa="firebase",Za="12.12.0",ec={[sn]:"fire-core",[Aa]:"fire-core-compat",[Pa]:"fire-analytics",[Oa]:"fire-analytics-compat",[Ca]:"fire-app-check",[Da]:"fire-app-check-compat",[La]:"fire-auth",[xa]:"fire-auth-compat",[Ra]:"fire-rtdb",[Na]:"fire-data-connect",[Ma]:"fire-rtdb-compat",[$a]:"fire-fn",[Ua]:"fire-fn-compat",[Wa]:"fire-iid",[Ba]:"fire-iid-compat",[Fa]:"fire-fcm",[Va]:"fire-fcm-compat",[ja]:"fire-perf",[qa]:"fire-perf-compat",[Ha]:"fire-rc",[za]:"fire-rc-compat",[Ga]:"fire-gcs",[Ka]:"fire-gcs-compat",[Ja]:"fire-fst",[Ya]:"fire-fst-compat",[Xa]:"fire-vertex","fire-js":"fire-js",[Qa]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ke(mc,pc,"app");var Wr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ti=new pn("@firebase/firestore");function se(i,...e){if(ti.logLevel<=W.DEBUG){const n=e.map(Cs);ti.debug(`Firestore (${mi}): ${i}`,...n)}}function Ds(i,...e){if(ti.logLevel<=W.ERROR){const n=e.map(Cs);ti.error(`Firestore (${mi}): ${i}`,...n)}}function Cs(i){if(typeof i=="string")return i;try{return function(n){return JSON.stringify(n)}(i)}catch{return i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $={CANCELLED:"cancelled",INVALID_ARGUMENT:"invalid-argument",FAILED_PRECONDITION:"failed-precondition"};class U extends Pe{constructor(e,n){super(e,n),this.code=e,this.message=n,this.toString=()=>`${this.name}: [code=${this.code}]: ${this.message}`}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function z(i,e){const n={typeString:i};return e&&(n.value=e),n}function Lt(i,e){if(!Dc(i))throw new U($.INVALID_ARGUMENT,"JSON must be an object");let n;for(const r in e)if(e[r]){const o=e[r].typeString,c="value"in e[r]?{value:e[r].value}:void 0;if(!(r in i)){n=`JSON missing required field: '${r}'`;break}const l=i[r];if(o&&typeof l!==o){n=`JSON field '${r}' must be a ${o}.`;break}if(c!==void 0&&l!==c.value){n=`Expected '${r}' field to equal '${c.value}'`;break}}if(n)throw new U($.INVALID_ARGUMENT,n);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rc{constructor(e,n=null,r=[],o=[],c=null,l="F",u=null,g=null){this.path=e,this.collectionGroup=n,this.explicitOrderBy=r,this.filters=o,this.limit=c,this.limitType=l,this.startAt=u,this.endAt=g,this.Ee=null,this.Ie=null,this.Re=null,this.startAt,this.endAt}}function Nc(i){return new Rc(i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bc="ComponentProvider",Kr=new Map;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fc="firestore.googleapis.com",Jr=!0;class Xr{constructor(e){if(e.host===void 0){if(e.ssl!==void 0)throw new U($.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host=Fc,this.ssl=Jr}else this.host=e.host,this.ssl=e.ssl??Jr;if(this.isUsingEmulator=e.emulatorOptions!==void 0,this.credentials=e.credentials,this.ignoreUndefinedProperties=!!e.ignoreUndefinedProperties,this.localCache=e.localCache,e.cacheSizeBytes===void 0)this.cacheSizeBytes=Mc;else{if(e.cacheSizeBytes!==-1&&e.cacheSizeBytes<$c)throw new U($.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=e.cacheSizeBytes}Pc("experimentalForceLongPolling",e.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",e.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!e.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:e.experimentalAutoDetectLongPolling===void 0?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!e.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=Wc(e.experimentalLongPollingOptions??{}),function(r){if(r.timeoutSeconds!==void 0){if(isNaN(r.timeoutSeconds))throw new U($.INVALID_ARGUMENT,`invalid long polling timeout: ${r.timeoutSeconds} (must not be NaN)`);if(r.timeoutSeconds<5)throw new U($.INVALID_ARGUMENT,`invalid long polling timeout: ${r.timeoutSeconds} (minimum allowed value is 5)`);if(r.timeoutSeconds>30)throw new U($.INVALID_ARGUMENT,`invalid long polling timeout: ${r.timeoutSeconds} (maximum allowed value is 30)`)}}(this.experimentalLongPollingOptions),this.useFetchStreams=!!e.useFetchStreams}isEqual(e){return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&function(r,o){return r.timeoutSeconds===o.timeoutSeconds}(this.experimentalLongPollingOptions,e.experimentalLongPollingOptions)&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams}}class Vc{constructor(e,n,r,o){this._authCredentials=e,this._appCheckCredentials=n,this._databaseId=r,this._app=o,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new Xr({}),this._settingsFrozen=!1,this._emulatorOptions={},this._terminateTask="notTerminated"}get app(){if(!this._app)throw new U($.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return this._terminateTask!=="notTerminated"}_setSettings(e){if(this._settingsFrozen)throw new U($.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new Xr(e),this._emulatorOptions=e.emulatorOptions||{},e.credentials!==void 0&&(this._authCredentials=function(r){if(!r)return new yc;switch(r.type){case"firstParty":return new Tc(r.sessionIndex||"0",r.iamToken||null,r.authTokenFactory||null);case"provider":return r.client;default:throw new U($.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}}(e.credentials))}_getSettings(){return this._settings}_getEmulatorOptions(){return this._emulatorOptions}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask==="notTerminated"&&(this._terminateTask=this._terminate()),this._terminateTask}async _restart(){this._terminateTask==="notTerminated"?await this._terminate():this._terminateTask="notTerminated"}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return function(n){const r=Kr.get(n);r&&(se(Bc,"Removing Datastore"),Kr.delete(n),r.terminate())}(this),Promise.resolve()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class me{constructor(e){this._byteString=e}static fromBase64String(e){try{return new me(Ve.fromBase64String(e))}catch(n){throw new U($.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+n)}}static fromUint8Array(e){return new me(Ve.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}toJSON(){return{type:me._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(e){if(Lt(e,me._jsonSchema))return me.fromBase64String(e.bytes)}}me._jsonSchemaVersion="firestore/bytes/1.0",me._jsonSchema={type:z("string",me._jsonSchemaVersion),bytes:z("string")};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xs{constructor(...e){for(let n=0;n<e.length;++n)if(e[n].length===0)throw new U($.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new $e(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Be{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new U($.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new U($.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return Ae(this._lat,e._lat)||Ae(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:Be._jsonSchemaVersion}}static fromJSON(e){if(Lt(e,Be._jsonSchema))return new Be(e.latitude,e.longitude)}}Be._jsonSchemaVersion="firestore/geoPoint/1.0",Be._jsonSchema={type:z("string",Be._jsonSchemaVersion),latitude:z("number"),longitude:z("number")};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ri=new pn("@firebase/auth");function Jc(i,...e){ri.logLevel<=W.WARN&&ri.warn(`Auth (${fi}): ${i}`,...e)}function Zt(i,...e){ri.logLevel<=W.ERROR&&ri.error(`Auth (${fi}): ${i}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tl=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],il=new xt(3e4,6e4);function Fs(i,e){return i.tenantId&&!e.tenantId?{...e,tenantId:i.tenantId}:e}async function pi(i,e,n,r,o={}){return Vs(i,o,async()=>{let c={},l={};r&&(e==="GET"?l=r:c={body:JSON.stringify(r)});const u=Ss({key:i.config.apiKey,...l}).slice(1),g=await i._getAdditionalHeaders();g["Content-Type"]="application/json",i.languageCode&&(g["X-Firebase-Locale"]=i.languageCode);const _={method:e,headers:g,...c};return Zo()||(_.referrerPolicy="no-referrer"),i.emulatorConfig&&Es(i.emulatorConfig.host)&&(_.credentials="include"),Bs.fetch()(await js(i,i.config.apiHost,n,u),_)})}async function Vs(i,e,n){i._canInitEmulator=!1;const r={...el,...e};try{const o=new nl(i),c=await Promise.race([n(),o.promise]);o.clearNetworkTimeout();const l=await c.json();if("needConfirmation"in l)throw Jt(i,"account-exists-with-different-credential",l);if(c.ok&&!("errorMessage"in l))return l;{const u=c.ok?l.errorMessage:l.error.message,[g,_]=u.split(" : ");if(g==="FEDERATED_USER_ID_ALREADY_LINKED")throw Jt(i,"credential-already-in-use",l);if(g==="EMAIL_EXISTS")throw Jt(i,"email-already-in-use",l);if(g==="USER_DISABLED")throw Jt(i,"user-disabled",l);const S=r[g]||g.toLowerCase().replace(/[_\s]+/g,"-");if(_)throw Ws(i,S,_);is(i,S)}}catch(o){if(o instanceof Pe)throw o;is(i,"network-request-failed",{message:String(o)})}}async function js(i,e,n,r){const o=`${e}${n}?${r}`,c=i,l=c.config.emulator?Zc(i.config,o):`${i.config.apiScheme}://${o}`;return tl.includes(n)&&(await c._persistenceManagerAvailable,c._getPersistenceType()==="COOKIE")?c._getPersistence()._getFinalTarget(l).toString():l}class nl{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,r)=>{this.timer=setTimeout(()=>r(Us(this.auth,"network-request-failed")),il.get())})}}function Jt(i,e,n){const r={appName:i.name};n.email&&(r.email=n.email),n.phoneNumber&&(r.phoneNumber=n.phoneNumber);const o=Us(i,e,r);return o.customData._tokenResponse=n,o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function dl(i,e){const n=await Vs(i,{},async()=>{const r=Ss({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:o,apiKey:c}=i.config,l=await js(i,o,"/v1/token",`key=${c}`),u=await i._getAdditionalHeaders();u["Content-Type"]="application/x-www-form-urlencoded";const g={method:"POST",headers:u,body:r};return i.emulatorConfig&&Es(i.emulatorConfig.host)&&(g.credentials="include"),Bs.fetch()(l,g)});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}async function ul(i,e){return pi(i,"POST","/v2/accounts:revokeToken",Fs(i,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _l{constructor(e){this.auth=e,this.queue=[]}pushCallback(e,n){const r=c=>new Promise((l,u)=>{try{const g=e(c);l(g)}catch(g){u(g)}});r.onAbort=n,this.queue.push(r);const o=this.queue.length-1;return()=>{this.queue[o]=()=>Promise.resolve()}}async runMiddleware(e){if(this.auth.currentUser===e)return;const n=[];try{for(const r of this.queue)await r(e),r.onAbort&&n.push(r.onAbort)}catch(r){n.reverse();for(const o of n)try{o()}catch{}throw this.auth._errorFactory.create("login-blocked",{originalMessage:r==null?void 0:r.message})}}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const Pl=5*60;Yo("authIdTokenMaxAge");Ol("Browser");console.warn("⚠️ Firebase未設定。.envファイルにAPIキーを設定してください。");function Dl(i){const e=new Date(i),n=e.getFullYear(),r=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${n}-${r}-${o}`}function Et(i){const e=new Date(i),n=["日","月","火","水","木","金","土"];return`${e.getMonth()+1}月${e.getDate()}日（${n[e.getDay()]}）`}function Ze(){return Dl(new Date)}function us(i){const[e,n]=i.split(":").map(Number);return e*60+n}function Ks(){return Date.now().toString(36)+Math.random().toString(36).slice(2,9)}function Js(i,e,n,r){const c=Xt(n-i),l=Xt(r-e),u=Math.sin(c/2)**2+Math.cos(Xt(i))*Math.cos(Xt(n))*Math.sin(l/2)**2;return 6371*2*Math.atan2(Math.sqrt(u),Math.sqrt(1-u))}function Xt(i){return i*(Math.PI/180)}function he(i){const e=document.createElement("div");return e.textContent=i,e.innerHTML}function R(i,e="info",n=3e3){const r=document.getElementById("toast-container"),o={success:"check_circle",error:"error",warning:"warning",info:"info"},c=document.createElement("div");c.className=`toast ${e}`,c.innerHTML=`
  ...
  `}function so(i=null){var c,l;const e=!!i,n=[...ci.physical.options,...ci.special.options],r=`
    <form id="client-form">
      ...
      <div class="form-group">
        ...
        <div class="tags-container" style="gap:8px">
          ${no.map(u=>{var g;return`<label style="display:flex;align-items:center;gap:4px;cursor:pointer;font-size:.85rem">
  ...
  `,document.getElementById("schedule-date").addEventListener("change",e=>{Xe=e.target.value,ui()}),document.getElementById("btn-add-visit").addEventListener("click",ad),await ui()}async function ui(){const i=document.getElementById("schedule-content"),[e,n,r]=await Promise.all([ge().catch(()=>[]),De().catch(()=>[]),Rt(Xe).catch(()=>[])]);if(r.length===0){i.innerHTML=`
    ...
    `;return}const o={};let c=0,l=0,u=0;for(const _ of r)o[_.staffId]||(o[_.staffId]=[]),o[_.staffId].push(_);let g="";if(window.isAdmin){for(const[b,E]of Object.entries(o)){const P=e.find(A=>A.id===b);if(!P)continue;const O=parseInt(P.wage)||1500;E.sort((A,D)=>(A.startTime||A.scheduledTime||"").localeCompare(D.startTime||D.scheduledTime||""));let L=null;E.forEach((A,D)=>{c+=parseInt(A.income)||3e3;const B=(A.duration||60)/60;l+=O*B;const j=n.find(v=>v.id===A.clientId),N=j?j.area:null;let K=0,q=0;D===0?K=4:L&&N&&L!==N?(K=8,q=20):(K=4,q=10),A.calculatedTravelTime=q,u+=K*25,L=N}),u+=4*25}const _=c-l-u,S=c>0?Math.round(_/c*100):0;g=`
      ...
      ${Object.entries(o).map(([_,S])=>{const b=e.find(E=>E.id===_);return`
          <div class="card" style="border-left:4px solid ${(b==null?void 0:b.color)||"#999"}">
            ...
            <div class="schedule-timeline">
              ${S.map((E,P)=>{const O=n.find(B=>B.id===E.clientId),L=E.startTime||E.scheduledTime||"--:--";let A="",D="";if(P>0){const B=S[P-1],j=B.startTime||B.scheduledTime,N=E.calculatedTravelTime||10;if(j&&L!=="--:--"){const[K,q]=j.split(":").map(Number),[v,h]=L.split(":").map(Number),m=K*60+q+(B.duration||60),p=v*60+h-m;p<N&&(D=`
  ...
  `),document.getElementById("vf-cancel").onclick=Oe,document.getElementById("vf-save").onclick=async()=>{const r=document.getElementById("vf-client").value,o=document.getElementById("vf-staff").value;if(!r||!o){R("利用者と職員を選択してください","warning");return}try{await Zs({date:Xe,clientId:r,staffId:o,scheduledTime:document.getElementById("vf-time").value,duration:parseInt(document.getElementById("vf-duration").value)||60,service:document.getElementById("vf-service").value,status:"scheduled"}),R("訪問予定を追加しました","success"),Oe(),await ui()}catch{R("追加に失敗しました","error")}}}document.addEventListener("click",async i=>{const e=i.target.closest("[data-delete-visit]");if(e&&await bn("削除確認","この訪問予定を削除しますか？"))try{await Fl(e.dataset.deleteVisit),R("訪問予定を削除しました","success"),await ui()}catch{R("削除に失敗しました","error")}});function cd(i,e){var l,u,g,_,S;let n=0;const r=[];let o=!0;for(const b of e.requiredServices||[])(u=(l=i.skills)==null?void 0:l.services)!=null&&u.includes(b)?(n+=vt.requiredSkill,r.push(`✅ ${b}対応可`)):(o=!1,r.push(`❌ ${b}に対応不可`));const c=[...((g=i.skills)==null?void 0:g.qualifications)||[],...((_=i.skills)==null?void 0:_.physical)||[],...((S=i.skills)==null?void 0:S.special)||[]];for(const b of e.requiredSkills||[])c.includes(b)?(n+=vt.requiredSkill,r.push(`✅ ${b}あり`)):(o=!1,r.push(`❌ ${b}なし`));if(e.genderPreference&&e.genderPreference!=="指定なし"){const b=e.genderPreference.replace("希望","");i.gender===b?(n+=vt.genderMatch,r.push(`✅ 性別希望合致（${b}）`)):(o=!1,r.push(`❌ 性別希望不一致（希望: ${b}）`))}if(i.type==="正社員"&&(n+=vt.staffType,r.push("✅ 正社員")),i.lat&&e.lat){const b=Js(i.lat,i.lng,e.lat,e.lng),E=Math.max(0,vt.proximity*(1-b/10));n+=E}return{score:Math.round(n),reasons:r,eligible:o}}function ld(i,e){const n=[],r=new Set,o={};for(const l of e){const u=i.filter(b=>b.isActive).map(b=>{const{score:E,eligible:P}=cd(b,l);let O=!0;const L=n.filter(A=>A.staffId===b.id);if(L.length>0){const A=us(l.startTime),D=A+(l.duration||60);for(const B of L){const j=us(B.startTime),N=j+(B.duration||60);if(A<N&&D>j){O=!1;break}const q=15;if(Math.abs(A-N)<q||Math.abs(j-D)<q){O=!1;break}}}return{staff:b,score:E,eligible:P&&O}}).filter(b=>b.eligible);if(u.length===0)continue;u.sort((b,E)=>{const P=o[b.staff.id]||0,O=o[E.staff.id]||0,L=b.staff.type==="パート"?5:10,A=E.staff.type==="パート"?5:10,D=P>=L,B=O>=A;return D!==B?D?1:-1:P!==O?P-O:b.staff.type!==E.staff.type?b.staff.type==="正社員"?-1:1:E.score-b.score});const g=u[0],_=o[g.staff.id]||0,S=g.staff.type==="パート"?5:10;_<S&&(n.push({staffId:g.staff.id,staffName:g.staff.name,visitId:l.id,clientId:l.clientId,clientName:l.clientName||"利用者",score:g.score,startTime:l.startTime,endTime:l.endTime}),r.add(l.id),o[g.staff.id]=_+1)}const c=e.filter(l=>!r.has(l.id)).map(l=>({visitId:l.id,clientName:l.clientName||"利用者",reason:"適格な職員なし、または上限超過"}));return{assignments:n,unassigned:c}}async function dd(i,e,n,r=ne,o=null){const c={};for(const u of i)c[u.staffId]||(c[u.staffId]=[]),c[u.staffId].push(u.clientId);const l={};for(const[u,g]of Object.entries(c)){const _=e.find(D=>D.id===u),S=g.map(D=>n.find(B=>B.id===D)).filter(Boolean);if(S.length===0)continue;const b=[{id:"office",name:"事業所",lat:r.lat,lng:r.lng,isOffice:!0},...S.map(D=>({id:D.id,name:D.name,lat:D.lat,lng:D.lng,duration:D.visitDuration,timeWindow:D.timeWindow}))];let E=null;typeof o=="function"&&(E=await o(b));const P=ud(b,E);let O=hd(b,P);O=fd(O,P);const L=md(O,P),A=pd(O,P,_,E);l[u]={staffId:u,staffName:(_==null?void 0:_.name)||"不明",staffColor:(_==null?void 0:_.color)||"#999",route:O,totalDistance:Math.round(L*10)/10,totalDuration:gd(A),schedule:A}}return l}function ud(i,e=null){const n=i.length,r=Array.from({length:n},()=>Array(n).fill(0));for(let o=0;o<n;o++)for(let c=0;c<n;c++)o!==c&&(e&&e[o]&&e[o][c]&&e[o][c].distance!==null?r[o][c]=e[o][c].distance:r[o][c]=Js(i[o].lat,i[o].lng,i[c].lat,i[c].lng));return r}function hd(i,e){const n=i.length,r=new Set([0]),o=[0],c=[],l=[];for(let _=1;_<n;_++){const S=i[_];S.timeWindow&&S.timeWindow.start?c.push({index:_,start:fn(S.timeWindow.start),end:fn(S.timeWindow.end)}):l.push(_)}c.sort((_,S)=>_.start-S.start);const u=[...c.map(_=>_.index),...l];let g=0;for(;r.size<n;){let _=-1,S=1/0;for(const b of u)r.has(b)||e[g][b]<S&&(S=e[g][b],_=b);if(_===-1)break;o.push(_),r.add(_),g=_}return o.push(0),o}function fd(i,e){const n=i.length;let r=!0,o=[...i];for(;r;){r=!1;for(let c=1;c<n-2;c++)for(let l=c+1;l<n-1;l++){const u=e[o[c-1]][o[c]]+e[o[l]][o[l+1]];if(e[o[c-1]][o[l]]+e[o[c]][o[l+1]]<u-.001){const _=[...o];let S=c,b=l;for(;S<b;)[_[S],_[b]]=[_[b],_[S]],S++,b--;o=_,r=!0}}}return o}function md(i,e){let n=0;for(let r=0;r<i.length-1;r++)n+=e[i[r]][i[r+1]];return n}function pd(i,e,n,r=null){const o=[];let l=fn((n==null?void 0:n.workStart)||"08:30");for(let u=0;u<i.length;u++){if(u>0){let g;const _=i[u-1],S=i[u];r&&r[_]&&r[_][S]&&r[_][S].duration!==null?g=r[_][S].duration:g=e[_][S]/20*60,l+=Math.ceil(g)}o.push({pointIndex:i[u],arrivalTime:vd(l),arrivalMinutes:l}),u>0&&u<i.length-1&&(l+=60)}return o}function gd(i){if(i.length<2)return 0;const e=i[0].arrivalMinutes;return i[i.length-1].arrivalMinutes-e}function fn(i){if(!i)return 0;const[e,n]=i.split(":").map(Number);return e*60+n}function vd(i){const e=Math.floor(i/60),n=i%60;return`${String(e).padStart(2,"0")}:${String(n).padStart(2,"0")}`}let mn=null,yd=null,Pt=Ze();async function _d(){const i=document.getElementById("page-container");i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
        <span class="material-icons-round">auto_fix_high</span>
        マッチング＆ルート最適化
      ...
      ${Object.entries(c).map(([l,u])=>{var _,S,b;const g=o[l];return`
          <div class="card" style="border-left:4px solid ${((_=u.staff)==null?void 0:_.color)||"#999"}">
            ...
            <div style="display:flex;flex-direction:column;gap:6px">
              ...
              ${((g==null?void 0:g.schedule)||[]).filter(E=>E.pointIndex!==0||g.schedule.indexOf(E)===g.schedule.length-1).map((E,P,O)=>{var L,A,D,B;return E.pointIndex===0&&P===O.length-1?`<div style="font-size:.8rem;color:var(--text-muted);display:flex;align-items:center;gap:4px">
                      <span class="material-icons-round" style="font-size:16px;color:var(--secondary)">business</span>
                      ${E.arrivalTime} 事業所帰着
                    </div>`:(u.clients.find(j=>(g.route[g.schedule.indexOf(E)],!0)),`<div class="visit-card">
                    <div style="display:flex;justify-content:space-between;align-items:center">
                      ...
                      <span class="tag">${((B=(D=u.clients[P])==null?void 0:D.client)==null?void 0:B.visitDuration)||60}分</span>
                    </div>
                  </div>`)}).join("")}
            </div>
          </div>
  ...
  `}async function wd(i,e){try{const n=Object.entries(e).map(([o,c])=>({staffId:o,date:Ze(),clientIds:c.route.slice(1,-1).map(l=>{var u;return(u=c.schedule[l])==null?void 0:u.clientId}).filter(Boolean),totalDistance:c.totalDistance,totalDuration:c.totalDuration,schedule:c.schedule})),r=Object.entries(e).map(([o,c])=>{const l=mn.filter(u=>u.staffId===o).map(u=>u.clientId);return{staffId:o,date:Pt,clientIds:l,totalDistance:c.totalDistance,totalDuration:c.totalDuration}});for(const o of mn)o.visitId&&await Bl(o.visitId,{staffId:o.staffId,staffName:o.staffName});await Vl(r),R("スケジュールとルートを保存しました！","success")}catch(n){R("保存に失敗しました: "+n.message,"error")}}let bt=Ze();async function bd(){var e,n;const i=document.getElementById("page-container");if(!window.isAdmin){i.innerHTML=`
      <div class="empty-state">
  ...
  `,await en(),(e=document.getElementById("revenue-date-picker"))==null||e.addEventListener("change",r=>{bt=r.target.value,en()}),(n=document.getElementById("btn-refresh-revenue"))==null||n.addEventListener("click",()=>{en()})}async function en(){const i=document.getElementById("revenue-content");if(!i)return;const[e,n,r,o]=await Promise.all([ge(),De(),Rt(bt),eo(bt)]);if(r.length===0){i.innerHTML=`
    ...
    `;return}let c=0,l=0,u=0,g=r.length;r.filter(E=>E.status==="completed").length;const _=e.map(E=>{const P=o.filter(N=>N.staffId===E.id),O=r.filter(N=>N.staffId===E.id);let L=0,A=0,D=0,B=0,j=0;return O.forEach(N=>{L+=N.income||0}),P.forEach(N=>{if(B+=N.totalDistance||0,D+=(N.totalDistance||0)*Zi,N.schedule&&N.schedule.length>=2){const K=N.schedule[0].arrivalMinutes;j=N.schedule[N.schedule.length-1].arrivalMinutes-K,A=j/60*(E.wage||2e3)}}),{...E,count:O.length,revenue:L,laborCost:A,vehicleCost:D,profit:L-A-D,workMinutes:j}}).filter(E=>E.count>0||E.revenue>0).sort((E,P)=>P.profit-E.profit);_.forEach(E=>{c+=E.revenue,l+=E.laborCost,u+=E.vehicleCost});const S=c-l-u,b=c>0?S/c*100:0;i.innerHTML=`
    <!-- メインKPI -->
    <div class="grid grid-4" style="margin-bottom:24px">
  ...
  `}const Sd={dashboard:{render:jl,title:"ダッシュボード"},map:{render:td,title:"マップビュー"},staff:{render:On,title:"職員管理"},client:{render:Pn,title:"利用者管理"},schedule:{render:od,title:"スケジュール"},matching:{render:_d,title:"マッチング＆最適化"},revenue:{render:bd,title:"収支シミュレーション"}};function Ed(){var e,n,r;document.querySelectorAll(".nav-item").forEach(o=>{o.addEventListener("click",()=>{const c=o.dataset.page;c&&hi(c)})}),(e=document.getElementById("btn-sidebar-toggle"))==null||e.addEventListener("click",()=>{document.getElementById("sidebar").classList.toggle("collapsed")}),(n=document.getElementById("btn-modal-close"))==null||n.addEventListener("click",()=>{document.getElementById("modal-overlay").style.display="none"}),(r=document.getElementById("modal-overlay"))==null||r.addEventListener("click",o=>{o.target===o.currentTarget&&(o.currentTarget.style.display="none")})}async function hi(i){const e=Sd[i];if(!e)return;document.querySelectorAll(".nav-item").forEach(r=>{r.classList.toggle("active",r.dataset.page===i)}),document.title=`${e.title} - CareRoute`;const n=document.getElementById("page-container");n.innerHTML='<div class="loading"><div class="spinner"></div></div>';try{await e.render()}catch(r){console.error(`ページ「${e.title}」の表示エラー:`,r),n.innerHTML=`
      <div class="empty-state">
...
既存データには影響しません。`))){e&&(e.innerHTML=`
    ...
    `);try{const n=await ge(),r=await De();if(n.length>0||r.length>0){if(!i&&!confirm("既存のデータを全て削除し、新しいエクセルデータを投入しますか？")){e&&(e.innerHTML=`
            <span class="material-icons-round" style="color:var(--secondary)">science</span>
            <span class="nav-label">デモデータ投入</span>
          `);return}typeof hs=="function"?await hs():(localStorage.removeItem("careroute_staff"),localStorage.removeItem("careroute_clients"),localStorage.removeItem("careroute_visits"))}for(const u of gs)await Ys(u);R(`職員 ${gs.length}名 を登録しました`,"success");for(const u of vs)await Qs(u);R(`利用者 ${vs.length}名 を登録しました`,"success");const o=new Date,c=o.getDay(),l={日:0,月:1,火:2,水:3,木:4,金:5,土:6};for(const u of ys){let g=new Date(o);if(u.dayOfWeek&&l[u.dayOfWeek]!==void 0){const P=l[u.dayOfWeek]-c;g.setDate(o.getDate()+P)}const _=g.getFullYear(),S=String(g.getMonth()+1).padStart(2,"0"),b=String(g.getDate()).padStart(2,"0"),E=`${_}-${S}-${b}`;await Zs({...u,date:E,status:"scheduled"})}R(`予定 ${ys.length}件 を登録しました`,"success"),await hi("dashboard"),e.innerHTML=`
