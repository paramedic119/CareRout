 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wl(i){ft(new ht("platform-logger",e=>new Ya(e),"PRIVATE")),ft(new ht("heartbeat",e=>new Nl(e),"PRIVATE")),Pe(On,sr,i),Pe(On,sr,"esm2020"),Pe("fire-js","")}Wl("");var Ul="firebase",Fl="12.12.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Je{constructor(e){this.binaryString=e}static fromBase64String(e){const n=function(o){try{return atob(o)}catch(l){throw typeof DOMException<"u"&&l instanceof DOMException?new sc("Invalid base64 string: "+l):l}}(e);return new Je(n)}static fromUint8Array(e){const n=function(o){let l="";for(let c=0;c<o.length;++c)l+=String.fromCharCode(o[c]);return l}(e);return new Je(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(n){return btoa(n)}(this.binaryString)}toUint8Array(){return function(n){const s=new Uint8Array(n.length);for(let o=0;o<n.length;o++)s[o]=n.charCodeAt(o);return s}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return Ce(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}Je.EMPTY_BYTE_STRING=new Je("");const pr="(default)";class Ti{constructor(e,n){this.projectId=e,this.database=n||pr}static empty(){return new Ti("","")}get isDefaultDatabase(){return this.database===pr}isEqual(e){return e instanceof Ti&&e.projectId===this.projectId&&e.database===this.database}}function rc(i,e){if(!Object.prototype.hasOwnProperty.apply(i.options,["projectId"]))throw new V(j.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Ti(i.options.projectId,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _e{constructor(e){this._byteString=e}static fromBase64String(e){try{return new _e(Je.fromBase64String(e))}catch(n){throw new V(j.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+n)}}static fromUint8Array(e){return new _e(Je.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}toJSON(){return{type:_e._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(e){if(Zt(e,_e._jsonSchema))return _e.fromBase64String(e.bytes)}}_e._jsonSchemaVersion="firestore/bytes/1.0",_e._jsonSchema={type:J("string",_e._jsonSchemaVersion),bytes:J("string")};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wi=new Un("@firebase/auth");function bc(i,...e){wi.logLevel<=q.WARN&&wi.warn(`Auth (${Ci}): ${i}`,...e)}function vi(i,...e){wi.logLevel<=q.ERROR&&wi.error(`Auth (${Ci}): ${i}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tn(i,e,n){return`firebase:${i}:${e}:${n}`}class dt{constructor(e,n,s){this.persistence=e,this.auth=n,this.userKey=s;const{config:o,name:l}=this.auth;this.fullUserKey=Tn(this.userKey,o.apiKey,l),this.fullPersistenceKey=Tn("persistence",o.apiKey,l),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const n=await Si(this.auth,{idToken:e}).catch(()=>{});return n?ve._fromGetAccountInfoResponse(this.auth,n,e):null}return ve._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,s="authUser"){if(!n.length)return new dt(qe(Lr),e,s);const o=(await Promise.all(n.map(async g=>{if(await g._isAvailable())return g}))).filter(g=>g);let l=o[0]||qe(Lr);const c=Tn(s,e.config.apiKey,e.name);let u=null;for(const g of n)try{const E=await g._get(c);if(E){let w;if(typeof E=="string"){const b=await Si(e,{idToken:E}).catch(()=>{});if(!b)break;w=await ve._fromGetAccountInfoResponse(e,b,E)}else w=ve._fromJSON(e,E);g!==l&&(u=w),l=g;break}}catch{}const m=o.filter(g=>g._shouldAllowMigration);return!l._shouldAllowMigration||!m.length?new dt(l,e,s):(l=m[0],u&&await l._set(c,u.toJSON()),await Promise.all(n.map(async g=>{if(g!==l)try{await g._remove(c)}catch{}})),new dt(l,e,s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pr(i){const e=i.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Fc(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Bc(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Vc(e))return"Blackberry";if(qc(e))return"Webos";if(Wc(e))return"Safari";if((e.includes("chrome/")||Uc(e))&&!e.includes("edge/"))return"Chrome";if(jc(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=i.match(n);if((s==null?void 0:s.length)===2)return s[1]}return"Other"}function Bc(i=ye()){return/firefox\//i.test(i)}function Wc(i=ye()){const e=i.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Uc(i=ye()){return/crios\//i.test(i)}function Fc(i=ye()){return/iemobile/i.test(i)}function jc(i=ye()){return/android/i.test(i)}function Vc(i=ye()){return/blackberry/i.test(i)}function qc(i=ye()){return/webos/i.test(i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const td=5*60;wa("authIdTokenMaxAge");ed("Browser");console.warn("⚠️ Firebase未設定。.envファイルにAPIキーを設定してください。");function zt(i){const e=new Date(i),n=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${n}-${s}-${o}`}function mt(i){const e=new Date(i),n=["日","月","火","水","木","金","土"];return`${e.getMonth()+1}月${e.getDate()}日（${n[e.getDay()]}）`}function Ye(){return zt(new Date)}function Ht(i){const e=Math.floor(i/60),n=i%60;return`${String(e).padStart(2,"0")}:${String(n).padStart(2,"0")}`}function K(i){if(!i)return 0;const[e,n]=i.split(":").map(Number);return e*60+n}function bo(){return Date.now().toString(36)+Math.random().toString(36).slice(2,9)}function To(i,e,n,s){const l=mi(n-i),c=mi(s-e),u=Math.sin(l/2)**2+Math.cos(mi(i))*Math.cos(mi(n))*Math.sin(c/2)**2;return 6371*2*Math.atan2(Math.sqrt(u),Math.sqrt(1-u))}function mi(i){return i*(Math.PI/180)}function Z(i){const e=document.createElement("div");return e.textContent=i,e.innerHTML}function N(i,e="info",n=3e3){const s=document.getElementById("toast-container"),o={success:"check_circle",error:"error",warning:"warning",info:"info"},l=document.createElement("div");l.className=`toast ${e}`,l.innerHTML=`
  ...
  `,s.appendChild(l),setTimeout(()=>{l.style.opacity="0",l.style.transform="translateX(40px)",l.style.transition="all .3s ease",setTimeout(()=>l.remove(),300)},n)}function vt(i,e,n=""){const s=document.getElementById("modal-overlay");document.getElementById("modal-title").textContent=i,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=n,s.style.display="flex"}function se(){document.getElementById("modal-overlay").style.display="none"}function yt(i,e){return new Promise(n=>{const s=`<p>${Z(e)}</p>`;vt(i,s,`
    ...
    `),document.getElementById("confirm-ok").onclick=()=>{se(),n(!0)},document.getElementById("confirm-cancel").onclick=()=>{se(),n(!1)}})}function wo(i,e){if(!i)return 0;let n=1500;return i.type==="正社員"?i.name.includes("前川")?n=2500:n=1500:i.type==="パート"&&(n=parseInt(i.wage)||1500),Math.round(n*(e/60))}function Cn(i,e){const s={身体介護:{20:1670,30:2500,60:3960,90:5790,120:7630},生活援助:{20:1830,45:2250,60:2870},通院等乗降介助:{per_trip:990},医療的ケア:{30:3e3,60:5e3}}[i];if(!s)return 3e3;if(s.per_trip)return s.per_trip;const o=Object.keys(s).map(Number).sort((c,u)=>c-u);let l=o[0];for(const c of o)e>=c&&(l=c);return s[l]||3e3}function id(i){{console.warn("Firebase未設定のためログイン画面を表示します"),setTimeout(()=>i(null,null),100);return}}async function nd(){throw new Error("Firebase未設定です。.envにAPIキーを設定してください。")}async function sd(){}function rd(){const i=document.getElementById("btn-google-login");i&&i.addEventListener("click",async()=>{i.disabled=!0,i.textContent="ログイン中...";try{await nd()}catch(e){console.error("ログインエラー:",e),e.code==="auth/popup-closed-by-user"?N("ログインがキャンセルされました","warning"):N("ログインに失敗しました","error"),i.disabled=!1,i.innerHTML=`
        ...
        Googleアカウントでログイン
      `}})}const Oe={};function _t(i){if(!Oe[i]){const e=localStorage.getItem(`careroute_${i}`);Oe[i]=e?JSON.parse(e):[]}return Oe[i]}function Ri(i){localStorage.setItem(`careroute_${i}`,JSON.stringify(Oe[i]||[]))}async function Rr(){localStorage.removeItem("careroute_staff"),localStorage.removeItem("careroute_clients"),localStorage.removeItem("careroute_visits"),localStorage.removeItem("careroute_routes"),Oe.staff=[],Oe.clients=[],Oe.visits=[],Oe.routes=[]}async function Kn(i,e){{const n=bo();return _t(i).push({id:n,...e,createdAt:new Date().toISOString()}),Ri(i),n}}async function Jn(i){return _t(i)}async function Xn(i,e,n){{const s=_t(i),o=s.findIndex(l=>l.id===e);o!==-1&&(s[o]={...s[o],...n,updatedAt:new Date().toISOString()},Ri(i));return}}async function Yn(i,e){{const n=_t(i),s=n.findIndex(o=>o.id===e);s!==-1&&(n.splice(s,1),Ri(i));return}}async function Eo(i,e,n,s){return _t(i).filter(l=>l[e]===s)}async function ae(){return Jn("staff")}async function So(i){return Kn("staff",i)}async function od(i,e){return Xn("staff",i,e)}async function ad(i){return Yn("staff",i)}async function ue(){return Jn("clients")}async function ko(i){return Kn("clients",i)}async function ld(i,e){return Xn("clients",i,e)}async function cd(i){return Yn("clients",i)}async function $i(){return Jn("visits")}async function Qe(i){return Eo("visits","date","==",i)}async function Bi(i){return Kn("visits",i)}async function pt(i,e){return Xn("visits",i,e)}async function Qn(i){return Yn("visits",i)}async function Zn(i){return Eo("routes","date","==",i)}async function Ao(i){{const e=_t("routes");for(const n of i){const s=e.findIndex(o=>o.staffId===n.staffId&&o.date===n.date);s>=0?e[s]={...n,updatedAt:new Date().toISOString()}:e.push({id:bo(),...n,createdAt:new Date().toISOString()})}Ri("routes");return}}async function dd(){const i=document.getElementById("page-container"),[e,n]=await Promise.all([ae().catch(()=>[]),ue().catch(()=>[])]),s=Ye(),o=await Qe(s).catch(()=>[]),l=e.filter(w=>w.isActive);n.filter(w=>w.isActive);const c=o.filter(w=>w.type!=="sales");c.filter(w=>w.status==="scheduled"||!w.status);const u=c.filter(w=>w.status==="completed"),m=c.filter(w=>w.status==="cancelled"),g=o.filter(w=>w.type==="sales"),E={};m.forEach(w=>{const b=w.cancelReason||"理由なし";E[b]=(E[b]||0)+1}),i.innerHTML=`
  ...
  `}let oe=null,Gt=[],Mn=[],Kt=null,Nn=null,Rn=[];function Xe(){return new Promise((i,e)=>{if(window.google&&window.google.maps){i();return}const n="AIzaSyCXFNBQjeiYpRYFdbs6VhISqlFZhrybM74",s=document.createElement("script");s.src=`https://maps.googleapis.com/maps/api/js?key=${n}&libraries=geometry,places&language=ja`,s.async=!0,s.defer=!0,s.onload=i,s.onerror=()=>e(new Error("Google Maps APIの読み込みに失敗しました")),document.head.appendChild(s)})}function ud(i,e={lat:35.6938,lng:139.7034},n=14){const s=document.getElementById(i);return s?!window.google||!window.google.maps?(s.innerHTML=`
  ...
  `}async function Dd(){const[i,e]=await Promise.all([ae().catch(()=>[]),ue().catch(()=>[])]),n=`
    <form id="visit-form">
      <div class="form-group">
  ...
  `),document.getElementById("manual-cancel").onclick=()=>{se()},document.getElementById("manual-ok").onclick=async()=>{const c=document.getElementById("manual-staff-select").value,u=document.getElementById("manual-time-input").value;se(),await zd(i,c,u)}}async function zd(i,e,n){const s=at.findIndex(E=>E.visitId===i);if(s===-1)return;const l=at[s].visit,c=Pi.find(E=>E.id===e),u=l.duration||60,m=K(n)+u;Ge.push({staffId:c.id,staffName:c.name,visitId:l.id,clientId:l.clientId,clientName:l.clientName||"利用者",score:9999,startTime:n,endTime:Ht(m),scheduledTime:n,duration:u}),at.splice(s,1);const g=document.getElementById("optimization-results");g.innerHTML='<div style="text-align:center;padding:32px;"><span class="material-icons-round" style="animation:spin 1s linear infinite">sync</span> ルート再計算中...</div>';try{Li=await is(Ge,Pi,Bn,Q,async w=>{try{return await Xe(),await Ai(w)}catch{return null}}),g.innerHTML=No(ns,Bn,Ge,at,Li),Ro(),N(`${c.name}さんに手動割り当てし、ルートを再計算しました`,"success")}catch(E){N("ルート再計算に失敗しました","error"),console.error(E)}}let Vt=Ye();async function Hd(){var e,n;const i=document.getElementById("page-container");if(!window.isAdmin){i.innerHTML=`
      <div class="empty-state">
  ...
  `}async function Gd(){const i=document.getElementById("page-container"),e=Ye();i.innerHTML=`
  ...
  `,document.getElementById("btn-add-sales").addEventListener("click",Jd),await Wi(e)}async function Wi(i){try{const e=await Qe(i),n="staff_1",s=e.filter(g=>g.staffId===n);s.sort((g,E)=>(g.scheduledTime||g.startTime||"").localeCompare(E.scheduledTime||E.startTime||""));const o=document.getElementById("my-schedule-list"),l=s.length,c=s.filter(g=>g.status==="completed").length,u=s.filter(g=>g.status==="cancelled").length;if(document.getElementById("my-schedule-summary").innerHTML=`
    ...
    `,o.innerHTML=m,document.querySelectorAll(".btn-complete-visit").forEach(g=>{g.addEventListener("click",async E=>{const w=E.currentTarget.dataset.id;if(confirm("この訪問を「完了」にしてよろしいですか？"))try{await pt(w,{status:"completed"}),N("訪問を完了しました","success"),Wi(i)}catch{N("更新に失敗しました","error")}})}),document.querySelectorAll(".btn-cancel-visit").forEach(g=>{g.addEventListener("click",E=>{const w=E.currentTarget.dataset.id;Kd(w,i)})})}catch(e){console.error("マイスケジュール取得エラー:",e),document.getElementById("my-schedule-list").innerHTML=`
  ...
  `,e.style.display="flex",document.getElementById("btn-submit-sales").addEventListener("click",async()=>{const l=document.getElementById("sales-client-name").value.trim();if(!l){N("訪問先名を入力してください","warning");return}const c=document.getElementById("sales-target-select").value,u=document.getElementById("sales-start-time").value,m=parseInt(document.getElementById("sales-duration").value,10);try{await Bi({staffId:"staff_1",staffName:"佐藤 看護師",clientId:"sales_"+Date.now(),clientName:l,date:i,startTime:u,scheduledTime:u,duration:m,type:"sales",salesTarget:c,status:"scheduled"}),N("営業予定を追加しました","success"),e.style.display="none",Wi(i)}catch(g){console.error(g),N("追加に失敗しました","error")}})}const Xd={calendar:{render:gt,title:"全体スケジュール"},schedule:{render:Od,title:"日別スケジュール確認"},map:{render:Ed,title:"日別ルートマップ"},dashboard:{render:dd,title:"ダッシュボード"},staff:{render:es,title:"職員管理"},client:{render:ts,title:"利用者管理"},matching:{render:Mo,title:"特定日の手動調整"},revenue:{render:Hd,title:"収支シミュレーション"},"my-schedule":{render:Gd,title:"マイスケジュール"}};function Yd(){var o,l,c,u;document.querySelectorAll(".nav-item").forEach(m=>{m.addEventListener("click",()=>{const g=m.dataset.page;g&&ut(g)})}),(o=document.getElementById("btn-sidebar-toggle"))==null||o.addEventListener("click",()=>{document.getElementById("sidebar").classList.toggle("collapsed")});const e=document.getElementById("sidebar"),n=document.getElementById("sidebar-overlay"),s=()=>{e.classList.toggle("open"),n.classList.toggle("open")};(l=document.getElementById("btn-mobile-menu"))==null||l.addEventListener("click",s),n==null||n.addEventListener("click",s),(c=document.getElementById("btn-modal-close"))==null||c.addEventListener("click",()=>{document.getElementById("modal-overlay").style.display="none"}),(u=document.getElementById("modal-overlay"))==null||u.addEventListener("click",m=>{m.target===m.currentTarget&&(m.currentTarget.style.display="none")})}async function ut(i){var s,o;const e=Xd[i];if(!e)return;if(window.isAdmin===!1&&i!=="my-schedule"){console.warn("アクセス権限がありません:",i);return}document.querySelectorAll(".nav-item").forEach(l=>{l.classList.toggle("active",l.dataset.page===i)}),(s=document.getElementById("sidebar"))==null||s.classList.remove("open"),(o=document.getElementById("sidebar-overlay"))==null||o.classList.remove("open"),document.title=`${e.title} - CareRoute`;const n=document.getElementById("page-container");n.innerHTML='<div class="loading"><div class="spinner"></div></div>';try{await e.render()}catch(l){console.error(`ページ「${e.title}」の表示エラー:`,l),n.innerHTML=`
      <div class="empty-state">
