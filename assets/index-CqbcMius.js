 ...
 */const Es=function(i){const e=[];let n=0;for(let r=0;r<i.length;r++){let o=i.charCodeAt(r);o<128?e[n++]=o:o<2048?(e[n++]=o>>6|192,e[n++]=o&63|128):(o&64512)===55296&&r+1<i.length&&(i.charCodeAt(r+1)&64512)===56320?(o=65536+((o&1023)<<10)+(i.charCodeAt(++r)&1023),e[n++]=o>>18|240,e[n++]=o>>12&63|128,e[n++]=o>>6&63|128,e[n++]=o&63|128):(e[n++]=o>>12|224,e[n++]=o>>6&63|128,e[n++]=o&63|128)}return e},Qo=function(i){const e=[];let n=0,r=0;for(;n<i.length;){const o=i[n++];if(o<128)e[r++]=String.fromCharCode(o);else if(o>191&&o<224){const c=i[n++];e[r++]=String.fromCharCode((o&31)<<6|c&63)}else if(o>239&&o<365){const c=i[n++],l=i[n++],u=i[n++],p=((o&7)<<18|(c&63)<<12|(l&63)<<6|u&63)-65536;e[r++]=String.fromCharCode(55296+(p>>10)),e[r++]=String.fromCharCode(56320+(p&1023))}else{const c=i[n++],l=i[n++];e[r++]=String.fromCharCode((o&15)<<12|(c&63)<<6|l&63)}}return e.join("")},ks={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(i,e){if(!Array.isArray(i))throw Error("encodeByteArray takes an array as a parameter");this.init_();const n=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,r=[];for(let o=0;o<i.length;o+=3){const c=i[o],l=o+1<i.length,u=l?i[o+1]:0,p=o+2<i.length,_=p?i[o+2]:0,E=c>>2,S=(c&3)<<4|u>>4;let w=(u&15)<<2|_>>6,k=_&63;p||(k=64,l||(w=64)),r.push(n[E],n[S],n[w],n[k])}return r.join("")},encodeString(i,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(i):this.encodeByteArray(Es(i),e)},decodeString(i,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(i):Qo(this.decodeStringToByteArray(i,e))},decodeStringToByteArray(i,e){this.init_();const n=e?this.charToByteMapWebSafe_:this.charToByteMap_,r=[];for(let o=0;o<i.length;){const c=n[i.charAt(o++)],u=o<i.length?n[i.charAt(o)]:0;++o;const _=o<i.length?n[i.charAt(o)]:64;++o;const S=o<i.length?n[i.charAt(o)]:64;if(++o,c==null||u==null||_==null||S==null)throw new Zo;const w=c<<2|u>>4;if(r.push(w),_!==64){const k=u<<4&240|_>>2;if(r.push(k),S!==64){const D=_<<6&192|S;r.push(D)}}}return r},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let i=0;i<this.ENCODED_VALS.length;i++)this.byteToCharMap_[i]=this.ENCODED_VALS.charAt(i),this.charToByteMap_[this.byteToCharMap_[i]]=i,this.byteToCharMapWebSafe_[i]=this.ENCODED_VALS_WEBSAFE.charAt(i),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[i]]=i,i>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(i)]=i,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(i)]=i)}}};class Zo extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const ea=function(i){const e=Es(i);return ks.encodeByteArray(e,!0)},As=function(i){return ea(i).replace(/\./g,"")},Os=function(i){try{return ks.decodeString(i,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ia=()=>ta().__FIREBASE_DEFAULTS__,na=()=>{if(typeof process>"u"||typeof xr>"u")return;const i=xr.__FIREBASE_DEFAULTS__;if(i)return JSON.parse(i)},ra=()=>{if(typeof document>"u")return;let i;try{i=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=i&&Os(i[1]);return e&&JSON.parse(e)},sa=()=>{try{return Yo()||ia()||na()||ra()}catch(i){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${i}`);return}},oa=i=>{var e;return(e=sa())==null?void 0:e[`_${i}`]};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pe(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function aa(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(pe())}function ca(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function la(){const i=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof i=="object"&&i.id!==void 0}function da(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function ua(){try{return typeof indexedDB=="object"}catch{return!1}}function ha(){return new Promise((i,e)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",o=self.indexedDB.open(r);o.onsuccess=()=>{o.result.close(),n||self.indexedDB.deleteDatabase(r),i(!0)},o.onupgradeneeded=()=>{n=!1},o.onerror=()=>{var c;e(((c=o.error)==null?void 0:c.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fa="FirebaseError";class Le extends Error{constructor(e,n,r){super(n),this.code=e,this.customData=r,this.name=fa,Object.setPrototypeOf(this,Le.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,xt.prototype.create)}}class xt{constructor(e,n,r){this.service=e,this.serviceName=n,this.errors=r}create(e,...n){const r=n[0]||{},o=`${this.service}/${e}`,c=this.errors[e],l=c?ma(c,r):"Error",u=`${this.serviceName}: ${l} (${o}).`;return new Le(o,u,r)}}function ma(i,e){return i.replace(pa,(n,r)=>{const o=e[r];return o!=null?String(o):`<${r}?>`})}const pa=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var j;(function(i){i[i.DEBUG=0]="DEBUG",i[i.VERBOSE=1]="VERBOSE",i[i.INFO=2]="INFO",i[i.WARN=3]="WARN",i[i.ERROR=4]="ERROR",i[i.SILENT=5]="SILENT"})(j||(j={}));const _a={debug:j.DEBUG,verbose:j.VERBOSE,info:j.INFO,warn:j.WARN,error:j.ERROR,silent:j.SILENT},Ia=j.INFO,Ta={[j.DEBUG]:"log",[j.VERBOSE]:"log",[j.INFO]:"info",[j.WARN]:"warn",[j.ERROR]:"error"},wa=(i,e,...n)=>{if(e<i.logLevel)return;const r=new Date().toISOString(),o=Ta[e];if(o)console[o](`[${r}]  ${i.name}:`,...n);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class yn{constructor(e){this.name=e,this._logLevel=Ia,this._logHandler=wa,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in j))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?_a[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,j.DEBUG,...e),this._logHandler(this,j.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,j.VERBOSE,...e),this._logHandler(this,j.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,j.INFO,...e),this._logHandler(this,j.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,j.WARN,...e),this._logHandler(this,j.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,j.ERROR,...e),this._logHandler(this,j.ERROR,...e)}}const ba=(i,e)=>e.some(n=>i instanceof n);let Nr,Rr;function Sa(){return Nr||(Nr=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Ea(){return Rr||(Rr=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Cs=new WeakMap,an=new WeakMap,Ls=new WeakMap,Xi=new WeakMap,_n=new WeakMap;function ka(i){const e=new Promise((n,r)=>{const o=()=>{i.removeEventListener("success",c),i.removeEventListener("error",l)},c=()=>{n(Oe(i.result)),o()},l=()=>{r(i.error),o()};i.addEventListener("success",c),i.addEventListener("error",l)});return e.then(n=>{n instanceof IDBCursor&&Cs.set(n,i)}).catch(()=>{}),_n.set(e,i),e}function Aa(i){if(an.has(i))return;const e=new Promise((n,r)=>{const o=()=>{i.removeEventListener("complete",c),i.removeEventListener("error",l),i.removeEventListener("abort",l)},c=()=>{n(),o()},l=()=>{r(i.error||new DOMException("AbortError","AbortError")),o()};i.addEventListener("complete",c),i.addEventListener("error",l),i.addEventListener("abort",l)});an.set(i,e)}let cn={get(i,e,n){if(i instanceof IDBTransaction){if(e==="done")return an.get(i);if(e==="objectStoreNames")return i.objectStoreNames||Ls.get(i);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return Oe(i[e])},set(i,e,n){return i[e]=n,!0},has(i,e){return i instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in i}};function Oa(i){cn=i(cn)}function Da(i){return i===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...n){const r=i.call(Yi(this),e,...n);return Ls.set(r,e.sort?e.sort():[e]),Oe(r)}:Ea().includes(i)?function(...e){return i.apply(Yi(this),e),Oe(Cs.get(this))}:function(...e){return Oe(i.apply(Yi(this),e))}}function Pa(i){return typeof i=="function"?Da(i):(i instanceof IDBTransaction&&Aa(i),ba(i,Sa())?new Proxy(i,cn):i)}function Oe(i){if(i instanceof IDBRequest)return ka(i);if(Xi.has(i))return Xi.get(i);const e=Pa(i);return e!==i&&(Xi.set(i,e),_n.set(e,i)),e}const Yi=i=>_n.get(i);function Ca(i,e,{blocked:n,upgrade:r,blocking:o,terminated:c}={}){const l=indexedDB.open(i,e),u=Oe(l);return r&&l.addEventListener("upgradeneeded",p=>{r(Oe(l.result),p.oldVersion,p.newVersion,Oe(l.transaction),p)}),n&&l.addEventListener("blocked",p=>n(p.oldVersion,p.newVersion,p)),u.then(p=>{c&&p.addEventListener("close",()=>c()),o&&p.addEventListener("versionchange",_=>o(_.oldVersion,_.newVersion,_))}).catch(()=>{}),u}const La=["get","getKey","getAll","getAllKeys","count"],xa=["put","add","delete","clear"],Qi=new Map;function Mr(i,e){if(!(i instanceof IDBDatabase&&!(e in i)&&typeof e=="string"))return;if(Qi.get(e))return Qi.get(e);const n=e.replace(/FromIndex$/,""),r=e!==n,o=xa.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(o||La.includes(n)))return;const c=async function(l,...u){const p=this.transaction(l,o?"readwrite":"readonly");let _=p.store;return r&&(_=_.index(u.shift())),(await Promise.all([_[n](...u),o&&p.done]))[0]};return Qi.set(e,c),c}Oa(i=>({...i,get:(e,n,r)=>Mr(e,n)||i.get(e,n,r),has:(e,n)=>!!Mr(e,n)||i.has(e,n)}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Na{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Ra(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function Ra(i){const e=i.getComponent();return(e==null?void 0:e.type)==="VERSION"}const ln="@firebase/app",$r="0.14.11";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ye=new yn("@firebase/app"),Ma="@firebase/app-compat",$a="@firebase/analytics-compat",Ba="@firebase/analytics",Wa="@firebase/app-check-compat",Ua="@firebase/app-check",Fa="@firebase/auth",Va="@firebase/auth-compat",ja="@firebase/database",qa="@firebase/data-connect",Ha="@firebase/database-compat",za="@firebase/functions",Ga="@firebase/functions-compat",Ka="@firebase/installations",Ja="@firebase/installations-compat",Xa="@firebase/messaging",Ya="@firebase/messaging-compat",Qa="@firebase/performance",Za="@firebase/performance-compat",ec="@firebase/remote-config",tc="@firebase/remote-config-compat",ic="@firebase/storage",nc="@firebase/storage-compat",rc="@firebase/firestore",sc="@firebase/ai",oc="@firebase/firestore-compat",ac="firebase",cc="12.12.0",lc={[ln]:"fire-core",[Ma]:"fire-core-compat",[Ba]:"fire-analytics",[$a]:"fire-analytics-compat",[Ua]:"fire-app-check",[Wa]:"fire-app-check-compat",[Fa]:"fire-auth",[Va]:"fire-auth-compat",[ja]:"fire-rtdb",[qa]:"fire-data-connect",[Ha]:"fire-rtdb-compat",[za]:"fire-fn",[Ga]:"fire-fn-compat",[Ka]:"fire-iid",[Ja]:"fire-iid-compat",[Xa]:"fire-fcm",[Ya]:"fire-fcm-compat",[Qa]:"fire-perf",[Za]:"fire-perf-compat",[ec]:"fire-rc",[tc]:"fire-rc-compat",[ic]:"fire-gcs",[nc]:"fire-gcs-compat",[rc]:"fire-fst",[oc]:"fire-fst-compat",[sc]:"fire-vertex","fire-js":"fire-js",[ac]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dc=new Map,uc=new Map,Br=new Map;function Wr(i,e){try{i.container.addComponent(e)}catch(n){ye.debug(`Component ${e.name} failed to register with FirebaseApp ${i.name}`,n)}}function tt(i){const e=i.name;if(Br.has(e))return ye.debug(`There were multiple attempts to register component ${e}.`),!1;Br.set(e,i);for(const n of dc.values())Wr(n,i);for(const n of uc.values())Wr(n,i);return!0}function $e(i){return i==null?!1:i.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fc="firebase-heartbeat-database",mc=1,kt="firebase-heartbeat-store";let Zi=null;function xs(){return Zi||(Zi=Ca(fc,mc,{upgrade:(i,e)=>{switch(e){case 0:try{i.createObjectStore(kt)}catch(n){console.warn(n)}}}}).catch(i=>{throw In.create("idb-open",{originalErrorMessage:i.message})})),Zi}async function pc(i){try{const n=(await xs()).transaction(kt),r=await n.objectStore(kt).get(Ns(i));return await n.done,r}catch(e){if(e instanceof Le)ye.warn(e.message);else{const n=In.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});ye.warn(n.message)}}}async function Ur(i,e){try{const r=(await xs()).transaction(kt,"readwrite");await r.objectStore(kt).put(e,Ns(i)),await r.done}catch(n){if(n instanceof Le)ye.warn(n.message);else{const r=In.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});ye.warn(r.message)}}}function Ns(i){return`${i.name}!${i.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gc=1024,vc=30;class yc{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new Ic(n),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){var e,n;try{const o=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),c=Fr();if(((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((n=this._heartbeatsCache)==null?void 0:n.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===c||this._heartbeatsCache.heartbeats.some(l=>l.date===c))return;if(this._heartbeatsCache.heartbeats.push({date:c,agent:o}),this._heartbeatsCache.heartbeats.length>vc){const l=Tc(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(l,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(r){ye.warn(r)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const n=Fr(),{heartbeatsToSend:r,unsentEntries:o}=_c(this._heartbeatsCache.heartbeats),c=As(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=n,o.length>0?(this._heartbeatsCache.heartbeats=o,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),c}catch(n){return ye.warn(n),""}}}function Fr(){return new Date().toISOString().substring(0,10)}function _c(i,e=gc){const n=[];let r=i.slice();for(const o of i){const c=n.find(l=>l.agent===o.agent);if(c){if(c.dates.push(o.date),Vr(n)>e){c.dates.pop();break}}else if(n.push({agent:o.agent,dates:[o.date]}),Vr(n)>e){n.pop();break}r=r.slice(1)}return{heartbeatsToSend:n,unsentEntries:r}}class Ic{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return ua()?ha().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const n=await pc(this.app);return n!=null&&n.heartbeats?n:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const r=await this.read();return Ur(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const r=await this.read();return Ur(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:[...r.heartbeats,...e.heartbeats]})}else return}}function Vr(i){return As(JSON.stringify({version:2,heartbeats:i})).length}function Tc(i){if(i.length===0)return-1;let e=0,n=i[0].date;for(let r=1;r<i.length;r++)i[r].date<n&&(n=i[r].date,e=r);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wc(i){tt(new et("platform-logger",e=>new Na(e),"PRIVATE")),tt(new et("heartbeat",e=>new yc(e),"PRIVATE")),De(ln,$r,i),De(ln,$r,"esm2020"),De("fire-js","")}wc("");var bc="firebase",Sc="12.12.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */De(bc,Sc,"app");var jr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let yi="12.12.0";function Ec(i){yi=i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lc(i){const e=typeof self<"u"&&(self.crypto||self.msCrypto),n=new Uint8Array(i);if(e&&typeof e.getRandomValues=="function")e.getRandomValues(n);else for(let r=0;r<i;r++)n[r]=Math.floor(256*Math.random());return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class He{constructor(e){this.binaryString=e}static fromBase64String(e){const n=function(o){try{return atob(o)}catch(c){throw typeof DOMException<"u"&&c instanceof DOMException?new Fc("Invalid base64 string: "+c):c}}(e);return new He(n)}static fromUint8Array(e){const n=function(o){let c="";for(let l=0;l<o.length;++l)c+=String.fromCharCode(o[l]);return c}(e);return new He(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(n){return btoa(n)}(this.binaryString)}toUint8Array(){return function(n){const r=new Uint8Array(n.length);for(let o=0;o<n.length;o++)r[o]=n.charCodeAt(o);return r}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return Pe(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}He.EMPTY_BYTE_STRING=new He("");const Kr="(default)";class ci{constructor(e,n){this.projectId=e,this.database=n||Kr}static empty(){return new ci("","")}get isDefaultDatabase(){return this.database===Kr}isEqual(e){return e instanceof ci&&e.projectId===this.projectId&&e.database===this.database}}function Vc(i,e){if(!Object.prototype.hasOwnProperty.apply(i.options,["projectId"]))throw new F(U.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ci(i.options.projectId,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jc{constructor(e,n=null,r=[],o=[],c=null,l="F",u=null,p=null){this.path=e,this.collectionGroup=n,this.explicitOrderBy=r,this.filters=o,this.limit=c,this.limitType=l,this.startAt=u,this.endAt=p,this.Ee=null,this.Ie=null,this.Re=null,this.startAt,this.endAt}}function qc(i){return new jc(i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kc(i){const e={};return i.timeoutSeconds!==void 0&&(e.timeoutSeconds=i.timeoutSeconds),e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jc="ComponentProvider",Qr=new Map;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */wt._jsonSchemaVersion="firestore/querySnapshot/1.0",wt._jsonSchema={type:K("string",wt._jsonSchemaVersion),bundleSource:K("string","QuerySnapshot"),bundleName:K("string"),bundle:K("string")};(function(e,n=!0){Ec(vi),tt(new et("firestore",(r,{instanceIdentifier:o,options:c})=>{const l=r.getProvider("app").getImmediate(),u=new Qc(new Oc(r.getProvider("auth-internal")),new Cc(l,r.getProvider("app-check-internal")),Vc(l,o),l);return c={useFetchStreams:n,...c},u._setSettings(c),u},"PUBLIC").setMultipleInstances(!0)),De(rs,ss,e),De(rs,ss,"esm2020")})();function Fs(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const nl=Fs,Vs=new xt("auth","Firebase",Fs());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const li=new yn("@firebase/auth");function rl(i,...e){li.logLevel<=j.WARN&&li.warn(`Auth (${vi}): ${i}`,...e)}function ii(i,...e){li.logLevel<=j.ERROR&&li.error(`Auth (${vi}): ${i}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function os(i,...e){throw En(i,...e)}function js(i,...e){return En(i,...e)}function qs(i,e,n){const r={...nl(),[e]:n};return new xt("auth","Firebase",r).create(e,{appName:i.name})}function ni(i){return qs(i,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function En(i,...e){if(typeof i!="string"){const n=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=i.name),i._errorFactory.create(n,...r)}return Vs.create(i,...e)}function W(i,e,...n){if(!i)throw En(e,...n)}function bt(i){const e="INTERNAL ASSERTION FAILED: "+i;throw ii(e),new Error(e)}function di(i,e){i||bt(e)}function sl(){return as()==="http:"||as()==="https:"}function as(){var i;return typeof self<"u"&&((i=self.location)==null?void 0:i.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ol(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(sl()||la()||"connection"in navigator)?navigator.onLine:!0}function al(){if(typeof navigator>"u")return null;const i=navigator;return i.languages&&i.languages[0]||i.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mt{constructor(e,n){this.shortDelay=e,this.longDelay=n,di(n>e,"Short delay should be less than long delay!"),this.isMobile=aa()||da()}get(){return ol()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cl(i,e){di(i.emulator,"Emulator should always be set here");const{url:n}=i.emulator;return e?`${n}${e.startsWith("/")?e.slice(1):e}`:n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dl=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],ul=new Mt(3e4,6e4);function zs(i,e){return i.tenantId&&!e.tenantId?{...e,tenantId:i.tenantId}:e}async function _i(i,e,n,r,o={}){return Gs(i,o,async()=>{let c={},l={};r&&(e==="GET"?l=r:c={body:JSON.stringify(r)});const u=Ds({key:i.config.apiKey,...l}).slice(1),p=await i._getAdditionalHeaders();p["Content-Type"]="application/json",i.languageCode&&(p["X-Firebase-Locale"]=i.languageCode);const _={method:e,headers:p,...c};return ca()||(_.referrerPolicy="no-referrer"),i.emulatorConfig&&Ps(i.emulatorConfig.host)&&(_.credentials="include"),Hs.fetch()(await Ks(i,i.config.apiHost,n,u),_)})}async function Gs(i,e,n){i._canInitEmulator=!1;const r={...ll,...e};try{const o=new hl(i),c=await Promise.race([n(),o.promise]);o.clearNetworkTimeout();const l=await c.json();if("needConfirmation"in l)throw Qt(i,"account-exists-with-different-credential",l);if(c.ok&&!("errorMessage"in l))return l;{const u=c.ok?l.errorMessage:l.error.message,[p,_]=u.split(" : ");if(p==="FEDERATED_USER_ID_ALREADY_LINKED")throw Qt(i,"credential-already-in-use",l);if(p==="EMAIL_EXISTS")throw Qt(i,"email-already-in-use",l);if(p==="USER_DISABLED")throw Qt(i,"user-disabled",l);const E=r[p]||p.toLowerCase().replace(/[_\s]+/g,"-");if(_)throw qs(i,E,_);os(i,E)}}catch(o){if(o instanceof Le)throw o;os(i,"network-request-failed",{message:String(o)})}}async function Ks(i,e,n,r){const o=`${e}${n}?${r}`,c=i,l=c.config.emulator?cl(i.config,o):`${i.config.apiScheme}://${o}`;return dl.includes(n)&&(await c._persistenceManagerAvailable,c._getPersistenceType()==="COOKIE")?c._getPersistence()._getFinalTarget(l).toString():l}class hl{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,r)=>{this.timer=setTimeout(()=>r(js(this.auth,"network-request-failed")),ul.get())})}}function Qt(i,e,n){const r={appName:i.name};n.email&&(r.email=n.email),n.phoneNumber&&(r.phoneNumber=n.phoneNumber);const o=js(i,e,r);return o.customData._tokenResponse=n,o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function fl(i,e){return _i(i,"POST","/v1/accounts:delete",e)}async function ui(i,e){return _i(i,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function St(i){if(i)try{const e=new Date(Number(i));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function ml(i,e=!1){const n=Nt(i),r=await n.getIdToken(e),o=Js(r);W(o&&o.exp&&o.auth_time&&o.iat,n.auth,"internal-error");const c=typeof o.firebase=="object"?o.firebase:void 0,l=c==null?void 0:c.sign_in_provider;return{claims:o,token:r,authTime:St(nn(o.auth_time)),issuedAtTime:St(nn(o.iat)),expirationTime:St(nn(o.exp)),signInProvider:l||null,signInSecondFactor:(c==null?void 0:c.sign_in_second_factor)||null}}function nn(i){return Number(i)*1e3}function Js(i){const[e,n,r]=i.split(".");if(e===void 0||n===void 0||r===void 0)return ii("JWT malformed, contained fewer than 3 sections"),null;try{const o=Os(n);return o?JSON.parse(o):(ii("Failed to decode base64 JWT payload"),null)}catch(o){return ii("Caught error parsing JWT payload as JSON",o==null?void 0:o.toString()),null}}function cs(i){const e=Js(i);return W(e,"internal-error"),W(typeof e.exp<"u","internal-error"),W(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function un(i,e,n=!1){if(n)return e;try{return await e}catch(r){throw r instanceof Le&&pl(r)&&i.auth.currentUser===i&&await i.auth.signOut(),r}}function pl({code:i}){return i==="auth/user-disabled"||i==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function us(i){const e=i.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Sl(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Tl(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(kl(e))return"Blackberry";if(Al(e))return"Webos";if(wl(e))return"Safari";if((e.includes("chrome/")||bl(e))&&!e.includes("edge/"))return"Chrome";if(El(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=i.match(n);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function Tl(i=pe()){return/firefox\//i.test(i)}function wl(i=pe()){const e=i.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function bl(i=pe()){return/crios\//i.test(i)}function Sl(i=pe()){return/iemobile/i.test(i)}function El(i=pe()){return/android/i.test(i)}function kl(i=pe()){return/blackberry/i.test(i)}function Al(i=pe()){return/webos/i.test(i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ol{constructor(e){this.auth=e,this.queue=[]}pushCallback(e,n){const r=c=>new Promise((l,u)=>{try{const p=e(c);l(p)}catch(p){u(p)}});r.onAbort=n,this.queue.push(r);const o=this.queue.length-1;return()=>{this.queue[o]=()=>Promise.resolve()}}async runMiddleware(e){if(this.auth.currentUser===e)return;const n=[];try{for(const r of this.queue)await r(e),r.onAbort&&n.push(r.onAbort)}catch(r){n.reverse();for(const o of n)try{o()}catch{}throw this.auth._errorFactory.create("login-blocked",{originalMessage:r==null?void 0:r.message})}}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Dl(i,e={}){return _i(i,"GET","/v2/passwordPolicy",zs(i,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ml(i){switch(i){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function $l(i){tt(new et("auth",(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),o=e.getProvider("heartbeat"),c=e.getProvider("app-check-internal"),{apiKey:l,authDomain:u}=r.options;W(l&&!l.includes(":"),"invalid-api-key",{appName:r.name});const p={apiKey:l,authDomain:u,clientPlatform:i,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Qs(i)},_=new Ll(r,o,c,p);return Nl(_,n),_},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,r)=>{e.getProvider("auth-internal").initialize()})),tt(new et("auth-internal",e=>{const n=xl(e.getProvider("auth").getImmediate());return(r=>new Rl(r))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),De(fs,ms,Ml(i)),De(fs,ms,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const Bl=5*60;oa("authIdTokenMaxAge");$l("Browser");console.warn("⚠️ Firebase未設定。.envファイルにAPIキーを設定してください。");function Zs(i){const e=new Date(i),n=e.getFullYear(),r=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${n}-${r}-${o}`}function At(i){const e=new Date(i),n=["日","月","火","水","木","金","土"];return`${e.getMonth()+1}月${e.getDate()}日（${n[e.getDay()]}）`}function $t(){return Zs(new Date)}function eo(i){const e=Math.floor(i/60),n=i%60;return`${String(e).padStart(2,"0")}:${String(n).padStart(2,"0")}`}function te(i){if(!i)return 0;const[e,n]=i.split(":").map(Number);return e*60+n}function to(){return Date.now().toString(36)+Math.random().toString(36).slice(2,9)}function io(i,e,n,r){const c=Zt(n-i),l=Zt(r-e),u=Math.sin(c/2)**2+Math.cos(Zt(i))*Math.cos(Zt(n))*Math.sin(l/2)**2;return 6371*2*Math.atan2(Math.sqrt(u),Math.sqrt(1-u))}function Zt(i){return i*(Math.PI/180)}function se(i){const e=document.createElement("div");return e.textContent=i,e.innerHTML}function R(i,e="info",n=3e3){const r=document.getElementById("toast-container"),o={success:"check_circle",error:"error",warning:"warning",info:"info"},c=document.createElement("div");c.className=`toast ${e}`,c.innerHTML=`
  ...
  `,r.appendChild(c),setTimeout(()=>{c.style.opacity="0",c.style.transform="translateX(40px)",c.style.transition="all .3s ease",setTimeout(()=>c.remove(),300)},n)}function Ii(i,e,n=""){const r=document.getElementById("modal-overlay");document.getElementById("modal-title").textContent=i,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=n,r.style.display="flex"}function Ce(){document.getElementById("modal-overlay").style.display="none"}function Ti(i,e){return new Promise(n=>{const r=`<p>${se(e)}</p>`;Ii(i,r,`
    ...
    `),document.getElementById("confirm-ok").onclick=()=>{Ce(),n(!0)},document.getElementById("confirm-cancel").onclick=()=>{Ce(),n(!1)}})}function no(i,e){if(!i)return 0;let n=1500;return i.type==="正社員"?i.name.includes("前川")?n=2500:n=1500:i.type==="パート"&&(n=parseInt(i.wage)||1500),Math.round(n*(e/60))}function fn(i,e){const r={身体介護:{20:1670,30:2500,60:3960,90:5790,120:7630},生活援助:{20:1830,45:2250,60:2870},通院等乗降介助:{per_trip:990},医療的ケア:{30:3e3,60:5e3}}[i];if(!r)return 3e3;if(r.per_trip)return r.per_trip;const o=Object.keys(r).map(Number).sort((l,u)=>l-u);let c=o[0];for(const l of o)e>=l&&(c=l);return r[c]||3e3}function Wl(i){{console.warn("Firebase未設定のためログイン画面を表示します"),setTimeout(()=>i(null,null),100);return}}async function Ul(){throw new Error("Firebase未設定です。.envにAPIキーを設定してください。")}async function Fl(){}function Vl(){const i=document.getElementById("btn-google-login");i&&i.addEventListener("click",async()=>{i.disabled=!0,i.textContent="ログイン中...";try{await Ul()}catch(e){console.error("ログインエラー:",e),e.code==="auth/popup-closed-by-user"?R("ログインがキャンセルされました","warning"):R("ログインに失敗しました","error"),i.disabled=!1,i.innerHTML=`
        ...
        Googleアカウントでログイン
      `}})}const Ae={};function it(i){if(!Ae[i]){const e=localStorage.getItem(`careroute_${i}`);Ae[i]=e?JSON.parse(e):[]}return Ae[i]}function wi(i){localStorage.setItem(`careroute_${i}`,JSON.stringify(Ae[i]||[]))}async function ps(){localStorage.removeItem("careroute_staff"),localStorage.removeItem("careroute_clients"),localStorage.removeItem("careroute_visits"),localStorage.removeItem("careroute_routes"),Ae.staff=[],Ae.clients=[],Ae.visits=[],Ae.routes=[]}async function kn(i,e){{const n=to();return it(i).push({id:n,...e,createdAt:new Date().toISOString()}),wi(i),n}}async function An(i){return it(i)}async function On(i,e,n){{const r=it(i),o=r.findIndex(c=>c.id===e);o!==-1&&(r[o]={...r[o],...n,updatedAt:new Date().toISOString()},wi(i));return}}async function Dn(i,e){{const n=it(i),r=n.findIndex(o=>o.id===e);r!==-1&&(n.splice(r,1),wi(i));return}}async function ro(i,e,n,r){return it(i).filter(c=>c[e]===r)}async function ge(){return An("staff")}async function so(i){return kn("staff",i)}async function jl(i,e){return On("staff",i,e)}async function ql(i){return Dn("staff",i)}async function _e(){return An("clients")}async function oo(i){return kn("clients",i)}async function Hl(i,e){return On("clients",i,e)}async function zl(i){return Dn("clients",i)}async function ao(){return An("visits")}async function ze(i){return ro("visits","date","==",i)}async function Pn(i){return kn("visits",i)}async function gs(i,e){return On("visits",i,e)}async function co(i){return Dn("visits",i)}async function Cn(i){return ro("routes","date","==",i)}async function Gl(i){{const e=it("routes");for(const n of i){const r=e.findIndex(o=>o.staffId===n.staffId&&o.date===n.date);r>=0?e[r]={...n,updatedAt:new Date().toISOString()}:e.push({id:to(),...n,createdAt:new Date().toISOString()})}wi("routes");return}}async function Kl(){const i=document.getElementById("page-container"),[e,n]=await Promise.all([ge().catch(()=>[]),_e().catch(()=>[])]),r=$t(),o=await ze(r).catch(()=>[]),c=e.filter(p=>p.isActive),l=n.filter(p=>p.isActive),u=o.filter(p=>p.status!=="cancelled");i.innerHTML=`
  ...
  `}let ne=null,Ot=[],mn=[],Dt=null,pn=null,gn=[];function Pt(){return new Promise((i,e)=>{if(window.google&&window.google.maps){i();return}const n="AIzaSyCXFNBQjeiYpRYFdbs6VhISqlFZhrybM74",r=document.createElement("script");r.src=`https://maps.googleapis.com/maps/api/js?key=${n}&libraries=geometry,places&language=ja`,r.async=!0,r.defer=!0,r.onload=i,r.onerror=()=>e(new Error("Google Maps APIの読み込みに失敗しました")),document.head.appendChild(r)})}function Jl(i,e={lat:35.6938,lng:139.7034},n=14){const r=document.getElementById(i);return r?!window.google||!window.google.maps?(r.innerHTML=`
    ...
    `,null):(ne=new google.maps.Map(r,{center:e,zoom:n,mapTypeControl:!0,streetViewControl:!1,fullscreenControl:!0,styles:td()}),Dt=new google.maps.InfoWindow,pn=new google.maps.DirectionsService,ne):null}function lo(i,e={}){if(!ne)return null;const n=new google.maps.Marker({map:ne,position:i,title:e.title||"",icon:e.icon||void 0,label:e.label||void 0});return e.infoContent&&n.addListener("click",()=>{Dt.setContent(e.infoContent),Dt.open(ne,n)}),Ot.push(n),n}function vs(i,e,n,r){if(!ne)return null;const o={path:"M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z",fillColor:e,fillOpacity:1,strokeColor:"#fff",strokeWeight:2,scale:1.8,anchor:new google.maps.Point(12,22),labelOrigin:new google.maps.Point(12,9)};return lo(i,{icon:o,label:void 0,infoContent:r})}function Xl(i,e){return ne?lo(i,{title:e,icon:{path:"M12 2L2 7v10l10 5 10-5V7L12 2z",fillColor:"#F59E0B",fillOpacity:1,strokeColor:"#fff",strokeWeight:2,scale:2,anchor:new google.maps.Point(12,12)},infoContent:`<div style="color:#333;padding:4px"><strong>🏢 ${e}</strong><br>（出発地点）</div>`}):null}function Yl(i,e,n){if(!ne)return null;const r=i.map(c=>({lat:c.lat,lng:c.lng})),o=new google.maps.Polyline({path:r,geodesic:!0,strokeColor:e,strokeOpacity:.8,strokeWeight:4,map:ne});return mn.push(o),o}async function Ql(i,e){if(!ne||!pn||i.length<2)return;const n=i[0],r=i[i.length-1],o=i.slice(1,-1).map(c=>({location:new google.maps.LatLng(c.lat,c.lng),stopover:!0}));try{const c=await new Promise((u,p)=>{pn.route({origin:new google.maps.LatLng(n.lat,n.lng),destination:new google.maps.LatLng(r.lat,r.lng),waypoints:o,travelMode:google.maps.TravelMode.DRIVING,optimizeWaypoints:!1},(_,E)=>{E==="OK"?u(_):p(new Error(`Directions API: ${E}`))})}),l=new google.maps.DirectionsRenderer({map:ne,directions:c,suppressMarkers:!0,polylineOptions:{strokeColor:e,strokeWeight:4,strokeOpacity:.8}});return gn.push(l),l}catch(c){return console.warn("Directions API呼び出し失敗。直線ポリラインで代替:",c),Yl(i,e)}}async function ys(i){if(!window.google||!window.google.maps)return null;const e=new google.maps.DistanceMatrixService,n=i.map(r=>new google.maps.LatLng(r.lat,r.lng));try{return(await new Promise((c,l)=>{e.getDistanceMatrix({origins:n,destinations:n,travelMode:google.maps.TravelMode.DRIVING,unitSystem:google.maps.UnitSystem.METRIC},(u,p)=>{p==="OK"?c(u):l(new Error(`Distance Matrix API: ${p}`))})})).rows.map(c=>c.elements.map(l=>({distance:l.status==="OK"?l.distance.value/1e3:null,duration:l.status==="OK"?Math.ceil(l.duration.value/60):null})))}catch(r){return console.error("Distance Matrix取得失敗:",r),null}}function Zl(){Ot.forEach(i=>i.setMap(null)),Ot=[],mn.forEach(i=>i.setMap(null)),mn=[],gn.forEach(i=>i.setMap(null)),gn=[],Dt&&Dt.close()}function ed(){if(!ne||Ot.length===0)return;const i=new google.maps.LatLngBounds;Ot.forEach(e=>i.extend(e.getPosition())),ne.fitBounds(i,50)}async function uo(i){if(!i||i.trim()==="")return null;if(!window.google||!window.google.maps)return console.warn("ジオコーディング: Google Maps APIが未読み込みです"),null;const e=new google.maps.Geocoder;try{return await new Promise((r,o)=>{e.geocode({address:i,region:"jp"},(c,l)=>{if(l==="OK"&&c[0]){const u=c[0].geometry.location;r({lat:u.lat(),lng:u.lng()})}else o(new Error(`ジオコーディング失敗: ${l}`))})})}catch(n){return console.warn("住所の座標変換に失敗:",n.message),null}}function td(){return[{elementType:"geometry",stylers:[{color:"#1d2c4d"}]},{elementType:"labels.text.fill",stylers:[{color:"#8ec3b9"}]},{elementType:"labels.text.stroke",stylers:[{color:"#1a3646"}]},{featureType:"road",elementType:"geometry",stylers:[{color:"#304a7d"}]},{featureType:"road",elementType:"geometry.stroke",stylers:[{color:"#255763"}]},{featureType:"road.highway",elementType:"geometry",stylers:[{color:"#2c6675"}]},{featureType:"water",elementType:"geometry",stylers:[{color:"#17263c"}]},{featureType:"poi",elementType:"labels",stylers:[{visibility:"off"}]}]}const fi={qualifications:{label:"資格",options:["介護福祉士","実務者研修修了","初任者研修修了","看護師","ヘルパー2級"]},services:{label:"対応可能サービス",options:["身体介護","生活援助","通院等乗降介助","医療的ケア"]},physical:{label:"身体的対応力",options:["重介護対応可","移乗介助可","入浴介助可","二人介助対応可"]},special:{label:"特別スキル",options:["認知症ケア","ターミナルケア","精神障害対応","障害児支援"]}},id=["要支援1","要支援2","要介護1","要介護2","要介護3","要介護4","要介護5"],ho=["身体介護","生活援助","通院等乗降介助","医療的ケア"],nd=["男性","女性"],rd=["指定なし","男性希望","女性希望"],_s=["#4A90D9","#E74C3C","#2ECC71","#F39C12","#9B59B6","#1ABC9C","#E67E22","#3498DB","#E91E63","#00BCD4","#8BC34A","#FF5722"],_t={requiredSkill:1e3,genderMatch:2e3,staffType:500,proximity:30},ri=25,Q={name:"事業所（拠点）",address:"〒501-3304 岐阜県加茂郡富加町高畑２９１",lat:35.497,lng:136.993};let vn="all",mi=$t();async function sd(){var n,r,o;const i=document.getElementById("page-container");i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
        <span class="material-icons-round">map</span>
        マップビュー
  ...
  `;try{await Pt()}catch(c){console.warn("Maps APIの読み込みスキップ:",c)}const e=Jl("map-canvas",{lat:Q.lat,lng:Q.lng});await ei(e),(n=document.getElementById("map-date-picker"))==null||n.addEventListener("change",c=>{mi=c.target.value,ei(e)}),(r=document.getElementById("staff-filter"))==null||r.addEventListener("change",c=>{vn=c.target.value,ei(e)}),(o=document.getElementById("btn-refresh-map"))==null||o.addEventListener("click",()=>{ei(e)})}async function ei(i){const[e,n,r]=await Promise.all([ge().catch(()=>[]),_e().catch(()=>[]),ze(mi).catch(()=>[])]),o=document.getElementById("staff-filter");if(o&&o.options.length<=1&&e.forEach(l=>{const u=document.createElement("option");u.value=l.id,u.textContent=l.name,o.appendChild(u)}),!i){ad(e,n);return}Zl(),Xl({lat:Q.lat,lng:Q.lng},Q.name);const c=await Cn(mi).catch(()=>[]);if(c.length>0)for(const l of c){if(vn!=="all"&&l.staffId!==vn)continue;const u=e.find(E=>E.id===l.staffId),p=(u==null?void 0:u.color)||"#999",_=[{lat:Q.lat,lng:Q.lng}];for(const E of l.clientIds||[]){const S=n.find(w=>w.id===E);S&&(_.push({lat:S.lat,lng:S.lng}),vs({lat:S.lat,lng:S.lng},p,"",`<div style="color:#333;padding:4px">
  ...
  `,document.getElementById("btn-add-staff").addEventListener("click",()=>fo())}function cd(i){return i.length===0?`
  ...
  `}function fo(i=null){const e=!!i,n=e?"職員情報の編集":"新規職員登録",r=`
    <form id="staff-form">
      <div class="form-row">
  ...
  `),document.getElementById("sf-cancel").onclick=Ce,document.getElementById("sf-save").onclick=async()=>{const c=document.getElementById("sf-name").value.trim();if(!c){R("氏名を入力してください","warning");return}const l=document.getElementById("sf-save");l.disabled=!0,l.textContent="保存中...";const u=document.getElementById("sf-address").value.trim();let p=(i==null?void 0:i.lat)||Q.lat,_=(i==null?void 0:i.lng)||Q.lng;if(u)try{await Pt();const S=await uo(u);S?(p=S.lat,_=S.lng):R("住所から座標を取得できませんでした","warning")}catch(S){console.warn("ジオコーディング失敗:",S)}const E={name:c,gender:document.getElementById("sf-gender").value,address:u,workStart:document.getElementById("sf-work-start").value,workEnd:document.getElementById("sf-work-end").value,lat:p,lng:_,skills:{},color:(i==null?void 0:i.color)||_s[Ct.length%_s.length],isActive:!0};for(const[S]of Object.entries(fi)){const w=document.querySelectorAll(`input[name="skill-${S}"]:checked`);E.skills[S]=Array.from(w).map(k=>k.value)}try{e?(await jl(i.id,E),R("職員情報を更新しました","success")):(await so(E),R("職員を登録しました","success")),Ce(),await Ln()}catch(S){R("保存に失敗しました: "+S.message,"error")}finally{l.disabled=!1,l.textContent=e?"更新":"登録"}}}document.addEventListener("click",async i=>{const e=i.target.closest("[data-edit-staff]");if(e){const r=Ct.find(o=>o.id===e.dataset.editStaff);r&&fo(r)}const n=i.target.closest("[data-delete-staff]");if(n){const r=Ct.find(o=>o.id===n.dataset.deleteStaff);if(r&&await Ti("削除確認",`${r.name} を削除しますか？`))try{await ql(r.id),R(`${r.name} を削除しました`,"success"),await Ln()}catch{R("削除に失敗しました","error")}}});let pi=[],Is=[];async function xn(){const i=document.getElementById("page-container");try{const[e,n]=await Promise.all([_e().catch(()=>[]),ao().catch(()=>[])]);pi=e,Is=n}catch(e){console.error("データの取得に失敗",e)}i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
  ...
  `,document.getElementById("btn-add-client").addEventListener("click",()=>mo())}function ld(i,e){return i.length===0?`<div class="empty-state">
      <span class="material-icons-round">person_off</span>
      <h3>利用者が登録されていません</h3>
  ...
  `}function mo(i=null){var c,l;const e=!!i,n=[...fi.physical.options,...fi.special.options],r=`
    <form id="client-form">
      <div class="form-row">
        <div class="form-group">
          <label class="form-label">氏名 *</label>
      ...
      <div class="form-group">
        ...
        <div class="tags-container" style="gap:8px">
          ${ho.map(u=>{var p;return`<label style="display:flex;align-items:center;gap:4px;cursor:pointer;font-size:.85rem">
  ...
  `),document.getElementById("cf-cancel").onclick=Ce,document.getElementById("cf-save").onclick=async()=>{const u=document.getElementById("cf-name").value.trim();if(!u){R("氏名を入力してください","warning");return}const p=document.getElementById("cf-save");p.disabled=!0,p.textContent="保存中...";const _=document.getElementById("cf-address").value.trim();let E=(i==null?void 0:i.lat)||Q.lat,S=(i==null?void 0:i.lng)||Q.lng;if(_)try{await Pt();const k=await uo(_);k?(E=k.lat,S=k.lng,R(`座標を取得しました: ${k.lat.toFixed(4)}, ${k.lng.toFixed(4)}`,"success")):R("住所から座標を取得できませんでした。事業所付近の座標を使用します。","warning")}catch(k){console.warn("ジオコーディング失敗:",k),R("座標取得に失敗。事業所付近の座標を使用します。","warning")}const w={name:u,careLevel:document.getElementById("cf-care-level").value,address:_,requiredServices:Array.from(document.querySelectorAll('input[name="cf-service"]:checked')).map(k=>k.value),requiredSkills:Array.from(document.querySelectorAll('input[name="cf-skill"]:checked')).map(k=>k.value),genderPreference:document.getElementById("cf-gender-pref").value,visitDuration:parseInt(document.getElementById("cf-duration").value)||60,timeWindow:{start:document.getElementById("cf-time-start").value,end:document.getElementById("cf-time-end").value},notes:document.getElementById("cf-notes").value.trim(),lat:E,lng:S,isActive:!0};try{e?(await Hl(i.id,w),R("利用者情報を更新しました","success")):(await oo(w),R("利用者を登録しました","success")),Ce(),await xn()}catch(k){R("保存に失敗しました: "+k.message,"error")}finally{p.disabled=!1,p.textContent=e?"更新":"登録"}}}document.addEventListener("click",async i=>{const e=i.target.closest("[data-edit-client]");if(e){const r=pi.find(o=>o.id===e.dataset.editClient);r&&mo(r)}const n=i.target.closest("[data-delete-client]");if(n){const r=pi.find(o=>o.id===n.dataset.deleteClient);if(r&&await Ti("削除確認",`${r.name} を削除しますか？`))try{await zl(r.id),R(`${r.name} を削除しました`,"success"),await xn()}catch{R("削除に失敗しました","error")}}});let Fe=$t();async function dd(){const i=document.getElementById("page-container");i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
  ...
  `,document.getElementById("schedule-date").addEventListener("change",e=>{Fe=e.target.value,Lt()}),document.getElementById("btn-add-visit").addEventListener("click",ud),document.getElementById("btn-generate-week").addEventListener("click",hd),await Lt()}async function Lt(){const i=document.getElementById("schedule-content"),[e,n,r,o]=await Promise.all([ge().catch(()=>[]),_e().catch(()=>[]),ze(Fe).catch(()=>[]),Cn(Fe).catch(()=>[])]);if(r.length===0){i.innerHTML=`
    ...
    `);for(const[w,k]of Object.entries(c)){const D=e.find(A=>A.id===w);if(!D)continue;const P=o.find(A=>A.staffId===w),L=parseInt(D.wage)||2e3;if(P&&(_+=(P.totalDistance||0)*ri),k.sort((A,C)=>{const N=A.optimizedArrivalTime||A.startTime||A.scheduledTime||"00:00",x=C.optimizedArrivalTime||C.startTime||C.scheduledTime||"00:00";return N.localeCompare(x)}),P&&P.schedule&&P.schedule.length>=2){const A=P.schedule[0].arrivalMinutes,N=(P.schedule[P.schedule.length-1].arrivalMinutes-A)/60;p+=N*L}else if(k.length>0){const A=k[0],C=k[k.length-1],N=A.startTime||A.scheduledTime||"09:00",x=C.startTime||C.scheduledTime||"17:00",B=te(N),g=(te(x)+(C.duration||60)-B)/60;p+=g*L}k.forEach((A,C)=>{u+=no(D,A.duration||60);let N=10,x=null;if(P&&P.schedule){const B=P.schedule.find(V=>V.clientId===A.clientId);B&&(N=B.travelTimeFromPrev||10,x=B.arrivalTime)}A.calculatedTravelTime=N,A.optimizedArrivalTime=x}),k.sort((A,C)=>{const N=A.optimizedArrivalTime||A.startTime||A.scheduledTime||"00:00",x=C.optimizedArrivalTime||C.startTime||C.scheduledTime||"00:00";return N.localeCompare(x)})}let S="";if(window.isAdmin){const w=u-p-_,k=u>0?Math.round(w/u*100):0;S=`
...
実行しますか？`))try{const[n,r]=await Promise.all([_e(),ao()]),o={月:1,火:2,水:3,木:4,金:5,土:6},c=new Date,l=c.getDay(),u=r.filter(S=>S.dayOfWeek&&o[S.dayOfWeek]!==void 0);let p=0,_=0;const E=new Map;for(const S of u){const w=o[S.dayOfWeek];if(w===void 0)continue;const k=w-l,D=new Date(c);D.setDate(c.getDate()+k);const P=Zs(D),L=`${P}_${S.clientId}`;if(E.has(L)){E.get(L).timeOptions.push({startTime:S.startTime||"09:00",duration:S.duration||60});continue}if((await ze(P)).some(C=>C.clientId===S.clientId)){E.set(L,null),_++;continue}E.set(L,{...S,date:P,timeOptions:[{startTime:S.startTime||"09:00",duration:S.duration||60}]})}for(const[S,w]of E){if(!w)continue;const k=n.find(V=>V.id===w.clientId),D=w.service||((e=k==null?void 0:k.requiredServices)==null?void 0:e[0])||"身体介護",P=w.duration||(k==null?void 0:k.visitDuration)||60,L=w.startTime||"09:00",A=fn(D,P),C=te(L)+P,N=Math.floor(C/60),x=C%60,B=`${String(N).padStart(2,"0")}:${String(x).padStart(2,"0")}`;await Pn({date:w.date,clientId:w.clientId,clientName:w.clientName||(k==null?void 0:k.name)||"利用者",staffId:w.staffId||null,staffName:w.staffName||"未設定",startTime:L,endTime:B,scheduledTime:L,duration:P,service:D,income:A,dayOfWeek:w.dayOfWeek,status:"scheduled",timeOptions:w.timeOptions}),p++}p>0?R(`今週の訪問予定 ${p}件 を自動生成しました！${_>0?`（${_}件は既存のためスキップ）`:""}`,"success"):R(`生成する予定がありませんでした。${_>0?`（${_}件は既に登録済み）`:"利用者の曜日設定を確認してください。"}`,"warning"),await Lt()}catch(n){console.error("週間スケジュール生成エラー:",n),R("スケジュール生成に失敗しました: "+n.message,"error")}}document.addEventListener("click",async i=>{const e=i.target.closest("[data-delete-visit]");if(e&&await Ti("削除確認","この訪問予定を削除しますか？"))try{await co(e.dataset.deleteVisit),R("訪問予定を削除しました","success"),await Lt()}catch{R("削除に失敗しました","error")}});function fd(i,e){var l,u,p,_,E;let n=0;const r=[];let o=!0;for(const S of e.requiredServices||[])(u=(l=i.skills)==null?void 0:l.services)!=null&&u.includes(S)?(n+=_t.requiredSkill,r.push(`✅ ${S}対応可`)):(o=!1,r.push(`❌ ${S}に対応不可`));const c=[...((p=i.skills)==null?void 0:p.qualifications)||[],...((_=i.skills)==null?void 0:_.physical)||[],...((E=i.skills)==null?void 0:E.special)||[]];for(const S of e.requiredSkills||[])c.includes(S)?(n+=_t.requiredSkill,r.push(`✅ ${S}あり`)):(o=!1,r.push(`❌ ${S}なし`));if(e.genderPreference&&e.genderPreference!=="指定なし"){const S=e.genderPreference.replace("希望","");i.gender===S?(n+=_t.genderMatch,r.push(`✅ 性別希望合致（${S}）`)):(o=!1,r.push(`❌ 性別希望不一致（希望: ${S}）`))}if(i.type==="正社員"&&(n+=_t.staffType,r.push("✅ 正社員")),i.lat&&e.lat){const S=io(i.lat,i.lng,e.lat,e.lng),w=Math.max(0,_t.proximity*(1-S/10));n+=w}return{score:Math.round(n),reasons:r,eligible:o}}function md(i,e,n=[],r=null,o=[]){const c=[],l=new Set,u={},p={};o.forEach((w,k)=>{p[w.id]=k});const _=(w,k)=>{if(!r)return 15;const D=p[w],P=p[k];return D!==void 0&&P!==void 0&&r[D][P]&&r[D][P].duration||15},E=[...e].sort((w,k)=>{const D=w.startTime||w.scheduledTime||"00:00",P=k.startTime||k.scheduledTime||"00:00";return D.localeCompare(P)});for(const w of E){if(c.some(A=>A.clientId===w.clientId))continue;const k=i.filter(A=>A.isActive).map(A=>{const C=n.find(g=>g.id===w.clientId),{score:N,eligible:x}=fd(A,C||w),B=w.timeOptions&&w.timeOptions.length>0?w.timeOptions:[{startTime:w.startTime||w.scheduledTime||"09:00",duration:w.duration||60}];let V=null;for(const g of B){let h=!0;const m=te(g.startTime),y=m+(g.duration||60),v=c.filter(I=>I.staffId===A.id);for(const I of v){const f=te(I.startTime),z=f+(I.duration||60);if(m<z&&y>f){h=!1;break}const ce=_(I.clientId,w.clientId);if(m>=z){if(m-z<ce){h=!1;break}}else if(y<=f&&f-y<ce){h=!1;break}}if(h){V=g;break}}return{staff:A,score:N,eligible:x&&!!V,chosenTime:V}}).filter(A=>A.eligible);if(k.length===0)continue;k.sort((A,C)=>{const N=u[A.staff.id]||0,x=u[C.staff.id]||0,B=A.staff.maxVisits||(A.staff.type==="パート"?5:10),V=C.staff.maxVisits||(C.staff.type==="パート"?5:10),g=N>=B,h=x>=V;return g!==h?g?1:-1:N!==x?N-x:A.staff.type!==C.staff.type?A.staff.type==="正社員"?-1:1:C.score-A.score});const D=k[0],P=u[D.staff.id]||0,L=D.staff.maxVisits||(D.staff.type==="パート"?5:10);if(P<L){const A=D.chosenTime.startTime,C=D.chosenTime.duration||60,N=te(A)+C;c.push({staffId:D.staff.id,staffName:D.staff.name,visitId:w.id,clientId:w.clientId,clientName:w.clientName||"利用者",score:D.score,startTime:A,endTime:eo(N),scheduledTime:A,duration:C}),l.add(w.id),u[D.staff.id]=P+1}}const S=e.filter(w=>!l.has(w.id)).map(w=>({visitId:w.id,clientName:w.clientName||"利用者",reason:"適格な職員なし、または上限超過"}));return{assignments:c,unassigned:S}}async function pd(i,e,n,r=Q,o=null){const c={};for(const u of i)c[u.staffId]||(c[u.staffId]=[]),c[u.staffId].push(u.clientId);const l={};for(const[u,p]of Object.entries(c)){const _=e.find(A=>A.id===u),E=p.map(A=>n.find(C=>C.id===A)).filter(Boolean);if(E.length===0)continue;const S=[{id:"office",name:"事業所",lat:r.lat,lng:r.lng,isOffice:!0},...E.map(A=>{const C=i.find(N=>N.clientId===A.id&&N.staffId===u);return{id:A.id,name:A.name,lat:A.lat,lng:A.lng,duration:A.visitDuration||60,scheduledStart:C?C.startTime:null,timeWindow:A.timeWindow}})];let w=null;typeof o=="function"&&(w=await o(S));const k=gd(S,w);let D=vd(S,k);D=yd(D,k);const P=_d(D,k),L=Id(D,k,_,w,S);l[u]={staffId:u,staffName:(_==null?void 0:_.name)||"不明",staffColor:(_==null?void 0:_.color)||"#999",route:D,totalDistance:Math.round(P*10)/10,totalDuration:Td(L),schedule:L}}return l}function gd(i,e=null){const n=i.length,r=Array.from({length:n},()=>Array(n).fill(0));for(let o=0;o<n;o++)for(let c=0;c<n;c++)o!==c&&(e&&e[o]&&e[o][c]&&e[o][c].distance!==null?r[o][c]=e[o][c].distance:r[o][c]=io(i[o].lat,i[o].lng,i[c].lat,i[c].lng));return r}function vd(i,e){const n=i.length,r=new Set([0]),o=[0],c=[],l=[];for(let _=1;_<n;_++){const E=i[_];E.timeWindow&&E.timeWindow.start?c.push({index:_,start:te(E.timeWindow.start),end:te(E.timeWindow.end)}):l.push(_)}c.sort((_,E)=>_.start-E.start);const u=[...c.map(_=>_.index),...l];let p=0;for(;r.size<n;){let _=-1,E=1/0;for(const S of u)r.has(S)||e[p][S]<E&&(E=e[p][S],_=S);if(_===-1)break;o.push(_),r.add(_),p=_}return o.push(0),o}function yd(i,e){const n=i.length;let r=!0,o=[...i];for(;r;){r=!1;for(let c=1;c<n-2;c++)for(let l=c+1;l<n-1;l++){const u=e[o[c-1]][o[c]]+e[o[l]][o[l+1]];if(e[o[c-1]][o[l]]+e[o[c]][o[l+1]]<u-.001){const _=[...o];let E=c,S=l;for(;E<S;)[_[E],_[S]]=[_[S],_[E]],E++,S--;o=_,r=!0}}}return o}function _d(i,e){let n=0;for(let r=0;r<i.length-1;r++)n+=e[i[r]][i[r+1]];return n}function Id(i,e,n,r=null,o=[]){const c=[];let u=te((n==null?void 0:n.workStart)||"08:30");for(let p=0;p<i.length;p++){let _=0;if(p>0){const S=i[p-1],w=i[p];r&&r[S]&&r[S][w]&&r[S][w].duration!==null?_=r[S][w].duration:_=e[S][w]/20*60,u+=Math.ceil(_)}const E=o[i[p]];if(E){let S=0;E.timeWindow&&E.timeWindow.start?S=te(E.timeWindow.start):E.scheduledStart&&(S=te(E.scheduledStart)),u<S&&(u=S)}if(c.push({pointIndex:i[p],clientId:E?E.id:null,arrivalTime:eo(u),arrivalMinutes:u,travelTimeFromPrev:Math.ceil(_)}),p>0&&p<i.length-1){const S=E&&E.duration||60;u+=S}}return c}function Td(i){if(i.length<2)return 0;const e=i[0].arrivalMinutes;return i[i.length-1].arrivalMinutes-e}let si=null,wd=null,qe=$t();async function po(){const i=document.getElementById("page-container"),e=await ge(),n=["日","月","火","水","木","金","土"][new Date(qe).getDay()];i.innerHTML=`
      ...
      ${Object.entries(c).map(([l,u])=>{var _,E,S;const p=o[l];return`
          <div class="card" style="border-left:4px solid ${((_=u.staff)==null?void 0:_.color)||"#999"}">
            ...
            <div style="display:flex;flex-direction:column;gap:6px">
              ...
              ${((p==null?void 0:p.schedule)||[]).filter(w=>w.pointIndex!==0||p.schedule.indexOf(w)===p.schedule.length-1).map((w,k,D)=>{var L,A;if(w.pointIndex===0&&k===D.length-1)return`<div style="font-size:.8rem;color:var(--text-muted);display:flex;align-items:center;gap:4px">
                      <span class="material-icons-round" style="font-size:16px;color:var(--secondary)">business</span>
                      ${w.arrivalTime} 事業所帰着
                    ...
                    <div style="display:flex;justify-content:space-between;align-items:center">
                      ...
                      <span class="tag">${((A=P==null?void 0:P.client)==null?void 0:A.visitDuration)||60}分</span>
                    </div>
                  </div>`}).join("")}
            </div>
          </div>
  ...
  `}async function Ed(i,e){try{const n=Object.entries(e).map(([c,l])=>{const u=si.filter(p=>p.staffId===c).map(p=>p.clientId);return{staffId:c,date:qe,clientIds:u,totalDistance:l.totalDistance,totalDuration:l.totalDuration,schedule:l.schedule}}),r=await ze(qe),o=new Set;for(const c of r){const l=si.find(u=>u.visitId===c.id);l&&(await gs(c.id,{staffId:l.staffId,staffName:l.staffName,startTime:l.startTime,endTime:l.endTime,scheduledTime:l.scheduledTime}),o.add(c.clientId))}for(const c of r)si.find(u=>u.visitId===c.id)||(o.has(c.clientId)?await co(c.id):await gs(c.id,{staffId:null,staffName:"未設定"}));await Gl(n),R("スケジュールとルートを保存しました！","success")}catch(n){R("保存に失敗しました: "+n.message,"error")}}let Et=$t();async function kd(){var e,n;const i=document.getElementById("page-container");if(!window.isAdmin){i.innerHTML=`
      <div class="empty-state">
  ...
  `,await sn(),(e=document.getElementById("revenue-date-picker"))==null||e.addEventListener("change",r=>{Et=r.target.value,sn()}),(n=document.getElementById("btn-refresh-revenue"))==null||n.addEventListener("click",()=>{sn()})}async function sn(){const i=document.getElementById("revenue-content");if(!i)return;const[e,n,r,o]=await Promise.all([ge(),_e(),ze(Et),Cn(Et)]);if(r.length===0){i.innerHTML=`
    ...
    `;return}let c=0,l=0,u=0,p=r.length;r.filter(w=>w.status==="completed").length;const _=e.map(w=>{const k=o.filter(x=>x.staffId===w.id),D=r.filter(x=>x.staffId===w.id);let P=0,L=0,A=0,C=0,N=0;if(D.forEach(x=>{P+=no(w,x.duration||60)}),k.forEach(x=>{if(C+=x.totalDistance||0,A+=(x.totalDistance||0)*ri,x.schedule&&x.schedule.length>=2){const B=x.schedule[0].arrivalMinutes;N=x.schedule[x.schedule.length-1].arrivalMinutes-B,L=N/60*(parseInt(w.wage)||2e3)}}),k.length===0&&D.length>0){const x=[...D].sort((m,y)=>(m.startTime||"09:00").localeCompare(y.startTime||"09:00")),B=x[0],V=x[x.length-1],g=te(B.startTime||"09:00");N=te(V.startTime||"17:00")+(V.duration||60)-g,L=N/60*(parseInt(w.wage)||2e3)}return{...w,count:D.length,revenue:P,laborCost:L,vehicleCost:A,profit:P-L-A,workMinutes:N}}).filter(w=>w.count>0||w.revenue>0).sort((w,k)=>k.profit-w.profit);_.forEach(w=>{c+=w.revenue,l+=w.laborCost,u+=w.vehicleCost});const E=c-l-u,S=c>0?E/c*100:0;i.innerHTML=`
    <!-- メインKPI -->
    <div class="grid grid-4" style="margin-bottom:24px">
  ...
  `}const Ad={dashboard:{render:Kl,title:"ダッシュボード"},map:{render:sd,title:"マップビュー"},staff:{render:Ln,title:"職員管理"},client:{render:xn,title:"利用者管理"},schedule:{render:dd,title:"スケジュール"},matching:{render:po,title:"マッチング＆最適化"},revenue:{render:kd,title:"収支シミュレーション"}};function Od(){var o,c,l,u;document.querySelectorAll(".nav-item").forEach(p=>{p.addEventListener("click",()=>{const _=p.dataset.page;_&&gi(_)})}),(o=document.getElementById("btn-sidebar-toggle"))==null||o.addEventListener("click",()=>{document.getElementById("sidebar").classList.toggle("collapsed")});const e=document.getElementById("sidebar"),n=document.getElementById("sidebar-overlay"),r=()=>{e.classList.toggle("open"),n.classList.toggle("open")};(c=document.getElementById("btn-mobile-menu"))==null||c.addEventListener("click",r),n==null||n.addEventListener("click",r),(l=document.getElementById("btn-modal-close"))==null||l.addEventListener("click",()=>{document.getElementById("modal-overlay").style.display="none"}),(u=document.getElementById("modal-overlay"))==null||u.addEventListener("click",p=>{p.target===p.currentTarget&&(p.currentTarget.style.display="none")})}async function gi(i){var r,o;const e=Ad[i];if(!e)return;document.querySelectorAll(".nav-item").forEach(c=>{c.classList.toggle("active",c.dataset.page===i)}),(r=document.getElementById("sidebar"))==null||r.classList.remove("open"),(o=document.getElementById("sidebar-overlay"))==null||o.classList.remove("open"),document.title=`${e.title} - CareRoute`;const n=document.getElementById("page-container");n.innerHTML='<div class="loading"><div class="spinner"></div></div>';try{await e.render()}catch(c){console.error(`ページ「${e.title}」の表示エラー:`,c),n.innerHTML=`
      <div class="empty-state">
