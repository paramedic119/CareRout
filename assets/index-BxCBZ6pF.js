 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Os(i){try{return(i.startsWith("http://")||i.startsWith("https://")?new URL(i).hostname:i).endsWith(".cloudworkstations.dev")}catch{return!1}}class Ye{constructor(e,n,r){this.name=e,this.instanceFactory=n,this.type=r,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ka{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Aa(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function Aa(i){const e=i.getComponent();return(e==null?void 0:e.type)==="VERSION"}const sn="@firebase/app",Nr="0.14.11";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ic=new Map,nc=new Map,Mr=new Map;function $r(i,e){try{i.container.addComponent(e)}catch(n){pe.debug(`Component ${e.name} failed to register with FirebaseApp ${i.name}`,n)}}function Qe(i){const e=i.name;if(Mr.has(e))return pe.debug(`There were multiple attempts to register component ${e}.`),!1;Mr.set(e,i);for(const n of ic.values())$r(n,i);for(const n of nc.values())$r(n,i);return!0}function Me(i){return i==null?!1:i.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sc="firebase-heartbeat-database",oc=1,St="firebase-heartbeat-store";let Ki=null;function Cs(){return Ki||(Ki=ba(sc,oc,{upgrade:(i,e)=>{switch(e){case 0:try{i.createObjectStore(St)}catch(n){console.warn(n)}}}}).catch(i=>{throw yn.create("idb-open",{originalErrorMessage:i.message})})),Ki}async function ac(i){try{const n=(await Cs()).transaction(St),r=await n.objectStore(St).get(Ls(i));return await n.done,r}catch(e){if(e instanceof Pe)pe.warn(e.message);else{const n=yn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});pe.warn(n.message)}}}async function Br(i,e){try{const r=(await Cs()).transaction(St,"readwrite");await r.objectStore(St).put(e,Ls(i)),await r.done}catch(n){if(n instanceof Pe)pe.warn(n.message);else{const r=yn.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});pe.warn(r.message)}}}function Ls(i){return`${i.name}!${i.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mc(i){Qe(new Ye("platform-logger",e=>new ka(e),"PRIVATE")),Qe(new Ye("heartbeat",e=>new dc(e),"PRIVATE")),ke(sn,Nr,i),ke(sn,Nr,"esm2020"),ke("fire-js","")}mc("");var pc="firebase",gc="12.12.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ke(pc,gc,"app");var Fr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ti=new gn("@firebase/firestore");function se(i,...e){if(ti.logLevel<=W.DEBUG){const n=e.map(Rs);ti.debug(`Firestore (${mi}): ${i}`,...n)}}function xs(i,...e){if(ti.logLevel<=W.ERROR){const n=e.map(Rs);ti.error(`Firestore (${mi}): ${i}`,...n)}}function Rs(i){if(typeof i=="string")return i;try{return function(n){return JSON.stringify(n)}(i)}catch{return i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ii(i,e,n){let r="Unexpected state";typeof e=="string"?r=e:n=e,Ns(i,r,n)}function Ns(i,e,n){let r=`FIRESTORE (${mi}) INTERNAL ASSERTION FAILED: ${e} (ID: ${i.toString(16)})`;if(n!==void 0)try{r+=" CONTEXT: "+JSON.stringify(n)}catch{r+=" CONTEXT: "+n}throw xs(r),new Error(r)}function yt(i,e,n,r){let o="Unexpected state";typeof n=="string"?o=n:r=n,i||Ns(e,o,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qr=-62135596800,Hr=1e6;class le{static now(){return le.fromMillis(Date.now())}static fromDate(e){return le.fromMillis(e.getTime())}static fromMillis(e){const n=Math.floor(e/1e3),r=Math.floor((e-1e3*n)*Hr);return new le(n,r)}constructor(e,n){if(this.seconds=e,this.nanoseconds=n,n<0)throw new B($.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+n);if(n>=1e9)throw new B($.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+n);if(e<qr)throw new B($.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e);if(e>=253402300800)throw new B($.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e)}toDate(){return new Date(this.toMillis())}toMillis(){return 1e3*this.seconds+this.nanoseconds/Hr}_compareTo(e){return this.seconds===e.seconds?Ae(this.nanoseconds,e.nanoseconds):Ae(this.seconds,e.seconds)}isEqual(e){return e.seconds===this.seconds&&e.nanoseconds===this.nanoseconds}toString(){return"Timestamp(seconds="+this.seconds+", nanoseconds="+this.nanoseconds+")"}toJSON(){return{type:le._jsonSchemaVersion,seconds:this.seconds,nanoseconds:this.nanoseconds}}static fromJSON(e){if(Lt(e,le._jsonSchema))return new le(e.seconds,e.nanoseconds)}valueOf(){const e=this.seconds-qr;return String(e).padStart(12,"0")+"."+String(this.nanoseconds).padStart(9,"0")}}le._jsonSchemaVersion="firestore/timestamp/1.0",le._jsonSchema={type:G("string",le._jsonSchemaVersion),seconds:G("number"),nanoseconds:G("number")};function Lc(i){return i.name==="IndexedDbTransactionError"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fc="ComponentProvider",Xr=new Map;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zr="AsyncQueue";class es{constructor(e=Promise.resolve()){this.Yu=[],this.ec=!1,this.tc=[],this.nc=null,this.rc=!1,this.sc=!1,this.oc=[],this.M_=new Uc(this,"async_queue_retry"),this._c=()=>{const r=Xi();r&&se(Zr,"Visibility state changed to "+r.visibilityState),this.M_.w_()},this.ac=e;const n=Xi();n&&typeof n.addEventListener=="function"&&n.addEventListener("visibilitychange",this._c)}get isShuttingDown(){return this.ec}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.uc(),this.cc(e)}enterRestrictedMode(e){if(!this.ec){this.ec=!0,this.sc=e||!1;const n=Xi();n&&typeof n.removeEventListener=="function"&&n.removeEventListener("visibilitychange",this._c)}}enqueue(e){if(this.uc(),this.ec)return new Promise(()=>{});const n=new _t;return this.cc(()=>this.ec&&this.sc?Promise.resolve():(e().then(n.resolve,n.reject),n.promise)).then(()=>n.promise)}enqueueRetryable(e){this.enqueueAndForget(()=>(this.Yu.push(e),this.lc()))}async lc(){if(this.Yu.length!==0){try{await this.Yu[0](),this.Yu.shift(),this.M_.reset()}catch(e){if(!Lc(e))throw e;se(Zr,"Operation failed with retryable error: "+e)}this.Yu.length>0&&this.M_.p_(()=>this.lc())}}cc(e){const n=this.ac.then(()=>(this.rc=!0,e().catch(r=>{throw this.nc=r,this.rc=!1,xs("INTERNAL UNHANDLED ERROR: ",ts(r)),r}).then(r=>(this.rc=!1,r))));return this.ac=n,n}enqueueAfterDelay(e,n,r){this.uc(),this.oc.indexOf(e)>-1&&(n=0);const o=In.createAndSchedule(this,e,n,r,c=>this.hc(c));return this.tc.push(o),o}uc(){this.nc&&ii(47125,{Pc:ts(this.nc)})}verifyOperationInProgress(){}async Tc(){let e;do e=this.ac,await e;while(e!==this.ac)}Ec(e){for(const n of this.tc)if(n.timerId===e)return!0;return!1}Ic(e){return this.Tc().then(()=>{this.tc.sort((n,r)=>n.targetTimeMs-r.targetTimeMs);for(const n of this.tc)if(n.skipDelay(),e!=="all"&&n.timerId===e)break;return this.Tc()})}Rc(e){this.oc.push(e)}hc(e){const n=this.tc.indexOf(e);this.tc.splice(n,1)}}function ts(i){let e=i.message||"";return i.stack&&(e=i.stack.includes(i.message)?i.stack:i.message+`
`+i.stack),e}class qc extends jc{constructor(e,n,r,o){super(e,n,r,o),this.type="firestore",this._queue=new es,this._persistenceKey=(o==null?void 0:o.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new es(e),this._firestoreClient=void 0,await e}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ms{constructor(...e){for(let n=0;n<e.length;++n)if(e[n].length===0)throw new B($.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new $e(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */It._jsonSchemaVersion="firestore/querySnapshot/1.0",It._jsonSchema={type:G("string",It._jsonSchemaVersion),bundleSource:G("string","QuerySnapshot"),bundleName:G("string"),bundle:G("string")};(function(e,n=!0){vc(fi),Qe(new Ye("firestore",(r,{instanceIdentifier:o,options:c})=>{const l=r.getProvider("app").getImmediate(),h=new qc(new Ic(r.getProvider("auth-internal")),new bc(l,r.getProvider("app-check-internal")),Rc(l,o),l);return c={useFetchStreams:n,...c},h._setSettings(c),h},"PUBLIC").setMultipleInstances(!0)),ke(is,ns,e),ke(is,ns,"esm2020")})();function Us(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Jc=Us,Ws=new Dt("auth","Firebase",Us());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rs(i,...e){throw bn(i,...e)}function Fs(i,...e){return bn(i,...e)}function Vs(i,e,n){const r={...Jc(),[e]:n};return new Dt("auth","Firebase",r).create(e,{appName:i.name})}function ei(i){return Vs(i,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function bn(i,...e){if(typeof i!="string"){const n=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=i.name),i._errorFactory.create(n,...r)}return Ws.create(i,...e)}function M(i,e,...n){if(!i)throw bn(e,...n)}function Tt(i){const e="INTERNAL ASSERTION FAILED: "+i;throw Zt(e),new Error(e)}function si(i,e){i||Tt(e)}function Yc(){return ss()==="http:"||ss()==="https:"}function ss(){var i;return typeof self<"u"&&((i=self.location)==null?void 0:i.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const il=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],nl=new xt(3e4,6e4);function qs(i,e){return i.tenantId&&!e.tenantId?{...e,tenantId:i.tenantId}:e}async function pi(i,e,n,r,o={}){return Hs(i,o,async()=>{let c={},l={};r&&(e==="GET"?l=r:c={body:JSON.stringify(r)});const h=As({key:i.config.apiKey,...l}).slice(1),g=await i._getAdditionalHeaders();g["Content-Type"]="application/json",i.languageCode&&(g["X-Firebase-Locale"]=i.languageCode);const T={method:e,headers:g,...c};return ea()||(T.referrerPolicy="no-referrer"),i.emulatorConfig&&Os(i.emulatorConfig.host)&&(T.credentials="include"),js.fetch()(await zs(i,i.config.apiHost,n,h),T)})}async function Hs(i,e,n){i._canInitEmulator=!1;const r={...tl,...e};try{const o=new rl(i),c=await Promise.race([n(),o.promise]);o.clearNetworkTimeout();const l=await c.json();if("needConfirmation"in l)throw Jt(i,"account-exists-with-different-credential",l);if(c.ok&&!("errorMessage"in l))return l;{const h=c.ok?l.errorMessage:l.error.message,[g,T]=h.split(" : ");if(g==="FEDERATED_USER_ID_ALREADY_LINKED")throw Jt(i,"credential-already-in-use",l);if(g==="EMAIL_EXISTS")throw Jt(i,"email-already-in-use",l);if(g==="USER_DISABLED")throw Jt(i,"user-disabled",l);const S=r[g]||g.toLowerCase().replace(/[_\s]+/g,"-");if(T)throw Vs(i,S,T);rs(i,S)}}catch(o){if(o instanceof Pe)throw o;rs(i,"network-request-failed",{message:String(o)})}}async function zs(i,e,n,r){const o=`${e}${n}?${r}`,c=i,l=c.config.emulator?el(i.config,o):`${i.config.apiScheme}://${o}`;return il.includes(n)&&(await c._persistenceManagerAvailable,c._getPersistenceType()==="COOKIE")?c._getPersistence()._getFinalTarget(l).toString():l}class rl{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,r)=>{this.timer=setTimeout(()=>r(Fs(this.auth,"network-request-failed")),nl.get())})}}function Jt(i,e,n){const r={appName:i.name};n.email&&(r.email=n.email),n.phoneNumber&&(r.phoneNumber=n.phoneNumber);const o=Fs(i,e,r);return o.customData._tokenResponse=n,o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wt(i){if(i)try{const e=new Date(Number(i));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function ol(i,e=!1){const n=Ct(i),r=await n.getIdToken(e),o=Gs(r);M(o&&o.exp&&o.auth_time&&o.iat,n.auth,"internal-error");const c=typeof o.firebase=="object"?o.firebase:void 0,l=c==null?void 0:c.sign_in_provider;return{claims:o,token:r,authTime:wt(Yi(o.auth_time)),issuedAtTime:wt(Yi(o.iat)),expirationTime:wt(Yi(o.exp)),signInProvider:l||null,signInSecondFactor:(c==null?void 0:c.sign_in_second_factor)||null}}function Yi(i){return Number(i)*1e3}function Gs(i){const[e,n,r]=i.split(".");if(e===void 0||n===void 0||r===void 0)return Zt("JWT malformed, contained fewer than 3 sections"),null;try{const o=ks(n);return o?JSON.parse(o):(Zt("Failed to decode base64 JWT payload"),null)}catch(o){return Zt("Caught error parsing JWT payload as JSON",o==null?void 0:o.toString()),null}}function os(i){const e=Gs(i);return M(e,"internal-error"),M(typeof e.exp<"u","internal-error"),M(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ul(i,e){const n=await Hs(i,{},async()=>{const r=As({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:o,apiKey:c}=i.config,l=await zs(i,o,"/v1/token",`key=${c}`),h=await i._getAdditionalHeaders();h["Content-Type"]="application/x-www-form-urlencoded";const g={method:"POST",headers:h,body:r};return i.emulatorConfig&&Os(i.emulatorConfig.host)&&(g.credentials="include"),js.fetch()(l,g)});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}async function hl(i,e){return pi(i,"POST","/v2/accounts:revokeToken",qs(i,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ls(i){const e=i.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(gl(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(fl(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(yl(e))return"Blackberry";if(_l(e))return"Webos";if(ml(e))return"Safari";if((e.includes("chrome/")||pl(e))&&!e.includes("edge/"))return"Chrome";if(vl(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=i.match(n);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function fl(i=fe()){return/firefox\//i.test(i)}function ml(i=fe()){const e=i.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function pl(i=fe()){return/crios\//i.test(i)}function gl(i=fe()){return/iemobile/i.test(i)}function vl(i=fe()){return/android/i.test(i)}function yl(i=fe()){return/blackberry/i.test(i)}function _l(i=fe()){return/webos/i.test(i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Tl(i,e={}){return pi(i,"GET","/v2/passwordPolicy",qs(i,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const Dl=5*60;Qo("authIdTokenMaxAge");Pl("Browser");console.warn("⚠️ Firebase未設定。.envファイルにAPIキーを設定してください。");function Cl(i){const e=new Date(i),n=e.getFullYear(),r=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${n}-${r}-${o}`}function Et(i){const e=new Date(i),n=["日","月","火","水","木","金","土"];return`${e.getMonth()+1}月${e.getDate()}日（${n[e.getDay()]}）`}function Ze(){return Cl(new Date)}function fs(i){const[e,n]=i.split(":").map(Number);return e*60+n}function Ys(){return Date.now().toString(36)+Math.random().toString(36).slice(2,9)}function Qs(i,e,n,r){const c=Xt(n-i),l=Xt(r-e),h=Math.sin(c/2)**2+Math.cos(Xt(i))*Math.cos(Xt(n))*Math.sin(l/2)**2;return 6371*2*Math.atan2(Math.sqrt(h),Math.sqrt(1-h))}function Xt(i){return i*(Math.PI/180)}function he(i){const e=document.createElement("div");return e.textContent=i,e.innerHTML}function R(i,e="info",n=3e3){const r=document.getElementById("toast-container"),o={success:"check_circle",error:"error",warning:"warning",info:"info"},c=document.createElement("div");c.className=`toast ${e}`,c.innerHTML=`
  ...
  `,r.appendChild(c),setTimeout(()=>{c.style.opacity="0",c.style.transform="translateX(40px)",c.style.transition="all .3s ease",setTimeout(()=>c.remove(),300)},n)}function gi(i,e,n=""){const r=document.getElementById("modal-overlay");document.getElementById("modal-title").textContent=i,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=n,r.style.display="flex"}function Oe(){document.getElementById("modal-overlay").style.display="none"}function Sn(i,e){return new Promise(n=>{const r=`<p>${he(e)}</p>`;gi(i,r,`
    ...
    `),document.getElementById("confirm-ok").onclick=()=>{Oe(),n(!0)},document.getElementById("confirm-cancel").onclick=()=>{Oe(),n(!1)}})}function Ll(i){{console.warn("Firebase未設定のためログイン画面を表示します"),setTimeout(()=>i(null,null),100);return}}async function xl(){throw new Error("Firebase未設定です。.envにAPIキーを設定してください。")}async function Rl(){}function Nl(){const i=document.getElementById("btn-google-login");i&&i.addEventListener("click",async()=>{i.disabled=!0,i.textContent="ログイン中...";try{await xl()}catch(e){console.error("ログインエラー:",e),e.code==="auth/popup-closed-by-user"?R("ログインがキャンセルされました","warning"):R("ログインに失敗しました","error"),i.disabled=!1,i.innerHTML=`
        ...
        Googleアカウントでログイン
      `}})}const Se={};function et(i){if(!Se[i]){const e=localStorage.getItem(`careroute_${i}`);Se[i]=e?JSON.parse(e):[]}return Se[i]}function vi(i){localStorage.setItem(`careroute_${i}`,JSON.stringify(Se[i]||[]))}async function ms(){localStorage.removeItem("careroute_staff"),localStorage.removeItem("careroute_clients"),localStorage.removeItem("careroute_visits"),localStorage.removeItem("careroute_routes"),Se.staff=[],Se.clients=[],Se.visits=[],Se.routes=[]}async function En(i,e){{const n=Ys();return et(i).push({id:n,...e,createdAt:new Date().toISOString()}),vi(i),n}}async function kn(i){return et(i)}async function An(i,e,n){{const r=et(i),o=r.findIndex(c=>c.id===e);o!==-1&&(r[o]={...r[o],...n,updatedAt:new Date().toISOString()},vi(i));return}}async function On(i,e){{const n=et(i),r=n.findIndex(o=>o.id===e);r!==-1&&(n.splice(r,1),vi(i));return}}async function Zs(i,e,n,r){return et(i).filter(c=>c[e]===r)}async function ge(){return kn("staff")}async function eo(i){return En("staff",i)}async function Ml(i,e){return An("staff",i,e)}async function $l(i){return On("staff",i)}async function De(){return kn("clients")}async function to(i){return En("clients",i)}async function Bl(i,e){return An("clients",i,e)}async function Ul(i){return On("clients",i)}async function Wl(){return kn("visits")}async function Rt(i){return Zs("visits","date","==",i)}async function io(i){return En("visits",i)}async function Fl(i,e){return An("visits",i,e)}async function Vl(i){return On("visits",i)}async function Pn(i){return Zs("routes","date","==",i)}async function jl(i){{const e=et("routes");for(const n of i)e.push({id:Ys(),...n,createdAt:new Date().toISOString()});vi("routes");return}}async function ql(){const i=document.getElementById("page-container"),[e,n]=await Promise.all([ge().catch(()=>[]),De().catch(()=>[])]),r=Ze(),o=await Rt(r).catch(()=>[]),c=e.filter(g=>g.isActive),l=n.filter(g=>g.isActive),h=o.filter(g=>g.status!=="cancelled");i.innerHTML=`
  ...
  `}let te=null,kt=[],ln=[],At=null,dn=null,un=[];function hn(){return new Promise((i,e)=>{if(window.google&&window.google.maps){i();return}const n="AIzaSyCXFNBQjeiYpRYFdbs6VhISqlFZhrybM74",r=document.createElement("script");r.src=`https://maps.googleapis.com/maps/api/js?key=${n}&libraries=geometry,places&language=ja`,r.async=!0,r.defer=!0,r.onload=i,r.onerror=()=>e(new Error("Google Maps APIの読み込みに失敗しました")),document.head.appendChild(r)})}function Hl(i,e={lat:35.6938,lng:139.7034},n=14){const r=document.getElementById(i);return r?!window.google||!window.google.maps?(r.innerHTML=`
    ...
    `,null):(te=new google.maps.Map(r,{center:e,zoom:n,mapTypeControl:!0,streetViewControl:!1,fullscreenControl:!0,styles:Yl()}),At=new google.maps.InfoWindow,dn=new google.maps.DirectionsService,te):null}function no(i,e={}){if(!te)return null;const n=new google.maps.Marker({map:te,position:i,title:e.title||"",icon:e.icon||void 0,label:e.label||void 0});return e.infoContent&&n.addListener("click",()=>{At.setContent(e.infoContent),At.open(te,n)}),kt.push(n),n}function ps(i,e,n,r){if(!te)return null;const o={path:"M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z",fillColor:e,fillOpacity:1,strokeColor:"#fff",strokeWeight:2,scale:1.8,anchor:new google.maps.Point(12,22),labelOrigin:new google.maps.Point(12,9)};return no(i,{icon:o,label:void 0,infoContent:r})}function zl(i,e){return te?no(i,{title:e,icon:{path:"M12 2L2 7v10l10 5 10-5V7L12 2z",fillColor:"#F59E0B",fillOpacity:1,strokeColor:"#fff",strokeWeight:2,scale:2,anchor:new google.maps.Point(12,12)},infoContent:`<div style="color:#333;padding:4px"><strong>🏢 ${e}</strong><br>（出発地点）</div>`}):null}function Gl(i,e,n){if(!te)return null;const r=i.map(c=>({lat:c.lat,lng:c.lng})),o=new google.maps.Polyline({path:r,geodesic:!0,strokeColor:e,strokeOpacity:.8,strokeWeight:4,map:te});return ln.push(o),o}async function Kl(i,e){if(!te||!dn||i.length<2)return;const n=i[0],r=i[i.length-1],o=i.slice(1,-1).map(c=>({location:new google.maps.LatLng(c.lat,c.lng),stopover:!0}));try{const c=await new Promise((h,g)=>{dn.route({origin:new google.maps.LatLng(n.lat,n.lng),destination:new google.maps.LatLng(r.lat,r.lng),waypoints:o,travelMode:google.maps.TravelMode.DRIVING,optimizeWaypoints:!1},(T,S)=>{S==="OK"?h(T):g(new Error(`Directions API: ${S}`))})}),l=new google.maps.DirectionsRenderer({map:te,directions:c,suppressMarkers:!0,polylineOptions:{strokeColor:e,strokeWeight:4,strokeOpacity:.8}});return un.push(l),l}catch(c){return console.warn("Directions API呼び出し失敗。直線ポリラインで代替:",c),Gl(i,e)}}async function gs(i){if(!window.google||!window.google.maps)return null;const e=new google.maps.DistanceMatrixService,n=i.map(r=>new google.maps.LatLng(r.lat,r.lng));try{return(await new Promise((c,l)=>{e.getDistanceMatrix({origins:n,destinations:n,travelMode:google.maps.TravelMode.DRIVING,unitSystem:google.maps.UnitSystem.METRIC},(h,g)=>{g==="OK"?c(h):l(new Error(`Distance Matrix API: ${g}`))})})).rows.map(c=>c.elements.map(l=>({distance:l.status==="OK"?l.distance.value/1e3:null,duration:l.status==="OK"?Math.ceil(l.duration.value/60):null})))}catch(r){return console.error("Distance Matrix取得失敗:",r),null}}function Jl(){kt.forEach(i=>i.setMap(null)),kt=[],ln.forEach(i=>i.setMap(null)),ln=[],un.forEach(i=>i.setMap(null)),un=[],At&&At.close()}function Xl(){if(!te||kt.length===0)return;const i=new google.maps.LatLngBounds;kt.forEach(e=>i.extend(e.getPosition())),te.fitBounds(i,50)}function Yl(){return[{elementType:"geometry",stylers:[{color:"#1d2c4d"}]},{elementType:"labels.text.fill",stylers:[{color:"#8ec3b9"}]},{elementType:"labels.text.stroke",stylers:[{color:"#1a3646"}]},{featureType:"road",elementType:"geometry",stylers:[{color:"#304a7d"}]},{featureType:"road",elementType:"geometry.stroke",stylers:[{color:"#255763"}]},{featureType:"road.highway",elementType:"geometry",stylers:[{color:"#2c6675"}]},{featureType:"water",elementType:"geometry",stylers:[{color:"#17263c"}]},{featureType:"poi",elementType:"labels",stylers:[{visibility:"off"}]}]}const ci={qualifications:{label:"資格",options:["介護福祉士","実務者研修修了","初任者研修修了","看護師","ヘルパー2級"]},services:{label:"対応可能サービス",options:["身体介護","生活援助","通院等乗降介助","医療的ケア"]},physical:{label:"身体的対応力",options:["重介護対応可","移乗介助可","入浴介助可","二人介助対応可"]},special:{label:"特別スキル",options:["認知症ケア","ターミナルケア","精神障害対応","障害児支援"]}},Ql=["要支援1","要支援2","要介護1","要介護2","要介護3","要介護4","要介護5"],ro=["身体介護","生活援助","通院等乗降介助","医療的ケア"],Zl=["男性","女性"],ed=["指定なし","男性希望","女性希望"],vs=["#4A90D9","#E74C3C","#2ECC71","#F39C12","#9B59B6","#1ABC9C","#E67E22","#3498DB","#E91E63","#00BCD4","#8BC34A","#FF5722"],vt={requiredSkill:1e3,genderMatch:2e3,staffType:500,proximity:30},Zi=25,ne={name:"事業所（拠点）",address:"〒501-3304 岐阜県加茂郡富加町高畑２９１",lat:35.497,lng:136.993};let fn="all",li=Ze();async function td(){var n,r,o;const i=document.getElementById("page-container");i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
        <span class="material-icons-round">map</span>
        マップビュー
  ...
  `}}function nd(i,e){const n=document.getElementById("route-legend");n&&(n.innerHTML=`
    ...
    `)}let Ot=[];async function Dn(){const i=document.getElementById("page-container");Ot=await ge().catch(()=>[]),i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
  ...
  `),document.getElementById("sf-cancel").onclick=Oe,document.getElementById("sf-save").onclick=async()=>{const c=document.getElementById("sf-name").value.trim();if(!c){R("氏名を入力してください","warning");return}const l={name:c,gender:document.getElementById("sf-gender").value,address:document.getElementById("sf-address").value.trim(),workStart:document.getElementById("sf-work-start").value,workEnd:document.getElementById("sf-work-end").value,lat:(i==null?void 0:i.lat)||35.69+Math.random()*.03,lng:(i==null?void 0:i.lng)||139.69+Math.random()*.05,skills:{},color:(i==null?void 0:i.color)||vs[Ot.length%vs.length],isActive:!0};for(const[h]of Object.entries(ci)){const g=document.querySelectorAll(`input[name="skill-${h}"]:checked`);l.skills[h]=Array.from(g).map(T=>T.value)}try{e?(await Ml(i.id,l),R("職員情報を更新しました","success")):(await eo(l),R("職員を登録しました","success")),Oe(),await Dn()}catch(h){R("保存に失敗しました: "+h.message,"error")}}}document.addEventListener("click",async i=>{const e=i.target.closest("[data-edit-staff]");if(e){const r=Ot.find(o=>o.id===e.dataset.editStaff);r&&so(r)}const n=i.target.closest("[data-delete-staff]");if(n){const r=Ot.find(o=>o.id===n.dataset.deleteStaff);if(r&&await Sn("削除確認",`${r.name} を削除しますか？`))try{await $l(r.id),R(`${r.name} を削除しました`,"success"),await Dn()}catch{R("削除に失敗しました","error")}}});let di=[],ys=[];async function Cn(){const i=document.getElementById("page-container");try{const[e,n]=await Promise.all([De().catch(()=>[]),Wl().catch(()=>[])]);di=e,ys=n}catch(e){console.error("データの取得に失敗",e)}i.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">
  ...
  `,document.getElementById("schedule-date").addEventListener("change",e=>{We=e.target.value,ui()}),document.getElementById("btn-add-visit").addEventListener("click",ad),await ui()}async function ui(){const i=document.getElementById("schedule-content"),[e,n,r,o]=await Promise.all([ge().catch(()=>[]),De().catch(()=>[]),Rt(We).catch(()=>[]),Pn(We).catch(()=>[])]);if(r.length===0){i.innerHTML=`
    ...
    `;return}const c={};let l=0,h=0,g=0;for(const S of r)c[S.staffId]||(c[S.staffId]=[]),c[S.staffId].push(S);let T="";if(window.isAdmin){for(const[E,A]of Object.entries(c)){const D=e.find(P=>P.id===E);if(!D)continue;const L=parseInt(D.wage)||1500,O=o.find(P=>P.staffId===E);O&&(g+=(O.totalDistance||0)*25),A.sort((P,F)=>(P.startTime||P.scheduledTime||"").localeCompare(F.startTime||F.scheduledTime||"")),A.forEach((P,F)=>{l+=parseInt(P.income)||3e3,h+=L*((P.duration||60)/60);let U=10;if(O&&O.schedule){const N=O.schedule.find(q=>q.clientId===P.clientId);N&&(U=N.travelTimeFromPrev||10)}P.calculatedTravelTime=U})}const S=l-h-g,b=l>0?Math.round(S/l*100):0;T=`
      ...
      ${Object.entries(c).map(([S,b])=>{const E=e.find(A=>A.id===S);return`
          <div class="card" style="border-left:4px solid ${(E==null?void 0:E.color)||"#999"}">
            ...
            <div class="schedule-timeline">
              ${b.map((A,D)=>{const L=n.find(U=>U.id===A.clientId),O=A.startTime||A.scheduledTime||"--:--";let P="",F="";if(D>0){const U=b[D-1],N=U.startTime||U.scheduledTime,q=A.calculatedTravelTime||10;if(N&&O!=="--:--"){const[H,v]=N.split(":").map(Number),[u,m]=O.split(":").map(Number),y=H*60+v+(U.duration||60),_=u*60+m-y;_<q&&(F=`
      ...
      ${Object.entries(c).map(([l,h])=>{var T,S,b;const g=o[l];return`
          <div class="card" style="border-left:4px solid ${((T=h.staff)==null?void 0:T.color)||"#999"}">
            ...
            <div style="display:flex;flex-direction:column;gap:6px">
              ...
              ${((g==null?void 0:g.schedule)||[]).filter(E=>E.pointIndex!==0||g.schedule.indexOf(E)===g.schedule.length-1).map((E,A,D)=>{var L,O,P,F;return E.pointIndex===0&&A===D.length-1?`<div style="font-size:.8rem;color:var(--text-muted);display:flex;align-items:center;gap:4px">
                      <span class="material-icons-round" style="font-size:16px;color:var(--secondary)">business</span>
                      ${E.arrivalTime} 事業所帰着
                    </div>`:(h.clients.find(U=>(g.route[g.schedule.indexOf(E)],!0)),`<div class="visit-card">
                    <div style="display:flex;justify-content:space-between;align-items:center">
                      <strong style="font-size:.85rem">${E.arrivalTime} ${((O=(L=h.clients[A])==null?void 0:L.client)==null?void 0:O.name)||"利用者"}</strong>
  ...
  `,await en(),(e=document.getElementById("revenue-date-picker"))==null||e.addEventListener("change",r=>{bt=r.target.value,en()}),(n=document.getElementById("btn-refresh-revenue"))==null||n.addEventListener("click",()=>{en()})}async function en(){const i=document.getElementById("revenue-content");if(!i)return;const[e,n,r,o]=await Promise.all([ge(),De(),Rt(bt),Pn(bt)]);if(r.length===0){i.innerHTML=`
      <div class="empty-state">
        <span class="material-icons-round" style="font-size:48px;opacity:.2">event_busy</span>
        <p>${Et(bt)} の訪問予定データがありません。</p>
      </div>
    `;return}let c=0,l=0,h=0,g=r.length;r.filter(E=>E.status==="completed").length;const T=e.map(E=>{const A=o.filter(N=>N.staffId===E.id),D=r.filter(N=>N.staffId===E.id);let L=0,O=0,P=0,F=0,U=0;return D.forEach(N=>{L+=N.income||0}),A.forEach(N=>{if(F+=N.totalDistance||0,P+=(N.totalDistance||0)*Zi,N.schedule&&N.schedule.length>=2){const q=N.schedule[0].arrivalMinutes;U=N.schedule[N.schedule.length-1].arrivalMinutes-q,O=U/60*(parseInt(E.wage)||2e3)}}),{...E,count:D.length,revenue:L,laborCost:O,vehicleCost:P,profit:L-O-P,workMinutes:U}}).filter(E=>E.count>0||E.revenue>0).sort((E,A)=>A.profit-E.profit);T.forEach(E=>{c+=E.revenue,l+=E.laborCost,h+=E.vehicleCost});const S=c-l-h,b=c>0?S/c*100:0;i.innerHTML=`
    <!-- メインKPI -->
    <div class="grid grid-4" style="margin-bottom:24px">
